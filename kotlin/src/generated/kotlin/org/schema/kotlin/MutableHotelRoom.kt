...
import org.schema.*
class MutableHotelRoom {
  private val map = HashMap<String,Any>()
  var bed: Any
    get() = map["bed"]!!
    set(value) { map["bed"] = value }
  fun bedBedDetails(builder: MutableBedDetails.() -> Unit) { map["bed"] = MutableBedDetails().apply(builder).build() }
  fun bedBedType(builder: MutableBedType.() -> Unit) { map["bed"] = MutableBedType().apply(builder).build() }
  var occupancy: QuantitativeValue
    get() = map["occupancy"] as QuantitativeValue
    set(value) { map["occupancy"] = value }
  fun occupancy(builder: MutableQuantitativeValue.() -> Unit) { map["occupancy"] = MutableQuantitativeValue().apply(builder).build() }
  ...
  var floorSize: QuantitativeValue
    get() = map["floorSize"] as QuantitativeValue
    set(value) { map["floorSize"] = value }
  fun floorSize(builder: MutableQuantitativeValue.() -> Unit) { map["floorSize"] = MutableQuantitativeValue().apply(builder).build() }
  var permittedUsage: String
    get() = map["permittedUsage"] as String
    set(value) { map["permittedUsage"] = value }
  var petsAllowed: Any
    get() = map["petsAllowed"]!!
  ...
  fun build() = org.schema.HotelRoom.Builder(map).build()
}
