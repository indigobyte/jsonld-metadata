...
class MutableCourse {
  ...
  var courseCode: String
    get() = map["courseCode"] as String
    set(value) { map["courseCode"] = value }
  var coursePrerequisites: Any
    get() = map["coursePrerequisites"]!!
    set(value) { map["coursePrerequisites"] = value }
  fun coursePrerequisitesAlignmentObject(builder: MutableAlignmentObject.() -> Unit) { map["coursePrerequisites"] = MutableAlignmentObject().apply(builder).build() }
  fun coursePrerequisitesCourse(builder: MutableCourse.() -> Unit) { map["coursePrerequisites"] = MutableCourse().apply(builder).build() }
  var hasCourseInstance: CourseInstance
    get() = map["hasCourseInstance"] as CourseInstance
    set(value) { map["hasCourseInstance"] = value }
  fun hasCourseInstance(builder: MutableCourseInstance.() -> Unit) { map["hasCourseInstance"] = MutableCourseInstance().apply(builder).build() }
  ...
  fun build() = org.schema.Course.Builder(map).build()
}
