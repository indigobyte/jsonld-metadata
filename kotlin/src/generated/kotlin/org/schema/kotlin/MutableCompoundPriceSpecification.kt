...
class MutableCompoundPriceSpecification {
  ...
  var priceComponent: UnitPriceSpecification
    get() = map["priceComponent"] as UnitPriceSpecification
    set(value) { map["priceComponent"] = value }
  fun priceComponent(builder: MutableUnitPriceSpecification.() -> Unit) { map["priceComponent"] = MutableUnitPriceSpecification().apply(builder).build() }
