...
import org.schema.*
class MutableMusicGroup {
  private val map = HashMap<String,Any>()
  var album: MusicAlbum
    get() = map["album"] as MusicAlbum
    set(value) { map["album"] = value }
  fun album(builder: MutableMusicAlbum.() -> Unit) { map["album"] = MutableMusicAlbum().apply(builder).build() }
  var genre: String
  ...
  fun build() = org.schema.MusicGroup.Builder(map).build()
}
