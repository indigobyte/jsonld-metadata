...
import org.schema.*
class MutableMusicComposition {
  private val map = HashMap<String,Any>()
  var musicArrangement: MusicComposition
    get() = map["musicArrangement"] as MusicComposition
    set(value) { map["musicArrangement"] = value }
  fun musicArrangement(builder: MutableMusicComposition.() -> Unit) { map["musicArrangement"] = MutableMusicComposition().apply(builder).build() }
  var composer: Any
    get() = map["composer"]!!
  ...
  var firstPerformance: Event
    get() = map["firstPerformance"] as Event
    set(value) { map["firstPerformance"] = value }
  fun firstPerformance(builder: MutableEvent.() -> Unit) { map["firstPerformance"] = MutableEvent().apply(builder).build() }
  var includedComposition: MusicComposition
    get() = map["includedComposition"] as MusicComposition
    set(value) { map["includedComposition"] = value }
  fun includedComposition(builder: MutableMusicComposition.() -> Unit) { map["includedComposition"] = MutableMusicComposition().apply(builder).build() }
  var iswcCode: String
    get() = map["iswcCode"] as String
    set(value) { map["iswcCode"] = value }
  var lyricist: Person
    get() = map["lyricist"] as Person
    set(value) { map["lyricist"] = value }
  fun lyricist(builder: MutablePerson.() -> Unit) { map["lyricist"] = MutablePerson().apply(builder).build() }
  var musicCompositionForm: String
    get() = map["musicCompositionForm"] as String
    set(value) { map["musicCompositionForm"] = value }
  var musicalKey: String
    get() = map["musicalKey"] as String
    set(value) { map["musicalKey"] = value }
  var recordedAs: MusicRecording
    get() = map["recordedAs"] as MusicRecording
    set(value) { map["recordedAs"] = value }
  fun recordedAs(builder: MutableMusicRecording.() -> Unit) { map["recordedAs"] = MutableMusicRecording().apply(builder).build() }
  var lyrics: CreativeWork
    get() = map["lyrics"] as CreativeWork
    set(value) { map["lyrics"] = value }
  fun lyrics(builder: MutableCreativeWork.() -> Unit) { map["lyrics"] = MutableCreativeWork().apply(builder).build() }
  ...
  fun build() = org.schema.MusicComposition.Builder(map).build()
}
