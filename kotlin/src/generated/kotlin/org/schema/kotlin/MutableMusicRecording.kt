...
class MutableMusicRecording {
  ...
  var inAlbum: MusicAlbum
    get() = map["inAlbum"] as MusicAlbum
    set(value) { map["inAlbum"] = value }
  fun inAlbum(builder: MutableMusicAlbum.() -> Unit) { map["inAlbum"] = MutableMusicAlbum().apply(builder).build() }
  var inPlaylist: MusicPlaylist
    get() = map["inPlaylist"] as MusicPlaylist
    set(value) { map["inPlaylist"] = value }
  fun inPlaylist(builder: MutableMusicPlaylist.() -> Unit) { map["inPlaylist"] = MutableMusicPlaylist().apply(builder).build() }
  var isrcCode: String
    get() = map["isrcCode"] as String
    set(value) { map["isrcCode"] = value }
  var recordingOf: MusicComposition
    get() = map["recordingOf"] as MusicComposition
    set(value) { map["recordingOf"] = value }
  fun recordingOf(builder: MutableMusicComposition.() -> Unit) { map["recordingOf"] = MutableMusicComposition().apply(builder).build() }
  ...
  fun build() = org.schema.MusicRecording.Builder(map).build()
}
