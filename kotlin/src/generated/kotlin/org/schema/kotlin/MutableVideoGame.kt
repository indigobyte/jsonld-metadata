...
class MutableVideoGame {
  ...
  var gameTip: CreativeWork
    get() = map["gameTip"] as CreativeWork
    set(value) { map["gameTip"] = value }
  fun gameTip(builder: MutableCreativeWork.() -> Unit) { map["gameTip"] = MutableCreativeWork().apply(builder).build() }
  ...
  var gameServer: GameServer
    get() = map["gameServer"] as GameServer
    set(value) { map["gameServer"] = value }
  fun gameServer(builder: MutableGameServer.() -> Unit) { map["gameServer"] = MutableGameServer().apply(builder).build() }
  ...
  fun build() = org.schema.VideoGame.Builder(map).build()
}
