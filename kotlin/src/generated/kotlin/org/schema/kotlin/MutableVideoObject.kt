...
class MutableVideoObject {
  ...
  var transcript: String
    get() = map["transcript"] as String
    set(value) { map["transcript"] = value }
  var videoFrameSize: String
    get() = map["videoFrameSize"] as String
    set(value) { map["videoFrameSize"] = value }
  var videoQuality: String
    get() = map["videoQuality"] as String
    set(value) { map["videoQuality"] = value }
  ...
  fun build() = org.schema.VideoObject.Builder(map).build()
}
