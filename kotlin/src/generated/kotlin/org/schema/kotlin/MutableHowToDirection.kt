...
class MutableHowToDirection {
  ...
  var afterMedia: Any
    get() = map["afterMedia"]!!
    set(value) { map["afterMedia"] = value }
  fun afterMediaMediaObject(builder: MutableMediaObject.() -> Unit) { map["afterMedia"] = MutableMediaObject().apply(builder).build() }
  var beforeMedia: Any
    get() = map["beforeMedia"]!!
    set(value) { map["beforeMedia"] = value }
  fun beforeMediaMediaObject(builder: MutableMediaObject.() -> Unit) { map["beforeMedia"] = MutableMediaObject().apply(builder).build() }
  var duringMedia: Any
    get() = map["duringMedia"]!!
    set(value) { map["duringMedia"] = value }
  fun duringMediaMediaObject(builder: MutableMediaObject.() -> Unit) { map["duringMedia"] = MutableMediaObject().apply(builder).build() }
  ...
  fun build() = org.schema.HowToDirection.Builder(map).build()
}
