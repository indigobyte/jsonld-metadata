...
import org.schema.*
class MutableDataFeed {
  private val map = HashMap<String,Any>()
  var dataFeedElement: Any
    get() = map["dataFeedElement"]!!
    set(value) { map["dataFeedElement"] = value }
  fun dataFeedElementDataFeedItem(builder: MutableDataFeedItem.() -> Unit) { map["dataFeedElement"] = MutableDataFeedItem().apply(builder).build() }
  fun dataFeedElementThing(builder: MutableThing.() -> Unit) { map["dataFeedElement"] = MutableThing().apply(builder).build() }
  var includedInDataCatalog: DataCatalog
    get() = map["includedInDataCatalog"] as DataCatalog
    set(value) { map["includedInDataCatalog"] = value }
  fun includedInDataCatalog(builder: MutableDataCatalog.() -> Unit) { map["includedInDataCatalog"] = MutableDataCatalog().apply(builder).build() }
  var distribution: DataDownload
    get() = map["distribution"] as DataDownload
    set(value) { map["distribution"] = value }
  fun distribution(builder: MutableDataDownload.() -> Unit) { map["distribution"] = MutableDataDownload().apply(builder).build() }
  var issn: Identifier
  ...
  fun build() = org.schema.DataFeed.Builder(map).build()
}
