...
import org.schema.*
class MutableScheduleAction {
  private val map = HashMap<String,Any>()
  var scheduledTime: java.util.Date
    get() = map["scheduledTime"] as java.util.Date
    set(value) { map["scheduledTime"] = value }
  var agent: Any
    get() = map["agent"]!!
  ...
  fun build() = org.schema.ScheduleAction.Builder(map).build()
}
