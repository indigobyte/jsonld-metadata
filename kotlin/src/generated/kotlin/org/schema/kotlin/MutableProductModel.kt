...
import org.schema.*
class MutableProductModel {
  private val map = HashMap<String,Any>()
  var isVariantOf: ProductModel
    get() = map["isVariantOf"] as ProductModel
    set(value) { map["isVariantOf"] = value }
  fun isVariantOf(builder: MutableProductModel.() -> Unit) { map["isVariantOf"] = MutableProductModel().apply(builder).build() }
  var predecessorOf: ProductModel
    get() = map["predecessorOf"] as ProductModel
    set(value) { map["predecessorOf"] = value }
  fun predecessorOf(builder: MutableProductModel.() -> Unit) { map["predecessorOf"] = MutableProductModel().apply(builder).build() }
  var successorOf: ProductModel
    get() = map["successorOf"] as ProductModel
    set(value) { map["successorOf"] = value }
  fun successorOf(builder: MutableProductModel.() -> Unit) { map["successorOf"] = MutableProductModel().apply(builder).build() }
  ...
  fun build() = org.schema.ProductModel.Builder(map).build()
}
