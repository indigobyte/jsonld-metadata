...
class MutableQuestion {
  ...
  var acceptedAnswer: Any
    get() = map["acceptedAnswer"]!!
    set(value) { map["acceptedAnswer"] = value }
  fun acceptedAnswerAnswer(builder: MutableAnswer.() -> Unit) { map["acceptedAnswer"] = MutableAnswer().apply(builder).build() }
  fun acceptedAnswerItemList(builder: MutableItemList.() -> Unit) { map["acceptedAnswer"] = MutableItemList().apply(builder).build() }
  var suggestedAnswer: SuggestedAnswer
    get() = map["suggestedAnswer"] as SuggestedAnswer
