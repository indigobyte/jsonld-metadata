...
import org.schema.*
class MutableQuestion {
  private val map = HashMap<String,Any>()
  var upvoteCount: Int
    get() = map["upvoteCount"] as Int
    set(value) { map["upvoteCount"] = value }
  var downvoteCount: Int
    get() = map["downvoteCount"] as Int
    set(value) { map["downvoteCount"] = value }
  var answerCount: Int
    get() = map["answerCount"] as Int
    set(value) { map["answerCount"] = value }
  var acceptedAnswer: AcceptedAnswer
    get() = map["acceptedAnswer"] as AcceptedAnswer
    set(value) { map["acceptedAnswer"] = value }
  var suggestedAnswer: Any
    get() = map["suggestedAnswer"]!!
    set(value) { map["suggestedAnswer"] = value }
  fun suggestedAnswerAnswer(builder: MutableAnswer.() -> Unit) { map["suggestedAnswer"] = MutableAnswer().apply(builder).build() }
  fun suggestedAnswerItemList(builder: MutableItemList.() -> Unit) { map["suggestedAnswer"] = MutableItemList().apply(builder).build() }
  ...
  fun build() = org.schema.Question.Builder(map).build()
}
