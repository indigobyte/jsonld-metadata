...
import org.schema.*
class MutableMediaSubscription {
  private val map = HashMap<String,Any>()
  var authenticator: Organization
    get() = map["authenticator"] as Organization
    set(value) { map["authenticator"] = value }
  fun authenticator(builder: MutableOrganization.() -> Unit) { map["authenticator"] = MutableOrganization().apply(builder).build() }
  ...
  fun build() = org.schema.MediaSubscription.Builder(map).build()
}
