...
import org.schema.*
class MutableSourceCodeRevision {
  private val map = HashMap<String,Any>()
  var tag: String
    get() = map["tag"] as String
    set(value) { map["tag"] = value }
  var branch: String
    get() = map["branch"] as String
    set(value) { map["branch"] = value }
  ...
  fun build() = org.schema.SourceCodeRevision.Builder(map).build()
}
