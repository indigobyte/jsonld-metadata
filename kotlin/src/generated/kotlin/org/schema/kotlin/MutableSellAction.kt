...
import org.schema.*
class MutableSellAction {
  private val map = HashMap<String,Any>()
  var buyer: Person
    get() = map["buyer"] as Person
    set(value) { map["buyer"] = value }
  fun buyer(builder: MutablePerson.() -> Unit) { map["buyer"] = MutablePerson().apply(builder).build() }
  var price: Any
    get() = map["price"]!!
  ...
  fun build() = org.schema.SellAction.Builder(map).build()
}
