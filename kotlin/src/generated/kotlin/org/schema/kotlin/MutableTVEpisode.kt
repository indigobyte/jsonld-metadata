...
class MutableTVEpisode {
  ...
  var episodeNumber: Any
    get() = map["episodeNumber"]!!
    set(value) { map["episodeNumber"] = value }
  var musicBy: Any
    get() = map["musicBy"]!!
  ...
  var partOfSeason: IsPartOf
    get() = map["partOfSeason"] as IsPartOf
    set(value) { map["partOfSeason"] = value }
  var partOfSeries: IsPartOf
    get() = map["partOfSeries"] as IsPartOf
    set(value) { map["partOfSeries"] = value }
  ...
  fun build() = org.schema.TVEpisode.Builder(map).build()
}
