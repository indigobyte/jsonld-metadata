...
import org.schema.*
class MutablePublicationVolume {
  ...
  var volumeNumber: VolumeNumber
    get() = map["volumeNumber"] as VolumeNumber
    set(value) { map["volumeNumber"] = value }
  ...
  fun build() = org.schema.PublicationVolume.Builder(map).build()
}
