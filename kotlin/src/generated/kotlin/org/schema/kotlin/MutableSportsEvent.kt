...
class MutableSportsEvent {
  ...
  var competitor: Any
    get() = map["competitor"]!!
    set(value) { map["competitor"] = value }
  fun competitorPerson(builder: MutablePerson.() -> Unit) { map["competitor"] = MutablePerson().apply(builder).build() }
  fun competitorSportsTeam(builder: MutableSportsTeam.() -> Unit) { map["competitor"] = MutableSportsTeam().apply(builder).build() }
