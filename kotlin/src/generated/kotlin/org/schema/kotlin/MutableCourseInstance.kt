...
import org.schema.*
class MutableCourseInstance {
  private val map = HashMap<String,Any>()
  var courseMode: String
    get() = map["courseMode"] as String
    set(value) { map["courseMode"] = value }
  var instructor: Person
    get() = map["instructor"] as Person
    set(value) { map["instructor"] = value }
  fun instructor(builder: MutablePerson.() -> Unit) { map["instructor"] = MutablePerson().apply(builder).build() }
  ...
  fun build() = org.schema.CourseInstance.Builder(map).build()
}
