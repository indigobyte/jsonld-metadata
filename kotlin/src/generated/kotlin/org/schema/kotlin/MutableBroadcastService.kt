...
import org.schema.*
class MutableBroadcastService {
  private val map = HashMap<String,Any>()
  var broadcaster: Organization
    get() = map["broadcaster"] as Organization
    set(value) { map["broadcaster"] = value }
  fun broadcaster(builder: MutableOrganization.() -> Unit) { map["broadcaster"] = MutableOrganization().apply(builder).build() }
  var parentService: BroadcastService
    get() = map["parentService"] as BroadcastService
    set(value) { map["parentService"] = value }
  fun parentService(builder: MutableBroadcastService.() -> Unit) { map["parentService"] = MutableBroadcastService().apply(builder).build() }
  var videoFormat: String
    get() = map["videoFormat"] as String
    set(value) { map["videoFormat"] = value }
  var broadcastAffiliateOf: Organization
    get() = map["broadcastAffiliateOf"] as Organization
    set(value) { map["broadcastAffiliateOf"] = value }
  fun broadcastAffiliateOf(builder: MutableOrganization.() -> Unit) { map["broadcastAffiliateOf"] = MutableOrganization().apply(builder).build() }
  var broadcastDisplayName: String
    get() = map["broadcastDisplayName"] as String
    set(value) { map["broadcastDisplayName"] = value }
  ...
  fun build() = org.schema.BroadcastService.Builder(map).build()
}
