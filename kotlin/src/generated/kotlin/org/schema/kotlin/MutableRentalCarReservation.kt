...
import org.schema.*
class MutableRentalCarReservation {
  private val map = HashMap<String,Any>()
  var pickupLocation: Place
    get() = map["pickupLocation"] as Place
    set(value) { map["pickupLocation"] = value }
  fun pickupLocation(builder: MutablePlace.() -> Unit) { map["pickupLocation"] = MutablePlace().apply(builder).build() }
  var dropoffLocation: Place
    get() = map["dropoffLocation"] as Place
    set(value) { map["dropoffLocation"] = value }
  fun dropoffLocation(builder: MutablePlace.() -> Unit) { map["dropoffLocation"] = MutablePlace().apply(builder).build() }
  var pickupTime: java.util.Date
    get() = map["pickupTime"] as java.util.Date
    set(value) { map["pickupTime"] = value }
  var dropoffTime: java.util.Date
    get() = map["dropoffTime"] as java.util.Date
    set(value) { map["dropoffTime"] = value }
  ...
  fun build() = org.schema.RentalCarReservation.Builder(map).build()
}
