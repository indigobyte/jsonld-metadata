...
import org.schema.*
class MutableReservationPackage {
  private val map = HashMap<String,Any>()
  var subReservation: Reservation
    get() = map["subReservation"] as Reservation
    set(value) { map["subReservation"] = value }
  fun subReservation(builder: MutableReservation.() -> Unit) { map["subReservation"] = MutableReservation().apply(builder).build() }
  ...
  fun build() = org.schema.ReservationPackage.Builder(map).build()
}
