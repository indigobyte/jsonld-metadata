...
import org.schema.*
class MutableMusicRelease {
  private val map = HashMap<String,Any>()
  var catalogNumber: String
    get() = map["catalogNumber"] as String
    set(value) { map["catalogNumber"] = value }
  var creditedTo: Any
    get() = map["creditedTo"]!!
    set(value) { map["creditedTo"] = value }
  fun creditedToOrganization(builder: MutableOrganization.() -> Unit) { map["creditedTo"] = MutableOrganization().apply(builder).build() }
  fun creditedToPerson(builder: MutablePerson.() -> Unit) { map["creditedTo"] = MutablePerson().apply(builder).build() }
  var musicReleaseFormat: MusicReleaseFormatType
    get() = map["musicReleaseFormat"] as MusicReleaseFormatType
    set(value) { map["musicReleaseFormat"] = value }
  var recordLabel: Organization
    get() = map["recordLabel"] as Organization
    set(value) { map["recordLabel"] = value }
  fun recordLabel(builder: MutableOrganization.() -> Unit) { map["recordLabel"] = MutableOrganization().apply(builder).build() }
  var releaseOf: MusicAlbum
    get() = map["releaseOf"] as MusicAlbum
    set(value) { map["releaseOf"] = value }
  fun releaseOf(builder: MutableMusicAlbum.() -> Unit) { map["releaseOf"] = MutableMusicAlbum().apply(builder).build() }
  var numTracks: Int
    get() = map["numTracks"] as Int
    set(value) { map["numTracks"] = value }
  var track: Any
    get() = map["track"]!!
    set(value) { map["track"] = value }
  fun trackItemList(builder: MutableItemList.() -> Unit) { map["track"] = MutableItemList().apply(builder).build() }
  fun trackMusicRecording(builder: MutableMusicRecording.() -> Unit) { map["track"] = MutableMusicRecording().apply(builder).build() }
  ...
  fun build() = org.schema.MusicRelease.Builder(map).build()
}
