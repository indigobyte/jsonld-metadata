...
import org.schema.*
class MutableUserComments {
  private val map = HashMap<String,Any>()
  var commentText: String
    get() = map["commentText"] as String
    set(value) { map["commentText"] = value }
  var commentTime: java.util.Date
    get() = map["commentTime"] as java.util.Date
    set(value) { map["commentTime"] = value }
  var creator: Any
    get() = map["creator"]!!
  ...
  var discusses: CreativeWork
    get() = map["discusses"] as CreativeWork
    set(value) { map["discusses"] = value }
  fun discusses(builder: MutableCreativeWork.() -> Unit) { map["discusses"] = MutableCreativeWork().apply(builder).build() }
  ...
  fun build() = org.schema.UserComments.Builder(map).build()
}
