...
import org.schema.*
class MutableClaimReview {
  private val map = HashMap<String,Any>()
  var claimReviewed: String
    get() = map["claimReviewed"] as String
    set(value) { map["claimReviewed"] = value }
  ...
  var reviewBody: String
    get() = map["reviewBody"] as String
    set(value) { map["reviewBody"] = value }
  var reviewRating: Rating
    get() = map["reviewRating"] as Rating
    set(value) { map["reviewRating"] = value }
  fun reviewRating(builder: MutableRating.() -> Unit) { map["reviewRating"] = MutableRating().apply(builder).build() }
  ...
  fun build() = org.schema.ClaimReview.Builder(map).build()
}
