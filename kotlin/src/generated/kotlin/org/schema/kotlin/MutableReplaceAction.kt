...
class MutableReplaceAction {
  ...
  var replacee: Replacee
    get() = map["replacee"] as Replacee
    set(value) { map["replacee"] = value }
  var replacer: Replacer
    get() = map["replacer"] as Replacer
    set(value) { map["replacer"] = value }
  var collection: Collection
    get() = map["collection"] as Collection
    set(value) { map["collection"] = value }
  var targetCollection: TargetCollection
    get() = map["targetCollection"] as TargetCollection
