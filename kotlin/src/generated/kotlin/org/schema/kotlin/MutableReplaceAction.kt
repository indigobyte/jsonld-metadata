...
import org.schema.*
class MutableReplaceAction {
  private val map = HashMap<String,Any>()
  var replacee: Thing
    get() = map["replacee"] as Thing
    set(value) { map["replacee"] = value }
  fun replacee(builder: MutableThing.() -> Unit) { map["replacee"] = MutableThing().apply(builder).build() }
  var replacer: Thing
    get() = map["replacer"] as Thing
    set(value) { map["replacer"] = value }
  fun replacer(builder: MutableThing.() -> Unit) { map["replacer"] = MutableThing().apply(builder).build() }
  var targetCollection: Thing
    get() = map["targetCollection"] as Thing
    set(value) { map["targetCollection"] = value }
  fun targetCollection(builder: MutableThing.() -> Unit) { map["targetCollection"] = MutableThing().apply(builder).build() }
  var agent: Any
    get() = map["agent"]!!
  ...
  fun build() = org.schema.ReplaceAction.Builder(map).build()
}
