...
import org.schema.*
class MutableImageObject {
  private val map = HashMap<String,Any>()
  var caption: Any
    get() = map["caption"]!!
    set(value) { map["caption"] = value }
  fun captionMediaObject(builder: MutableMediaObject.() -> Unit) { map["caption"] = MutableMediaObject().apply(builder).build() }
  var exifData: Any
    get() = map["exifData"]!!
    set(value) { map["exifData"] = value }
  fun exifDataPropertyValue(builder: MutablePropertyValue.() -> Unit) { map["exifData"] = MutablePropertyValue().apply(builder).build() }
  var representativeOfPage: Boolean
    get() = map["representativeOfPage"] as Boolean
    set(value) { map["representativeOfPage"] = value }
  var thumbnail: ImageObject
    get() = map["thumbnail"] as ImageObject
    set(value) { map["thumbnail"] = value }
  fun thumbnail(builder: MutableImageObject.() -> Unit) { map["thumbnail"] = MutableImageObject().apply(builder).build() }
  ...
  fun build() = org.schema.ImageObject.Builder(map).build()
}
