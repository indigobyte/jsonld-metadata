...
class MutableBook {
  ...
  var bookEdition: String
    get() = map["bookEdition"] as String
    set(value) { map["bookEdition"] = value }
  var bookFormat: BookFormatType
    get() = map["bookFormat"] as BookFormatType
    set(value) { map["bookFormat"] = value }
  var illustrator: Person
    get() = map["illustrator"] as Person
    set(value) { map["illustrator"] = value }
  fun illustrator(builder: MutablePerson.() -> Unit) { map["illustrator"] = MutablePerson().apply(builder).build() }
  var isbn: Identifier
    get() = map["isbn"] as Identifier
    set(value) { map["isbn"] = value }
  var numberOfPages: Int
    get() = map["numberOfPages"] as Int
    set(value) { map["numberOfPages"] = value }
  ...
  fun build() = org.schema.Book.Builder(map).build()
}
