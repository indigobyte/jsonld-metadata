...
import org.schema.*
class MutableSoftwareSourceCode {
  private val map = HashMap<String,Any>()
  var codeRepository: String
    get() = map["codeRepository"] as String
    set(value) { map["codeRepository"] = value }
  var programmingLanguage: Any
    get() = map["programmingLanguage"]!!
    set(value) { map["programmingLanguage"] = value }
  fun programmingLanguageComputerLanguage(builder: MutableComputerLanguage.() -> Unit) { map["programmingLanguage"] = MutableComputerLanguage().apply(builder).build() }
  var runtimePlatform: String
    get() = map["runtimePlatform"] as String
    set(value) { map["runtimePlatform"] = value }
  var codeSampleType: String
    get() = map["codeSampleType"] as String
    set(value) { map["codeSampleType"] = value }
  var targetProduct: SoftwareApplication
    get() = map["targetProduct"] as SoftwareApplication
    set(value) { map["targetProduct"] = value }
  fun targetProduct(builder: MutableSoftwareApplication.() -> Unit) { map["targetProduct"] = MutableSoftwareApplication().apply(builder).build() }
  ...
  fun build() = org.schema.SoftwareSourceCode.Builder(map).build()
}
