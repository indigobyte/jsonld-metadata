...
import org.schema.*
class MutableCommentAction {
  private val map = HashMap<String,Any>()
  var resultComment: Comment
    get() = map["resultComment"] as Comment
    set(value) { map["resultComment"] = value }
  fun resultComment(builder: MutableComment.() -> Unit) { map["resultComment"] = MutableComment().apply(builder).build() }
  var about: About
  ...
  fun build() = org.schema.CommentAction.Builder(map).build()
}
