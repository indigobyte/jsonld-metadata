...
import org.schema.*
class MutablePerformAction {
  private val map = HashMap<String,Any>()
  var entertainmentBusiness: EntertainmentBusiness
    get() = map["entertainmentBusiness"] as EntertainmentBusiness
    set(value) { map["entertainmentBusiness"] = value }
  fun entertainmentBusiness(builder: MutableEntertainmentBusiness.() -> Unit) { map["entertainmentBusiness"] = MutableEntertainmentBusiness().apply(builder).build() }
  ...
  fun build() = org.schema.PerformAction.Builder(map).build()
}
