...
import org.schema.*
class MutableLiveBlogPosting {
  private val map = HashMap<String,Any>()
  var coverageStartTime: java.util.Date
    get() = map["coverageStartTime"] as java.util.Date
    set(value) { map["coverageStartTime"] = value }
  var coverageEndTime: java.util.Date
    get() = map["coverageEndTime"] as java.util.Date
    set(value) { map["coverageEndTime"] = value }
  var liveBlogUpdate: BlogPosting
    get() = map["liveBlogUpdate"] as BlogPosting
    set(value) { map["liveBlogUpdate"] = value }
  fun liveBlogUpdate(builder: MutableBlogPosting.() -> Unit) { map["liveBlogUpdate"] = MutableBlogPosting().apply(builder).build() }
  var sharedContent: CreativeWork
    get() = map["sharedContent"] as CreativeWork
    set(value) { map["sharedContent"] = value }
  fun sharedContent(builder: MutableCreativeWork.() -> Unit) { map["sharedContent"] = MutableCreativeWork().apply(builder).build() }
  var articleBody: String
    get() = map["articleBody"] as String
    set(value) { map["articleBody"] = value }
  var articleSection: String
    get() = map["articleSection"] as String
    set(value) { map["articleSection"] = value }
  var wordCount: Int
    get() = map["wordCount"] as Int
    set(value) { map["wordCount"] = value }
  var pageEnd: Any
    get() = map["pageEnd"]!!
    set(value) { map["pageEnd"] = value }
  var pageStart: Any
    get() = map["pageStart"]!!
    set(value) { map["pageStart"] = value }
  var pagination: String
    get() = map["pagination"] as String
    set(value) { map["pagination"] = value }
  var speakable: Any
    get() = map["speakable"]!!
  ...
  fun build() = org.schema.LiveBlogPosting.Builder(map).build()
}
