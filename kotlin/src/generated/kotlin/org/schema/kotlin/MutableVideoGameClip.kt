...
class MutableVideoGameClip {
  ...
  var clipNumber: Position
    get() = map["clipNumber"] as Position
    set(value) { map["clipNumber"] = value }
  var director: Person
  ...
  var partOfEpisode: IsPartOf
    get() = map["partOfEpisode"] as IsPartOf
    set(value) { map["partOfEpisode"] = value }
  ...
  fun build() = org.schema.VideoGameClip.Builder(map).build()
}
