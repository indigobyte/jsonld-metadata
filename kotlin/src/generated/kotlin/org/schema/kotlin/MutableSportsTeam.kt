...
import org.schema.*
class MutableSportsTeam {
  private val map = HashMap<String,Any>()
  var coach: Person
    get() = map["coach"] as Person
    set(value) { map["coach"] = value }
  fun coach(builder: MutablePerson.() -> Unit) { map["coach"] = MutablePerson().apply(builder).build() }
  var athlete: Person
    get() = map["athlete"] as Person
    set(value) { map["athlete"] = value }
  fun athlete(builder: MutablePerson.() -> Unit) { map["athlete"] = MutablePerson().apply(builder).build() }
  var sport: String
    get() = map["sport"] as String
    set(value) { map["sport"] = value }
  ...
  fun build() = org.schema.SportsTeam.Builder(map).build()
}
