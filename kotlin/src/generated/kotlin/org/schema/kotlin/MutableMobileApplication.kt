...
import org.schema.*
class MutableMobileApplication {
  private val map = HashMap<String,Any>()
  var carrierRequirements: String
    get() = map["carrierRequirements"] as String
    set(value) { map["carrierRequirements"] = value }
  ...
  fun build() = org.schema.MobileApplication.Builder(map).build()
}
