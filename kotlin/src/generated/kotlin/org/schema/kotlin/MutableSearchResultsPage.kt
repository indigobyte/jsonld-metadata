...
import org.schema.*
class MutableSearchResultsPage {
  private val map = HashMap<String,Any>()
  var breadcrumb: Any
    get() = map["breadcrumb"]!!
    set(value) { map["breadcrumb"] = value }
  fun breadcrumbBreadcrumbList(builder: MutableBreadcrumbList.() -> Unit) { map["breadcrumb"] = MutableBreadcrumbList().apply(builder).build() }
  var lastReviewed: java.util.Date
    get() = map["lastReviewed"] as java.util.Date
    set(value) { map["lastReviewed"] = value }
  var mainContentOfPage: WebPageElement
    get() = map["mainContentOfPage"] as WebPageElement
    set(value) { map["mainContentOfPage"] = value }
  fun mainContentOfPage(builder: MutableWebPageElement.() -> Unit) { map["mainContentOfPage"] = MutableWebPageElement().apply(builder).build() }
  var primaryImageOfPage: ImageObject
    get() = map["primaryImageOfPage"] as ImageObject
    set(value) { map["primaryImageOfPage"] = value }
  fun primaryImageOfPage(builder: MutableImageObject.() -> Unit) { map["primaryImageOfPage"] = MutableImageObject().apply(builder).build() }
  var relatedLink: String
    get() = map["relatedLink"] as String
    set(value) { map["relatedLink"] = value }
  var reviewedBy: Any
    get() = map["reviewedBy"]!!
    set(value) { map["reviewedBy"] = value }
  fun reviewedByOrganization(builder: MutableOrganization.() -> Unit) { map["reviewedBy"] = MutableOrganization().apply(builder).build() }
  fun reviewedByPerson(builder: MutablePerson.() -> Unit) { map["reviewedBy"] = MutablePerson().apply(builder).build() }
  var significantLink: String
    get() = map["significantLink"] as String
    set(value) { map["significantLink"] = value }
  var specialty: Specialty
    get() = map["specialty"] as Specialty
    set(value) { map["specialty"] = value }
  var speakable: Any
    get() = map["speakable"]!!
    set(value) { map["speakable"] = value }
  fun speakableSpeakableSpecification(builder: MutableSpeakableSpecification.() -> Unit) { map["speakable"] = MutableSpeakableSpecification().apply(builder).build() }
  ...
  fun build() = org.schema.SearchResultsPage.Builder(map).build()
}
