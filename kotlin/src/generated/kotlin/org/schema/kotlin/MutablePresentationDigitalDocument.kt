...
import org.schema.*
class MutablePresentationDigitalDocument {
  private val map = HashMap<String,Any>()
  var hasDigitalDocumentPermission: DigitalDocumentPermission
    get() = map["hasDigitalDocumentPermission"] as DigitalDocumentPermission
    set(value) { map["hasDigitalDocumentPermission"] = value }
  fun hasDigitalDocumentPermission(builder: MutableDigitalDocumentPermission.() -> Unit) { map["hasDigitalDocumentPermission"] = MutableDigitalDocumentPermission().apply(builder).build() }
  ...
  fun build() = org.schema.PresentationDigitalDocument.Builder(map).build()
}
