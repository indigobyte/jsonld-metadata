...
import org.schema.*
class MutableSoftwareApplicationBuild {
  private val map = HashMap<String,Any>()
  var softwareApplication: SoftwareApplication
    get() = map["softwareApplication"] as SoftwareApplication
    set(value) { map["softwareApplication"] = value }
  fun softwareApplication(builder: MutableSoftwareApplication.() -> Unit) { map["softwareApplication"] = MutableSoftwareApplication().apply(builder).build() }
  var project: Project
  ...
  var status: Status
    get() = map["status"] as Status
    set(value) { map["status"] = value }
  var state: BuildState
    get() = map["state"] as BuildState
    set(value) { map["state"] = value }
  var message: String
    get() = map["message"] as String
    set(value) { map["message"] = value }
  var totalTestsCount: Int
    get() = map["totalTestsCount"] as Int
    set(value) { map["totalTestsCount"] = value }
  var successTestsCount: Int
    get() = map["successTestsCount"] as Int
    set(value) { map["successTestsCount"] = value }
  var failedTestsCount: Int
    get() = map["failedTestsCount"] as Int
    set(value) { map["failedTestsCount"] = value }
  var newlyFailedTestsCount: Int
    get() = map["newlyFailedTestsCount"] as Int
    set(value) { map["newlyFailedTestsCount"] = value }
  var ignoredTestsCount: Int
    get() = map["ignoredTestsCount"] as Int
    set(value) { map["ignoredTestsCount"] = value }
  var fixedTestsCount: Int
    get() = map["fixedTestsCount"] as Int
    set(value) { map["fixedTestsCount"] = value }
  ...
  fun build() = org.schema.SoftwareApplicationBuild.Builder(map).build()
}
