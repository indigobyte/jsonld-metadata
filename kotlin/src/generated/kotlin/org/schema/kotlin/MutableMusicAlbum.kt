...
import org.schema.*
class MutableMusicAlbum {
  private val map = HashMap<String,Any>()
  var byArtist: Any
    get() = map["byArtist"]!!
    set(value) { map["byArtist"] = value }
  fun byArtistMusicGroup(builder: MutableMusicGroup.() -> Unit) { map["byArtist"] = MutableMusicGroup().apply(builder).build() }
  fun byArtistPerson(builder: MutablePerson.() -> Unit) { map["byArtist"] = MutablePerson().apply(builder).build() }
  var albumProductionType: MusicAlbumProductionType
    get() = map["albumProductionType"] as MusicAlbumProductionType
    set(value) { map["albumProductionType"] = value }
  var albumReleaseType: MusicAlbumReleaseType
    get() = map["albumReleaseType"] as MusicAlbumReleaseType
    set(value) { map["albumReleaseType"] = value }
  var albumRelease: MusicRelease
    get() = map["albumRelease"] as MusicRelease
    set(value) { map["albumRelease"] = value }
  fun albumRelease(builder: MutableMusicRelease.() -> Unit) { map["albumRelease"] = MutableMusicRelease().apply(builder).build() }
  var numTracks: Int
  ...
  fun build() = org.schema.MusicAlbum.Builder(map).build()
}
