...
import org.schema.*
class MutableDeliveryEvent {
  private val map = HashMap<String,Any>()
  var accessCode: String
    get() = map["accessCode"] as String
    set(value) { map["accessCode"] = value }
  var availableFrom: java.util.Date
    get() = map["availableFrom"] as java.util.Date
    set(value) { map["availableFrom"] = value }
  var availableThrough: java.util.Date
    get() = map["availableThrough"] as java.util.Date
    set(value) { map["availableThrough"] = value }
  ...
  fun build() = org.schema.DeliveryEvent.Builder(map).build()
}
