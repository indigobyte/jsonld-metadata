...
import org.schema.*
class MutableNewsArticle {
  private val map = HashMap<String,Any>()
  var dateline: String
    get() = map["dateline"] as String
    set(value) { map["dateline"] = value }
  var printColumn: String
    get() = map["printColumn"] as String
    set(value) { map["printColumn"] = value }
  var printEdition: String
    get() = map["printEdition"] as String
    set(value) { map["printEdition"] = value }
  var printPage: String
    get() = map["printPage"] as String
    set(value) { map["printPage"] = value }
  var printSection: String
    get() = map["printSection"] as String
    set(value) { map["printSection"] = value }
  ...
  fun build() = org.schema.NewsArticle.Builder(map).build()
}
