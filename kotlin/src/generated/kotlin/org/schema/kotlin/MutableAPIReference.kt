...
import org.schema.*
class MutableAPIReference {
  private val map = HashMap<String,Any>()
  var executableLibraryName: String
    get() = map["executableLibraryName"] as String
    set(value) { map["executableLibraryName"] = value }
  var assemblyVersion: String
    get() = map["assemblyVersion"] as String
    set(value) { map["assemblyVersion"] = value }
  var programmingModel: String
    get() = map["programmingModel"] as String
    set(value) { map["programmingModel"] = value }
  var targetPlatform: String
    get() = map["targetPlatform"] as String
    set(value) { map["targetPlatform"] = value }
  var dependencies: String
    get() = map["dependencies"] as String
    set(value) { map["dependencies"] = value }
  var proficiencyLevel: String
    get() = map["proficiencyLevel"] as String
    set(value) { map["proficiencyLevel"] = value }
  ...
  fun build() = org.schema.APIReference.Builder(map).build()
}
