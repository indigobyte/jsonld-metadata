...
class MutableComment {
  ...
  var parentItem: Question
    get() = map["parentItem"] as Question
    set(value) { map["parentItem"] = value }
  fun parentItem(builder: MutableQuestion.() -> Unit) { map["parentItem"] = MutableQuestion().apply(builder).build() }
  ...
  fun build() = org.schema.Comment.Builder(map).build()
}
