...
import org.schema.*
class MutableTaxiReservation {
  private val map = HashMap<String,Any>()
  var partySize: Any
    get() = map["partySize"]!!
    set(value) { map["partySize"] = value }
  fun partySizeQuantitativeValue(builder: MutableQuantitativeValue.() -> Unit) { map["partySize"] = MutableQuantitativeValue().apply(builder).build() }
  ...
  fun build() = org.schema.TaxiReservation.Builder(map).build()
}
