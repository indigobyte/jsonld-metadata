...
import org.schema.*
class MutableWinAction {
  private val map = HashMap<String,Any>()
  var loser: Person
    get() = map["loser"] as Person
    set(value) { map["loser"] = value }
  fun loser(builder: MutablePerson.() -> Unit) { map["loser"] = MutablePerson().apply(builder).build() }
  var agent: Any
    get() = map["agent"]!!
  ...
  fun build() = org.schema.WinAction.Builder(map).build()
}
