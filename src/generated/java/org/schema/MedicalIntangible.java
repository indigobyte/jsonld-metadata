...
public class MedicalIntangible extends MedicalEntity {
  protected MedicalIntangible(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link MedicalIntangible}
   */
  public static class Builder extends MedicalEntity.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MedicalIntangible build() {
      return new MedicalIntangible(myData);
    }
    /**
