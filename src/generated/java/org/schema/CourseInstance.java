...
public class CourseInstance extends Event {
   ...
   * @return instructor property set by first invocation of instructor method or {@code null}.
   */
  @JsonIgnore public Person getInstructor() {
    return (Person) getValue("instructor");
  }
  /**
   * A person assigned to instruct or provide instructional assistance for the [[CourseInstance]].
   * @return all instructor properties as {@link java.util.Collection} or an empty collection 
   * if instructor was not set.
   */
  @JsonIgnore public java.util.Collection<Person> getInstructors() {
    final java.lang.Object current = myData.get("instructor");
   ...
   * @return courseMode property set by first invocation of courseMode method or {@code null}.
   */
  @JsonIgnore public String getCourseMode() {
    return (String) getValue("courseMode");
  }
  /**
   * The medium or means of delivery of the course instance or the mode of study, either as a text label (e.g. &quot;online&quot;, &quot;onsite&quot; or &quot;blended&quot;; &quot;synchronous&quot; or &quot;asynchronous&quot;; &quot;full-time&quot; or &quot;part-time&quot;) or as a URL reference to a term from a controlled vocabulary (e.g. https://ceds.ed.gov/element/001311#Asynchronous ).
   * @return all courseMode properties as {@link java.util.Collection} or an empty collection 
   * if courseMode was not set.
   */
  @JsonIgnore public java.util.Collection<String> getCourseModes() {
    final java.lang.Object current = myData.get("courseMode");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return courseWorkload property set by first invocation of courseWorkload method or {@code null}.
   */
  @JsonIgnore public String getCourseWorkload() {
    return (String) getValue("courseWorkload");
  }
  /**
   * The amount of work expected of students taking the course, often provided as a figure per week or per month, and may be broken down by type. For example, &quot;2 hours of lectures, 1 hour of lab work and 3 hours of independent study per week&quot;.
   * @return all courseWorkload properties as {@link java.util.Collection} or an empty collection 
   * if courseWorkload was not set.
   */
  @JsonIgnore public java.util.Collection<String> getCourseWorkloads() {
    final java.lang.Object current = myData.get("courseWorkload");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
  ...
  protected CourseInstance(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends Event.Builder {
     ...
     */
    @NotNull public Builder instructor(@NotNull Person person) {
      putValue("instructor", person);
      return this;
    }
    /**
     * A person assigned to instruct or provide instructional assistance for the [[CourseInstance]].
     ...
     * @return this builder instance
     */
    @NotNull public Builder instructor(@NotNull Person.Builder person) {
      putValue("instructor", person.build());
      return this;
    }
    /**
     * Remove instructor property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeInstructor() {
      removeValue("instructor");
      return this;
    }
    /**
     * Get currently set value for instructor property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getInstructor() {
      return myData.get("instructor");
    }
    /**
     * The medium or means of delivery of the course instance or the mode of study, either as a text label (e.g. &quot;online&quot;, &quot;onsite&quot; or &quot;blended&quot;; &quot;synchronous&quot; or &quot;asynchronous&quot;; &quot;full-time&quot; or &quot;part-time&quot;) or as a URL reference to a term from a controlled vocabulary (e.g. https://ceds.ed.gov/element/001311#Asynchronous ).
     * @param courseMode value to set
     * @return this builder instance
     */
    @NotNull public Builder courseMode(@NotNull String courseMode) {
      putValue("courseMode", courseMode);
      return this;
    }
    /**
     * Remove courseMode property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCourseMode() {
      removeValue("courseMode");
      return this;
    }
    /**
     * Get currently set value for courseMode property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCourseMode() {
      return myData.get("courseMode");
    }
    /**
     * The amount of work expected of students taking the course, often provided as a figure per week or per month, and may be broken down by type. For example, &quot;2 hours of lectures, 1 hour of lab work and 3 hours of independent study per week&quot;.
     * @param courseWorkload value to set
     * @return this builder instance
     */
    @NotNull public Builder courseWorkload(@NotNull String courseWorkload) {
      putValue("courseWorkload", courseWorkload);
      return this;
    }
    /**
     * Remove courseWorkload property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCourseWorkload() {
      removeValue("courseWorkload");
      return this;
    }
    /**
     * Get currently set value for courseWorkload property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCourseWorkload() {
      return myData.get("courseWorkload");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("instructor".equals(key) && value instanceof Person) { this.instructor((Person)value); return; }
      if ("instructors".equals(key) && value instanceof Person) { this.instructor((Person)value); return; }
      if ("courseMode".equals(key) && value instanceof String) { this.courseMode((String)value); return; }
      if ("courseModes".equals(key) && value instanceof String) { this.courseMode((String)value); return; }
      if ("courseWorkload".equals(key) && value instanceof String) { this.courseWorkload((String)value); return; }
      if ("courseWorkloads".equals(key) && value instanceof String) { this.courseWorkload((String)value); return; }
