...
/**
 * An account that allows an investor to deposit funds and place investment orders with a licensed broker or brokerage firm.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#FIBO
 */
public class BrokerageAccount extends InvestmentOrDeposit {
  protected BrokerageAccount(java.util.Map<String,Object> data) {
    super(data);
  }
