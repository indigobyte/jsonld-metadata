...
/**
 * A large, usually printed placard, bill, or announcement, often illustrated, that is posted to advertise or publicize something.Source: https://github.com/schemaorg/schemaorg/issues/1448
 */
public class Poster extends CreativeWork {
  protected Poster(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Poster}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public Poster build() {
      return new Poster(myData);
    }
    /**
