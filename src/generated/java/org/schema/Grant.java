...
public class Grant extends Intangible {
   ...
   * @return fundedItem property set by first invocation of fundedItem method or {@code null}.
   */
  ...
  /**
   * Indicates an item funded or sponsored through a [[Grant]].
   * @return all fundedItem properties as {@link java.util.Collection} or an empty collection 
   * if fundedItem was not set.
   */
  ...
  public static class Builder extends Intangible.Builder {
    ...
    /**
     * Remove fundedItem property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeFundedItem() {
      removeValue("fundedItem");
      return this;
    }
    /**
     * Get currently set value for fundedItem property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getFundedItem() {
      return myData.get("fundedItem");
    }
    /**
     * A person or organization that supports a thing through a pledge, promise, or financial contribution. e.g. a sponsor of a Medical Study or a corporate sponsor of an event.
