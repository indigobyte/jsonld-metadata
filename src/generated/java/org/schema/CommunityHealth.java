 ...
 */
public class CommunityHealth extends MedicalBusiness {
  protected CommunityHealth(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link CommunityHealth}
   */
  public static class Builder extends MedicalBusiness.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public CommunityHealth build() {
      return new CommunityHealth(myData);
    }
    /**
