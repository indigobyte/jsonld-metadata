...
public class Episode extends CreativeWork {
  ...
  @JsonIgnore public EpisodeNumber getEpisodeNumber() {
    return (EpisodeNumber) getValue("episodeNumber");
  }
  @JsonIgnore public Collection<EpisodeNumber> getEpisodeNumbers() {
    final Object current = myData.get("episodeNumber");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<EpisodeNumber>) current;
    }
    return Arrays.asList((EpisodeNumber) current);
  }
  /**
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @NotNull public Builder episodeNumber(@NotNull EpisodeNumber episodeNumber) {
    ...
    @Override protected void fromMap(String key, Object value) {
      ...
      if ("episodeNumber".equals(key) && value instanceof EpisodeNumber) { episodeNumber((EpisodeNumber)value); return; }
      if ("episodeNumbers".equals(key) && value instanceof EpisodeNumber) { episodeNumber((EpisodeNumber)value); return; }
