...
public class Episode extends CreativeWork {
   ...
   * @return episodeNumber property set by first invocation of episodeNumber method or {@code null}.
   */
  ...
  /**
   * Position of the episode within an ordered group of episodes.
   * @return all episodeNumber properties as {@link java.util.Collection} or an empty collection 
   * if episodeNumber was not set.
   */
  ...
  protected Episode(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
