...
public class Vein extends Vessel {
   ...
   * @return drainsTo property set by first invocation of drainsTo method or {@code null}.
   */
  @JsonIgnore public Vessel getDrainsTo() {
    return (Vessel) getValue("drainsTo");
  }
  /**
   * The vasculature that the vein drains into.
   * @return all drainsTo properties as {@link java.util.Collection} or an empty collection 
   * if drainsTo was not set.
   */
  @JsonIgnore public java.util.Collection<Vessel> getDrainsTos() {
    final java.lang.Object current = myData.get("drainsTo");
   ...
   * @return regionDrained property set by first invocation of regionDrained method or {@code null}.
   */
  @JsonIgnore public AnatomicalStructure getRegionDrainedAnatomicalStructure() {
    return (AnatomicalStructure) getValue("regionDrained");
  }
  /**
   * The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
   * @return all regionDrained properties as {@link java.util.Collection} or an empty collection 
   * if regionDrained was not set.
   */
   ...
   * @return regionDrained property set by first invocation of regionDrained method or {@code null}.
   */
  @JsonIgnore public AnatomicalSystem getRegionDrainedAnatomicalSystem() {
    return (AnatomicalSystem) getValue("regionDrained");
  }
  /**
   * The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
   * @return all regionDrained properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return tributary property set by first invocation of tributary method or {@code null}.
   */
  @JsonIgnore public AnatomicalStructure getTributary() {
    return (AnatomicalStructure) getValue("tributary");
  }
  /**
   * The anatomical or organ system that the vein flows into; a larger structure that the vein connects to.
   * @return all tributary properties as {@link java.util.Collection} or an empty collection 
   * if tributary was not set.
   */
  @JsonIgnore public java.util.Collection<AnatomicalStructure> getTributarys() {
    final java.lang.Object current = myData.get("tributary");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<AnatomicalStructure>) current;
    }
  ...
  protected Vein(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link Vein}
   */
  public static class Builder extends Vessel.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public Vein build() {
      return new Vein(myData);
    }
    /**
     * The vasculature that the vein drains into.
     * @param vessel value to set
     * @return this builder instance
     */
    @NotNull public Builder drainsTo(@NotNull Vessel vessel) {
      putValue("drainsTo", vessel);
      return this;
    }
    /**
     * The vasculature that the vein drains into.
     ...
     * @return this builder instance
     */
    @NotNull public Builder drainsTo(@NotNull Vessel.Builder vessel) {
      putValue("drainsTo", vessel.build());
      return this;
    }
    /**
     * Remove drainsTo property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeDrainsTo() {
      removeValue("drainsTo");
      return this;
    }
    /**
     * Get currently set value for drainsTo property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getDrainsTo() {
      return myData.get("drainsTo");
    }
    /**
     * The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
     ...
     * @return this builder instance
     */
    @NotNull public Builder regionDrained(@NotNull AnatomicalStructure anatomicalStructure) {
      putValue("regionDrained", anatomicalStructure);
      return this;
    }
    /**
     * The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
     ...
     * @return this builder instance
     */
    @NotNull public Builder regionDrained(@NotNull AnatomicalStructure.Builder anatomicalStructure) {
      putValue("regionDrained", anatomicalStructure.build());
      return this;
    }
    /**
     * The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
     ...
     * @return this builder instance
     */
    @NotNull public Builder regionDrained(@NotNull AnatomicalSystem anatomicalSystem) {
      putValue("regionDrained", anatomicalSystem);
      return this;
    }
    /**
     * The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
     ...
     * @return this builder instance
     */
    @NotNull public Builder regionDrained(@NotNull AnatomicalSystem.Builder anatomicalSystem) {
      putValue("regionDrained", anatomicalSystem.build());
      return this;
    }
    /**
     * Remove regionDrained property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRegionDrained() {
      removeValue("regionDrained");
      return this;
    }
    /**
     * Get currently set value for regionDrained property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRegionDrained() {
      return myData.get("regionDrained");
    }
    /**
     * The anatomical or organ system that the vein flows into; a larger structure that the vein connects to.
     * @param anatomicalStructure value to set
     * @return this builder instance
     */
    @NotNull public Builder tributary(@NotNull AnatomicalStructure anatomicalStructure) {
      putValue("tributary", anatomicalStructure);
      return this;
    }
    /**
     * The anatomical or organ system that the vein flows into; a larger structure that the vein connects to.
     ...
     * @return this builder instance
     */
    @NotNull public Builder tributary(@NotNull AnatomicalStructure.Builder anatomicalStructure) {
      putValue("tributary", anatomicalStructure.build());
      return this;
    }
    /**
     * Remove tributary property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeTributary() {
      removeValue("tributary");
      return this;
    }
    /**
     * Get currently set value for tributary property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getTributary() {
      return myData.get("tributary");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("drainsTo".equals(key) && value instanceof Vessel) { this.drainsTo((Vessel)value); return; }
      if ("drainsTos".equals(key) && value instanceof Vessel) { this.drainsTo((Vessel)value); return; }
      if ("regionDrained".equals(key) && value instanceof AnatomicalStructure) { this.regionDrained((AnatomicalStructure)value); return; }
      if ("regionDraineds".equals(key) && value instanceof AnatomicalStructure) { this.regionDrained((AnatomicalStructure)value); return; }
      if ("regionDrained".equals(key) && value instanceof AnatomicalSystem) { this.regionDrained((AnatomicalSystem)value); return; }
      if ("regionDraineds".equals(key) && value instanceof AnatomicalSystem) { this.regionDrained((AnatomicalSystem)value); return; }
      if ("tributary".equals(key) && value instanceof AnatomicalStructure) { this.tributary((AnatomicalStructure)value); return; }
      if ("tributarys".equals(key) && value instanceof AnatomicalStructure) { this.tributary((AnatomicalStructure)value); return; }
