...
public class UserPlusOnes extends UserInteraction {
  protected UserPlusOnes(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link UserPlusOnes}
   */
  public static class Builder extends UserInteraction.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public UserPlusOnes build() {
      return new UserPlusOnes(myData);
    }
    /**
