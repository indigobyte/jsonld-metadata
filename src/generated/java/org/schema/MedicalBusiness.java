 ...
 */
public class MedicalBusiness extends LocalBusiness {
  protected MedicalBusiness(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link MedicalBusiness}
   */
  public static class Builder extends LocalBusiness.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MedicalBusiness build() {
      return new MedicalBusiness(myData);
    }
    /**
