...
public class Book extends CreativeWork {
   ...
   * @return numberOfPages property set by first invocation of numberOfPages method or {@code null}.
   */
  @JsonIgnore public Integer getNumberOfPages() {
    return (Integer) getValue("numberOfPages");
  }
  /**
   * The number of pages in the book.
   * @return all numberOfPages properties as {@link java.util.Collection} or an empty collection 
   * if numberOfPages was not set.
   */
  @JsonIgnore public java.util.Collection<Integer> getNumberOfPagess() {
    final java.lang.Object current = myData.get("numberOfPages");
   ...
   * @return isbn property set by first invocation of isbn method or {@code null}.
   */
  ...
  /**
   * The ISBN of the book.
   * @return all isbn properties as {@link java.util.Collection} or an empty collection 
   * if isbn was not set.
   */
  @JsonIgnore public java.util.Collection<Identifier> getIsbns() {
    final java.lang.Object current = myData.get("isbn");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return illustrator property set by first invocation of illustrator method or {@code null}.
   */
  @JsonIgnore public Person getIllustrator() {
    return (Person) getValue("illustrator");
  }
  /**
   * The illustrator of the book.
   * @return all illustrator properties as {@link java.util.Collection} or an empty collection 
   * if illustrator was not set.
   */
  @JsonIgnore public java.util.Collection<Person> getIllustrators() {
    final java.lang.Object current = myData.get("illustrator");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return bookEdition property set by first invocation of bookEdition method or {@code null}.
   */
  @JsonIgnore public String getBookEdition() {
    return (String) getValue("bookEdition");
  }
  /**
   * The edition of the book.
   * @return all bookEdition properties as {@link java.util.Collection} or an empty collection 
   * if bookEdition was not set.
   */
  @JsonIgnore public java.util.Collection<String> getBookEditions() {
    final java.lang.Object current = myData.get("bookEdition");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return bookFormat property set by first invocation of bookFormat method or {@code null}.
   */
  @JsonIgnore public BookFormatType getBookFormat() {
    return (BookFormatType) getValue("bookFormat");
  }
  /**
   * The format of the book.
   * @return all bookFormat properties as {@link java.util.Collection} or an empty collection 
   * if bookFormat was not set.
   */
  @JsonIgnore public java.util.Collection<BookFormatType> getBookFormats() {
    final java.lang.Object current = myData.get("bookFormat");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return abridged property set by first invocation of abridged method or {@code null}.
   */
  @JsonIgnore public Boolean getAbridged() {
    return (Boolean) getValue("abridged");
  }
  /**
   * Indicates whether the book is an abridged edition.
   * @return all abridged properties as {@link java.util.Collection} or an empty collection 
   * if abridged was not set.
   */
  @JsonIgnore public java.util.Collection<Boolean> getAbridgeds() {
    final java.lang.Object current = myData.get("abridged");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected Book(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @NotNull public Book build() {
      return new Book(myData);
    }
    /**
     * The number of pages in the book.
     ...
     */
    @NotNull public Builder numberOfPages(@NotNull Integer integer) {
      putValue("numberOfPages", integer);
      return this;
    }
    /**
     * Remove numberOfPages property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeNumberOfPages() {
      removeValue("numberOfPages");
      return this;
    }
    /**
     * Get currently set value for numberOfPages property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getNumberOfPages() {
      return myData.get("numberOfPages");
    }
    /**
     * The ISBN of the book.
    ...
    /**
     * Remove isbn property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIsbn() {
      removeValue("isbn");
      return this;
    }
    /**
     * Get currently set value for isbn property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIsbn() {
      return myData.get("isbn");
    }
    /**
     * The illustrator of the book.
     ...
     * @return this builder instance
     */
    @NotNull public Builder illustrator(@NotNull Person person) {
      putValue("illustrator", person);
      return this;
    }
    /**
     * The illustrator of the book.
     ...
     * @return this builder instance
     */
    @NotNull public Builder illustrator(@NotNull Person.Builder person) {
      putValue("illustrator", person.build());
      return this;
    }
    /**
     * Remove illustrator property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIllustrator() {
      removeValue("illustrator");
      return this;
    }
    /**
     * Get currently set value for illustrator property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIllustrator() {
      return myData.get("illustrator");
    }
    /**
     * The edition of the book.
     * @param bookEdition value to set
     * @return this builder instance
     */
    @NotNull public Builder bookEdition(@NotNull String bookEdition) {
      putValue("bookEdition", bookEdition);
      return this;
    }
    /**
     * Remove bookEdition property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeBookEdition() {
      removeValue("bookEdition");
      return this;
    }
    /**
     * Get currently set value for bookEdition property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getBookEdition() {
      return myData.get("bookEdition");
    }
    /**
     * The format of the book.
     * @param bookFormatType value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove bookFormat property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeBookFormat() {
      removeValue("bookFormat");
      return this;
    }
    /**
     * Get currently set value for bookFormat property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getBookFormat() {
      return myData.get("bookFormat");
    }
    /**
     * Indicates whether the book is an abridged edition.
     * @param abridged value to set
     * @return this builder instance
     */
    @NotNull public Builder abridged(@NotNull Boolean abridged) {
      putValue("abridged", abridged);
      return this;
    }
    /**
     * Remove abridged property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAbridged() {
      removeValue("abridged");
      return this;
    }
    /**
     * Get currently set value for abridged property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAbridged() {
      return myData.get("abridged");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("bookEditions".equals(key) && value instanceof String) { this.bookEdition((String)value); return; }
      if ("bookFormat".equals(key) && value instanceof BookFormatType) { this.bookFormat((BookFormatType)value); return; }
      if ("bookFormats".equals(key) && value instanceof BookFormatType) { this.bookFormat((BookFormatType)value); return; }
      if ("abridged".equals(key) && value instanceof Boolean) { this.abridged((Boolean)value); return; }
      if ("abridgeds".equals(key) && value instanceof Boolean) { this.abridged((Boolean)value); return; }
