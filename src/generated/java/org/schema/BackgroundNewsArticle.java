 ...
 */
public class BackgroundNewsArticle extends NewsArticle {
  protected BackgroundNewsArticle(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link BackgroundNewsArticle}
   */
  public static class Builder extends NewsArticle.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public BackgroundNewsArticle build() {
      return new BackgroundNewsArticle(myData);
    }
    /**
