...
public class FollowAction extends InteractAction {
   ...
   * @return followee property set by first invocation of followee method or {@code null}.
   */
  ...
  /**
   * A sub property of object. The person or organization being followed.
   * @return all followee properties as {@link java.util.Collection} or an empty collection 
   * if followee was not set.
   */
  ...
  public static class Builder extends InteractAction.Builder {
    ...
    /**
     * Remove followee property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeFollowee() {
      removeValue("followee");
      return this;
    }
    /**
     * Get currently set value for followee property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getFollowee() {
      return myData.get("followee");
    }
    /**
