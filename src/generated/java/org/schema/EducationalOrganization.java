...
public class EducationalOrganization extends CivicStructure {
  ...
  protected EducationalOrganization(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends CivicStructure.Builder {
    ...
    @NotNull public EducationalOrganization build() {
      return new EducationalOrganization(myData);
    }
    /**
     * Alumni of an organization.
