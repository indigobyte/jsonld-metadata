...
public class MusicAlbum extends MusicPlaylist {
   ...
   * @return byArtist property set by first invocation of byArtist method or {@code null}.
   */
  ...
  /**
   * The artist that performed this album or recording.
   * @return all byArtist properties as {@link java.util.Collection} or an empty collection 
   * if byArtist was not set.
   */
  @JsonIgnore public java.util.Collection<MusicGroup> getByArtistMusicGroups() {
    final java.lang.Object current = myData.get("byArtist");
   ...
   * @return albumReleaseType property set by first invocation of albumReleaseType method or {@code null}.
   */
  @JsonIgnore public MusicAlbumReleaseType getAlbumReleaseType() {
    return (MusicAlbumReleaseType) getValue("albumReleaseType");
  }
  /**
   * The kind of release which this album is: single, EP or album.
   * @return all albumReleaseType properties as {@link java.util.Collection} or an empty collection 
   * if albumReleaseType was not set.
   */
  @JsonIgnore public java.util.Collection<MusicAlbumReleaseType> getAlbumReleaseTypes() {
    final java.lang.Object current = myData.get("albumReleaseType");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return albumProductionType property set by first invocation of albumProductionType method or {@code null}.
   */
  @JsonIgnore public MusicAlbumProductionType getAlbumProductionType() {
    return (MusicAlbumProductionType) getValue("albumProductionType");
  }
  /**
   * Classification of the album by it's type of content: soundtrack, live album, studio album, etc.
   * @return all albumProductionType properties as {@link java.util.Collection} or an empty collection 
   * if albumProductionType was not set.
   */
  @JsonIgnore public java.util.Collection<MusicAlbumProductionType> getAlbumProductionTypes() {
    final java.lang.Object current = myData.get("albumProductionType");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return albumRelease property set by first invocation of albumRelease method or {@code null}.
   */
  @JsonIgnore public MusicRelease getAlbumRelease() {
    return (MusicRelease) getValue("albumRelease");
  }
  /**
   * A release of this album.
   * @return all albumRelease properties as {@link java.util.Collection} or an empty collection 
   * if albumRelease was not set.
   */
  @JsonIgnore public java.util.Collection<MusicRelease> getAlbumReleases() {
    final java.lang.Object current = myData.get("albumRelease");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected MusicAlbum(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends MusicPlaylist.Builder {
    ...
    /**
     * Remove byArtist property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeByArtist() {
      removeValue("byArtist");
      return this;
    }
    /**
     * Get currently set value for byArtist property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getByArtist() {
      return myData.get("byArtist");
    }
    /**
     * The kind of release which this album is: single, EP or album.
     * @param musicAlbumReleaseType value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove albumReleaseType property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAlbumReleaseType() {
      removeValue("albumReleaseType");
      return this;
    }
    /**
     * Get currently set value for albumReleaseType property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAlbumReleaseType() {
      return myData.get("albumReleaseType");
    }
    /**
     * Classification of the album by it's type of content: soundtrack, live album, studio album, etc.
     * @param musicAlbumProductionType value to set
     * @return this builder instance
     */
    @NotNull public Builder albumProductionType(@NotNull MusicAlbumProductionType musicAlbumProductionType) {
      putValue("albumProductionType", musicAlbumProductionType);
      return this;
    }
    /**
     * Remove albumProductionType property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAlbumProductionType() {
      removeValue("albumProductionType");
      return this;
    }
    /**
     * Get currently set value for albumProductionType property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAlbumProductionType() {
      return myData.get("albumProductionType");
    }
    /**
     * A release of this album.
     * @param musicRelease value to set
     * @return this builder instance
     */
    @NotNull public Builder albumRelease(@NotNull MusicRelease musicRelease) {
      putValue("albumRelease", musicRelease);
      return this;
    }
    /**
     * A release of this album.
     ...
     * @return this builder instance
     */
    @NotNull public Builder albumRelease(@NotNull MusicRelease.Builder musicRelease) {
      putValue("albumRelease", musicRelease.build());
      return this;
    }
    /**
     * Remove albumRelease property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAlbumRelease() {
      removeValue("albumRelease");
      return this;
    }
    /**
     * Get currently set value for albumRelease property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAlbumRelease() {
      return myData.get("albumRelease");
    }
    /**
