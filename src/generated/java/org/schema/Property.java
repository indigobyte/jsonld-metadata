...
public class Property extends Intangible {
   ...
   * @return supersededBy property set by first invocation of supersededBy method or {@code null}.
   */
  ...
  /**
   * Relates a term (i.e. a property, class or enumeration) to one that supersedes it.
   * @return all supersededBy properties as {@link java.util.Collection} or an empty collection 
   * if supersededBy was not set.
   */
   ...
   * @return inverseOf property set by first invocation of inverseOf method or {@code null}.
   */
  ...
  /**
   * Relates a property to a property that is its inverse. Inverse properties relate the same pairs of items to each other, but in reversed direction. For example, the 'alumni' and 'alumniOf' properties are inverseOf each other. Some properties don't have explicit inverses; in these situations RDFa and JSON-LD syntax for reverse properties can be used.
   * @return all inverseOf properties as {@link java.util.Collection} or an empty collection 
   * if inverseOf was not set.
   */
  ...
  public static class Builder extends Intangible.Builder {
    ...
    /**
     * Remove inverseOf property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeInverseOf() {
      removeValue("inverseOf");
      return this;
    }
    /**
     * Get currently set value for inverseOf property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getInverseOf() {
      return myData.get("inverseOf");
    }
    /**
