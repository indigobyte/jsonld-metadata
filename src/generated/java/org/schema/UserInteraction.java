...
public class UserInteraction extends Event {
  protected UserInteraction(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link UserInteraction}
   */
  public static class Builder extends Event.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public UserInteraction build() {
      return new UserInteraction(myData);
    }
    /**
