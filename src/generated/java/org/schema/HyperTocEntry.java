...
public class HyperTocEntry extends CreativeWork {
   ...
   * @return utterances property set by first invocation of utterances method or {@code null}.
   */
  @JsonIgnore public String getUtterances() {
    return (String) getValue("utterances");
  }
  /**
   * Text of an utterances (spoken words, lyrics etc.) that occurs at a certain section of a media object, represented as a [[HyperTocEntry]].
   * @return all utterances properties as {@link java.util.Collection} or an empty collection 
   * if utterances was not set.
   */
  @JsonIgnore public java.util.Collection<String> getUtterancess() {
    final java.lang.Object current = myData.get("utterances");
   ...
   * @return tocContinuation property set by first invocation of tocContinuation method or {@code null}.
   */
  @JsonIgnore public HyperTocEntry getTocContinuation() {
    return (HyperTocEntry) getValue("tocContinuation");
  }
  /**
   * A [[HyperTocEntry]] can have a [[tocContinuation]] indicated, which is another [[HyperTocEntry]] that would be the default next item to play or render.
   * @return all tocContinuation properties as {@link java.util.Collection} or an empty collection 
   * if tocContinuation was not set.
   */
  @JsonIgnore public java.util.Collection<HyperTocEntry> getTocContinuations() {
    final java.lang.Object current = myData.get("tocContinuation");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected HyperTocEntry(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link HyperTocEntry}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public HyperTocEntry build() {
      return new HyperTocEntry(myData);
    }
    /**
     * Text of an utterances (spoken words, lyrics etc.) that occurs at a certain section of a media object, represented as a [[HyperTocEntry]].
     * @param utterances value to set
     * @return this builder instance
     */
    @NotNull public Builder utterances(@NotNull String utterances) {
      putValue("utterances", utterances);
      return this;
    }
    /**
     * Remove utterances property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeUtterances() {
      removeValue("utterances");
      return this;
    }
    /**
     * Get currently set value for utterances property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getUtterances() {
      return myData.get("utterances");
    }
    /**
     * A [[HyperTocEntry]] can have a [[tocContinuation]] indicated, which is another [[HyperTocEntry]] that would be the default next item to play or render.
     ...
     * @return this builder instance
     */
    @NotNull public Builder tocContinuation(@NotNull HyperTocEntry hyperTocEntry) {
      putValue("tocContinuation", hyperTocEntry);
      return this;
    }
    /**
     * A [[HyperTocEntry]] can have a [[tocContinuation]] indicated, which is another [[HyperTocEntry]] that would be the default next item to play or render.
     ...
     * @return this builder instance
     */
    @NotNull public Builder tocContinuation(@NotNull HyperTocEntry.Builder hyperTocEntry) {
      putValue("tocContinuation", hyperTocEntry.build());
      return this;
    }
    /**
     * Remove tocContinuation property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeTocContinuation() {
      removeValue("tocContinuation");
      return this;
    }
    /**
     * Get currently set value for tocContinuation property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getTocContinuation() {
      return myData.get("tocContinuation");
    }
    /**
     * A media object that encodes this CreativeWork. This property is a synonym for encoding.
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("utterances".equals(key) && value instanceof String) { this.utterances((String)value); return; }
      if ("utterancess".equals(key) && value instanceof String) { this.utterances((String)value); return; }
      if ("tocContinuation".equals(key) && value instanceof HyperTocEntry) { this.tocContinuation((HyperTocEntry)value); return; }
      if ("tocContinuations".equals(key) && value instanceof HyperTocEntry) { this.tocContinuation((HyperTocEntry)value); return; }
