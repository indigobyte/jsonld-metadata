...
public class CookAction extends CreateAction {
   ...
   * @return foodEstablishment property set by first invocation of foodEstablishment method or {@code null}.
   */
  ...
  /**
   * A sub property of location. The specific food establishment where the action occurred.
   * @return all foodEstablishment properties as {@link java.util.Collection} or an empty collection 
   * if foodEstablishment was not set.
   */
  @JsonIgnore public java.util.Collection<Location> getFoodEstablishments() {
    final java.lang.Object current = myData.get("foodEstablishment");
   ...
   * @return foodEvent property set by first invocation of foodEvent method or {@code null}.
   */
  ...
  /**
   * A sub property of location. The specific food event where the action occurred.
   * @return all foodEvent properties as {@link java.util.Collection} or an empty collection 
   * if foodEvent was not set.
   */
  @JsonIgnore public java.util.Collection<Location> getFoodEvents() {
    final java.lang.Object current = myData.get("foodEvent");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Location>) current;
    }
   ...
   * @return recipe property set by first invocation of recipe method or {@code null}.
   */
  ...
  /**
   * A sub property of instrument. The recipe/instructions used to perform the action.
   * @return all recipe properties as {@link java.util.Collection} or an empty collection 
   * if recipe was not set.
   */
  @JsonIgnore public java.util.Collection<Instrument> getRecipes() {
    final java.lang.Object current = myData.get("recipe");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected CookAction(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends CreateAction.Builder {
    ...
    /**
     * Remove foodEstablishment property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeFoodEstablishment() {
      removeValue("foodEstablishment");
      return this;
    }
    /**
     * Get currently set value for foodEstablishment property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getFoodEstablishment() {
      return myData.get("foodEstablishment");
    }
    /**
     * A sub property of location. The specific food event where the action occurred.
     * @param location value to set
    ...
    /**
     * Remove foodEvent property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeFoodEvent() {
      removeValue("foodEvent");
      return this;
    }
    /**
     * Get currently set value for foodEvent property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getFoodEvent() {
      return myData.get("foodEvent");
    }
    /**
     * A sub property of instrument. The recipe/instructions used to perform the action.
    ...
    /**
     * Remove recipe property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRecipe() {
      removeValue("recipe");
      return this;
    }
    /**
     * Get currently set value for recipe property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRecipe() {
      return myData.get("recipe");
    }
    /**
