...
public class MedicalTrial extends MedicalStudy {
   ...
   * @return trialDesign property set by first invocation of trialDesign method or {@code null}.
   */
  ...
  /**
   * Specifics about the trial design (enumerated).
   * @return all trialDesign properties as {@link java.util.Collection} or an empty collection 
   * if trialDesign was not set.
   */
  ...
  public static class Builder extends MedicalStudy.Builder {
    ...
    /**
     * Specifics about the trial design (enumerated).
     * @param medicalTrialDesign value to set
    ...
    /**
     * Remove trialDesign property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeTrialDesign() {
      removeValue("trialDesign");
      return this;
    }
    /**
     * Get currently set value for trialDesign property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getTrialDesign() {
      return myData.get("trialDesign");
    }
    /**
