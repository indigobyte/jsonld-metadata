 ...
 */
public class ImageObject extends MediaObject implements org.schema.Image {
  /**
   ...
   * @return representativeOfPage property set by first invocation of representativeOfPage method or {@code null}.
   */
  ...
  /**
   * Indicates whether this image is representative of the content of the page.
   * @return all representativeOfPage properties as {@link java.util.Collection} or an empty collection 
   * if representativeOfPage was not set.
   */
  @JsonIgnore public java.util.Collection<Boolean> getRepresentativeOfPages() {
    final java.lang.Object current = myData.get("representativeOfPage");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return exifData property set by first invocation of exifData method or {@code null}.
   */
  ...
  /**
   * exif data for this object.
   * @return all exifData properties as {@link java.util.Collection} or an empty collection 
   * if exifData was not set.
   */
  @JsonIgnore public java.util.Collection<PropertyValue> getExifDataPropertyValues() {
    final java.lang.Object current = myData.get("exifData");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected ImageObject(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends MediaObject.Builder {
    ...
    /**
     * Indicates whether this image is representative of the content of the page.
     * @param representativeOfPage value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove representativeOfPage property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRepresentativeOfPage() {
      removeValue("representativeOfPage");
      return this;
    }
    /**
     * Get currently set value for representativeOfPage property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRepresentativeOfPage() {
      return myData.get("representativeOfPage");
    }
    /**
     * Thumbnail image for an image or video.
    ...
    /**
     * Remove exifData property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeExifData() {
      removeValue("exifData");
      return this;
    }
    /**
     * Get currently set value for exifData property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getExifData() {
      return myData.get("exifData");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("exifData".equals(key) && value instanceof PropertyValue) { this.exifData((PropertyValue)value); return; }
      if ("exifDatas".equals(key) && value instanceof PropertyValue) { this.exifData((PropertyValue)value); return; }
      if ("exifData".equals(key) && value instanceof String) { this.exifData((String)value); return; }
      if ("exifDatas".equals(key) && value instanceof String) { this.exifData((String)value); return; }
