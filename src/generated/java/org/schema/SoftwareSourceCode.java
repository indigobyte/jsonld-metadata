...
public class SoftwareSourceCode extends CreativeWork {
   ...
   * @return programmingLanguage property set by first invocation of programmingLanguage method or {@code null}.
   */
  @JsonIgnore public ComputerLanguage getProgrammingLanguageComputerLanguage() {
    return (ComputerLanguage) getValue("programmingLanguage");
  }
  /**
   * The computer programming language.
   * @return all programmingLanguage properties as {@link java.util.Collection} or an empty collection 
   * if programmingLanguage was not set.
   */
   ...
   * @return programmingLanguage property set by first invocation of programmingLanguage method or {@code null}.
   */
  @JsonIgnore public String getProgrammingLanguageString() {
    return (String) getValue("programmingLanguage");
  }
  /**
   * The computer programming language.
   * @return all programmingLanguage properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return codeRepository property set by first invocation of codeRepository method or {@code null}.
   */
  @JsonIgnore public String getCodeRepository() {
    return (String) getValue("codeRepository");
  }
  /**
   * Link to the repository where the un-compiled, human readable code and related code is located (SVN, github, CodePlex).
   * @return all codeRepository properties as {@link java.util.Collection} or an empty collection 
   * if codeRepository was not set.
   */
   ...
   * @return runtimePlatform property set by first invocation of runtimePlatform method or {@code null}.
   */
  @JsonIgnore public String getRuntimePlatform() {
    return (String) getValue("runtimePlatform");
  }
  /**
   * Runtime platform or script interpreter dependencies (Example - Java v1, Python2.3, .Net Framework 3.0).
   * @return all runtimePlatform properties as {@link java.util.Collection} or an empty collection 
   * if runtimePlatform was not set.
   */
   ...
   * @return targetProduct property set by first invocation of targetProduct method or {@code null}.
   */
  @JsonIgnore public SoftwareApplication getTargetProduct() {
    return (SoftwareApplication) getValue("targetProduct");
  }
  /**
   * Target Operating System / Product to which the code applies.  If applies to several versions, just the product name can be used.
   * @return all targetProduct properties as {@link java.util.Collection} or an empty collection 
   * if targetProduct was not set.
   */
   ...
   * @return codeSampleType property set by first invocation of codeSampleType method or {@code null}.
   */
  @JsonIgnore public String getCodeSampleType() {
    return (String) getValue("codeSampleType");
  }
  /**
   * What type of code sample: full (compile ready) solution, code snippet, inline code, scripts, template.
   * @return all codeSampleType properties as {@link java.util.Collection} or an empty collection 
   * if codeSampleType was not set.
   */
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    /**
     * The computer programming language.
     * @param computerLanguage value to set
     * @return this builder instance
     */
    @NotNull public Builder programmingLanguage(@NotNull ComputerLanguage computerLanguage) {
      putValue("programmingLanguage", computerLanguage);
      return this;
    }
    /**
     * The computer programming language.
     ...
     * @return this builder instance
     */
    @NotNull public Builder programmingLanguage(@NotNull ComputerLanguage.Builder computerLanguage) {
      putValue("programmingLanguage", computerLanguage.build());
      return this;
    }
    /**
     * The computer programming language.
     * @param programmingLanguage value to set
     * @return this builder instance
     */
    @NotNull public Builder programmingLanguage(@NotNull String programmingLanguage) {
      putValue("programmingLanguage", programmingLanguage);
      return this;
    }
    /**
     * Remove programmingLanguage property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeProgrammingLanguage() {
      removeValue("programmingLanguage");
      return this;
    }
    /**
     * Get currently set value for programmingLanguage property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getProgrammingLanguage() {
      return myData.get("programmingLanguage");
    }
    /**
     * Link to the repository where the un-compiled, human readable code and related code is located (SVN, github, CodePlex).
     * @param codeRepository value to set
     * @return this builder instance
     */
    @NotNull public Builder codeRepository(@NotNull String codeRepository) {
      putValue("codeRepository", codeRepository);
      return this;
    }
    /**
     * Remove codeRepository property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCodeRepository() {
      removeValue("codeRepository");
      return this;
    }
    /**
     * Get currently set value for codeRepository property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCodeRepository() {
      return myData.get("codeRepository");
    }
    /**
     * Runtime platform or script interpreter dependencies (Example - Java v1, Python2.3, .Net Framework 3.0).
     * @param runtimePlatform value to set
     * @return this builder instance
     */
    @NotNull public Builder runtimePlatform(@NotNull String runtimePlatform) {
      putValue("runtimePlatform", runtimePlatform);
      return this;
    }
    /**
     * Remove runtimePlatform property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRuntimePlatform() {
      removeValue("runtimePlatform");
      return this;
    }
    /**
     * Get currently set value for runtimePlatform property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRuntimePlatform() {
      return myData.get("runtimePlatform");
    }
    /**
     * Target Operating System / Product to which the code applies.  If applies to several versions, just the product name can be used.
     ...
     * @return this builder instance
     */
    @NotNull public Builder targetProduct(@NotNull SoftwareApplication softwareApplication) {
      putValue("targetProduct", softwareApplication);
      return this;
    }
    /**
     * Target Operating System / Product to which the code applies.  If applies to several versions, just the product name can be used.
     ...
     * @return this builder instance
     */
    @NotNull public Builder targetProduct(@NotNull SoftwareApplication.Builder softwareApplication) {
      putValue("targetProduct", softwareApplication.build());
      return this;
    }
    /**
     * Remove targetProduct property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeTargetProduct() {
      removeValue("targetProduct");
      return this;
    }
    /**
     * Get currently set value for targetProduct property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getTargetProduct() {
      return myData.get("targetProduct");
    }
    /**
     * What type of code sample: full (compile ready) solution, code snippet, inline code, scripts, template.
     * @param codeSampleType value to set
     * @return this builder instance
     */
    @NotNull public Builder codeSampleType(@NotNull String codeSampleType) {
      putValue("codeSampleType", codeSampleType);
      return this;
    }
    /**
     * Remove codeSampleType property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCodeSampleType() {
      removeValue("codeSampleType");
      return this;
    }
    /**
     * Get currently set value for codeSampleType property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCodeSampleType() {
      return myData.get("codeSampleType");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("programmingLanguages".equals(key) && value instanceof String) { this.programmingLanguage((String)value); return; }
      if ("codeRepository".equals(key) && value instanceof String) { this.codeRepository((String)value); return; }
      if ("codeRepositorys".equals(key) && value instanceof String) { this.codeRepository((String)value); return; }
      if ("runtimePlatform".equals(key) && value instanceof String) { this.runtimePlatform((String)value); return; }
      if ("runtimePlatforms".equals(key) && value instanceof String) { this.runtimePlatform((String)value); return; }
      if ("targetProduct".equals(key) && value instanceof SoftwareApplication) { this.targetProduct((SoftwareApplication)value); return; }
      if ("targetProducts".equals(key) && value instanceof SoftwareApplication) { this.targetProduct((SoftwareApplication)value); return; }
      if ("codeSampleType".equals(key) && value instanceof String) { this.codeSampleType((String)value); return; }
      if ("codeSampleTypes".equals(key) && value instanceof String) { this.codeSampleType((String)value); return; }
