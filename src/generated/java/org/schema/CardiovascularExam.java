 ...
 */
public class CardiovascularExam extends PhysicalExam {
  protected CardiovascularExam(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends PhysicalExam.Builder {
    ...
    @NotNull public CardiovascularExam build() {
      return new CardiovascularExam(myData);
    }
    /**
