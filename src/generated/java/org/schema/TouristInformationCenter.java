...
public class TouristInformationCenter extends LocalBusiness {
  protected TouristInformationCenter(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends LocalBusiness.Builder {
    ...
    @NotNull public TouristInformationCenter build() {
      return new TouristInformationCenter(myData);
    }
    /**
