...
/**
 * A Research project.Source: https://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#FundInfoCollab
 */
public class ResearchProject extends Project {
  protected ResearchProject(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link ResearchProject}
   */
  public static class Builder extends Project.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public ResearchProject build() {
      return new ResearchProject(myData);
    }
    /**
