...
public class BusinessAudience extends Audience {
   ...
   * @return yearlyRevenue property set by first invocation of yearlyRevenue method or {@code null}.
   */
  ...
  /**
   * The size of the business in annual revenue.
   * @return all yearlyRevenue properties as {@link java.util.Collection} or an empty collection 
   * if yearlyRevenue was not set.
   */
  @JsonIgnore public java.util.Collection<QuantitativeValue> getYearlyRevenues() {
    final java.lang.Object current = myData.get("yearlyRevenue");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<QuantitativeValue>) current;
    }
   ...
   * @return yearsInOperation property set by first invocation of yearsInOperation method or {@code null}.
   */
  ...
  /**
   * The age of the business.
   * @return all yearsInOperation properties as {@link java.util.Collection} or an empty collection 
   * if yearsInOperation was not set.
   */
  @JsonIgnore public java.util.Collection<QuantitativeValue> getYearsInOperations() {
    final java.lang.Object current = myData.get("yearsInOperation");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<QuantitativeValue>) current;
    }
  ...
  protected BusinessAudience(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends Audience.Builder {
    ...
    /**
     * Remove yearlyRevenue property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeYearlyRevenue() {
      removeValue("yearlyRevenue");
      return this;
    }
    /**
     * Get currently set value for yearlyRevenue property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getYearlyRevenue() {
      return myData.get("yearlyRevenue");
    }
    /**
     * The age of the business.
     * @param quantitativeValue value to set
    ...
    /**
     * Remove yearsInOperation property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeYearsInOperation() {
      removeValue("yearsInOperation");
      return this;
    }
    /**
     * Get currently set value for yearsInOperation property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getYearsInOperation() {
      return myData.get("yearsInOperation");
    }
    /**
