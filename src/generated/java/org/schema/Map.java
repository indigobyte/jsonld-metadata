...
public class Map extends CreativeWork {
   ...
   * @return mapType property set by first invocation of mapType method or {@code null}.
   */
  @JsonIgnore public MapCategoryType getMapType() {
    return (MapCategoryType) getValue("mapType");
  }
  /**
   * Indicates the kind of Map, from the MapCategoryType Enumeration.
   * @return all mapType properties as {@link java.util.Collection} or an empty collection 
   * if mapType was not set.
   */
  @JsonIgnore public java.util.Collection<MapCategoryType> getMapTypes() {
    final java.lang.Object current = myData.get("mapType");
  ...
  protected Map(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @NotNull public Map build() {
      return new Map(myData);
    }
    /**
     * Indicates the kind of Map, from the MapCategoryType Enumeration.
     * @param mapCategoryType value to set
    ...
    /**
     * Remove mapType property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeMapType() {
      removeValue("mapType");
      return this;
    }
    /**
     * Get currently set value for mapType property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getMapType() {
      return myData.get("mapType");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("mapType".equals(key) && value instanceof MapCategoryType) { this.mapType((MapCategoryType)value); return; }
      if ("mapTypes".equals(key) && value instanceof MapCategoryType) { this.mapType((MapCategoryType)value); return; }
