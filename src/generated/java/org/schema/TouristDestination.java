 ...
 *   (See examples below).Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#IIT-CNR.it
 */
public class TouristDestination extends Place {
   ...
   * Attraction located at destination.
   */
  @JsonIgnore public Collection<TouristAttraction> getIncludesAttractions() {
    final Object current = myData.get("includesAttraction");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<TouristAttraction>) current;
    }
  ...
  protected TouristDestination(java.util.Map<String,Object> data) {
    super(data);
  }
