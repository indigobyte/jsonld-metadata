...
public class TouristDestination extends Place {
   ...
   * @return includesAttraction property set by first invocation of includesAttraction method or {@code null}.
   */
  @JsonIgnore public TouristAttraction getIncludesAttraction() {
    return (TouristAttraction) getValue("includesAttraction");
  }
  /**
   * Attraction located at destination.
   * @return all includesAttraction properties as {@link java.util.Collection} or an empty collection 
   * if includesAttraction was not set.
   */
  @JsonIgnore public java.util.Collection<TouristAttraction> getIncludesAttractions() {
    final java.lang.Object current = myData.get("includesAttraction");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<TouristAttraction>) current;
    }
    return Arrays.asList((TouristAttraction) current);
  }
  protected TouristDestination(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link TouristDestination}
   */
  public static class Builder extends Place.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public TouristDestination build() {
      return new TouristDestination(myData);
    }
    /**
     * Attraction suitable for type(s) of tourist. eg. Children, visitors from a particular country, etc. 
    ...
    /**
     * Attraction located at destination.
     * @param touristAttraction value to set
     * @return this builder instance
     */
    @NotNull public Builder includesAttraction(@NotNull TouristAttraction touristAttraction) {
      putValue("includesAttraction", touristAttraction);
      return this;
    }
    /**
     * Attraction located at destination.
     ...
     * @return this builder instance
     */
    @NotNull public Builder includesAttraction(@NotNull TouristAttraction.Builder touristAttraction) {
      putValue("includesAttraction", touristAttraction.build());
      return this;
    }
    /**
     * Remove includesAttraction property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIncludesAttraction() {
      removeValue("includesAttraction");
      return this;
    }
    /**
     * Get currently set value for includesAttraction property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIncludesAttraction() {
      return myData.get("includesAttraction");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("includesAttraction".equals(key) && value instanceof TouristAttraction) { this.includesAttraction((TouristAttraction)value); return; }
      if ("includesAttractions".equals(key) && value instanceof TouristAttraction) { this.includesAttraction((TouristAttraction)value); return; }
