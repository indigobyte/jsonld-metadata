...
public class Physician extends MedicalOrganization {
   ...
   * @return hospitalAffiliation property set by first invocation of hospitalAffiliation method or {@code null}.
   */
  @JsonIgnore public Hospital getHospitalAffiliation() {
    return (Hospital) getValue("hospitalAffiliation");
  }
  /**
   * A hospital with which the physician or office is affiliated.
   * @return all hospitalAffiliation properties as {@link java.util.Collection} or an empty collection 
   * if hospitalAffiliation was not set.
   */
  @JsonIgnore public java.util.Collection<Hospital> getHospitalAffiliations() {
    final java.lang.Object current = myData.get("hospitalAffiliation");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Hospital>) current;
    }
    return Arrays.asList((Hospital) current);
  }
  /**
  ...
  protected Physician(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Physician}
   */
  public static class Builder extends MedicalOrganization.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public Physician build() {
      return new Physician(myData);
    }
    /**
     * A hospital with which the physician or office is affiliated.
     * @param hospital value to set
     * @return this builder instance
     */
    @NotNull public Builder hospitalAffiliation(@NotNull Hospital hospital) {
      putValue("hospitalAffiliation", hospital);
      return this;
    }
    /**
     * A hospital with which the physician or office is affiliated.
     ...
     * @return this builder instance
     */
    @NotNull public Builder hospitalAffiliation(@NotNull Hospital.Builder hospital) {
      putValue("hospitalAffiliation", hospital.build());
      return this;
    }
    /**
     * Remove hospitalAffiliation property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeHospitalAffiliation() {
      removeValue("hospitalAffiliation");
      return this;
    }
    /**
     * Get currently set value for hospitalAffiliation property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getHospitalAffiliation() {
      return myData.get("hospitalAffiliation");
    }
    /**
     * A medical specialty of the provider.
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("hospitalAffiliation".equals(key) && value instanceof Hospital) { this.hospitalAffiliation((Hospital)value); return; }
      if ("hospitalAffiliations".equals(key) && value instanceof Hospital) { this.hospitalAffiliation((Hospital)value); return; }
