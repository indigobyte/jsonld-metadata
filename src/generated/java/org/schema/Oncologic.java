 ...
 */
public class Oncologic extends MedicalBusiness {
  protected Oncologic(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends MedicalBusiness.Builder {
    ...
    @NotNull public Oncologic build() {
      return new Oncologic(myData);
    }
    /**
