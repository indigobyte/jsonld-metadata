...
/**
 * An agent orders a (not yet released) object/product/service to be delivered/sent.Source: https://github.com/schemaorg/schemaorg/issues/1125
 */
public class PreOrderAction extends TradeAction {
  protected PreOrderAction(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link PreOrderAction}
   */
  public static class Builder extends TradeAction.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public PreOrderAction build() {
      return new PreOrderAction(myData);
    }
    /**
