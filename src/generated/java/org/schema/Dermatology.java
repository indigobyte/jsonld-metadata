 ...
 */
public class Dermatology extends MedicalBusiness {
  protected Dermatology(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Dermatology}
   */
  public static class Builder extends MedicalBusiness.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public Dermatology build() {
      return new Dermatology(myData);
    }
    /**
