 ...
 */
public class Obstetric extends MedicalBusiness {
  protected Obstetric(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link Obstetric}
   */
  public static class Builder extends MedicalBusiness.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public Obstetric build() {
      return new Obstetric(myData);
    }
    /**
