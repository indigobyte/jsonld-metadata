...
public class VoteAction extends ChooseAction {
  @JsonIgnore public Candidate getCandidate() {
    return (Candidate) getValue("candidate");
  }
  @JsonIgnore public Collection<Candidate> getCandidates() {
    final Object current = myData.get("candidate");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<Candidate>) current;
    }
    return Arrays.asList((Candidate) current);
  }
  protected VoteAction(java.util.Map<String,Object> data) {
    super(data);
  }
  ...
  public static class Builder extends ChooseAction.Builder {
    ...
    @NotNull public Builder candidate(@NotNull Candidate candidate) {
      putValue("candidate", candidate);
      return this;
    }
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("candidate".equals(key) && value instanceof Candidate) { candidate((Candidate)value); return; }
      if ("candidates".equals(key) && value instanceof Candidate) { candidate((Candidate)value); return; }
