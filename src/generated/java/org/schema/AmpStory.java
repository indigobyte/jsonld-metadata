 ...
 */
public class AmpStory extends CreativeWork {
  protected AmpStory(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link AmpStory}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public AmpStory build() {
      return new AmpStory(myData);
    }
    /**
