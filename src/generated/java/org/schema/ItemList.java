...
public class ItemList extends Intangible implements org.schema.SuggestedAnswer {
   ...
   * @return itemListOrder property set by first invocation of itemListOrder method or {@code null}.
   */
  ...
  /**
   * Type of ordering (e.g. Ascending, Descending, Unordered).
   * @return all itemListOrder properties as {@link java.util.Collection} or an empty collection 
   * if itemListOrder was not set.
   */
   ...
   * @return itemListElement property set by first invocation of itemListElement method or {@code null}.
   */
  ...
  /**
   * For itemListElement values, you can use simple strings (e.g. &quot;Peter&quot;, &quot;Paul&quot;, &quot;Mary&quot;), existing entities, or use ListItem.\n\nText values are best if the elements in the list are plain strings. Existing entities are best for a simple, unordered list of existing things in your data. ListItem is used with ordered lists when you want to provide additional context about the element in that list or when the same item might be in different places in different lists.\n\nNote: The order of elements in your mark-up is not sufficient for indicating the order or elements.  Use ListItem with a 'position' property in such cases.
   * @return all itemListElement properties as {@link java.util.Collection} or an empty collection 
   * if itemListElement was not set.
   */
   ...
   * @return numberOfItems property set by first invocation of numberOfItems method or {@code null}.
   */
  ...
  /**
   * The number of items in an ItemList. Note that some descriptions might not fully describe all items in a list (e.g., multi-page pagination); in such cases, the numberOfItems would be for the entire list.
   * @return all numberOfItems properties as {@link java.util.Collection} or an empty collection 
   * if numberOfItems was not set.
   */
  ...
  public static class Builder extends Intangible.Builder {
    ...
    /**
     * Type of ordering (e.g. Ascending, Descending, Unordered).
     * @param itemListOrderType value to set
    ...
    /**
     * Type of ordering (e.g. Ascending, Descending, Unordered).
     * @param itemListOrder value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove itemListOrder property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeItemListOrder() {
      removeValue("itemListOrder");
      return this;
    }
    /**
     * Get currently set value for itemListOrder property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getItemListOrder() {
      return myData.get("itemListOrder");
    }
    /**
     * For itemListElement values, you can use simple strings (e.g. &quot;Peter&quot;, &quot;Paul&quot;, &quot;Mary&quot;), existing entities, or use ListItem.\n\nText values are best if the elements in the list are plain strings. Existing entities are best for a simple, unordered list of existing things in your data. ListItem is used with ordered lists when you want to provide additional context about the element in that list or when the same item might be in different places in different lists.\n\nNote: The order of elements in your mark-up is not sufficient for indicating the order or elements.  Use ListItem with a 'position' property in such cases.
    ...
    /**
     * For itemListElement values, you can use simple strings (e.g. &quot;Peter&quot;, &quot;Paul&quot;, &quot;Mary&quot;), existing entities, or use ListItem.\n\nText values are best if the elements in the list are plain strings. Existing entities are best for a simple, unordered list of existing things in your data. ListItem is used with ordered lists when you want to provide additional context about the element in that list or when the same item might be in different places in different lists.\n\nNote: The order of elements in your mark-up is not sufficient for indicating the order or elements.  Use ListItem with a 'position' property in such cases.
     * @param itemListElement value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove itemListElement property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeItemListElement() {
      removeValue("itemListElement");
      return this;
    }
    /**
     * Get currently set value for itemListElement property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getItemListElement() {
      return myData.get("itemListElement");
    }
    /**
     * The number of items in an ItemList. Note that some descriptions might not fully describe all items in a list (e.g., multi-page pagination); in such cases, the numberOfItems would be for the entire list.
    ...
    /**
     * Remove numberOfItems property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeNumberOfItems() {
      removeValue("numberOfItems");
      return this;
    }
    /**
     * Get currently set value for numberOfItems property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getNumberOfItems() {
      return myData.get("numberOfItems");
    }
    /**
