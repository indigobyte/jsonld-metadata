...
/**
 * Printed music, as opposed to performed or recorded music.Source: https://github.com/schemaorg/schemaorg/issues/1448
 */
public class SheetMusic extends CreativeWork {
  protected SheetMusic(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link SheetMusic}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public SheetMusic build() {
      return new SheetMusic(myData);
    }
    /**
