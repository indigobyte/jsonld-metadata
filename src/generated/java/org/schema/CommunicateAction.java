...
public class CommunicateAction extends InteractAction {
  ...
  @JsonIgnore public Language getLanguage() {
    return (Language) getValue("language");
  }
  @JsonIgnore public Collection<Language> getLanguages() {
    final Object current = myData.get("language");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<Language>) current;
    }
  ...
  public static class Builder extends InteractAction.Builder {
    ...
    @Override protected void fromMap(String key, Object value) {
      ...
      if ("language".equals(key) && value instanceof Language) { language((Language)value); return; }
      if ("languages".equals(key) && value instanceof Language) { language((Language)value); return; }
