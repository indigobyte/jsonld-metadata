...
public class LendAction extends TransferAction {
   ...
   * @return borrower property set by first invocation of borrower method or {@code null}.
   */
  @JsonIgnore public Participant getBorrower() {
    return (Participant) getValue("borrower");
  }
  /**
   * A sub property of participant. The person that borrows the object being lent.
   * @return all borrower properties as {@link java.util.Collection} or an empty collection 
   * if borrower was not set.
   */
  @JsonIgnore public java.util.Collection<Participant> getBorrowers() {
    final java.lang.Object current = myData.get("borrower");
  ...
  protected LendAction(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link LendAction}
   */
  public static class Builder extends TransferAction.Builder {
     ...
     */
    @NotNull public Builder borrower(@NotNull Participant participant) {
      putValue("borrower", participant);
      return this;
    }
    /**
     * Remove borrower property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeBorrower() {
      removeValue("borrower");
      return this;
    }
    /**
     * Get currently set value for borrower property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getBorrower() {
      return myData.get("borrower");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("borrower".equals(key) && value instanceof Participant) { this.borrower((Participant)value); return; }
      if ("borrowers".equals(key) && value instanceof Participant) { this.borrower((Participant)value); return; }
