...
public class MaximumDoseSchedule extends DoseSchedule {
  protected MaximumDoseSchedule(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link MaximumDoseSchedule}
   */
  public static class Builder extends DoseSchedule.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MaximumDoseSchedule build() {
      return new MaximumDoseSchedule(myData);
    }
    /**
