...
public class MediaObject extends CreativeWork implements org.schema.Caption {
   ...
   * @return embedUrl property set by first invocation of embedUrl method or {@code null}.
   */
  @JsonIgnore public String getEmbedUrl() {
    return (String) getValue("embedUrl");
  }
  /**
   * A URL pointing to a player for a specific video. In general, this is the information in the ```src``` element of an ```embed``` tag and should not be the same as the content of the ```loc``` tag.
   * @return all embedUrl properties as {@link java.util.Collection} or an empty collection 
   * if embedUrl was not set.
   */
   ...
   * @return contentUrl property set by first invocation of contentUrl method or {@code null}.
   */
  @JsonIgnore public String getContentUrl() {
    return (String) getValue("contentUrl");
  }
  /**
   * Actual bytes of the media object, for example the image file or video file.
   * @return all contentUrl properties as {@link java.util.Collection} or an empty collection 
   * if contentUrl was not set.
   */
   ...
   * @return uploadDate property set by first invocation of uploadDate method or {@code null}.
   */
  @JsonIgnore public java.util.Date getUploadDate() {
    return (java.util.Date) getValue("uploadDate");
  }
  /**
   * Date when this media object was uploaded to this site.
   * @return all uploadDate properties as {@link java.util.Collection} or an empty collection 
   * if uploadDate was not set.
   */
   ...
   * @return sha256 property set by first invocation of sha256 method or {@code null}.
   */
  ...
  /**
   * The [SHA-2](https://en.wikipedia.org/wiki/SHA-2) SHA256 hash of the content of the item. For example, a zero-length input has value 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855'
   * @return all sha256 properties as {@link java.util.Collection} or an empty collection 
   * if sha256 was not set.
   */
   ...
   * @return playerType property set by first invocation of playerType method or {@code null}.
   */
  ...
  /**
   * Player type required&amp;#x2014;for example, Flash or Silverlight.
   * @return all playerType properties as {@link java.util.Collection} or an empty collection 
   * if playerType was not set.
   */
   ...
   * @return associatedArticle property set by first invocation of associatedArticle method or {@code null}.
   */
  @JsonIgnore public NewsArticle getAssociatedArticle() {
    return (NewsArticle) getValue("associatedArticle");
  }
  /**
   * A NewsArticle associated with the Media Object.
   * @return all associatedArticle properties as {@link java.util.Collection} or an empty collection 
   * if associatedArticle was not set.
   */
   ...
   * @return contentSize property set by first invocation of contentSize method or {@code null}.
   */
  @JsonIgnore public String getContentSize() {
    return (String) getValue("contentSize");
  }
  /**
   * File size in (mega/kilo) bytes.
   * @return all contentSize properties as {@link java.util.Collection} or an empty collection 
   * if contentSize was not set.
   */
   ...
   * @return regionsAllowed property set by first invocation of regionsAllowed method or {@code null}.
   */
  @JsonIgnore public Place getRegionsAllowed() {
    return (Place) getValue("regionsAllowed");
  }
  /**
   * The regions where the media is allowed. If not specified, then it's assumed to be allowed everywhere. Specify the countries in [ISO 3166 format](http://en.wikipedia.org/wiki/ISO_3166).
   * @return all regionsAllowed properties as {@link java.util.Collection} or an empty collection 
   * if regionsAllowed was not set.
   */
   ...
   * @return bitrate property set by first invocation of bitrate method or {@code null}.
   */
  @JsonIgnore public String getBitrate() {
    return (String) getValue("bitrate");
  }
  /**
   * The bitrate of the media object.
   * @return all bitrate properties as {@link java.util.Collection} or an empty collection 
   * if bitrate was not set.
   */
   ...
   * @return encodesCreativeWork property set by first invocation of encodesCreativeWork method or {@code null}.
   */
  @JsonIgnore public CreativeWork getEncodesCreativeWork() {
    return (CreativeWork) getValue("encodesCreativeWork");
  }
  /**
   * The CreativeWork encoded by this media object.
   * @return all encodesCreativeWork properties as {@link java.util.Collection} or an empty collection 
   * if encodesCreativeWork was not set.
   */
