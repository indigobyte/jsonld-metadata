...
/**
 * A collection or bound volume of maps, charts, plates or tables, physical or in media form illustrating any subject.Source: http://www.productontology.org/id/Atlas
 */
public class Atlas extends CreativeWork {
  protected Atlas(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Atlas}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public Atlas build() {
      return new Atlas(myData);
    }
    /**
