 ...
 */
public class IITCNRit extends Organization {
  protected IITCNRit(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link IITCNRit}
   */
  public static class Builder extends Organization.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public IITCNRit build() {
      return new IITCNRit(myData);
    }
    /**
