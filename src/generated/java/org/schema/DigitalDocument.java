...
public class DigitalDocument extends CreativeWork {
   ...
   * @return hasDigitalDocumentPermission property set by first invocation of hasDigitalDocumentPermission method or {@code null}.
   */
  @JsonIgnore public DigitalDocumentPermission getHasDigitalDocumentPermission() {
    return (DigitalDocumentPermission) getValue("hasDigitalDocumentPermission");
  }
  /**
   * A permission related to the access to this document (e.g. permission to read or write an electronic document). For a public document, specify a grantee with an Audience with audienceType equal to &quot;public&quot;.
   * @return all hasDigitalDocumentPermission properties as {@link java.util.Collection} or an empty collection 
   * if hasDigitalDocumentPermission was not set.
   */
  @JsonIgnore public java.util.Collection<DigitalDocumentPermission> getHasDigitalDocumentPermissions() {
    final java.lang.Object current = myData.get("hasDigitalDocumentPermission");
  ...
  protected DigitalDocument(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link DigitalDocument}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public DigitalDocument build() {
      return new DigitalDocument(myData);
    }
    /**
     * A permission related to the access to this document (e.g. permission to read or write an electronic document). For a public document, specify a grantee with an Audience with audienceType equal to &quot;public&quot;.
     * @param digitalDocumentPermission value to set
     * @return this builder instance
     */
    @NotNull public Builder hasDigitalDocumentPermission(@NotNull DigitalDocumentPermission digitalDocumentPermission) {
      putValue("hasDigitalDocumentPermission", digitalDocumentPermission);
      return this;
    }
    /**
     * A permission related to the access to this document (e.g. permission to read or write an electronic document). For a public document, specify a grantee with an Audience with audienceType equal to &quot;public&quot;.
     ...
     * @return this builder instance
     */
    @NotNull public Builder hasDigitalDocumentPermission(@NotNull DigitalDocumentPermission.Builder digitalDocumentPermission) {
      putValue("hasDigitalDocumentPermission", digitalDocumentPermission.build());
      return this;
    }
    /**
     * Remove hasDigitalDocumentPermission property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeHasDigitalDocumentPermission() {
      removeValue("hasDigitalDocumentPermission");
      return this;
    }
    /**
     * Get currently set value for hasDigitalDocumentPermission property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getHasDigitalDocumentPermission() {
      return myData.get("hasDigitalDocumentPermission");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("hasDigitalDocumentPermission".equals(key) && value instanceof DigitalDocumentPermission) { this.hasDigitalDocumentPermission((DigitalDocumentPermission)value); return; }
      if ("hasDigitalDocumentPermissions".equals(key) && value instanceof DigitalDocumentPermission) { this.hasDigitalDocumentPermission((DigitalDocumentPermission)value); return; }
