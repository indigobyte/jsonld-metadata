...
public class SourceCodeRevision extends SoftwareApplication {
   ...
   * Revision tag.
   */
  @JsonIgnore public String getTag() {
    return (String) getValue("tag");
  }
  /**
   * Revision tag.
   */
  @JsonIgnore public Collection<String> getTags() {
    final Object current = myData.get("tag");
   ...
   * Revision branch.
   */
  @JsonIgnore public String getBranch() {
    return (String) getValue("branch");
  }
  /**
   * Revision branch.
   */
  @JsonIgnore public Collection<String> getBranchs() {
  ...
  protected SourceCodeRevision(java.util.Map<String,Object> data) {
    super(data);
  }
