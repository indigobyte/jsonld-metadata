...
public class Airport extends CivicStructure {
   ...
   * @return icaoCode property set by first invocation of icaoCode method or {@code null}.
   */
  @JsonIgnore public String getIcaoCode() {
    return (String) getValue("icaoCode");
  }
  /**
   * ICAO identifier for an airport.
   * @return all icaoCode properties as {@link java.util.Collection} or an empty collection 
   * if icaoCode was not set.
   */
  @JsonIgnore public java.util.Collection<String> getIcaoCodes() {
    final java.lang.Object current = myData.get("icaoCode");
   ...
   * @return iataCode property set by first invocation of iataCode method or {@code null}.
   */
  @JsonIgnore public String getIataCode() {
    return (String) getValue("iataCode");
  }
  /**
   * IATA identifier for an airline or airport.
   * @return all iataCode properties as {@link java.util.Collection} or an empty collection 
   * if iataCode was not set.
   */
  ...
  protected Airport(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends CivicStructure.Builder {
    ...
    /**
     * ICAO identifier for an airport.
     * @param icaoCode value to set
     * @return this builder instance
     */
    @NotNull public Builder icaoCode(@NotNull String icaoCode) {
      putValue("icaoCode", icaoCode);
      return this;
    }
    /**
     * Remove icaoCode property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIcaoCode() {
      removeValue("icaoCode");
      return this;
    }
    /**
     * Get currently set value for icaoCode property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIcaoCode() {
      return myData.get("icaoCode");
    }
    /**
     * IATA identifier for an airline or airport.
     * @param iataCode value to set
     * @return this builder instance
     */
    @NotNull public Builder iataCode(@NotNull String iataCode) {
      putValue("iataCode", iataCode);
      return this;
    }
    /**
     * Remove iataCode property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIataCode() {
      removeValue("iataCode");
      return this;
    }
    /**
     * Get currently set value for iataCode property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIataCode() {
      return myData.get("iataCode");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("icaoCode".equals(key) && value instanceof String) { this.icaoCode((String)value); return; }
      if ("icaoCodes".equals(key) && value instanceof String) { this.icaoCode((String)value); return; }
