...
public class WebPage extends CreativeWork {
   ...
   * @return relatedLink property set by first invocation of relatedLink method or {@code null}.
   */
  @JsonIgnore public String getRelatedLink() {
    return (String) getValue("relatedLink");
  }
  /**
   * A link related to this web page, for example to other related web pages.
   * @return all relatedLink properties as {@link java.util.Collection} or an empty collection 
   * if relatedLink was not set.
   */
  @JsonIgnore public java.util.Collection<String> getRelatedLinks() {
    final java.lang.Object current = myData.get("relatedLink");
   ...
   * @return reviewedBy property set by first invocation of reviewedBy method or {@code null}.
   */
  @JsonIgnore public Organization getReviewedByOrganization() {
    return (Organization) getValue("reviewedBy");
  }
  /**
   * People or organizations that have reviewed the content on this web page for accuracy and/or completeness.
   * @return all reviewedBy properties as {@link java.util.Collection} or an empty collection 
   * if reviewedBy was not set.
   */
  @JsonIgnore public java.util.Collection<Organization> getReviewedByOrganizations() {
    final java.lang.Object current = myData.get("reviewedBy");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return reviewedBy property set by first invocation of reviewedBy method or {@code null}.
   */
  @JsonIgnore public Person getReviewedByPerson() {
    return (Person) getValue("reviewedBy");
  }
  /**
   * People or organizations that have reviewed the content on this web page for accuracy and/or completeness.
   * @return all reviewedBy properties as {@link java.util.Collection} or an empty collection 
   ...
   *          
   *                                 @return speakable property set by first invocation of speakable method or {@code null}.
   */
  @JsonIgnore public SpeakableSpecification getSpeakableSpeakableSpecification() {
    return (SpeakableSpecification) getValue("speakable");
  }
  /**
   *                                     Indicates sections of a Web page that are particularly 'speakable' in the sense of being highlighted as being especially appropriate for text-to-speech conversion. Other sections of a page may also be usefully spoken in particular circumstances; the 'speakable' property serves to indicate the parts most likely to be generally useful for speech.
   * 
   ...
   * we define a supporting type, [[SpeakableSpecification]]  which is defined to be a possible value of the *speakable* property.
   *          
   *                                     @return all speakable properties as {@link java.util.Collection} or an empty collection 
   *                                     if speakable was not set.
   */
   ...
   *                                 @return speakable property set by first invocation of speakable method or {@code null}.
   */
  @JsonIgnore public String getSpeakableString() {
    return (String) getValue("speakable");
  }
  /**
   *                                     Indicates sections of a Web page that are particularly 'speakable' in the sense of being highlighted as being especially appropriate for text-to-speech conversion. Other sections of a page may also be usefully spoken in particular circumstances; the 'speakable' property serves to indicate the parts most likely to be generally useful for speech.
   * 
   ...
   * @return mainContentOfPage property set by first invocation of mainContentOfPage method or {@code null}.
   */
  @JsonIgnore public WebPageElement getMainContentOfPage() {
    return (WebPageElement) getValue("mainContentOfPage");
  }
  /**
   * Indicates if this web page element is the main subject of the page.
   * @return all mainContentOfPage properties as {@link java.util.Collection} or an empty collection 
   * if mainContentOfPage was not set.
   */
  @JsonIgnore public java.util.Collection<WebPageElement> getMainContentOfPages() {
    final java.lang.Object current = myData.get("mainContentOfPage");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return primaryImageOfPage property set by first invocation of primaryImageOfPage method or {@code null}.
   */
  @JsonIgnore public ImageObject getPrimaryImageOfPage() {
    return (ImageObject) getValue("primaryImageOfPage");
  }
  /**
   * Indicates the main image on the page.
   * @return all primaryImageOfPage properties as {@link java.util.Collection} or an empty collection 
   * if primaryImageOfPage was not set.
   */
  @JsonIgnore public java.util.Collection<ImageObject> getPrimaryImageOfPages() {
    final java.lang.Object current = myData.get("primaryImageOfPage");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return specialty property set by first invocation of specialty method or {@code null}.
   */
  @JsonIgnore public Specialty getSpecialty() {
    return (Specialty) getValue("specialty");
  }
  /**
   * One of the domain specialities to which this web page's content applies.
   * @return all specialty properties as {@link java.util.Collection} or an empty collection 
   * if specialty was not set.
   */
  @JsonIgnore public java.util.Collection<Specialty> getSpecialtys() {
    final java.lang.Object current = myData.get("specialty");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return breadcrumb property set by first invocation of breadcrumb method or {@code null}.
   */
  @JsonIgnore public BreadcrumbList getBreadcrumbBreadcrumbList() {
    return (BreadcrumbList) getValue("breadcrumb");
  }
  /**
   * A set of links that can help a user understand and navigate a website hierarchy.
   * @return all breadcrumb properties as {@link java.util.Collection} or an empty collection 
   * if breadcrumb was not set.
   */
  @JsonIgnore public java.util.Collection<BreadcrumbList> getBreadcrumbBreadcrumbLists() {
    final java.lang.Object current = myData.get("breadcrumb");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return breadcrumb property set by first invocation of breadcrumb method or {@code null}.
   */
  @JsonIgnore public String getBreadcrumbString() {
    return (String) getValue("breadcrumb");
  }
  /**
   * A set of links that can help a user understand and navigate a website hierarchy.
   * @return all breadcrumb properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return significantLink property set by first invocation of significantLink method or {@code null}.
   */
  @JsonIgnore public String getSignificantLink() {
    return (String) getValue("significantLink");
  }
  /**
   * One of the more significant URLs on the page. Typically, these are the non-navigation links that are clicked on the most.
   * @return all significantLink properties as {@link java.util.Collection} or an empty collection 
   * if significantLink was not set.
   */
  @JsonIgnore public java.util.Collection<String> getSignificantLinks() {
    final java.lang.Object current = myData.get("significantLink");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
   ...
   * @return lastReviewed property set by first invocation of lastReviewed method or {@code null}.
   */
  @JsonIgnore public java.util.Date getLastReviewed() {
    return (java.util.Date) getValue("lastReviewed");
  }
  /**
   * Date on which the content on this web page was last reviewed for accuracy and/or completeness.
   * @return all lastReviewed properties as {@link java.util.Collection} or an empty collection 
   * if lastReviewed was not set.
   */
  @JsonIgnore public java.util.Collection<java.util.Date> getLastRevieweds() {
    final java.lang.Object current = myData.get("lastReviewed");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected WebPage(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @NotNull public WebPage build() {
      return new WebPage(myData);
    }
    /**
     * A link related to this web page, for example to other related web pages.
     * @param relatedLink value to set
    ...
    /**
     * Remove relatedLink property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRelatedLink() {
      removeValue("relatedLink");
      return this;
    }
    /**
     * Get currently set value for relatedLink property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRelatedLink() {
      return myData.get("relatedLink");
    }
    /**
     * People or organizations that have reviewed the content on this web page for accuracy and/or completeness.
    ...
    /**
     * Remove reviewedBy property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeReviewedBy() {
      removeValue("reviewedBy");
      return this;
    }
    /**
     * Get currently set value for reviewedBy property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getReviewedBy() {
      return myData.get("reviewedBy");
    }
    /**
     *                                         Indicates sections of a Web page that are particularly 'speakable' in the sense of being highlighted as being especially appropriate for text-to-speech conversion. Other sections of a page may also be usefully spoken in particular circumstances; the 'speakable' property serves to indicate the parts most likely to be generally useful for speech.
     * 
     ...
     * we define a supporting type, [[SpeakableSpecification]]  which is defined to be a possible value of the *speakable* property.
     *          
     *                                         @param speakableSpecification value to set
     *                                         @return this builder instance
     */
    ...
    /**
     * Remove speakable property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSpeakable() {
      removeValue("speakable");
      return this;
    }
    /**
     * Get currently set value for speakable property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSpeakable() {
      return myData.get("speakable");
    }
    /**
     * Indicates if this web page element is the main subject of the page.
     * @param webPageElement value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove mainContentOfPage property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeMainContentOfPage() {
      removeValue("mainContentOfPage");
      return this;
    }
    /**
     * Get currently set value for mainContentOfPage property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getMainContentOfPage() {
      return myData.get("mainContentOfPage");
    }
    /**
     * Indicates the main image on the page.
    ...
    /**
     * Remove primaryImageOfPage property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePrimaryImageOfPage() {
      removeValue("primaryImageOfPage");
      return this;
    }
    /**
     * Get currently set value for primaryImageOfPage property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPrimaryImageOfPage() {
      return myData.get("primaryImageOfPage");
    }
    /**
     * One of the domain specialities to which this web page's content applies.
     * @param specialty value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove specialty property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSpecialty() {
      removeValue("specialty");
      return this;
    }
    /**
     * Get currently set value for specialty property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSpecialty() {
      return myData.get("specialty");
    }
    /**
     * A set of links that can help a user understand and navigate a website hierarchy.
     * @param breadcrumbList value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove breadcrumb property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeBreadcrumb() {
      removeValue("breadcrumb");
      return this;
    }
    /**
     * Get currently set value for breadcrumb property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getBreadcrumb() {
      return myData.get("breadcrumb");
    }
    /**
     * One of the more significant URLs on the page. Typically, these are the non-navigation links that are clicked on the most.
     * @param significantLink value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove significantLink property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSignificantLink() {
      removeValue("significantLink");
      return this;
    }
    /**
     * Get currently set value for significantLink property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSignificantLink() {
      return myData.get("significantLink");
    }
    /**
     * Date on which the content on this web page was last reviewed for accuracy and/or completeness.
    ...
    /**
     * Remove lastReviewed property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLastReviewed() {
      removeValue("lastReviewed");
      return this;
    }
    /**
     * Get currently set value for lastReviewed property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLastReviewed() {
      return myData.get("lastReviewed");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("relatedLink".equals(key) && value instanceof String) { this.relatedLink((String)value); return; }
      if ("relatedLinks".equals(key) && value instanceof String) { this.relatedLink((String)value); return; }
      if ("reviewedBy".equals(key) && value instanceof Organization) { this.reviewedBy((Organization)value); return; }
      if ("reviewedBys".equals(key) && value instanceof Organization) { this.reviewedBy((Organization)value); return; }
      if ("reviewedBy".equals(key) && value instanceof Person) { this.reviewedBy((Person)value); return; }
      if ("reviewedBys".equals(key) && value instanceof Person) { this.reviewedBy((Person)value); return; }
      ...
      if ("mainContentOfPage".equals(key) && value instanceof WebPageElement) { this.mainContentOfPage((WebPageElement)value); return; }
      if ("mainContentOfPages".equals(key) && value instanceof WebPageElement) { this.mainContentOfPage((WebPageElement)value); return; }
      if ("primaryImageOfPage".equals(key) && value instanceof ImageObject) { this.primaryImageOfPage((ImageObject)value); return; }
      if ("primaryImageOfPages".equals(key) && value instanceof ImageObject) { this.primaryImageOfPage((ImageObject)value); return; }
      if ("specialty".equals(key) && value instanceof Specialty) { this.specialty((Specialty)value); return; }
      if ("specialtys".equals(key) && value instanceof Specialty) { this.specialty((Specialty)value); return; }
      if ("breadcrumb".equals(key) && value instanceof BreadcrumbList) { this.breadcrumb((BreadcrumbList)value); return; }
      if ("breadcrumbs".equals(key) && value instanceof BreadcrumbList) { this.breadcrumb((BreadcrumbList)value); return; }
      if ("breadcrumb".equals(key) && value instanceof String) { this.breadcrumb((String)value); return; }
      if ("breadcrumbs".equals(key) && value instanceof String) { this.breadcrumb((String)value); return; }
      if ("significantLink".equals(key) && value instanceof String) { this.significantLink((String)value); return; }
      if ("significantLinks".equals(key) && value instanceof String) { this.significantLink((String)value); return; }
      if ("lastReviewed".equals(key) && value instanceof java.util.Date) { this.lastReviewed((java.util.Date)value); return; }
      if ("lastRevieweds".equals(key) && value instanceof java.util.Date) { this.lastReviewed((java.util.Date)value); return; }
