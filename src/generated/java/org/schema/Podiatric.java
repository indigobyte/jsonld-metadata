 ...
 */
public class Podiatric extends MedicalBusiness {
  protected Podiatric(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Podiatric}
   */
  public static class Builder extends MedicalBusiness.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public Podiatric build() {
      return new Podiatric(myData);
    }
    /**
