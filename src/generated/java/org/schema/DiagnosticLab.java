...
public class DiagnosticLab extends MedicalOrganization {
   ...
   * @return availableTest property set by first invocation of availableTest method or {@code null}.
   */
  @JsonIgnore public MedicalTest getAvailableTest() {
    return (MedicalTest) getValue("availableTest");
  }
  /**
   * A diagnostic test or procedure offered by this lab.
   * @return all availableTest properties as {@link java.util.Collection} or an empty collection 
   * if availableTest was not set.
   */
  @JsonIgnore public java.util.Collection<MedicalTest> getAvailableTests() {
    final java.lang.Object current = myData.get("availableTest");
  ...
  protected DiagnosticLab(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link DiagnosticLab}
   */
  public static class Builder extends MedicalOrganization.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public DiagnosticLab build() {
      return new DiagnosticLab(myData);
    }
    /**
     * A diagnostic test or procedure offered by this lab.
     ...
     */
    @NotNull public Builder availableTest(@NotNull MedicalTest medicalTest) {
      putValue("availableTest", medicalTest);
      return this;
    }
    /**
     * A diagnostic test or procedure offered by this lab.
     ...
     * @return this builder instance
     */
    @NotNull public Builder availableTest(@NotNull MedicalTest.Builder medicalTest) {
      putValue("availableTest", medicalTest.build());
      return this;
    }
    /**
     * Remove availableTest property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAvailableTest() {
      removeValue("availableTest");
      return this;
    }
    /**
     * Get currently set value for availableTest property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAvailableTest() {
      return myData.get("availableTest");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("availableTest".equals(key) && value instanceof MedicalTest) { this.availableTest((MedicalTest)value); return; }
      if ("availableTests".equals(key) && value instanceof MedicalTest) { this.availableTest((MedicalTest)value); return; }
