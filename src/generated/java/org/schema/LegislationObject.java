...
/**
 * A specific object or file containing a Legislation. Note that the same Legislation can be published in multiple files. For example, a digitally signed PDF, a plain PDF and an HTML version.Source: https://github.com/schemaorg/schemaorg/issues/1156
 */
public class LegislationObject extends Legislation {
  ...
  protected LegislationObject(java.util.Map<String,Object> data) {
    super(data);
  }
