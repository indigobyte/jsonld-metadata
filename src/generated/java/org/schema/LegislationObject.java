 ...
 */
public class LegislationObject extends Legislation {
  /**
   * The legal value of this legislation file. The same legislation can be written in multiple files with different legal values. Typically a digitally signed PDF have a &quot;stronger&quot; legal value than the HTML file of the same act.
   * @return legislationLegalValue property set by first invocation of legislationLegalValue method or {@code null}.
   */
  @JsonIgnore public LegalValueLevel getLegislationLegalValue() {
    return (LegalValueLevel) getValue("legislationLegalValue");
  }
  /**
   * The legal value of this legislation file. The same legislation can be written in multiple files with different legal values. Typically a digitally signed PDF have a &quot;stronger&quot; legal value than the HTML file of the same act.
   * @return all legislationLegalValue properties as {@link java.util.Collection} or an empty collection 
   * if legislationLegalValue was not set.
   */
  @JsonIgnore public java.util.Collection<LegalValueLevel> getLegislationLegalValues() {
    final java.lang.Object current = myData.get("legislationLegalValue");
  ...
  protected LegislationObject(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link LegislationObject}
   */
  public static class Builder extends Legislation.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public LegislationObject build() {
      return new LegislationObject(myData);
    }
    /**
     * The legal value of this legislation file. The same legislation can be written in multiple files with different legal values. Typically a digitally signed PDF have a &quot;stronger&quot; legal value than the HTML file of the same act.
     * @param legalValueLevel value to set
     * @return this builder instance
     */
    @NotNull public Builder legislationLegalValue(@NotNull LegalValueLevel legalValueLevel) {
      putValue("legislationLegalValue", legalValueLevel);
      return this;
    }
    /**
     * Remove legislationLegalValue property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLegislationLegalValue() {
      removeValue("legislationLegalValue");
      return this;
    }
    /**
     * Get currently set value for legislationLegalValue property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLegislationLegalValue() {
      return myData.get("legislationLegalValue");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("legislationLegalValue".equals(key) && value instanceof LegalValueLevel) { this.legislationLegalValue((LegalValueLevel)value); return; }
      if ("legislationLegalValues".equals(key) && value instanceof LegalValueLevel) { this.legislationLegalValue((LegalValueLevel)value); return; }
