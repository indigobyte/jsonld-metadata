...
public class Audiobook extends AudioObject {
   ...
   * @return readBy property set by first invocation of readBy method or {@code null}.
   */
  @JsonIgnore public Actor getReadBy() {
    return (Actor) getValue("readBy");
  }
  /**
   * A person who reads (performs) the audiobook.
   * @return all readBy properties as {@link java.util.Collection} or an empty collection 
   * if readBy was not set.
   */
  @JsonIgnore public java.util.Collection<Actor> getReadBys() {
    final java.lang.Object current = myData.get("readBy");
  ...
  protected Audiobook(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link Audiobook}
   */
  public static class Builder extends AudioObject.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public Audiobook build() {
      return new Audiobook(myData);
    }
    /**
     * A person who reads (performs) the audiobook.
     ...
     */
    @NotNull public Builder readBy(@NotNull Actor actor) {
      putValue("readBy", actor);
      return this;
    }
    /**
     * Remove readBy property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeReadBy() {
      removeValue("readBy");
      return this;
    }
    /**
     * Get currently set value for readBy property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getReadBy() {
      return myData.get("readBy");
    }
    /**
     * The duration of the item (movie, audio recording, event, etc.) in [ISO 8601 date format](http://en.wikipedia.org/wiki/ISO_8601).
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("readBy".equals(key) && value instanceof Actor) { this.readBy((Actor)value); return; }
      if ("readBys".equals(key) && value instanceof Actor) { this.readBy((Actor)value); return; }
