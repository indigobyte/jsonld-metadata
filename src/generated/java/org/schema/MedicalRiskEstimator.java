...
public class MedicalRiskEstimator extends MedicalEntity {
   ...
   * @return estimatesRiskOf property set by first invocation of estimatesRiskOf method or {@code null}.
   */
  @JsonIgnore public MedicalEntity getEstimatesRiskOf() {
    return (MedicalEntity) getValue("estimatesRiskOf");
  }
  /**
   * The condition, complication, or symptom whose risk is being estimated.
   * @return all estimatesRiskOf properties as {@link java.util.Collection} or an empty collection 
   * if estimatesRiskOf was not set.
   */
  @JsonIgnore public java.util.Collection<MedicalEntity> getEstimatesRiskOfs() {
    final java.lang.Object current = myData.get("estimatesRiskOf");
   ...
   * @return includedRiskFactor property set by first invocation of includedRiskFactor method or {@code null}.
   */
  @JsonIgnore public MedicalRiskFactor getIncludedRiskFactor() {
    return (MedicalRiskFactor) getValue("includedRiskFactor");
  }
  /**
   * A modifiable or non-modifiable risk factor included in the calculation, e.g. age, coexisting condition.
   * @return all includedRiskFactor properties as {@link java.util.Collection} or an empty collection 
   * if includedRiskFactor was not set.
   */
  @JsonIgnore public java.util.Collection<MedicalRiskFactor> getIncludedRiskFactors() {
    final java.lang.Object current = myData.get("includedRiskFactor");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected MedicalRiskEstimator(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link MedicalRiskEstimator}
   */
  public static class Builder extends MedicalEntity.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MedicalRiskEstimator build() {
      return new MedicalRiskEstimator(myData);
    }
    /**
     * The condition, complication, or symptom whose risk is being estimated.
     ...
     */
    @NotNull public Builder estimatesRiskOf(@NotNull MedicalEntity medicalEntity) {
      putValue("estimatesRiskOf", medicalEntity);
      return this;
    }
    /**
     * The condition, complication, or symptom whose risk is being estimated.
     ...
     * @return this builder instance
     */
    @NotNull public Builder estimatesRiskOf(@NotNull MedicalEntity.Builder medicalEntity) {
      putValue("estimatesRiskOf", medicalEntity.build());
      return this;
    }
    /**
     * Remove estimatesRiskOf property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeEstimatesRiskOf() {
      removeValue("estimatesRiskOf");
      return this;
    }
    /**
     * Get currently set value for estimatesRiskOf property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getEstimatesRiskOf() {
      return myData.get("estimatesRiskOf");
    }
    /**
     * A modifiable or non-modifiable risk factor included in the calculation, e.g. age, coexisting condition.
     ...
     * @return this builder instance
     */
    @NotNull public Builder includedRiskFactor(@NotNull MedicalRiskFactor medicalRiskFactor) {
      putValue("includedRiskFactor", medicalRiskFactor);
      return this;
    }
    /**
     * A modifiable or non-modifiable risk factor included in the calculation, e.g. age, coexisting condition.
     ...
     * @return this builder instance
     */
    @NotNull public Builder includedRiskFactor(@NotNull MedicalRiskFactor.Builder medicalRiskFactor) {
      putValue("includedRiskFactor", medicalRiskFactor.build());
      return this;
    }
    /**
     * Remove includedRiskFactor property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIncludedRiskFactor() {
      removeValue("includedRiskFactor");
      return this;
    }
    /**
     * Get currently set value for includedRiskFactor property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIncludedRiskFactor() {
      return myData.get("includedRiskFactor");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("estimatesRiskOf".equals(key) && value instanceof MedicalEntity) { this.estimatesRiskOf((MedicalEntity)value); return; }
      if ("estimatesRiskOfs".equals(key) && value instanceof MedicalEntity) { this.estimatesRiskOf((MedicalEntity)value); return; }
      if ("includedRiskFactor".equals(key) && value instanceof MedicalRiskFactor) { this.includedRiskFactor((MedicalRiskFactor)value); return; }
      if ("includedRiskFactors".equals(key) && value instanceof MedicalRiskFactor) { this.includedRiskFactor((MedicalRiskFactor)value); return; }
