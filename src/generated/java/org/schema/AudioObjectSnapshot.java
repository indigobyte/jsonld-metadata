...
public class AudioObjectSnapshot extends AudioObject {
  protected AudioObjectSnapshot(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link AudioObjectSnapshot}
   */
  public static class Builder extends AudioObject.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public AudioObjectSnapshot build() {
      return new AudioObjectSnapshot(myData);
    }
    /**
