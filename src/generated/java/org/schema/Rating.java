...
public class Rating extends Intangible {
   ...
   * @return ratingExplanation property set by first invocation of ratingExplanation method or {@code null}.
   */
  ...
  /**
   * A short explanation (e.g. one to two sentences) providing background context and other information that led to the conclusion expressed in the rating. This is particularly applicable to ratings associated with &quot;fact check&quot; markup using [[ClaimReview]].
   * @return all ratingExplanation properties as {@link java.util.Collection} or an empty collection 
   * if ratingExplanation was not set.
   */
   ...
   * @return worstRating property set by first invocation of worstRating method or {@code null}.
   */
  ...
  /**
   * The lowest value allowed in this rating system. If worstRating is omitted, 1 is assumed.
   * @return all worstRating properties as {@link java.util.Collection} or an empty collection 
   * if worstRating was not set.
   */
   ...
   * @return bestRating property set by first invocation of bestRating method or {@code null}.
   */
  ...
  /**
   * The highest value allowed in this rating system. If bestRating is omitted, 5 is assumed.
   * @return all bestRating properties as {@link java.util.Collection} or an empty collection 
   * if bestRating was not set.
   */
   ...
   * @return ratingValue property set by first invocation of ratingValue method or {@code null}.
   */
  ...
  /**
   * The rating for the content.\n\nUsage guidelines:\n\n* Use values from 0123456789 (Unicode 'DIGIT ZERO' (U+0030) to 'DIGIT NINE' (U+0039)) rather than superficially similiar Unicode symbols.\n* Use '.' (Unicode 'FULL STOP' (U+002E)) rather than ',' to indicate a decimal point. Avoid using these symbols as a readability separator.
   * @return all ratingValue properties as {@link java.util.Collection} or an empty collection 
   * if ratingValue was not set.
   */
