...
public class ChildrensEvent extends Event {
  protected ChildrensEvent(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link ChildrensEvent}
   */
  public static class Builder extends Event.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public ChildrensEvent build() {
      return new ChildrensEvent(myData);
    }
    /**
