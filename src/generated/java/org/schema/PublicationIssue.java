...
/**
 * A part of a successively published publication such as a periodical or publication volume, often numbered, usually containing a grouping of works such as articles.\n\nSee also [blog post](http://blog.schema.org/2014/09/schemaorg-support-for-bibliographic_2.html).Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_bibexEquivalent class: http://purl.org/ontology/bibo/Issue
 */
public class PublicationIssue extends CreativeWork {
  @JsonIgnore public IssueNumber getIssueNumber() {
    return (IssueNumber) getValue("issueNumber");
  }
  @JsonIgnore public Collection<IssueNumber> getIssueNumbers() {
    final Object current = myData.get("issueNumber");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<IssueNumber>) current;
    }
    return Arrays.asList((IssueNumber) current);
  }
  /**
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @NotNull public Builder issueNumber(@NotNull IssueNumber issueNumber) {
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("issueNumber".equals(key) && value instanceof IssueNumber) { issueNumber((IssueNumber)value); return; }
      if ("issueNumbers".equals(key) && value instanceof IssueNumber) { issueNumber((IssueNumber)value); return; }
