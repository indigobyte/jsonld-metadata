 ...
 */
public class Pediatric extends MedicalBusiness {
  protected Pediatric(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends MedicalBusiness.Builder {
    ...
    @NotNull public Pediatric build() {
      return new Pediatric(myData);
    }
    /**
