...
public class MedicalContraindication extends MedicalEntity {
  protected MedicalContraindication(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link MedicalContraindication}
   */
  public static class Builder extends MedicalEntity.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MedicalContraindication build() {
      return new MedicalContraindication(myData);
    }
    /**
