...
/**
 * Short story or tale. A brief work of literature, usually written in narrative prose.Source: https://github.com/schemaorg/schemaorg/issues/1976
 */
public class ShortStory extends CreativeWork {
  protected ShortStory(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link ShortStory}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public ShortStory build() {
      return new ShortStory(myData);
    }
    /**
