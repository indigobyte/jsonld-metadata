...
public class ReportedDoseSchedule extends DoseSchedule {
  protected ReportedDoseSchedule(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link ReportedDoseSchedule}
   */
  public static class Builder extends DoseSchedule.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public ReportedDoseSchedule build() {
      return new ReportedDoseSchedule(myData);
    }
    /**
