...
public class 3DModel extends MediaObject {
  ...
  protected 3DModel(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link 3DModel}
   */
  public static class Builder extends MediaObject.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public 3DModel build() {
      return new 3DModel(myData);
    }
    /**
     * Whether the 3DModel allows resizing. For example, room layout applications often do not allow 3DModel elements to be resized to reflect reality.
     */
