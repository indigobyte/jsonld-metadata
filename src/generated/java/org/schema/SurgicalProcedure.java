...
/**
 * A medical procedure involving an incision with instruments; performed for diagnose, or therapeutic purposes.Equivalent class: http://purl.bioontology.org/ontology/SNOMEDCT/387713003
 */
public class SurgicalProcedure extends MedicalProcedure {
  protected SurgicalProcedure(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends MedicalProcedure.Builder {
    ...
    @NotNull public SurgicalProcedure build() {
      return new SurgicalProcedure(myData);
    }
    /**
