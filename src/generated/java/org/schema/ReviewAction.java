...
public class ReviewAction extends AssessAction {
   ...
   * @return resultReview property set by first invocation of resultReview method or {@code null}.
   */
  @JsonIgnore public Result getResultReview() {
    return (Result) getValue("resultReview");
  }
  /**
   * A sub property of result. The review that resulted in the performing of the action.
   * @return all resultReview properties as {@link java.util.Collection} or an empty collection 
   * if resultReview was not set.
   */
  @JsonIgnore public java.util.Collection<Result> getResultReviews() {
    final java.lang.Object current = myData.get("resultReview");
  ...
  protected ReviewAction(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends AssessAction.Builder {
     ...
     */
    @NotNull public Builder resultReview(@NotNull Result result) {
      putValue("resultReview", result);
      return this;
    }
    /**
     * Remove resultReview property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeResultReview() {
      removeValue("resultReview");
      return this;
    }
    /**
     * Get currently set value for resultReview property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getResultReview() {
      return myData.get("resultReview");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("resultReview".equals(key) && value instanceof Result) { this.resultReview((Result)value); return; }
      if ("resultReviews".equals(key) && value instanceof Result) { this.resultReview((Result)value); return; }
