...
public class CreativeWorkSeason extends CreativeWork {
   ...
   * @return seasonNumber property set by first invocation of seasonNumber method or {@code null}.
   */
  ...
  /**
   * Position of the season within an ordered group of seasons.
   * @return all seasonNumber properties as {@link java.util.Collection} or an empty collection 
   * if seasonNumber was not set.
   */
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    /**
     * Position of the season within an ordered group of seasons.
     * @param seasonNumber value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove seasonNumber property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSeasonNumber() {
      removeValue("seasonNumber");
      return this;
    }
    /**
     * Get currently set value for seasonNumber property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSeasonNumber() {
      return myData.get("seasonNumber");
    }
    /**
     * The end date and time of the item (in [ISO 8601 date format](http://en.wikipedia.org/wiki/ISO_8601)).
     * @param date value to set
