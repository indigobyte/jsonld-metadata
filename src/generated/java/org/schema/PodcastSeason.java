...
public class PodcastSeason extends CreativeWorkSeason {
  protected PodcastSeason(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link PodcastSeason}
   */
  public static class Builder extends CreativeWorkSeason.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public PodcastSeason build() {
      return new PodcastSeason(myData);
    }
    /**
