...
/**
 * A single season of a podcast. Many podcasts do not break down into separate seasons. In that case, PodcastSeries should be used.Source: https://github.com/schemaorg/schemaorg/issues/373
 */
public class PodcastSeason extends CreativeWorkSeason {
  protected PodcastSeason(java.util.Map<String,Object> data) {
    super(data);
  }
