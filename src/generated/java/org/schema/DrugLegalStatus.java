...
public class DrugLegalStatus extends MedicalIntangible {
  ...
  protected DrugLegalStatus(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link DrugLegalStatus}
   */
  public static class Builder extends MedicalIntangible.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public DrugLegalStatus build() {
      return new DrugLegalStatus(myData);
    }
    /**
     * The location in which the status applies.
