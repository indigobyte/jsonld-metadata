 ...
 */
public class TheTrustProject extends Organization {
  protected TheTrustProject(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link TheTrustProject}
   */
  public static class Builder extends Organization.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public TheTrustProject build() {
      return new TheTrustProject(myData);
    }
    /**
