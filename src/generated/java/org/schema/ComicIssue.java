...
public class ComicIssue extends PublicationIssue {
   ...
   *                            @return variantCover property set by first invocation of variantCover method or {@code null}.
   */
  @JsonIgnore public String getVariantCover() {
    return (String) getValue("variantCover");
  }
  /**
   *                                A description of the variant cover
   * for the issue, if the issue is a variant printing. For example, &quot;Bryan Hitch
   * Variant Cover&quot; or &quot;2nd Printing Variant&quot;.
   *                                @return all variantCover properties as {@link java.util.Collection} or an empty collection 
   *                                if variantCover was not set.
   */
  @JsonIgnore public java.util.Collection<String> getVariantCovers() {
    final java.lang.Object current = myData.get("variantCover");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected ComicIssue(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link ComicIssue}
   */
  public static class Builder extends PublicationIssue.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public ComicIssue build() {
      return new ComicIssue(myData);
    }
    /**
     * The individual who adds lettering, including speech balloons and sound effects, to artwork.
     ...
     * for the issue, if the issue is a variant printing. For example, &quot;Bryan Hitch
     * Variant Cover&quot; or &quot;2nd Printing Variant&quot;.
     *                                    @param variantCover value to set
     *                                    @return this builder instance
     */
    @NotNull public Builder variantCover(@NotNull String variantCover) {
      putValue("variantCover", variantCover);
      return this;
    }
    /**
     * Remove variantCover property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeVariantCover() {
      removeValue("variantCover");
      return this;
    }
    /**
     * Get currently set value for variantCover property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getVariantCover() {
      return myData.get("variantCover");
    }
    /**
    ...
    /**
     * Remove issueNumber property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIssueNumber() {
      removeValue("issueNumber");
      return this;
    }
    /**
     * Get currently set value for issueNumber property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIssueNumber() {
      return myData.get("issueNumber");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("variantCover".equals(key) && value instanceof String) { this.variantCover((String)value); return; }
      if ("variantCovers".equals(key) && value instanceof String) { this.variantCover((String)value); return; }
