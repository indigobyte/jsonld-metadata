...
/**
 * A motorcycle or motorbike is a single-track, two-wheeled motor vehicle.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#Automotive_Ontology_Working_Group
 */
public class Motorcycle extends Vehicle {
  protected Motorcycle(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Motorcycle}
   */
  public static class Builder extends Vehicle.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public Motorcycle build() {
      return new Motorcycle(myData);
    }
    /**
