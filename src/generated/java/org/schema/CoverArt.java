 ...
 */
public class CoverArt extends VisualArtwork {
  protected CoverArt(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link CoverArt}
   */
  public static class Builder extends VisualArtwork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public CoverArt build() {
      return new CoverArt(myData);
    }
    /**
