...
/**
 * A collection of datasets.Equivalent class: http://www.w3.org/ns/dcat#Catalog
 */
public class DataCatalog extends CreativeWork {
   ...
   * @return dataset property set by first invocation of dataset method or {@code null}.
   */
  @JsonIgnore public Dataset getDataset() {
    return (Dataset) getValue("dataset");
  }
  /**
   * A dataset contained in this catalog.
   * @return all dataset properties as {@link java.util.Collection} or an empty collection 
   * if dataset was not set.
   */
  @JsonIgnore public java.util.Collection<Dataset> getDatasets() {
    final java.lang.Object current = myData.get("dataset");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected DataCatalog(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends CreativeWork.Builder {
     ...
     * @return this builder instance
     */
    @NotNull public Builder dataset(@NotNull Dataset dataset) {
      putValue("dataset", dataset);
      return this;
    }
    /**
     * A dataset contained in this catalog.
     ...
     * @return this builder instance
     */
    @NotNull public Builder dataset(@NotNull Dataset.Builder dataset) {
      putValue("dataset", dataset.build());
      return this;
    }
    /**
     * Remove dataset property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeDataset() {
      removeValue("dataset");
      return this;
    }
    /**
     * Get currently set value for dataset property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getDataset() {
      return myData.get("dataset");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("dataset".equals(key) && value instanceof Dataset) { this.dataset((Dataset)value); return; }
      if ("datasets".equals(key) && value instanceof Dataset) { this.dataset((Dataset)value); return; }
