...
public class ChooseAction extends AssessAction {
   ...
   * @return actionOption property set by first invocation of actionOption method or {@code null}.
   */
  ...
  /**
   * A sub property of object. The options subject to this action.
   * @return all actionOption properties as {@link java.util.Collection} or an empty collection 
   * if actionOption was not set.
   */
