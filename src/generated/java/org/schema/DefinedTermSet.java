...
/**
 * A set of defined terms for example a set of categories or a classification scheme, a glossary, dictionary or enumeration.Source: https://github.com/schemaorg/schemaorg/issues/894
 */
public class DefinedTermSet extends CreativeWork implements InDefinedTermSet {
  /**
  ...
  protected DefinedTermSet(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link DefinedTermSet}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public DefinedTermSet build() {
      return new DefinedTermSet(myData);
    }
    /**
     * A Defined Term contained in this term set.
     */
