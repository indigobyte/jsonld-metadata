...
/**
 * A [[FAQPage]] is a [[WebPage]] presenting one or more "[Frequently asked questions](https://en.wikipedia.org/wiki/FAQ)" (see also [[QAPage]]).Source: https://github.com/schemaorg/schemaorg/issues/1723
 */
public class FAQPage extends WebPage {
  protected FAQPage(java.util.Map<String,Object> data) {
    super(data);
  }
