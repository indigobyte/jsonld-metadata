...
public class TechArticle extends Article {
   ...
   * @return proficiencyLevel property set by first invocation of proficiencyLevel method or {@code null}.
   */
  ...
  /**
   * Proficiency needed for this content; expected values: 'Beginner', 'Expert'.
   * @return all proficiencyLevel properties as {@link java.util.Collection} or an empty collection 
   * if proficiencyLevel was not set.
   */
  @JsonIgnore public java.util.Collection<String> getProficiencyLevels() {
    final java.lang.Object current = myData.get("proficiencyLevel");
   ...
   * @return dependencies property set by first invocation of dependencies method or {@code null}.
   */
  ...
  /**
   * Prerequisites needed to fulfill steps in article.
   * @return all dependencies properties as {@link java.util.Collection} or an empty collection 
   * if dependencies was not set.
   */
  @JsonIgnore public java.util.Collection<String> getDependenciess() {
    final java.lang.Object current = myData.get("dependencies");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
  ...
  protected TechArticle(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends Article.Builder {
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("proficiencyLevel".equals(key) && value instanceof String) { this.proficiencyLevel((String)value); return; }
      if ("proficiencyLevels".equals(key) && value instanceof String) { this.proficiencyLevel((String)value); return; }
      if ("dependencies".equals(key) && value instanceof String) { this.dependencies((String)value); return; }
      if ("dependenciess".equals(key) && value instanceof String) { this.dependencies((String)value); return; }
