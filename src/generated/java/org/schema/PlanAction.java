...
public class PlanAction extends OrganizeAction {
   ...
   * @return scheduledTime property set by first invocation of scheduledTime method or {@code null}.
   */
  @JsonIgnore public java.util.Date getScheduledTime() {
    return (java.util.Date) getValue("scheduledTime");
  }
  /**
   * The time the object is scheduled to.
   * @return all scheduledTime properties as {@link java.util.Collection} or an empty collection 
   * if scheduledTime was not set.
   */
  @JsonIgnore public java.util.Collection<java.util.Date> getScheduledTimes() {
    final java.lang.Object current = myData.get("scheduledTime");
  ...
  protected PlanAction(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends OrganizeAction.Builder {
     ...
     */
    @NotNull public Builder scheduledTime(@NotNull java.util.Date date) {
      putValue("scheduledTime", date);
      return this;
    }
    /**
     * Remove scheduledTime property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeScheduledTime() {
      removeValue("scheduledTime");
      return this;
    }
    /**
     * Get currently set value for scheduledTime property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getScheduledTime() {
      return myData.get("scheduledTime");
    }
    /**
