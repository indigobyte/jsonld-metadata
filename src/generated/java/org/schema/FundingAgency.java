 ...
 *     
 */
public class FundingAgency extends Project {
  protected FundingAgency(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link FundingAgency}
   */
  public static class Builder extends Project.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public FundingAgency build() {
      return new FundingAgency(myData);
    }
    /**
