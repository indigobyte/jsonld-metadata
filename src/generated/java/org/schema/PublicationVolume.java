...
/**
 * A part of a successively published publication such as a periodical or multi-volume work, often numbered. It may represent a time span, such as a year.\n\nSee also [blog post](http://blog.schema.org/2014/09/schemaorg-support-for-bibliographic_2.html).Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_bibex
 */
public class PublicationVolume extends CreativeWork {
  ...
  @JsonIgnore public VolumeNumber getVolumeNumber() {
    return (VolumeNumber) getValue("volumeNumber");
  }
  @JsonIgnore public Collection<VolumeNumber> getVolumeNumbers() {
    final Object current = myData.get("volumeNumber");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<VolumeNumber>) current;
    }
    return Arrays.asList((VolumeNumber) current);
  }
  protected PublicationVolume(java.util.Map<String,Object> data) {
    super(data);
  }
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @NotNull public Builder volumeNumber(@NotNull VolumeNumber volumeNumber) {
    ...
    @Override protected void fromMap(String key, Object value) {
      ...
      if ("volumeNumber".equals(key) && value instanceof VolumeNumber) { volumeNumber((VolumeNumber)value); return; }
      if ("volumeNumbers".equals(key) && value instanceof VolumeNumber) { volumeNumber((VolumeNumber)value); return; }
