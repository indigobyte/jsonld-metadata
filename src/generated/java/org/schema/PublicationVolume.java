 ...
 * 
 *       <br/><br/>See also <a href="http://blog.schema.org/2014/09/schemaorg-support-for-bibliographic_2.html">blog post</a>.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_bibex
 */
public class PublicationVolume extends CreativeWork {
   ...
   * Identifies the volume of publication or multi-part work; for example, "iii" or "2".
   */
  @JsonIgnore public Collection<Integer> getVolumeNumberIntegers() {
   ...
   * Identifies the volume of publication or multi-part work; for example, "iii" or "2".
   */
  @JsonIgnore public Collection<String> getVolumeNumberStrings() {
    final Object current = myData.get("volumeNumber");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<String>) current;
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @Override protected void fromMap(String key, Object value) {
      ...
      if ("volumeNumber".equals(key) && value instanceof Integer) { volumeNumber((Integer)value); return; }
      if ("volumeNumbers".equals(key) && value instanceof Integer) { volumeNumber((Integer)value); return; }
      if ("volumeNumber".equals(key) && value instanceof String) { volumeNumber((String)value); return; }
      if ("volumeNumbers".equals(key) && value instanceof String) { volumeNumber((String)value); return; }
