...
/**
 * A company or fund that gathers capital from a number of investors to create a pool of money that is then re-invested into stocks, bonds and other assets.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#FIBO
 */
public class InvestmentFund extends InvestmentOrDeposit {
  protected InvestmentFund(java.util.Map<String,Object> data) {
    super(data);
  }
