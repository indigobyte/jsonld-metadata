...
public class BoatReservation extends Reservation {
  protected BoatReservation(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link BoatReservation}
   */
  public static class Builder extends Reservation.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public BoatReservation build() {
      return new BoatReservation(myData);
    }
    /**
