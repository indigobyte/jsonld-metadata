 ...
 */
public class Geriatric extends MedicalBusiness {
  protected Geriatric(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends MedicalBusiness.Builder {
    ...
    @NotNull public Geriatric build() {
      return new Geriatric(myData);
    }
    /**
