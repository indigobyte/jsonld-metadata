...
public class MedicalTestPanel extends MedicalTest {
   ...
   * @return subTest property set by first invocation of subTest method or {@code null}.
   */
  @JsonIgnore public MedicalTest getSubTest() {
    return (MedicalTest) getValue("subTest");
  }
  /**
   * A component test of the panel.
   * @return all subTest properties as {@link java.util.Collection} or an empty collection 
   * if subTest was not set.
   */
  @JsonIgnore public java.util.Collection<MedicalTest> getSubTests() {
    final java.lang.Object current = myData.get("subTest");
  ...
  protected MedicalTestPanel(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends MedicalTest.Builder {
    ...
    @NotNull public MedicalTestPanel build() {
      return new MedicalTestPanel(myData);
    }
    /**
     * A component test of the panel.
     ...
     */
    @NotNull public Builder subTest(@NotNull MedicalTest medicalTest) {
      putValue("subTest", medicalTest);
      return this;
    }
    /**
     * A component test of the panel.
     ...
     * @return this builder instance
     */
    @NotNull public Builder subTest(@NotNull MedicalTest.Builder medicalTest) {
      putValue("subTest", medicalTest.build());
      return this;
    }
    /**
     * Remove subTest property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSubTest() {
      removeValue("subTest");
      return this;
    }
    /**
     * Get currently set value for subTest property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSubTest() {
      return myData.get("subTest");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("subTest".equals(key) && value instanceof MedicalTest) { this.subTest((MedicalTest)value); return; }
      if ("subTests".equals(key) && value instanceof MedicalTest) { this.subTest((MedicalTest)value); return; }
