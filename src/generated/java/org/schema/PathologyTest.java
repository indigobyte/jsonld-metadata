...
public class PathologyTest extends MedicalTest {
   ...
   * @return tissueSample property set by first invocation of tissueSample method or {@code null}.
   */
  @JsonIgnore public String getTissueSample() {
    return (String) getValue("tissueSample");
  }
  /**
   * The type of tissue sample required for the test.
   * @return all tissueSample properties as {@link java.util.Collection} or an empty collection 
   * if tissueSample was not set.
   */
  @JsonIgnore public java.util.Collection<String> getTissueSamples() {
    final java.lang.Object current = myData.get("tissueSample");
  ...
  protected PathologyTest(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link PathologyTest}
   */
  public static class Builder extends MedicalTest.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public PathologyTest build() {
      return new PathologyTest(myData);
    }
    /**
     * The type of tissue sample required for the test.
     * @param tissueSample value to set
     * @return this builder instance
     */
    @NotNull public Builder tissueSample(@NotNull String tissueSample) {
      putValue("tissueSample", tissueSample);
      return this;
    }
    /**
     * Remove tissueSample property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeTissueSample() {
      removeValue("tissueSample");
      return this;
    }
    /**
     * Get currently set value for tissueSample property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getTissueSample() {
      return myData.get("tissueSample");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("tissueSample".equals(key) && value instanceof String) { this.tissueSample((String)value); return; }
      if ("tissueSamples".equals(key) && value instanceof String) { this.tissueSample((String)value); return; }
