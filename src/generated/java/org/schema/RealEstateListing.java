...
public class RealEstateListing extends WebPage {
  ...
  protected RealEstateListing(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link RealEstateListing}
   */
  public static class Builder extends WebPage.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public RealEstateListing build() {
      return new RealEstateListing(myData);
    }
    /**
     * Publication date of an online listing.
