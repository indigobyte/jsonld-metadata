...
public class Course extends LearningResource {
   ...
   * @return coursePrerequisites property set by first invocation of coursePrerequisites method or {@code null}.
   */
  ...
  /**
   * Requirements for taking the Course. May be completion of another [[Course]] or a textual description like &quot;permission of instructor&quot;. Requirements may be a pre-requisite competency, referenced using [[AlignmentObject]].
   * @return all coursePrerequisites properties as {@link java.util.Collection} or an empty collection 
   * if coursePrerequisites was not set.
   */
   ...
   * @return hasCourseInstance property set by first invocation of hasCourseInstance method or {@code null}.
   */
  @JsonIgnore public CourseInstance getHasCourseInstance() {
    return (CourseInstance) getValue("hasCourseInstance");
  }
  /**
   * An offering of the course at a specific time and place or through specific media or mode of study or to a specific section of students.
   * @return all hasCourseInstance properties as {@link java.util.Collection} or an empty collection 
   * if hasCourseInstance was not set.
   */
   ...
   * @return courseCode property set by first invocation of courseCode method or {@code null}.
   */
  @JsonIgnore public String getCourseCode() {
    return (String) getValue("courseCode");
  }
  /**
   * The identifier for the [[Course]] used by the course [[provider]] (e.g. CS101 or 6.001).
   * @return all courseCode properties as {@link java.util.Collection} or an empty collection 
   * if courseCode was not set.
   */
  ...
  public static class Builder extends LearningResource.Builder {
    ...
    /**
     * Requirements for taking the Course. May be completion of another [[Course]] or a textual description like &quot;permission of instructor&quot;. Requirements may be a pre-requisite competency, referenced using [[AlignmentObject]].
     * @param coursePrerequisites value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove coursePrerequisites property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCoursePrerequisites() {
      removeValue("coursePrerequisites");
      return this;
    }
    /**
     * Get currently set value for coursePrerequisites property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCoursePrerequisites() {
      return myData.get("coursePrerequisites");
    }
    /**
     * An offering of the course at a specific time and place or through specific media or mode of study or to a specific section of students.
     * @param courseInstance value to set
     * @return this builder instance
     */
    @NotNull public Builder hasCourseInstance(@NotNull CourseInstance courseInstance) {
      putValue("hasCourseInstance", courseInstance);
      return this;
    }
    /**
     * An offering of the course at a specific time and place or through specific media or mode of study or to a specific section of students.
     ...
     * @return this builder instance
     */
    @NotNull public Builder hasCourseInstance(@NotNull CourseInstance.Builder courseInstance) {
      putValue("hasCourseInstance", courseInstance.build());
      return this;
    }
    /**
     * Remove hasCourseInstance property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeHasCourseInstance() {
      removeValue("hasCourseInstance");
      return this;
    }
    /**
     * Get currently set value for hasCourseInstance property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getHasCourseInstance() {
      return myData.get("hasCourseInstance");
    }
    /**
     * The identifier for the [[Course]] used by the course [[provider]] (e.g. CS101 or 6.001).
     * @param courseCode value to set
     * @return this builder instance
     */
    @NotNull public Builder courseCode(@NotNull String courseCode) {
      putValue("courseCode", courseCode);
      return this;
    }
    /**
     * Remove courseCode property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCourseCode() {
      removeValue("courseCode");
      return this;
    }
    /**
     * Get currently set value for courseCode property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCourseCode() {
      return myData.get("courseCode");
    }
    /**
     * A description of the qualification, award, certificate, diploma or other occupational credential awarded as a consequence of successful completion of this course or program.
     * @param educationalOccupationalCredential value to set
