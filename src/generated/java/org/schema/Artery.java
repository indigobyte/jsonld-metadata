...
/**
 * A type of blood vessel that specifically carries blood away from the heart.Equivalent class: http://purl.bioontology.org/ontology/SNOMEDCT/51114001
 */
public class Artery extends Vessel {
  /**
   * The area to which the artery supplies blood.
   * @return supplyTo property set by first invocation of supplyTo method or {@code null}.
   */
  ...
  /**
   * The area to which the artery supplies blood.
   * @return all supplyTo properties as {@link java.util.Collection} or an empty collection 
   * if supplyTo was not set.
   */
   ...
   * @return arterialBranch property set by first invocation of arterialBranch method or {@code null}.
   */
  ...
  /**
   * The branches that comprise the arterial structure.
   * @return all arterialBranch properties as {@link java.util.Collection} or an empty collection 
   * if arterialBranch was not set.
   */
  ...
  public static class Builder extends Vessel.Builder {
    ...
    /**
     * Remove supplyTo property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSupplyTo() {
      removeValue("supplyTo");
      return this;
    }
    /**
     * Get currently set value for supplyTo property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSupplyTo() {
      return myData.get("supplyTo");
    }
    /**
     * The branches that comprise the arterial structure.
     * @param anatomicalStructure value to set
    ...
    /**
     * Remove arterialBranch property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeArterialBranch() {
      removeValue("arterialBranch");
      return this;
    }
    /**
     * Get currently set value for arterialBranch property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getArterialBranch() {
      return myData.get("arterialBranch");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("arterialBranchs".equals(key) && value instanceof AnatomicalStructure) { this.arterialBranch((AnatomicalStructure)value); return; }
