...
public class SatiricalArticle extends Article {
  protected SatiricalArticle(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link SatiricalArticle}
   */
  public static class Builder extends Article.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public SatiricalArticle build() {
      return new SatiricalArticle(myData);
    }
    /**
