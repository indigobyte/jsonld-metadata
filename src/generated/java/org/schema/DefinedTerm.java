...
public class DefinedTerm extends Intangible implements org.schema.HasDefinedTerm {
   ...
   * @return termCode property set by first invocation of termCode method or {@code null}.
   */
  ...
  /**
   * A code that identifies this [[DefinedTerm]] within a [[DefinedTermSet]]
   * @return all termCode properties as {@link java.util.Collection} or an empty collection 
   * if termCode was not set.
   */
   ...
   * @return inDefinedTermSet property set by first invocation of inDefinedTermSet method or {@code null}.
   */
  ...
  /**
   * A [[DefinedTermSet]] that contains this term.
   * @return all inDefinedTermSet properties as {@link java.util.Collection} or an empty collection 
   * if inDefinedTermSet was not set.
   */
