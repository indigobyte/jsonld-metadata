...
public class BorrowAction extends TransferAction {
  @JsonIgnore public Lender getLender() {
    return (Lender) getValue("lender");
  }
  @JsonIgnore public Collection<Lender> getLenders() {
    final Object current = myData.get("lender");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<Lender>) current;
    }
    return Arrays.asList((Lender) current);
  }
  ...
  public static class Builder extends TransferAction.Builder {
    ...
    @NotNull public Builder lender(@NotNull Lender lender) {
      putValue("lender", lender);
      return this;
    }
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("lender".equals(key) && value instanceof Lender) { lender((Lender)value); return; }
      if ("lenders".equals(key) && value instanceof Lender) { lender((Lender)value); return; }
