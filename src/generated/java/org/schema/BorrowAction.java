...
public class BorrowAction extends TransferAction {
   ...
   * @return lender property set by first invocation of lender method or {@code null}.
   */
  ...
  /**
   * A sub property of participant. The person that lends the object being borrowed.
   * @return all lender properties as {@link java.util.Collection} or an empty collection 
   * if lender was not set.
   */
  @JsonIgnore public java.util.Collection<Participant> getLenders() {
    final java.lang.Object current = myData.get("lender");
  ...
  protected BorrowAction(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends TransferAction.Builder {
    ...
    /**
     * Remove lender property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLender() {
      removeValue("lender");
      return this;
    }
    /**
     * Get currently set value for lender property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLender() {
      return myData.get("lender");
    }
    /**
