...
public class CategoryCodeSet extends DefinedTermSet {
   ...
   * @return hasCategoryCode property set by first invocation of hasCategoryCode method or {@code null}.
   */
  @JsonIgnore public HasDefinedTerm getHasCategoryCode() {
    return (HasDefinedTerm) getValue("hasCategoryCode");
  }
  /**
   * A Category code contained in this code set.
   * @return all hasCategoryCode properties as {@link java.util.Collection} or an empty collection 
   * if hasCategoryCode was not set.
   */
  @JsonIgnore public java.util.Collection<HasDefinedTerm> getHasCategoryCodes() {
    final java.lang.Object current = myData.get("hasCategoryCode");
  ...
  protected CategoryCodeSet(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link CategoryCodeSet}
   */
  public static class Builder extends DefinedTermSet.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public CategoryCodeSet build() {
      return new CategoryCodeSet(myData);
    }
    /**
     * A Category code contained in this code set.
     ...
     */
    @NotNull public Builder hasCategoryCode(@NotNull HasDefinedTerm hasDefinedTerm) {
      putValue("hasCategoryCode", hasDefinedTerm);
      return this;
    }
    /**
     * Remove hasCategoryCode property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeHasCategoryCode() {
      removeValue("hasCategoryCode");
      return this;
    }
    /**
     * Get currently set value for hasCategoryCode property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getHasCategoryCode() {
      return myData.get("hasCategoryCode");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("hasCategoryCode".equals(key) && value instanceof HasDefinedTerm) { this.hasCategoryCode((HasDefinedTerm)value); return; }
      if ("hasCategoryCodes".equals(key) && value instanceof HasDefinedTerm) { this.hasCategoryCode((HasDefinedTerm)value); return; }
