 ...
 */
public class ComicCoverArt extends CoverArt {
  protected ComicCoverArt(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link ComicCoverArt}
   */
  public static class Builder extends CoverArt.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public ComicCoverArt build() {
      return new ComicCoverArt(myData);
    }
    /**
