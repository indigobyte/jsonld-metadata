...
public class FoodEstablishment extends LocalBusiness {
   ...
   * @return acceptsReservations property set by first invocation of acceptsReservations method or {@code null}.
   */
  @JsonIgnore public Boolean getAcceptsReservationsBoolean() {
    return (Boolean) getValue("acceptsReservations");
  }
  /**
   * Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings ```Yes``` or ```No```.
   * @return all acceptsReservations properties as {@link java.util.Collection} or an empty collection 
   * if acceptsReservations was not set.
   */
   ...
   * @return acceptsReservations property set by first invocation of acceptsReservations method or {@code null}.
   */
  @JsonIgnore public String getAcceptsReservationsString() {
    return (String) getValue("acceptsReservations");
  }
  /**
   * Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings ```Yes``` or ```No```.
   * @return all acceptsReservations properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return starRating property set by first invocation of starRating method or {@code null}.
   */
  @JsonIgnore public Rating getStarRating() {
    return (Rating) getValue("starRating");
  }
  /**
   * An official rating for a lodging business or food establishment, e.g. from national associations or standards bodies. Use the author property to indicate the rating organization, e.g. as an Organization with name such as (e.g. HOTREC, DEHOGA, WHR, or Hotelstars).
   * @return all starRating properties as {@link java.util.Collection} or an empty collection 
   * if starRating was not set.
   */
   ...
   * @return hasMenu property set by first invocation of hasMenu method or {@code null}.
   */
  ...
  /**
   * Either the actual menu as a structured representation, as text, or a URL of the menu.
   * @return all hasMenu properties as {@link java.util.Collection} or an empty collection 
   * if hasMenu was not set.
   */
   ...
   * @return servesCuisine property set by first invocation of servesCuisine method or {@code null}.
   */
  @JsonIgnore public String getServesCuisine() {
    return (String) getValue("servesCuisine");
  }
  /**
   * The cuisine of the restaurant.
   * @return all servesCuisine properties as {@link java.util.Collection} or an empty collection 
   * if servesCuisine was not set.
   */
  ...
  public static class Builder extends LocalBusiness.Builder {
    ...
    /**
     * Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings ```Yes``` or ```No```.
     * @param acceptsReservations value to set
     * @return this builder instance
     */
    @NotNull public Builder acceptsReservations(@NotNull Boolean acceptsReservations) {
      putValue("acceptsReservations", acceptsReservations);
      return this;
    }
    /**
     * Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings ```Yes``` or ```No```.
     ...
     * @return this builder instance
     */
    @NotNull public Builder acceptsReservations(@NotNull String acceptsReservations) {
      putValue("acceptsReservations", acceptsReservations);
      return this;
    }
    /**
     * Remove acceptsReservations property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAcceptsReservations() {
      removeValue("acceptsReservations");
      return this;
    }
    /**
     * Get currently set value for acceptsReservations property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAcceptsReservations() {
      return myData.get("acceptsReservations");
    }
    /**
     * An official rating for a lodging business or food establishment, e.g. from national associations or standards bodies. Use the author property to indicate the rating organization, e.g. as an Organization with name such as (e.g. HOTREC, DEHOGA, WHR, or Hotelstars).
     ...
     * @return this builder instance
     */
    @NotNull public Builder starRating(@NotNull Rating rating) {
      putValue("starRating", rating);
      return this;
    }
    /**
     * An official rating for a lodging business or food establishment, e.g. from national associations or standards bodies. Use the author property to indicate the rating organization, e.g. as an Organization with name such as (e.g. HOTREC, DEHOGA, WHR, or Hotelstars).
     ...
     * @return this builder instance
     */
    @NotNull public Builder starRating(@NotNull Rating.Builder rating) {
      putValue("starRating", rating.build());
      return this;
    }
    /**
     * Remove starRating property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeStarRating() {
      removeValue("starRating");
      return this;
    }
    /**
     * Get currently set value for starRating property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getStarRating() {
      return myData.get("starRating");
    }
    /**
     * Either the actual menu as a structured representation, as text, or a URL of the menu.
    ...
    /**
     * Remove hasMenu property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeHasMenu() {
      removeValue("hasMenu");
      return this;
    }
    /**
     * Get currently set value for hasMenu property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getHasMenu() {
      return myData.get("hasMenu");
    }
    /**
     * The cuisine of the restaurant.
     * @param servesCuisine value to set
     * @return this builder instance
     */
    @NotNull public Builder servesCuisine(@NotNull String servesCuisine) {
      putValue("servesCuisine", servesCuisine);
      return this;
    }
    /**
     * Remove servesCuisine property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeServesCuisine() {
      removeValue("servesCuisine");
      return this;
    }
    /**
     * Get currently set value for servesCuisine property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getServesCuisine() {
      return myData.get("servesCuisine");
    }
    /**
     * The currency accepted.\n\nUse standard formats: [ISO 4217 currency format](http://en.wikipedia.org/wiki/ISO_4217) e.g. &quot;USD&quot;; [Ticker symbol](https://en.wikipedia.org/wiki/List_of_cryptocurrencies) for cryptocurrencies e.g. &quot;BTC&quot;; well known names for [Local Exchange Tradings Systems](https://en.wikipedia.org/wiki/Local_exchange_trading_system) (LETS) and other currency types e.g. &quot;Ithaca HOUR&quot;.
     * @param currenciesAccepted value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove currenciesAccepted property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCurrenciesAccepted() {
      removeValue("currenciesAccepted");
      return this;
    }
    /**
     * Get currently set value for currenciesAccepted property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCurrenciesAccepted() {
      return myData.get("currenciesAccepted");
    }
    /**
     * Cash, Credit Card, Cryptocurrency, Local Exchange Tradings System, etc.
     * @param paymentAccepted value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove paymentAccepted property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePaymentAccepted() {
      removeValue("paymentAccepted");
      return this;
    }
    /**
     * Get currently set value for paymentAccepted property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPaymentAccepted() {
      return myData.get("paymentAccepted");
    }
    /**
     * The price range of the business, for example ```$$$```.
     * @param priceRange value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove priceRange property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePriceRange() {
      removeValue("priceRange");
      return this;
    }
    /**
     * Get currently set value for priceRange property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPriceRange() {
      return myData.get("priceRange");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("acceptsReservationss".equals(key) && value instanceof String) { this.acceptsReservations((String)value); return; }
      ...
      if ("hasMenu".equals(key) && value instanceof Menu) { this.hasMenu((Menu)value); return; }
      if ("hasMenus".equals(key) && value instanceof Menu) { this.hasMenu((Menu)value); return; }
      if ("hasMenu".equals(key) && value instanceof String) { this.hasMenu((String)value); return; }
      if ("hasMenus".equals(key) && value instanceof String) { this.hasMenu((String)value); return; }
      if ("servesCuisine".equals(key) && value instanceof String) { this.servesCuisine((String)value); return; }
      if ("servesCuisines".equals(key) && value instanceof String) { this.servesCuisine((String)value); return; }
