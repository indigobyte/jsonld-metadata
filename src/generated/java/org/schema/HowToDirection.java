...
public class HowToDirection extends CreativeWork {
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @Override protected void fromMap(String key, Object value) {
      ...
      if ("afterMedias".equals(key) && value instanceof MediaObject) { afterMedia((MediaObject)value); return; }
      if ("afterMedia".equals(key) && value instanceof String) { afterMedia((String)value); return; }
      if ("afterMedias".equals(key) && value instanceof String) { afterMedia((String)value); return; }
      if ("beforeMedia".equals(key) && value instanceof MediaObject) { beforeMedia((MediaObject)value); return; }
      if ("beforeMedias".equals(key) && value instanceof MediaObject) { beforeMedia((MediaObject)value); return; }
      if ("beforeMedia".equals(key) && value instanceof String) { beforeMedia((String)value); return; }
      if ("beforeMedias".equals(key) && value instanceof String) { beforeMedia((String)value); return; }
      if ("duringMedia".equals(key) && value instanceof MediaObject) { duringMedia((MediaObject)value); return; }
      if ("duringMedias".equals(key) && value instanceof MediaObject) { duringMedia((MediaObject)value); return; }
      if ("duringMedia".equals(key) && value instanceof String) { duringMedia((String)value); return; }
      if ("duringMedias".equals(key) && value instanceof String) { duringMedia((String)value); return; }
