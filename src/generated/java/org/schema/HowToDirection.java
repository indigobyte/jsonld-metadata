...
public class HowToDirection extends CreativeWork {
   ...
   * @return duringMedia property set by first invocation of duringMedia method or {@code null}.
   */
  @JsonIgnore public MediaObject getDuringMediaMediaObject() {
    return (MediaObject) getValue("duringMedia");
  }
  /**
   * A media object representing the circumstances while performing this direction.
   * @return all duringMedia properties as {@link java.util.Collection} or an empty collection 
   * if duringMedia was not set.
   */
  @JsonIgnore public java.util.Collection<MediaObject> getDuringMediaMediaObjects() {
    final java.lang.Object current = myData.get("duringMedia");
   ...
   * @return duringMedia property set by first invocation of duringMedia method or {@code null}.
   */
  @JsonIgnore public String getDuringMediaString() {
    return (String) getValue("duringMedia");
  }
  /**
   * A media object representing the circumstances while performing this direction.
   * @return all duringMedia properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return beforeMedia property set by first invocation of beforeMedia method or {@code null}.
   */
  @JsonIgnore public MediaObject getBeforeMediaMediaObject() {
    return (MediaObject) getValue("beforeMedia");
  }
  /**
   * A media object representing the circumstances before performing this direction.
   * @return all beforeMedia properties as {@link java.util.Collection} or an empty collection 
   * if beforeMedia was not set.
   */
  @JsonIgnore public java.util.Collection<MediaObject> getBeforeMediaMediaObjects() {
    final java.lang.Object current = myData.get("beforeMedia");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<MediaObject>) current;
    }
   ...
   * @return beforeMedia property set by first invocation of beforeMedia method or {@code null}.
   */
  @JsonIgnore public String getBeforeMediaString() {
    return (String) getValue("beforeMedia");
  }
  /**
   * A media object representing the circumstances before performing this direction.
   * @return all beforeMedia properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return supply property set by first invocation of supply method or {@code null}.
   */
  ...
  /**
   * A sub-property of instrument. A supply consumed when performing instructions or a direction.
   * @return all supply properties as {@link java.util.Collection} or an empty collection 
   * if supply was not set.
   */
  @JsonIgnore public java.util.Collection<Supply> getSupplys() {
    final java.lang.Object current = myData.get("supply");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return prepTime property set by first invocation of prepTime method or {@code null}.
   */
  ...
  /**
   * The length of time it takes to prepare the items to be used in instructions or a direction, in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).
   * @return all prepTime properties as {@link java.util.Collection} or an empty collection 
   * if prepTime was not set.
   */
  @JsonIgnore public java.util.Collection<Duration> getPrepTimes() {
    final java.lang.Object current = myData.get("prepTime");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return tool property set by first invocation of tool method or {@code null}.
   */
  @JsonIgnore public Instrument getTool() {
    return (Instrument) getValue("tool");
  }
  /**
   * A sub property of instrument. An object used (but not consumed) when performing instructions or a direction.
   * @return all tool properties as {@link java.util.Collection} or an empty collection 
   * if tool was not set.
   */
  @JsonIgnore public java.util.Collection<Instrument> getTools() {
    final java.lang.Object current = myData.get("tool");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return afterMedia property set by first invocation of afterMedia method or {@code null}.
   */
  @JsonIgnore public MediaObject getAfterMediaMediaObject() {
    return (MediaObject) getValue("afterMedia");
  }
  /**
   * A media object representing the circumstances after performing this direction.
   * @return all afterMedia properties as {@link java.util.Collection} or an empty collection 
   * if afterMedia was not set.
   */
  @JsonIgnore public java.util.Collection<MediaObject> getAfterMediaMediaObjects() {
    final java.lang.Object current = myData.get("afterMedia");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<MediaObject>) current;
    }
   ...
   * @return afterMedia property set by first invocation of afterMedia method or {@code null}.
   */
  @JsonIgnore public String getAfterMediaString() {
    return (String) getValue("afterMedia");
  }
  /**
   * A media object representing the circumstances after performing this direction.
   * @return all afterMedia properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return totalTime property set by first invocation of totalTime method or {@code null}.
   */
  ...
  /**
   * The total time required to perform instructions or a direction (including time to prepare the supplies), in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).
   * @return all totalTime properties as {@link java.util.Collection} or an empty collection 
   * if totalTime was not set.
   */
  @JsonIgnore public java.util.Collection<Duration> getTotalTimes() {
    final java.lang.Object current = myData.get("totalTime");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Duration>) current;
    }
   ...
   * @return performTime property set by first invocation of performTime method or {@code null}.
   */
  ...
  /**
   * The length of time it takes to perform instructions or a direction (not including time to prepare the supplies), in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).
   * @return all performTime properties as {@link java.util.Collection} or an empty collection 
   * if performTime was not set.
   */
  @JsonIgnore public java.util.Collection<PerformTime> getPerformTimes() {
    final java.lang.Object current = myData.get("performTime");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected HowToDirection(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link HowToDirection}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public HowToDirection build() {
      return new HowToDirection(myData);
    }
    /**
     * A media object representing the circumstances while performing this direction.
     ...
     */
    @NotNull public Builder duringMedia(@NotNull MediaObject mediaObject) {
      putValue("duringMedia", mediaObject);
      return this;
    }
    /**
     * A media object representing the circumstances while performing this direction.
     ...
     * @return this builder instance
     */
    @NotNull public Builder duringMedia(@NotNull MediaObject.Builder mediaObject) {
      putValue("duringMedia", mediaObject.build());
      return this;
    }
    /**
     * A media object representing the circumstances while performing this direction.
     * @param duringMedia value to set
     * @return this builder instance
     */
    @NotNull public Builder duringMedia(@NotNull String duringMedia) {
      putValue("duringMedia", duringMedia);
      return this;
    }
    /**
     * Remove duringMedia property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeDuringMedia() {
      removeValue("duringMedia");
      return this;
    }
    /**
     * Get currently set value for duringMedia property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getDuringMedia() {
      return myData.get("duringMedia");
    }
    /**
     * A media object representing the circumstances before performing this direction.
     * @param mediaObject value to set
     * @return this builder instance
     */
    @NotNull public Builder beforeMedia(@NotNull MediaObject mediaObject) {
      putValue("beforeMedia", mediaObject);
      return this;
    }
    /**
     * A media object representing the circumstances before performing this direction.
     ...
     * @return this builder instance
     */
    @NotNull public Builder beforeMedia(@NotNull MediaObject.Builder mediaObject) {
      putValue("beforeMedia", mediaObject.build());
      return this;
    }
    /**
     * A media object representing the circumstances before performing this direction.
     * @param beforeMedia value to set
     * @return this builder instance
     */
    @NotNull public Builder beforeMedia(@NotNull String beforeMedia) {
      putValue("beforeMedia", beforeMedia);
      return this;
    }
    /**
     * Remove beforeMedia property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeBeforeMedia() {
      removeValue("beforeMedia");
      return this;
    }
    /**
     * Get currently set value for beforeMedia property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getBeforeMedia() {
      return myData.get("beforeMedia");
    }
    /**
     * A sub-property of instrument. A supply consumed when performing instructions or a direction.
     * @param supply value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove supply property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSupply() {
      removeValue("supply");
      return this;
    }
    /**
     * Get currently set value for supply property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSupply() {
      return myData.get("supply");
    }
    /**
     * The length of time it takes to prepare the items to be used in instructions or a direction, in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).
    ...
    /**
     * Remove prepTime property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePrepTime() {
      removeValue("prepTime");
      return this;
    }
    /**
     * Get currently set value for prepTime property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPrepTime() {
      return myData.get("prepTime");
    }
    /**
     * A sub property of instrument. An object used (but not consumed) when performing instructions or a direction.
     ...
     * @return this builder instance
     */
    @NotNull public Builder tool(@NotNull Instrument instrument) {
      putValue("tool", instrument);
      return this;
    }
    /**
     * Remove tool property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeTool() {
      removeValue("tool");
      return this;
    }
    /**
     * Get currently set value for tool property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getTool() {
      return myData.get("tool");
    }
    /**
     * A media object representing the circumstances after performing this direction.
     * @param mediaObject value to set
     * @return this builder instance
     */
    @NotNull public Builder afterMedia(@NotNull MediaObject mediaObject) {
      putValue("afterMedia", mediaObject);
      return this;
    }
    /**
     * A media object representing the circumstances after performing this direction.
     ...
     * @return this builder instance
     */
    @NotNull public Builder afterMedia(@NotNull MediaObject.Builder mediaObject) {
      putValue("afterMedia", mediaObject.build());
      return this;
    }
    /**
     * A media object representing the circumstances after performing this direction.
     * @param afterMedia value to set
     * @return this builder instance
     */
    @NotNull public Builder afterMedia(@NotNull String afterMedia) {
      putValue("afterMedia", afterMedia);
      return this;
    }
    /**
     * Remove afterMedia property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAfterMedia() {
      removeValue("afterMedia");
      return this;
    }
    /**
     * Get currently set value for afterMedia property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAfterMedia() {
      return myData.get("afterMedia");
    }
    /**
     * The total time required to perform instructions or a direction (including time to prepare the supplies), in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).
     * @param duration value to set
    ...
    /**
     * Remove totalTime property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeTotalTime() {
      removeValue("totalTime");
      return this;
    }
    /**
     * Get currently set value for totalTime property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getTotalTime() {
      return myData.get("totalTime");
    }
    /**
     * The length of time it takes to perform instructions or a direction (not including time to prepare the supplies), in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).
     * @param performTime value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove performTime property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePerformTime() {
      removeValue("performTime");
      return this;
    }
    /**
     * Get currently set value for performTime property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPerformTime() {
      return myData.get("performTime");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("duringMedia".equals(key) && value instanceof MediaObject) { this.duringMedia((MediaObject)value); return; }
      if ("duringMedias".equals(key) && value instanceof MediaObject) { this.duringMedia((MediaObject)value); return; }
      if ("duringMedia".equals(key) && value instanceof String) { this.duringMedia((String)value); return; }
      if ("duringMedias".equals(key) && value instanceof String) { this.duringMedia((String)value); return; }
      if ("beforeMedia".equals(key) && value instanceof MediaObject) { this.beforeMedia((MediaObject)value); return; }
      if ("beforeMedias".equals(key) && value instanceof MediaObject) { this.beforeMedia((MediaObject)value); return; }
      if ("beforeMedia".equals(key) && value instanceof String) { this.beforeMedia((String)value); return; }
      if ("beforeMedias".equals(key) && value instanceof String) { this.beforeMedia((String)value); return; }
      if ("supply".equals(key) && value instanceof Supply) { this.supply((Supply)value); return; }
      if ("supplys".equals(key) && value instanceof Supply) { this.supply((Supply)value); return; }
      if ("prepTime".equals(key) && value instanceof Duration) { this.prepTime((Duration)value); return; }
      if ("prepTimes".equals(key) && value instanceof Duration) { this.prepTime((Duration)value); return; }
      if ("tool".equals(key) && value instanceof Instrument) { this.tool((Instrument)value); return; }
      if ("tools".equals(key) && value instanceof Instrument) { this.tool((Instrument)value); return; }
      if ("afterMedia".equals(key) && value instanceof MediaObject) { this.afterMedia((MediaObject)value); return; }
      if ("afterMedias".equals(key) && value instanceof MediaObject) { this.afterMedia((MediaObject)value); return; }
      if ("afterMedia".equals(key) && value instanceof String) { this.afterMedia((String)value); return; }
      if ("afterMedias".equals(key) && value instanceof String) { this.afterMedia((String)value); return; }
      if ("totalTime".equals(key) && value instanceof Duration) { this.totalTime((Duration)value); return; }
      if ("totalTimes".equals(key) && value instanceof Duration) { this.totalTime((Duration)value); return; }
      if ("performTime".equals(key) && value instanceof PerformTime) { this.performTime((PerformTime)value); return; }
      if ("performTimes".equals(key) && value instanceof PerformTime) { this.performTime((PerformTime)value); return; }
