...
public class WinAction extends AchieveAction {
  @JsonIgnore public Loser getLoser() {
    return (Loser) getValue("loser");
  }
  @JsonIgnore public Collection<Loser> getLosers() {
    final Object current = myData.get("loser");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<Loser>) current;
    }
    return Arrays.asList((Loser) current);
  }
  ...
  public static class Builder extends AchieveAction.Builder {
    ...
    @NotNull public Builder loser(@NotNull Loser loser) {
      putValue("loser", loser);
      return this;
    }
    /**
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("loser".equals(key) && value instanceof Loser) { loser((Loser)value); return; }
      if ("losers".equals(key) && value instanceof Loser) { loser((Loser)value); return; }
