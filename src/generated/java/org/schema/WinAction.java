...
public class WinAction extends AchieveAction {
   ...
   */
  @JsonIgnore public Person getLoser() {
    return (Person) getValue("loser");
  }
  /**
   * A sub property of participant. The loser of the action.
   */
  @JsonIgnore public Collection<Person> getLosers() {
  ...
  public static class Builder extends AchieveAction.Builder {
     ...
     * A sub property of participant. The loser of the action.
     */
    @NotNull public Builder loser(@NotNull Person person) {
      putValue("loser", person);
      return this;
    }
    /**
     * A sub property of participant. The loser of the action.
     */
    @NotNull public Builder loser(@NotNull Person.Builder person) {
      putValue("loser", person.build());
      return this;
    }
    /**
