...
public class WinAction extends AchieveAction {
   ...
   * @return loser property set by first invocation of loser method or {@code null}.
   */
  @JsonIgnore public Participant getLoser() {
    return (Participant) getValue("loser");
  }
  /**
   * A sub property of participant. The loser of the action.
   * @return all loser properties as {@link java.util.Collection} or an empty collection 
   * if loser was not set.
   */
  @JsonIgnore public java.util.Collection<Participant> getLosers() {
    final java.lang.Object current = myData.get("loser");
  ...
  protected WinAction(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends AchieveAction.Builder {
     ...
     */
    @NotNull public Builder loser(@NotNull Participant participant) {
      putValue("loser", participant);
      return this;
    }
    /**
     * Remove loser property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLoser() {
      removeValue("loser");
      return this;
    }
    /**
     * Get currently set value for loser property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLoser() {
      return myData.get("loser");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("loser".equals(key) && value instanceof Participant) { this.loser((Participant)value); return; }
      if ("losers".equals(key) && value instanceof Participant) { this.loser((Participant)value); return; }
