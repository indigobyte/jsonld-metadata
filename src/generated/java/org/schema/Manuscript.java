...
/**
 * A book, document, or piece of music written by hand rather than typed or printed.Source: https://github.com/schemaorg/schemaorg/issues/1448
 */
public class Manuscript extends CreativeWork {
  protected Manuscript(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Manuscript}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public Manuscript build() {
      return new Manuscript(myData);
    }
    /**
