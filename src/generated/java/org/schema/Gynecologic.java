 ...
 */
public class Gynecologic extends MedicalBusiness {
  protected Gynecologic(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends MedicalBusiness.Builder {
    ...
    @NotNull public Gynecologic build() {
      return new Gynecologic(myData);
    }
    /**
