 ...
 */
public class StupidType extends Thing {
  /**
  ...
  protected StupidType(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link StupidType}
   */
  public static class Builder extends Thing.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public StupidType build() {
      return new StupidType(myData);
    }
    /**
     * This is a StupidProperty! - for testing only
     */
