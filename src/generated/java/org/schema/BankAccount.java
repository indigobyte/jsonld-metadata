...
public class BankAccount extends FinancialProduct {
   ...
   * @return bankAccountType property set by first invocation of bankAccountType method or {@code null}.
   */
  ...
  /**
   * The type of a bank account.
   * @return all bankAccountType properties as {@link java.util.Collection} or an empty collection 
   * if bankAccountType was not set.
   */
  @JsonIgnore public java.util.Collection<String> getBankAccountTypes() {
    final java.lang.Object current = myData.get("bankAccountType");
   ...
   * @return accountOverdraftLimit property set by first invocation of accountOverdraftLimit method or {@code null}.
   */
  ...
  /**
   * An overdraft is an extension of credit from a lending institution when an account reaches zero. An overdraft allows the individual to continue withdrawing money even if the account has no funds in it. Basically the bank allows people to borrow a set amount of money.
   * @return all accountOverdraftLimit properties as {@link java.util.Collection} or an empty collection 
   * if accountOverdraftLimit was not set.
   */
  @JsonIgnore public java.util.Collection<MonetaryAmount> getAccountOverdraftLimits() {
    final java.lang.Object current = myData.get("accountOverdraftLimit");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return accountMinimumInflow property set by first invocation of accountMinimumInflow method or {@code null}.
   */
  ...
  /**
   * A minimum amount that has to be paid in every month.
   * @return all accountMinimumInflow properties as {@link java.util.Collection} or an empty collection 
   * if accountMinimumInflow was not set.
   */
  @JsonIgnore public java.util.Collection<MonetaryAmount> getAccountMinimumInflows() {
    final java.lang.Object current = myData.get("accountMinimumInflow");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<MonetaryAmount>) current;
    }
  ...
  protected BankAccount(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends FinancialProduct.Builder {
    ...
    @NotNull public BankAccount build() {
      return new BankAccount(myData);
    }
    /**
     * The type of a bank account.
     * @param bankAccountType value to set
    ...
    /**
     * Remove bankAccountType property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeBankAccountType() {
      removeValue("bankAccountType");
      return this;
    }
    /**
     * Get currently set value for bankAccountType property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getBankAccountType() {
      return myData.get("bankAccountType");
    }
    /**
     * An overdraft is an extension of credit from a lending institution when an account reaches zero. An overdraft allows the individual to continue withdrawing money even if the account has no funds in it. Basically the bank allows people to borrow a set amount of money.
    ...
    /**
     * Remove accountOverdraftLimit property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAccountOverdraftLimit() {
      removeValue("accountOverdraftLimit");
      return this;
    }
    /**
     * Get currently set value for accountOverdraftLimit property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAccountOverdraftLimit() {
      return myData.get("accountOverdraftLimit");
    }
    /**
     * A minimum amount that has to be paid in every month.
     * @param monetaryAmount value to set
    ...
    /**
     * Remove accountMinimumInflow property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAccountMinimumInflow() {
      removeValue("accountMinimumInflow");
      return this;
    }
    /**
     * Get currently set value for accountMinimumInflow property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAccountMinimumInflow() {
      return myData.get("accountMinimumInflow");
    }
    /**
