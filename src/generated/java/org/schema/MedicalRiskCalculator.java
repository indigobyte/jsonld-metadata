...
public class MedicalRiskCalculator extends MedicalRiskEstimator {
  protected MedicalRiskCalculator(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link MedicalRiskCalculator}
   */
  public static class Builder extends MedicalRiskEstimator.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MedicalRiskCalculator build() {
      return new MedicalRiskCalculator(myData);
    }
    /**
