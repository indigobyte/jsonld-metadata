...
/**
 * A radio channel that uses AM.Source: https://github.com/schemaorg/schemaorg/issues/1004
 */
public class AMRadioChannel extends RadioChannel {
  protected AMRadioChannel(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link AMRadioChannel}
   */
  public static class Builder extends RadioChannel.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public AMRadioChannel build() {
      return new AMRadioChannel(myData);
    }
    /**
