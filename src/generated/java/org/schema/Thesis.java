...
public class Thesis extends CreativeWork {
   ...
   * @return inSupportOf property set by first invocation of inSupportOf method or {@code null}.
   */
  @JsonIgnore public String getInSupportOf() {
    return (String) getValue("inSupportOf");
  }
  /**
   * Qualification, candidature, degree, application that Thesis supports.
   * @return all inSupportOf properties as {@link java.util.Collection} or an empty collection 
   * if inSupportOf was not set.
   */
  @JsonIgnore public java.util.Collection<String> getInSupportOfs() {
    final java.lang.Object current = myData.get("inSupportOf");
  ...
  protected Thesis(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Thesis}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public Thesis build() {
      return new Thesis(myData);
    }
    /**
     * Qualification, candidature, degree, application that Thesis supports.
     * @param inSupportOf value to set
     * @return this builder instance
     */
    @NotNull public Builder inSupportOf(@NotNull String inSupportOf) {
      putValue("inSupportOf", inSupportOf);
      return this;
    }
    /**
     * Remove inSupportOf property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeInSupportOf() {
      removeValue("inSupportOf");
      return this;
    }
    /**
     * Get currently set value for inSupportOf property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getInSupportOf() {
      return myData.get("inSupportOf");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("inSupportOf".equals(key) && value instanceof String) { this.inSupportOf((String)value); return; }
      if ("inSupportOfs".equals(key) && value instanceof String) { this.inSupportOf((String)value); return; }
