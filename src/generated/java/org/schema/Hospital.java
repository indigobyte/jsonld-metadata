...
public class Hospital extends CivicStructure {
   ...
   * Indicates data describing a hospital, e.g. a CDC [[CDCPMDRecord]] or as some kind of [[Dataset]].
   */
  @JsonIgnore public Collection<CDCPMDRecord> getHealthcareReportingDataCDCPMDRecords() {
    final Object current = myData.get("healthcareReportingData");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<CDCPMDRecord>) current;
    }
   ...
   * Indicates data describing a hospital, e.g. a CDC [[CDCPMDRecord]] or as some kind of [[Dataset]].
   */
  @JsonIgnore public Collection<Dataset> getHealthcareReportingDataDatasets() {
    final Object current = myData.get("healthcareReportingData");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
