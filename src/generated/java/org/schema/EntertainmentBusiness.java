 ...
 */
public class EntertainmentBusiness extends LocalBusiness implements EntertainmentBusiness {
  protected EntertainmentBusiness(java.util.Map<String,Object> data) {
    super(data);
  }
