...
public class MathSolver extends CreativeWork {
   ...
   * @return mathExpression property set by first invocation of mathExpression method or {@code null}.
   */
  @JsonIgnore public SolveMathAction getMathExpressionSolveMathAction() {
    return (SolveMathAction) getValue("mathExpression");
  }
  /**
   * A mathematical expression (e.g. 'x^2-3x=0') that may be solved for a specific variable, simplified, or transformed. This can take many formats, e.g. LaTeX, Ascii-Math, or math as you would write with a keyboard.
   * @return all mathExpression properties as {@link java.util.Collection} or an empty collection 
   * if mathExpression was not set.
   */
  @JsonIgnore public java.util.Collection<SolveMathAction> getMathExpressionSolveMathActions() {
    final java.lang.Object current = myData.get("mathExpression");
   ...
   * @return mathExpression property set by first invocation of mathExpression method or {@code null}.
   */
  @JsonIgnore public String getMathExpressionString() {
    return (String) getValue("mathExpression");
  }
  /**
   * A mathematical expression (e.g. 'x^2-3x=0') that may be solved for a specific variable, simplified, or transformed. This can take many formats, e.g. LaTeX, Ascii-Math, or math as you would write with a keyboard.
   * @return all mathExpression properties as {@link java.util.Collection} or an empty collection 
  ...
  protected MathSolver(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link MathSolver}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MathSolver build() {
      return new MathSolver(myData);
    }
    /**
     * A mathematical expression (e.g. 'x^2-3x=0') that may be solved for a specific variable, simplified, or transformed. This can take many formats, e.g. LaTeX, Ascii-Math, or math as you would write with a keyboard.
     * @param solveMathAction value to set
     * @return this builder instance
     */
    @NotNull public Builder mathExpression(@NotNull SolveMathAction solveMathAction) {
      putValue("mathExpression", solveMathAction);
      return this;
    }
    /**
     * A mathematical expression (e.g. 'x^2-3x=0') that may be solved for a specific variable, simplified, or transformed. This can take many formats, e.g. LaTeX, Ascii-Math, or math as you would write with a keyboard.
     ...
     * @return this builder instance
     */
    @NotNull public Builder mathExpression(@NotNull SolveMathAction.Builder solveMathAction) {
      putValue("mathExpression", solveMathAction.build());
      return this;
    }
    /**
     * A mathematical expression (e.g. 'x^2-3x=0') that may be solved for a specific variable, simplified, or transformed. This can take many formats, e.g. LaTeX, Ascii-Math, or math as you would write with a keyboard.
     * @param mathExpression value to set
     * @return this builder instance
     */
    @NotNull public Builder mathExpression(@NotNull String mathExpression) {
      putValue("mathExpression", mathExpression);
      return this;
    }
    /**
     * Remove mathExpression property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeMathExpression() {
      removeValue("mathExpression");
      return this;
    }
    /**
     * Get currently set value for mathExpression property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getMathExpression() {
      return myData.get("mathExpression");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("mathExpression".equals(key) && value instanceof SolveMathAction) { this.mathExpression((SolveMathAction)value); return; }
      if ("mathExpressions".equals(key) && value instanceof SolveMathAction) { this.mathExpression((SolveMathAction)value); return; }
      if ("mathExpression".equals(key) && value instanceof String) { this.mathExpression((String)value); return; }
      if ("mathExpressions".equals(key) && value instanceof String) { this.mathExpression((String)value); return; }
