...
public class Blog extends CreativeWork {
   ...
   * @return blogPost property set by first invocation of blogPost method or {@code null}.
   */
  @JsonIgnore public BlogPosting getBlogPost() {
    return (BlogPosting) getValue("blogPost");
  }
  /**
   * A posting that is part of this blog.
   * @return all blogPost properties as {@link java.util.Collection} or an empty collection 
   * if blogPost was not set.
   */
  @JsonIgnore public java.util.Collection<BlogPosting> getBlogPosts() {
    final java.lang.Object current = myData.get("blogPost");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected Blog(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link Blog}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public Blog build() {
      return new Blog(myData);
    }
    /**
     * The International Standard Serial Number (ISSN) that identifies this serial publication. You can repeat this property to identify different formats of, or the linking ISSN (ISSN-L) for, this serial publication.
     ...
     * @return this builder instance
     */
    @NotNull public Builder blogPost(@NotNull BlogPosting blogPosting) {
      putValue("blogPost", blogPosting);
      return this;
    }
    /**
     * A posting that is part of this blog.
     ...
     * @return this builder instance
     */
    @NotNull public Builder blogPost(@NotNull BlogPosting.Builder blogPosting) {
      putValue("blogPost", blogPosting.build());
      return this;
    }
    /**
     * Remove blogPost property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeBlogPost() {
      removeValue("blogPost");
      return this;
    }
    /**
     * Get currently set value for blogPost property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getBlogPost() {
      return myData.get("blogPost");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("blogPost".equals(key) && value instanceof BlogPosting) { this.blogPost((BlogPosting)value); return; }
      if ("blogPosts".equals(key) && value instanceof BlogPosting) { this.blogPost((BlogPosting)value); return; }
