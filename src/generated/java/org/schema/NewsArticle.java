...
public class NewsArticle extends Article {
   ...
   * @return printSection property set by first invocation of printSection method or {@code null}.
   */
  @JsonIgnore public String getPrintSection() {
    return (String) getValue("printSection");
  }
  /**
   * If this NewsArticle appears in print, this field indicates the print section in which the article appeared.
   * @return all printSection properties as {@link java.util.Collection} or an empty collection 
   * if printSection was not set.
   */
   ...
   * @return printEdition property set by first invocation of printEdition method or {@code null}.
   */
  @JsonIgnore public String getPrintEdition() {
    return (String) getValue("printEdition");
  }
  /**
   * The edition of the print product in which the NewsArticle appears.
   * @return all printEdition properties as {@link java.util.Collection} or an empty collection 
   * if printEdition was not set.
   */
   ...
   * @return printColumn property set by first invocation of printColumn method or {@code null}.
   */
  @JsonIgnore public String getPrintColumn() {
    return (String) getValue("printColumn");
  }
  /**
   * The number of the column in which the NewsArticle appears in the print edition.
   * @return all printColumn properties as {@link java.util.Collection} or an empty collection 
   * if printColumn was not set.
   */
   ...
   *       
   *                                 @return dateline property set by first invocation of dateline method or {@code null}.
   */
  @JsonIgnore public String getDateline() {
    return (String) getValue("dateline");
  }
  /**
   *                                     A [dateline](https://en.wikipedia.org/wiki/Dateline) is a brief piece of text included in news articles that describes where and when the story was written or filed though the date is often omitted. Sometimes only a placename is provided.
   * 
   ...
   * Dateline summaries are oriented more towards human readers than towards automated processing, and can vary substantially. Some examples: &quot;BEIRUT, Lebanon, June 2.&quot;, &quot;Paris, France&quot;, &quot;December 19, 2017 11:43AM Reporting from Washington&quot;, &quot;Beijing/Moscow&quot;, &quot;QUEZON CITY, Philippines&quot;.
   *       
   *                                     @return all dateline properties as {@link java.util.Collection} or an empty collection 
   *                                     if dateline was not set.
   */
   ...
   * @return printPage property set by first invocation of printPage method or {@code null}.
   */
  @JsonIgnore public String getPrintPage() {
    return (String) getValue("printPage");
  }
  /**
   * If this NewsArticle appears in print, this field indicates the name of the page on which the article is found. Please note that this field is intended for the exact page name (e.g. A5, B18).
   * @return all printPage properties as {@link java.util.Collection} or an empty collection 
   * if printPage was not set.
   */
  ...
  public static class Builder extends Article.Builder {
    ...
    @NotNull public NewsArticle build() {
      return new NewsArticle(myData);
    }
    /**
     * If this NewsArticle appears in print, this field indicates the print section in which the article appeared.
     * @param printSection value to set
     * @return this builder instance
     */
    @NotNull public Builder printSection(@NotNull String printSection) {
      putValue("printSection", printSection);
      return this;
    }
    /**
     * Remove printSection property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePrintSection() {
      removeValue("printSection");
      return this;
    }
    /**
     * Get currently set value for printSection property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPrintSection() {
      return myData.get("printSection");
    }
    /**
     * The edition of the print product in which the NewsArticle appears.
     * @param printEdition value to set
     * @return this builder instance
     */
    @NotNull public Builder printEdition(@NotNull String printEdition) {
      putValue("printEdition", printEdition);
      return this;
    }
    /**
     * Remove printEdition property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePrintEdition() {
      removeValue("printEdition");
      return this;
    }
    /**
     * Get currently set value for printEdition property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPrintEdition() {
      return myData.get("printEdition");
    }
    /**
     * The number of the column in which the NewsArticle appears in the print edition.
     * @param printColumn value to set
     * @return this builder instance
     */
    @NotNull public Builder printColumn(@NotNull String printColumn) {
      putValue("printColumn", printColumn);
      return this;
    }
    /**
     * Remove printColumn property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePrintColumn() {
      removeValue("printColumn");
      return this;
    }
    /**
     * Get currently set value for printColumn property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPrintColumn() {
      return myData.get("printColumn");
    }
    /**
     *                                         A [dateline](https://en.wikipedia.org/wiki/Dateline) is a brief piece of text included in news articles that describes where and when the story was written or filed though the date is often omitted. Sometimes only a placename is provided.
     * 
     ...
     * Dateline summaries are oriented more towards human readers than towards automated processing, and can vary substantially. Some examples: &quot;BEIRUT, Lebanon, June 2.&quot;, &quot;Paris, France&quot;, &quot;December 19, 2017 11:43AM Reporting from Washington&quot;, &quot;Beijing/Moscow&quot;, &quot;QUEZON CITY, Philippines&quot;.
     *       
     *                                         @param dateline value to set
     *                                         @return this builder instance
     */
    @NotNull public Builder dateline(@NotNull String dateline) {
      putValue("dateline", dateline);
      return this;
    }
    /**
     * Remove dateline property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeDateline() {
      removeValue("dateline");
      return this;
    }
    /**
     * Get currently set value for dateline property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getDateline() {
      return myData.get("dateline");
    }
    /**
     * If this NewsArticle appears in print, this field indicates the name of the page on which the article is found. Please note that this field is intended for the exact page name (e.g. A5, B18).
     * @param printPage value to set
     * @return this builder instance
     */
    @NotNull public Builder printPage(@NotNull String printPage) {
      putValue("printPage", printPage);
      return this;
    }
    /**
     * Remove printPage property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePrintPage() {
      removeValue("printPage");
      return this;
    }
    /**
     * Get currently set value for printPage property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPrintPage() {
      return myData.get("printPage");
    }
    /**
