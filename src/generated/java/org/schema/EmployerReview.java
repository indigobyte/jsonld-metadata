 ...
 */
public class EmployerReview extends Review {
  protected EmployerReview(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link EmployerReview}
   */
  public static class Builder extends Review.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public EmployerReview build() {
      return new EmployerReview(myData);
    }
    /**
