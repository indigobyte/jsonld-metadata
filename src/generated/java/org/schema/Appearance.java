 ...
 */
public class Appearance extends PhysicalExam {
  protected Appearance(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends PhysicalExam.Builder {
    ...
    @NotNull public Appearance build() {
      return new Appearance(myData);
    }
    /**
