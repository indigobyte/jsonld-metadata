...
public class _3DModel extends MediaObject {
   ...
   * @return isResizable property set by first invocation of isResizable method or {@code null}.
   */
  @JsonIgnore public Boolean getIsResizable() {
    return (Boolean) getValue("isResizable");
  }
  /**
   * Whether the 3DModel allows resizing. For example, room layout applications often do not allow 3DModel elements to be resized to reflect reality.
   * @return all isResizable properties as {@link java.util.Collection} or an empty collection 
   * if isResizable was not set.
   */
  @JsonIgnore public java.util.Collection<Boolean> getIsResizables() {
    final java.lang.Object current = myData.get("isResizable");
  ...
  public static class Builder extends MediaObject.Builder {
    ...
    @NotNull public _3DModel build() {
      return new _3DModel(myData);
    }
    /**
     * Whether the 3DModel allows resizing. For example, room layout applications often do not allow 3DModel elements to be resized to reflect reality.
     * @param isResizable value to set
     * @return this builder instance
     */
    @NotNull public Builder isResizable(@NotNull Boolean isResizable) {
      putValue("isResizable", isResizable);
      return this;
    }
    /**
     * Remove isResizable property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIsResizable() {
      removeValue("isResizable");
      return this;
    }
    /**
     * Get currently set value for isResizable property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIsResizable() {
      return myData.get("isResizable");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("isResizable".equals(key) && value instanceof Boolean) { this.isResizable((Boolean)value); return; }
      if ("isResizables".equals(key) && value instanceof Boolean) { this.isResizable((Boolean)value); return; }
