...
public class MobileApplication extends SoftwareApplication {
   ...
   * @return carrierRequirements property set by first invocation of carrierRequirements method or {@code null}.
   */
  ...
  /**
   * Specifies specific carrier(s) requirements for the application (e.g. an application may only work on a specific carrier network).
   * @return all carrierRequirements properties as {@link java.util.Collection} or an empty collection 
   * if carrierRequirements was not set.
   */
  @JsonIgnore public java.util.Collection<String> getCarrierRequirementss() {
    final java.lang.Object current = myData.get("carrierRequirements");
  ...
  protected MobileApplication(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends SoftwareApplication.Builder {
    ...
    /**
     * Specifies specific carrier(s) requirements for the application (e.g. an application may only work on a specific carrier network).
     * @param carrierRequirements value to set
    ...
    /**
     * Remove carrierRequirements property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCarrierRequirements() {
      removeValue("carrierRequirements");
      return this;
    }
    /**
     * Get currently set value for carrierRequirements property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCarrierRequirements() {
      return myData.get("carrierRequirements");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("carrierRequirements".equals(key) && value instanceof String) { this.carrierRequirements((String)value); return; }
      if ("carrierRequirementss".equals(key) && value instanceof String) { this.carrierRequirements((String)value); return; }
