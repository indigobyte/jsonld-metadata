...
public class BroadcastEvent extends PublicationEvent {
   ...
   * @return broadcastOfEvent property set by first invocation of broadcastOfEvent method or {@code null}.
   */
  ...
  /**
   * The event being broadcast such as a sporting event or awards ceremony.
   * @return all broadcastOfEvent properties as {@link java.util.Collection} or an empty collection 
   * if broadcastOfEvent was not set.
   */
  @JsonIgnore public java.util.Collection<Event> getBroadcastOfEvents() {
    final java.lang.Object current = myData.get("broadcastOfEvent");
   ...
   * @return isLiveBroadcast property set by first invocation of isLiveBroadcast method or {@code null}.
   */
  @JsonIgnore public Boolean getIsLiveBroadcast() {
    return (Boolean) getValue("isLiveBroadcast");
  }
  /**
   * True if the broadcast is of a live event.
   * @return all isLiveBroadcast properties as {@link java.util.Collection} or an empty collection 
   * if isLiveBroadcast was not set.
   */
  @JsonIgnore public java.util.Collection<Boolean> getIsLiveBroadcasts() {
    final java.lang.Object current = myData.get("isLiveBroadcast");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected BroadcastEvent(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends PublicationEvent.Builder {
    ...
    /**
     * Remove broadcastOfEvent property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeBroadcastOfEvent() {
      removeValue("broadcastOfEvent");
      return this;
    }
    /**
     * Get currently set value for broadcastOfEvent property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getBroadcastOfEvent() {
      return myData.get("broadcastOfEvent");
    }
    /**
     * True if the broadcast is of a live event.
     * @param isLiveBroadcast value to set
     * @return this builder instance
     */
    @NotNull public Builder isLiveBroadcast(@NotNull Boolean isLiveBroadcast) {
      putValue("isLiveBroadcast", isLiveBroadcast);
      return this;
    }
    /**
     * Remove isLiveBroadcast property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIsLiveBroadcast() {
      removeValue("isLiveBroadcast");
      return this;
    }
    /**
     * Get currently set value for isLiveBroadcast property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIsLiveBroadcast() {
      return myData.get("isLiveBroadcast");
    }
    /**
     * Languages in which subtitles/captions are available, in [IETF BCP 47 standard format](http://tools.ietf.org/html/bcp47).
     ...
     * @return this builder instance
     */
    @NotNull public Builder publishedOn(@NotNull BroadcastService broadcastService) {
      putValue("publishedOn", broadcastService);
      return this;
    }
    /**
     * A broadcast service associated with the publication event.
    ...
    /**
     * Remove publishedOn property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePublishedOn() {
      removeValue("publishedOn");
      return this;
    }
    /**
     * Get currently set value for publishedOn property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPublishedOn() {
      return myData.get("publishedOn");
    }
    /**
     ...
     * @return this builder instance
     */
    @NotNull public Builder publishedBy(@NotNull Organization organization) {
      putValue("publishedBy", organization);
      return this;
    }
    /**
     * An agent associated with the publication event.
     ...
     * @return this builder instance
     */
    @NotNull public Builder publishedBy(@NotNull Organization.Builder organization) {
      putValue("publishedBy", organization.build());
      return this;
    }
    /**
     * An agent associated with the publication event.
     ...
     * @return this builder instance
     */
    @NotNull public Builder publishedBy(@NotNull Person person) {
      putValue("publishedBy", person);
      return this;
    }
    /**
     * An agent associated with the publication event.
     ...
     * @return this builder instance
     */
    @NotNull public Builder publishedBy(@NotNull Person.Builder person) {
      putValue("publishedBy", person.build());
      return this;
    }
    /**
     * Remove publishedBy property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePublishedBy() {
      removeValue("publishedBy");
      return this;
    }
    /**
     * Get currently set value for publishedBy property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPublishedBy() {
      return myData.get("publishedBy");
    }
    /**
