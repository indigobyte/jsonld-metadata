...
public class VisualArtwork extends CreativeWork {
  ...
  @JsonIgnore public ArtMedium getArtMedium() {
    return (ArtMedium) getValue("artMedium");
  }
  @JsonIgnore public Collection<ArtMedium> getArtMediums() {
  ...
  @JsonIgnore public Surface getSurface() {
    return (Surface) getValue("surface");
  }
  @JsonIgnore public Collection<Surface> getSurfaces() {
    final Object current = myData.get("surface");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<Surface>) current;
    }
    return Arrays.asList((Surface) current);
  }
  /**
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @NotNull public Builder artMedium(@NotNull ArtMedium artMedium) {
      putValue("artMedium", artMedium);
      return this;
    }
    @NotNull public Builder surface(@NotNull Surface surface) {
      putValue("surface", surface);
      return this;
    }
    /**
     * The supporting materials for the artwork, e.g. Canvas, Paper, Wood, Board, etc.
    ...
    @Override protected void fromMap(String key, Object value) {
      ...
      if ("artMedium".equals(key) && value instanceof ArtMedium) { artMedium((ArtMedium)value); return; }
      if ("artMediums".equals(key) && value instanceof ArtMedium) { artMedium((ArtMedium)value); return; }
      if ("surface".equals(key) && value instanceof Surface) { surface((Surface)value); return; }
      if ("surfaces".equals(key) && value instanceof Surface) { surface((Surface)value); return; }
