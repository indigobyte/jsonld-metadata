...
public class VisualArtwork extends CreativeWork {
   ...
   * @return artworkSurface property set by first invocation of artworkSurface method or {@code null}.
   */
  @JsonIgnore public String getArtworkSurface() {
    return (String) getValue("artworkSurface");
  }
  /**
   * The supporting materials for the artwork, e.g. Canvas, Paper, Wood, Board, etc.
   * @return all artworkSurface properties as {@link java.util.Collection} or an empty collection 
   * if artworkSurface was not set.
   */
  @JsonIgnore public java.util.Collection<String> getArtworkSurfaces() {
    final java.lang.Object current = myData.get("artworkSurface");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return letterer property set by first invocation of letterer method or {@code null}.
   */
  @JsonIgnore public Person getLetterer() {
    return (Person) getValue("letterer");
  }
  /**
   * The individual who adds lettering, including speech balloons and sound effects, to artwork.
   * @return all letterer properties as {@link java.util.Collection} or an empty collection 
   * if letterer was not set.
   */
  @JsonIgnore public java.util.Collection<Person> getLetterers() {
    final java.lang.Object current = myData.get("letterer");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return inker property set by first invocation of inker method or {@code null}.
   */
  @JsonIgnore public Person getInker() {
    return (Person) getValue("inker");
  }
  /**
   * The individual who traces over the pencil drawings in ink after pencils are complete.
   * @return all inker properties as {@link java.util.Collection} or an empty collection 
   * if inker was not set.
   */
  @JsonIgnore public java.util.Collection<Person> getInkers() {
    final java.lang.Object current = myData.get("inker");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Person>) current;
    }
   ...
   * @return colorist property set by first invocation of colorist method or {@code null}.
   */
  @JsonIgnore public Person getColorist() {
    return (Person) getValue("colorist");
  }
  /**
   * The individual who adds color to inked drawings.
   * @return all colorist properties as {@link java.util.Collection} or an empty collection 
   * if colorist was not set.
   */
  @JsonIgnore public java.util.Collection<Person> getColorists() {
    final java.lang.Object current = myData.get("colorist");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Person>) current;
    }
   ...
   *                            @return artist property set by first invocation of artist method or {@code null}.
   */
  @JsonIgnore public Person getArtist() {
    return (Person) getValue("artist");
  }
  /**
   *                                The primary artist for a work
   * in a medium other than pencils or digital line art--for example, if the
   * primary artwork is done in watercolors or digital paints.
   *                                @return all artist properties as {@link java.util.Collection} or an empty collection 
   *                                if artist was not set.
   */
  @JsonIgnore public java.util.Collection<Person> getArtists() {
    final java.lang.Object current = myData.get("artist");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Person>) current;
    }
   ...
   * @return penciler property set by first invocation of penciler method or {@code null}.
   */
  @JsonIgnore public Person getPenciler() {
    return (Person) getValue("penciler");
  }
  /**
   * The individual who draws the primary narrative artwork.
   * @return all penciler properties as {@link java.util.Collection} or an empty collection 
   * if penciler was not set.
   */
  @JsonIgnore public java.util.Collection<Person> getPencilers() {
    final java.lang.Object current = myData.get("penciler");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Person>) current;
    }
   ...
   * @return artMedium property set by first invocation of artMedium method or {@code null}.
   */
  ...
  /**
   * The material used. (e.g. Oil, Watercolour, Acrylic, Linoprint, Marble, Cyanotype, Digital, Lithograph, DryPoint, Intaglio, Pastel, Woodcut, Pencil, Mixed Media, etc.)
   * @return all artMedium properties as {@link java.util.Collection} or an empty collection 
   * if artMedium was not set.
   */
  @JsonIgnore public java.util.Collection<Material> getArtMediums() {
    final java.lang.Object current = myData.get("artMedium");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return artEdition property set by first invocation of artEdition method or {@code null}.
   */
  @JsonIgnore public Integer getArtEditionInteger() {
    return (Integer) getValue("artEdition");
  }
  /**
   * The number of copies when multiple copies of a piece of artwork are produced - e.g. for a limited edition of 20 prints, 'artEdition' refers to the total number of copies (in this example &quot;20&quot;).
   * @return all artEdition properties as {@link java.util.Collection} or an empty collection 
   * if artEdition was not set.
   */
  @JsonIgnore public java.util.Collection<Integer> getArtEditionIntegers() {
    final java.lang.Object current = myData.get("artEdition");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return artEdition property set by first invocation of artEdition method or {@code null}.
   */
  @JsonIgnore public String getArtEditionString() {
    return (String) getValue("artEdition");
  }
  /**
   * The number of copies when multiple copies of a piece of artwork are produced - e.g. for a limited edition of 20 prints, 'artEdition' refers to the total number of copies (in this example &quot;20&quot;).
   * @return all artEdition properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return artform property set by first invocation of artform method or {@code null}.
   */
  @JsonIgnore public String getArtform() {
    return (String) getValue("artform");
  }
  /**
   * e.g. Painting, Drawing, Sculpture, Print, Photograph, Assemblage, Collage, etc.
   * @return all artform properties as {@link java.util.Collection} or an empty collection 
   * if artform was not set.
   */
  @JsonIgnore public java.util.Collection<String> getArtforms() {
    final java.lang.Object current = myData.get("artform");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
  ...
  protected VisualArtwork(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    /**
     * The supporting materials for the artwork, e.g. Canvas, Paper, Wood, Board, etc.
     * @param artworkSurface value to set
     * @return this builder instance
     */
    @NotNull public Builder artworkSurface(@NotNull String artworkSurface) {
      putValue("artworkSurface", artworkSurface);
      return this;
    }
    /**
     * Remove artworkSurface property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeArtworkSurface() {
      removeValue("artworkSurface");
      return this;
    }
    /**
     * Get currently set value for artworkSurface property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getArtworkSurface() {
      return myData.get("artworkSurface");
    }
    /**
     * The individual who adds lettering, including speech balloons and sound effects, to artwork.
     ...
     * @return this builder instance
     */
    @NotNull public Builder letterer(@NotNull Person person) {
      putValue("letterer", person);
      return this;
    }
    /**
     * The individual who adds lettering, including speech balloons and sound effects, to artwork.
     ...
     * @return this builder instance
     */
    @NotNull public Builder letterer(@NotNull Person.Builder person) {
      putValue("letterer", person.build());
      return this;
    }
    /**
     * Remove letterer property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLetterer() {
      removeValue("letterer");
      return this;
    }
    /**
     * Get currently set value for letterer property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLetterer() {
      return myData.get("letterer");
    }
    /**
     * The individual who traces over the pencil drawings in ink after pencils are complete.
     * @param person value to set
     * @return this builder instance
     */
    @NotNull public Builder inker(@NotNull Person person) {
      putValue("inker", person);
      return this;
    }
    /**
     * The individual who traces over the pencil drawings in ink after pencils are complete.
     ...
     * @return this builder instance
     */
    @NotNull public Builder inker(@NotNull Person.Builder person) {
      putValue("inker", person.build());
      return this;
    }
    /**
     * Remove inker property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeInker() {
      removeValue("inker");
      return this;
    }
    /**
     * Get currently set value for inker property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getInker() {
      return myData.get("inker");
    }
    /**
     * The individual who adds color to inked drawings.
     * @param person value to set
     * @return this builder instance
     */
    @NotNull public Builder colorist(@NotNull Person person) {
      putValue("colorist", person);
      return this;
    }
    /**
     * The individual who adds color to inked drawings.
     ...
     * @return this builder instance
     */
    @NotNull public Builder colorist(@NotNull Person.Builder person) {
      putValue("colorist", person.build());
      return this;
    }
    /**
     * Remove colorist property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeColorist() {
      removeValue("colorist");
      return this;
    }
    /**
     * Get currently set value for colorist property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getColorist() {
      return myData.get("colorist");
    }
    /**
     *                                    The primary artist for a work
     * in a medium other than pencils or digital line art--for example, if the
     ...
     *                                    @return this builder instance
     */
    @NotNull public Builder artist(@NotNull Person person) {
      putValue("artist", person);
      return this;
    }
    /**
     *                                        The primary artist for a work
     ...
     *                                        @return this builder instance
     */
    @NotNull public Builder artist(@NotNull Person.Builder person) {
      putValue("artist", person.build());
      return this;
    }
    /**
     * Remove artist property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeArtist() {
      removeValue("artist");
      return this;
    }
    /**
     * Get currently set value for artist property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getArtist() {
      return myData.get("artist");
    }
    /**
     * The depth of the item.
     * @param distance value to set
     ...
     * @return this builder instance
     */
    @NotNull public Builder penciler(@NotNull Person person) {
      putValue("penciler", person);
      return this;
    }
    /**
     * The individual who draws the primary narrative artwork.
     ...
     * @return this builder instance
     */
    @NotNull public Builder penciler(@NotNull Person.Builder person) {
      putValue("penciler", person.build());
      return this;
    }
    /**
     * Remove penciler property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePenciler() {
      removeValue("penciler");
      return this;
    }
    /**
     * Get currently set value for penciler property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPenciler() {
      return myData.get("penciler");
    }
    /**
     * The material used. (e.g. Oil, Watercolour, Acrylic, Linoprint, Marble, Cyanotype, Digital, Lithograph, DryPoint, Intaglio, Pastel, Woodcut, Pencil, Mixed Media, etc.)
    ...
    /**
     * Remove artMedium property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeArtMedium() {
      removeValue("artMedium");
      return this;
    }
    /**
     * Get currently set value for artMedium property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getArtMedium() {
      return myData.get("artMedium");
    }
    /**
     * The number of copies when multiple copies of a piece of artwork are produced - e.g. for a limited edition of 20 prints, 'artEdition' refers to the total number of copies (in this example &quot;20&quot;).
     ...
     * @return this builder instance
     */
    @NotNull public Builder artEdition(@NotNull Integer integer) {
      putValue("artEdition", integer);
      return this;
    }
    /**
     * The number of copies when multiple copies of a piece of artwork are produced - e.g. for a limited edition of 20 prints, 'artEdition' refers to the total number of copies (in this example &quot;20&quot;).
     * @param artEdition value to set
     * @return this builder instance
     */
    @NotNull public Builder artEdition(@NotNull String artEdition) {
      putValue("artEdition", artEdition);
      return this;
    }
    /**
     * Remove artEdition property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeArtEdition() {
      removeValue("artEdition");
      return this;
    }
    /**
     * Get currently set value for artEdition property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getArtEdition() {
      return myData.get("artEdition");
    }
    /**
     * e.g. Painting, Drawing, Sculpture, Print, Photograph, Assemblage, Collage, etc.
     * @param artform value to set
     * @return this builder instance
     */
    @NotNull public Builder artform(@NotNull String artform) {
      putValue("artform", artform);
      return this;
    }
    /**
     * Remove artform property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeArtform() {
      removeValue("artform");
      return this;
    }
    /**
     * Get currently set value for artform property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getArtform() {
      return myData.get("artform");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("artworkSurface".equals(key) && value instanceof String) { this.artworkSurface((String)value); return; }
      if ("artworkSurfaces".equals(key) && value instanceof String) { this.artworkSurface((String)value); return; }
      if ("letterer".equals(key) && value instanceof Person) { this.letterer((Person)value); return; }
      if ("letterers".equals(key) && value instanceof Person) { this.letterer((Person)value); return; }
      if ("inker".equals(key) && value instanceof Person) { this.inker((Person)value); return; }
      if ("inkers".equals(key) && value instanceof Person) { this.inker((Person)value); return; }
      if ("colorist".equals(key) && value instanceof Person) { this.colorist((Person)value); return; }
      if ("colorists".equals(key) && value instanceof Person) { this.colorist((Person)value); return; }
      if ("artist".equals(key) && value instanceof Person) { this.artist((Person)value); return; }
      if ("artists".equals(key) && value instanceof Person) { this.artist((Person)value); return; }
      ...
      if ("artEditions".equals(key) && value instanceof String) { this.artEdition((String)value); return; }
      if ("artform".equals(key) && value instanceof String) { this.artform((String)value); return; }
      if ("artforms".equals(key) && value instanceof String) { this.artform((String)value); return; }
