...
/**
 * A process of care used in either a diagnostic, therapeutic, preventive or palliative capacity that relies on invasive (surgical), non-invasive, or other techniques.Equivalent class: http://purl.bioontology.org/ontology/SNOMEDCT/50731006
 */
public class MedicalProcedure extends MedicalEntity {
   ...
   * @return preparation property set by first invocation of preparation method or {@code null}.
   */
  @JsonIgnore public MedicalEntity getPreparationMedicalEntity() {
    return (MedicalEntity) getValue("preparation");
  }
  /**
   * Typical preparation that a patient must undergo before having the procedure performed.
   * @return all preparation properties as {@link java.util.Collection} or an empty collection 
   * if preparation was not set.
   */
   ...
   * @return preparation property set by first invocation of preparation method or {@code null}.
   */
  @JsonIgnore public String getPreparationString() {
   ...
   * @return procedureType property set by first invocation of procedureType method or {@code null}.
   */
  ...
  /**
   * The type of procedure, for example Surgical, Noninvasive, or Percutaneous.
   * @return all procedureType properties as {@link java.util.Collection} or an empty collection 
   * if procedureType was not set.
   */
   ...
   * @return howPerformed property set by first invocation of howPerformed method or {@code null}.
   */
  ...
  /**
   * How the procedure is performed.
   * @return all howPerformed properties as {@link java.util.Collection} or an empty collection 
   * if howPerformed was not set.
   */
   ...
   * @return followup property set by first invocation of followup method or {@code null}.
   */
  ...
  /**
   * Typical or recommended followup care after the procedure is performed.
   * @return all followup properties as {@link java.util.Collection} or an empty collection 
   * if followup was not set.
   */
  ...
  public static class Builder extends MedicalEntity.Builder {
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("preparation".equals(key) && value instanceof MedicalEntity) { this.preparation((MedicalEntity)value); return; }
      if ("preparations".equals(key) && value instanceof MedicalEntity) { this.preparation((MedicalEntity)value); return; }
      if ("preparation".equals(key) && value instanceof String) { this.preparation((String)value); return; }
      if ("preparations".equals(key) && value instanceof String) { this.preparation((String)value); return; }
      if ("procedureType".equals(key) && value instanceof MedicalProcedureType) { this.procedureType((MedicalProcedureType)value); return; }
      if ("procedureTypes".equals(key) && value instanceof MedicalProcedureType) { this.procedureType((MedicalProcedureType)value); return; }
      if ("howPerformed".equals(key) && value instanceof String) { this.howPerformed((String)value); return; }
      if ("howPerformeds".equals(key) && value instanceof String) { this.howPerformed((String)value); return; }
      if ("followup".equals(key) && value instanceof String) { this.followup((String)value); return; }
      if ("followups".equals(key) && value instanceof String) { this.followup((String)value); return; }
