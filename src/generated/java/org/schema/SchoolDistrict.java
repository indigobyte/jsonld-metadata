...
/**
 * A School District is an administrative area for the administration of schools.Source: https://github.com/schemaorg/schemaorg/issues/2500
 */
public class SchoolDistrict extends AdministrativeArea {
  protected SchoolDistrict(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link SchoolDistrict}
   */
  public static class Builder extends AdministrativeArea.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public SchoolDistrict build() {
      return new SchoolDistrict(myData);
    }
    /**
