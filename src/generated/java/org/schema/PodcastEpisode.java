 ...
 */
public class PodcastEpisode extends Episode {
  protected PodcastEpisode(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link PodcastEpisode}
   */
  public static class Builder extends Episode.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public PodcastEpisode build() {
      return new PodcastEpisode(myData);
    }
    /**
