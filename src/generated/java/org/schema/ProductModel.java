...
public class ProductModel extends Product {
   ...
   * @return predecessorOf property set by first invocation of predecessorOf method or {@code null}.
   */
  ...
  /**
   * A pointer from a previous, often discontinued variant of the product to its newer variant.
   * @return all predecessorOf properties as {@link java.util.Collection} or an empty collection 
   * if predecessorOf was not set.
   */
  @JsonIgnore public java.util.Collection<ProductModel> getPredecessorOfs() {
    final java.lang.Object current = myData.get("predecessorOf");
   ...
   * @return successorOf property set by first invocation of successorOf method or {@code null}.
   */
  ...
  /**
   * A pointer from a newer variant of a product  to its previous, often discontinued predecessor.
   * @return all successorOf properties as {@link java.util.Collection} or an empty collection 
   * if successorOf was not set.
   */
  @JsonIgnore public java.util.Collection<ProductModel> getSuccessorOfs() {
    final java.lang.Object current = myData.get("successorOf");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<ProductModel>) current;
    }
  ...
  protected ProductModel(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends Product.Builder {
    ...
    /**
     * Remove predecessorOf property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePredecessorOf() {
      removeValue("predecessorOf");
      return this;
    }
    /**
     * Get currently set value for predecessorOf property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPredecessorOf() {
      return myData.get("predecessorOf");
    }
    /**
     * A pointer from a newer variant of a product  to its previous, often discontinued predecessor.
     * @param productModel value to set
    ...
    /**
     * Remove successorOf property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSuccessorOf() {
      removeValue("successorOf");
      return this;
    }
    /**
     * Get currently set value for successorOf property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSuccessorOf() {
      return myData.get("successorOf");
    }
    /**
     * Indicates the kind of product that this is a variant of. In the case of [[ProductModel]], this is a pointer (from a ProductModel) to a base product from which this product is a variant. It is safe to infer that the variant inherits all product features from the base model, unless defined locally. This is not transitive. In the case of a [[ProductGroup]], the group description also serves as a template, representing a set of Products that vary on explicitly defined, specific dimensions only (so it defines both a set of variants, as well as which values distinguish amongst those variants). When used with [[ProductGroup]], this property can apply to any [[Product]] included in the group.
