...
public class LymphaticVessel extends Vessel {
   ...
   * @return runsTo property set by first invocation of runsTo method or {@code null}.
   */
  @JsonIgnore public Vessel getRunsTo() {
    return (Vessel) getValue("runsTo");
  }
  /**
   * The vasculature the lymphatic structure runs, or efferents, to.
   * @return all runsTo properties as {@link java.util.Collection} or an empty collection 
   * if runsTo was not set.
   */
   ...
   * @return originatesFrom property set by first invocation of originatesFrom method or {@code null}.
   */
  @JsonIgnore public Vessel getOriginatesFrom() {
    return (Vessel) getValue("originatesFrom");
  }
  /**
   * The vasculature the lymphatic structure originates, or afferents, from.
   * @return all originatesFrom properties as {@link java.util.Collection} or an empty collection 
   * if originatesFrom was not set.
   */
  ...
  public static class Builder extends Vessel.Builder {
    ...
    @NotNull public LymphaticVessel build() {
      return new LymphaticVessel(myData);
    }
    /**
     * The vasculature the lymphatic structure runs, or efferents, to.
     ...
     */
    @NotNull public Builder runsTo(@NotNull Vessel vessel) {
      putValue("runsTo", vessel);
      return this;
    }
    /**
     * The vasculature the lymphatic structure runs, or efferents, to.
     ...
     * @return this builder instance
     */
    @NotNull public Builder runsTo(@NotNull Vessel.Builder vessel) {
      putValue("runsTo", vessel.build());
      return this;
    }
    /**
     * Remove runsTo property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRunsTo() {
      removeValue("runsTo");
      return this;
    }
    /**
     * Get currently set value for runsTo property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRunsTo() {
      return myData.get("runsTo");
    }
    /**
     * The vasculature the lymphatic structure originates, or afferents, from.
     * @param vessel value to set
     * @return this builder instance
     */
    @NotNull public Builder originatesFrom(@NotNull Vessel vessel) {
      putValue("originatesFrom", vessel);
      return this;
    }
    /**
     * The vasculature the lymphatic structure originates, or afferents, from.
     ...
     * @return this builder instance
     */
    @NotNull public Builder originatesFrom(@NotNull Vessel.Builder vessel) {
      putValue("originatesFrom", vessel.build());
      return this;
    }
    /**
     * Remove originatesFrom property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeOriginatesFrom() {
      removeValue("originatesFrom");
      return this;
    }
    /**
     * Get currently set value for originatesFrom property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getOriginatesFrom() {
      return myData.get("originatesFrom");
    }
    /**
     * The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("originatesFroms".equals(key) && value instanceof Vessel) { this.originatesFrom((Vessel)value); return; }
