...
/**
 * A Workers Union (also known as a Labor Union, Labour Union, or Trade Union) is an organization that promotes the interests of its worker members by collectively bargaining with management, organizing, and political lobbying.Source: https://github.com/schemaorg/schemaorg/issues/243
 */
public class WorkersUnion extends Organization {
  protected WorkersUnion(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link WorkersUnion}
   */
  public static class Builder extends Organization.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public WorkersUnion build() {
      return new WorkersUnion(myData);
    }
    /**
