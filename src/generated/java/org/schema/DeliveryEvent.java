...
public class DeliveryEvent extends Event {
   ...
   * @return accessCode property set by first invocation of accessCode method or {@code null}.
   */
  ...
  /**
   * Password, PIN, or access code needed for delivery (e.g. from a locker).
   * @return all accessCode properties as {@link java.util.Collection} or an empty collection 
   * if accessCode was not set.
   */
  @JsonIgnore public java.util.Collection<String> getAccessCodes() {
    final java.lang.Object current = myData.get("accessCode");
   ...
   * @return availableFrom property set by first invocation of availableFrom method or {@code null}.
   */
  ...
  /**
   * When the item is available for pickup from the store, locker, etc.
   * @return all availableFrom properties as {@link java.util.Collection} or an empty collection 
   * if availableFrom was not set.
   */
  @JsonIgnore public java.util.Collection<java.util.Date> getAvailableFroms() {
    final java.lang.Object current = myData.get("availableFrom");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return availableThrough property set by first invocation of availableThrough method or {@code null}.
   */
  ...
  /**
   * After this date, the item will no longer be available for pickup.
   * @return all availableThrough properties as {@link java.util.Collection} or an empty collection 
   * if availableThrough was not set.
   */
  @JsonIgnore public java.util.Collection<java.util.Date> getAvailableThroughs() {
    final java.lang.Object current = myData.get("availableThrough");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<java.util.Date>) current;
    }
  ...
  public static class Builder extends Event.Builder {
    ...
    /**
     * Remove accessCode property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAccessCode() {
      removeValue("accessCode");
      return this;
    }
    /**
     * Get currently set value for accessCode property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAccessCode() {
      return myData.get("accessCode");
    }
    /**
     * Method used for delivery or shipping.
    ...
    /**
     * Remove availableFrom property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAvailableFrom() {
      removeValue("availableFrom");
      return this;
    }
    /**
     * Get currently set value for availableFrom property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAvailableFrom() {
      return myData.get("availableFrom");
    }
    /**
     * After this date, the item will no longer be available for pickup.
     * @param date value to set
    ...
    /**
     * Remove availableThrough property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAvailableThrough() {
      removeValue("availableThrough");
      return this;
    }
    /**
     * Get currently set value for availableThrough property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAvailableThrough() {
      return myData.get("availableThrough");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("accessCode".equals(key) && value instanceof String) { this.accessCode((String)value); return; }
      if ("accessCodes".equals(key) && value instanceof String) { this.accessCode((String)value); return; }
      ...
      if ("availableFrom".equals(key) && value instanceof java.util.Date) { this.availableFrom((java.util.Date)value); return; }
      if ("availableFroms".equals(key) && value instanceof java.util.Date) { this.availableFrom((java.util.Date)value); return; }
      if ("availableThrough".equals(key) && value instanceof java.util.Date) { this.availableThrough((java.util.Date)value); return; }
      if ("availableThroughs".equals(key) && value instanceof java.util.Date) { this.availableThrough((java.util.Date)value); return; }
