...
public class MedicalConditionStage extends MedicalIntangible {
   ...
   * @return subStageSuffix property set by first invocation of subStageSuffix method or {@code null}.
   */
  ...
  /**
   * The substage, e.g. 'a' for Stage IIIa.
   * @return all subStageSuffix properties as {@link java.util.Collection} or an empty collection 
   * if subStageSuffix was not set.
   */
  @JsonIgnore public java.util.Collection<String> getSubStageSuffixs() {
    final java.lang.Object current = myData.get("subStageSuffix");
   ...
   * @return stageAsNumber property set by first invocation of stageAsNumber method or {@code null}.
   */
  ...
  /**
   * The stage represented as a number, e.g. 3.
   * @return all stageAsNumber properties as {@link java.util.Collection} or an empty collection 
   * if stageAsNumber was not set.
   */
  @JsonIgnore public java.util.Collection<Integer> getStageAsNumberIntegers() {
    final java.lang.Object current = myData.get("stageAsNumber");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected MedicalConditionStage(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends MedicalIntangible.Builder {
    ...
    @NotNull public MedicalConditionStage build() {
      return new MedicalConditionStage(myData);
    }
    /**
     * The substage, e.g. 'a' for Stage IIIa.
     * @param subStageSuffix value to set
    ...
    /**
     * Remove subStageSuffix property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSubStageSuffix() {
      removeValue("subStageSuffix");
      return this;
    }
    /**
     * Get currently set value for subStageSuffix property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSubStageSuffix() {
      return myData.get("subStageSuffix");
    }
    /**
     * The stage represented as a number, e.g. 3.
    ...
    /**
     * The stage represented as a number, e.g. 3.
     * @param stageAsNumber value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove stageAsNumber property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeStageAsNumber() {
      removeValue("stageAsNumber");
      return this;
    }
    /**
     * Get currently set value for stageAsNumber property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getStageAsNumber() {
      return myData.get("stageAsNumber");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("subStageSuffix".equals(key) && value instanceof String) { this.subStageSuffix((String)value); return; }
      if ("subStageSuffixs".equals(key) && value instanceof String) { this.subStageSuffix((String)value); return; }
      if ("stageAsNumber".equals(key) && value instanceof Integer) { this.stageAsNumber((Integer)value); return; }
      if ("stageAsNumbers".equals(key) && value instanceof Integer) { this.stageAsNumber((Integer)value); return; }
      if ("stageAsNumber".equals(key) && value instanceof Long) { this.stageAsNumber((Long)value); return; }
      if ("stageAsNumbers".equals(key) && value instanceof Long) { this.stageAsNumber((Long)value); return; }
      if ("stageAsNumber".equals(key) && value instanceof Float) { this.stageAsNumber((Float)value); return; }
      if ("stageAsNumbers".equals(key) && value instanceof Float) { this.stageAsNumber((Float)value); return; }
      if ("stageAsNumber".equals(key) && value instanceof Double) { this.stageAsNumber((Double)value); return; }
      if ("stageAsNumbers".equals(key) && value instanceof Double) { this.stageAsNumber((Double)value); return; }
      if ("stageAsNumber".equals(key) && value instanceof String) { this.stageAsNumber((String)value); return; }
      if ("stageAsNumbers".equals(key) && value instanceof String) { this.stageAsNumber((String)value); return; }
