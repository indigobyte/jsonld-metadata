...
public class MedicalSign extends MedicalSignOrSymptom {
   ...
   * @return identifyingExam property set by first invocation of identifyingExam method or {@code null}.
   */
  @JsonIgnore public PhysicalExam getIdentifyingExam() {
    return (PhysicalExam) getValue("identifyingExam");
  }
  /**
   * A physical examination that can identify this sign.
   * @return all identifyingExam properties as {@link java.util.Collection} or an empty collection 
   * if identifyingExam was not set.
   */
   ...
   * @return identifyingTest property set by first invocation of identifyingTest method or {@code null}.
   */
  @JsonIgnore public MedicalTest getIdentifyingTest() {
    return (MedicalTest) getValue("identifyingTest");
  }
  /**
   * A diagnostic test that can identify this sign.
   * @return all identifyingTest properties as {@link java.util.Collection} or an empty collection 
   * if identifyingTest was not set.
   */
  ...
  public static class Builder extends MedicalSignOrSymptom.Builder {
    ...
    @NotNull public MedicalSign build() {
      return new MedicalSign(myData);
    }
    /**
     * A physical examination that can identify this sign.
     * @param physicalExam value to set
     * @return this builder instance
     */
    @NotNull public Builder identifyingExam(@NotNull PhysicalExam physicalExam) {
      putValue("identifyingExam", physicalExam);
      return this;
    }
    /**
     * A physical examination that can identify this sign.
     ...
     * @return this builder instance
     */
    @NotNull public Builder identifyingExam(@NotNull PhysicalExam.Builder physicalExam) {
      putValue("identifyingExam", physicalExam.build());
      return this;
    }
    /**
     * Remove identifyingExam property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIdentifyingExam() {
      removeValue("identifyingExam");
      return this;
    }
    /**
     * Get currently set value for identifyingExam property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIdentifyingExam() {
      return myData.get("identifyingExam");
    }
    /**
     * A diagnostic test that can identify this sign.
     ...
     * @return this builder instance
     */
    @NotNull public Builder identifyingTest(@NotNull MedicalTest medicalTest) {
      putValue("identifyingTest", medicalTest);
      return this;
    }
    /**
     * A diagnostic test that can identify this sign.
     ...
     * @return this builder instance
     */
    @NotNull public Builder identifyingTest(@NotNull MedicalTest.Builder medicalTest) {
      putValue("identifyingTest", medicalTest.build());
      return this;
    }
    /**
     * Remove identifyingTest property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIdentifyingTest() {
      removeValue("identifyingTest");
      return this;
    }
    /**
     * Get currently set value for identifyingTest property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIdentifyingTest() {
      return myData.get("identifyingTest");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("identifyingTests".equals(key) && value instanceof MedicalTest) { this.identifyingTest((MedicalTest)value); return; }
