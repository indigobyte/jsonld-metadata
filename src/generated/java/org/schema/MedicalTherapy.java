...
public class MedicalTherapy extends TherapeuticProcedure {
   ...
   * @return duplicateTherapy property set by first invocation of duplicateTherapy method or {@code null}.
   */
  @JsonIgnore public MedicalTherapy getDuplicateTherapy() {
    return (MedicalTherapy) getValue("duplicateTherapy");
  }
  /**
   * A therapy that duplicates or overlaps this one.
   * @return all duplicateTherapy properties as {@link java.util.Collection} or an empty collection 
   * if duplicateTherapy was not set.
   */
  ...
  public static class Builder extends TherapeuticProcedure.Builder {
    ...
    @NotNull public MedicalTherapy build() {
      return new MedicalTherapy(myData);
    }
    /**
     * A possible serious complication and/or serious side effect of this therapy. Serious adverse outcomes include those that are life-threatening; result in death, disability, or permanent damage; require hospitalization or prolong existing hospitalization; cause congenital anomalies or birth defects; or jeopardize the patient and may require medical or surgical intervention to prevent one of the outcomes in this definition.
    ...
    /**
     * Remove duplicateTherapy property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeDuplicateTherapy() {
      removeValue("duplicateTherapy");
      return this;
    }
    /**
     * Get currently set value for duplicateTherapy property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getDuplicateTherapy() {
      return myData.get("duplicateTherapy");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("duplicateTherapy".equals(key) && value instanceof MedicalTherapy) { this.duplicateTherapy((MedicalTherapy)value); return; }
      if ("duplicateTherapys".equals(key) && value instanceof MedicalTherapy) { this.duplicateTherapy((MedicalTherapy)value); return; }
