...
public class NewsMediaOrganization extends Organization {
   ...
   * @return verificationFactCheckingPolicy property set by first invocation of verificationFactCheckingPolicy method or {@code null}.
   */
  @JsonIgnore public PublishingPrinciples getVerificationFactCheckingPolicy() {
    return (PublishingPrinciples) getValue("verificationFactCheckingPolicy");
  }
  /**
   * Disclosure about verification and fact-checking processes for a [[NewsMediaOrganization]] or other fact-checking [[Organization]].
   * @return all verificationFactCheckingPolicy properties as {@link java.util.Collection} or an empty collection 
   * if verificationFactCheckingPolicy was not set.
   */
   ...
   * @return noBylinesPolicy property set by first invocation of noBylinesPolicy method or {@code null}.
   */
  @JsonIgnore public PublishingPrinciples getNoBylinesPolicy() {
    return (PublishingPrinciples) getValue("noBylinesPolicy");
  }
  /**
   * For a [[NewsMediaOrganization]] or other news-related [[Organization]], a statement explaining when authors of articles are not named in bylines.
   * @return all noBylinesPolicy properties as {@link java.util.Collection} or an empty collection 
   * if noBylinesPolicy was not set.
   */
   ...
   * @return missionCoveragePrioritiesPolicy property set by first invocation of missionCoveragePrioritiesPolicy method or {@code null}.
   */
  ...
  /**
   * For a [[NewsMediaOrganization]], a statement on coverage priorities, including any public agenda or stance on issues.
   * @return all missionCoveragePrioritiesPolicy properties as {@link java.util.Collection} or an empty collection 
   * if missionCoveragePrioritiesPolicy was not set.
   */
   ...
   * @return masthead property set by first invocation of masthead method or {@code null}.
   */
  ...
  /**
   * For a [[NewsMediaOrganization]], a link to the masthead page or a page listing top editorial management.
   * @return all masthead properties as {@link java.util.Collection} or an empty collection 
   * if masthead was not set.
   */
  ...
  public static class Builder extends Organization.Builder {
    ...
    @NotNull public NewsMediaOrganization build() {
      return new NewsMediaOrganization(myData);
    }
    /**
     * Disclosure about verification and fact-checking processes for a [[NewsMediaOrganization]] or other fact-checking [[Organization]].
     ...
     */
    @NotNull public Builder verificationFactCheckingPolicy(@NotNull PublishingPrinciples publishingPrinciples) {
      putValue("verificationFactCheckingPolicy", publishingPrinciples);
      return this;
    }
    /**
     * Remove verificationFactCheckingPolicy property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeVerificationFactCheckingPolicy() {
      removeValue("verificationFactCheckingPolicy");
      return this;
    }
    /**
     * Get currently set value for verificationFactCheckingPolicy property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getVerificationFactCheckingPolicy() {
      return myData.get("verificationFactCheckingPolicy");
    }
    /**
     * Statement on diversity policy by an [[Organization]] e.g. a [[NewsMediaOrganization]]. For a [[NewsMediaOrganization]], a statement describing the newsroom&rsquo;s diversity policy on both staffing and sources, typically providing staffing data.
     ...
     * @return this builder instance
     */
    @NotNull public Builder noBylinesPolicy(@NotNull PublishingPrinciples publishingPrinciples) {
      putValue("noBylinesPolicy", publishingPrinciples);
      return this;
    }
    /**
     * Remove noBylinesPolicy property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeNoBylinesPolicy() {
      removeValue("noBylinesPolicy");
      return this;
    }
    /**
     * Get currently set value for noBylinesPolicy property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getNoBylinesPolicy() {
      return myData.get("noBylinesPolicy");
    }
    /**
     * For an [[Organization]] (often but not necessarily a [[NewsMediaOrganization]]), a description of organizational ownership structure; funding and grants. In a news/media setting, this is with particular reference to editorial independence.   Note that the [[funder]] is also available and can be used to make basic funder information machine-readable.
     * @param publishingPrinciples value to set
    ...
    /**
     * Remove missionCoveragePrioritiesPolicy property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeMissionCoveragePrioritiesPolicy() {
      removeValue("missionCoveragePrioritiesPolicy");
      return this;
    }
    /**
     * Get currently set value for missionCoveragePrioritiesPolicy property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getMissionCoveragePrioritiesPolicy() {
      return myData.get("missionCoveragePrioritiesPolicy");
    }
    /**
     * For a [[NewsMediaOrganization]] or other news-related [[Organization]], a statement about public engagement activities (for news media, the newsroom&rsquo;s), including involving the public - digitally or otherwise -- in coverage decisions, reporting and activities after publication.
     * @param publishingPrinciples value to set
    ...
    /**
     * Remove masthead property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeMasthead() {
      removeValue("masthead");
      return this;
    }
    /**
     * Get currently set value for masthead property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getMasthead() {
      return myData.get("masthead");
    }
    /**
     * Statement about ethics policy, e.g. of a [[NewsMediaOrganization]] regarding journalistic and publishing practices, or of a [[Restaurant]], a page describing food source policies. In the case of a [[NewsMediaOrganization]], an ethicsPolicy is typically a statement describing the personal, organizational, and corporate standards of behavior expected by the organization.
     * @param creativeWork value to set
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("noBylinesPolicy".equals(key) && value instanceof PublishingPrinciples) { this.noBylinesPolicy((PublishingPrinciples)value); return; }
      if ("noBylinesPolicys".equals(key) && value instanceof PublishingPrinciples) { this.noBylinesPolicy((PublishingPrinciples)value); return; }
