...
public class HyperToc extends CreativeWork {
   ...
   * @return tocEntry property set by first invocation of tocEntry method or {@code null}.
   */
  ...
  /**
   * Indicates a [[HyperTocEntry]] in a [[HyperToc]].
   * @return all tocEntry properties as {@link java.util.Collection} or an empty collection 
   * if tocEntry was not set.
   */
  @JsonIgnore public java.util.Collection<HasPart> getTocEntrys() {
    final java.lang.Object current = myData.get("tocEntry");
  ...
  protected HyperToc(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link HyperToc}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public HyperToc build() {
      return new HyperToc(myData);
    }
    /**
     * Indicates a [[HyperTocEntry]] in a [[HyperToc]].
    ...
    /**
     * Remove tocEntry property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeTocEntry() {
      removeValue("tocEntry");
      return this;
    }
    /**
     * Get currently set value for tocEntry property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getTocEntry() {
      return myData.get("tocEntry");
    }
    /**
     * A media object that encodes this CreativeWork. This property is a synonym for encoding.
