 ...
 *       
 */
public class CovidTestingFacility extends MedicalClinic {
  protected CovidTestingFacility(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link CovidTestingFacility}
   */
  public static class Builder extends MedicalClinic.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public CovidTestingFacility build() {
      return new CovidTestingFacility(myData);
    }
    /**
