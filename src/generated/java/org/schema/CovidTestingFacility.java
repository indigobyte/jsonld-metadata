 ...
 *       about that place e.g. contact info, address, opening hours. Note that in an emergency, such information may not always be reliable.Source: https://github.com/schemaorg/schemaorg/issues/2490
 */
public class CovidTestingFacility extends MedicalClinic {
  protected CovidTestingFacility(java.util.Map<String,Object> data) {
    super(data);
  }
