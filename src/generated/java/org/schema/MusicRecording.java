...
public class MusicRecording extends CreativeWork {
   ...
   * @return inPlaylist property set by first invocation of inPlaylist method or {@code null}.
   */
  ...
  /**
   * The playlist to which this recording belongs.
   * @return all inPlaylist properties as {@link java.util.Collection} or an empty collection 
   * if inPlaylist was not set.
   */
  @JsonIgnore public java.util.Collection<MusicPlaylist> getInPlaylists() {
    final java.lang.Object current = myData.get("inPlaylist");
   ...
   * @return inAlbum property set by first invocation of inAlbum method or {@code null}.
   */
  ...
  /**
   * The album to which this recording belongs.
   * @return all inAlbum properties as {@link java.util.Collection} or an empty collection 
   * if inAlbum was not set.
   */
  @JsonIgnore public java.util.Collection<MusicAlbum> getInAlbums() {
    final java.lang.Object current = myData.get("inAlbum");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return isrcCode property set by first invocation of isrcCode method or {@code null}.
   */
  ...
  /**
   * The International Standard Recording Code for the recording.
   * @return all isrcCode properties as {@link java.util.Collection} or an empty collection 
   * if isrcCode was not set.
   */
  @JsonIgnore public java.util.Collection<String> getIsrcCodes() {
    final java.lang.Object current = myData.get("isrcCode");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return recordingOf property set by first invocation of recordingOf method or {@code null}.
   */
  ...
  /**
   * The composition this track is a recording of.
   * @return all recordingOf properties as {@link java.util.Collection} or an empty collection 
   * if recordingOf was not set.
   */
  @JsonIgnore public java.util.Collection<MusicComposition> getRecordingOfs() {
    final java.lang.Object current = myData.get("recordingOf");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected MusicRecording(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    /**
     * The playlist to which this recording belongs.
     * @param musicPlaylist value to set
    ...
    /**
     * Remove inPlaylist property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeInPlaylist() {
      removeValue("inPlaylist");
      return this;
    }
    /**
     * Get currently set value for inPlaylist property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getInPlaylist() {
      return myData.get("inPlaylist");
    }
    /**
     * The duration of the item (movie, audio recording, event, etc.) in [ISO 8601 date format](http://en.wikipedia.org/wiki/ISO_8601).
    ...
    /**
     * Remove inAlbum property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeInAlbum() {
      removeValue("inAlbum");
      return this;
    }
    /**
     * Get currently set value for inAlbum property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getInAlbum() {
      return myData.get("inAlbum");
    }
    /**
     * The International Standard Recording Code for the recording.
     * @param isrcCode value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove isrcCode property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIsrcCode() {
      removeValue("isrcCode");
      return this;
    }
    /**
     * Get currently set value for isrcCode property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIsrcCode() {
      return myData.get("isrcCode");
    }
    /**
     * The composition this track is a recording of.
    ...
    /**
     * Remove recordingOf property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRecordingOf() {
      removeValue("recordingOf");
      return this;
    }
    /**
     * Get currently set value for recordingOf property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRecordingOf() {
      return myData.get("recordingOf");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("inPlaylist".equals(key) && value instanceof MusicPlaylist) { this.inPlaylist((MusicPlaylist)value); return; }
      if ("inPlaylists".equals(key) && value instanceof MusicPlaylist) { this.inPlaylist((MusicPlaylist)value); return; }
      ...
      if ("inAlbum".equals(key) && value instanceof MusicAlbum) { this.inAlbum((MusicAlbum)value); return; }
      if ("inAlbums".equals(key) && value instanceof MusicAlbum) { this.inAlbum((MusicAlbum)value); return; }
      if ("isrcCode".equals(key) && value instanceof String) { this.isrcCode((String)value); return; }
      if ("isrcCodes".equals(key) && value instanceof String) { this.isrcCode((String)value); return; }
      if ("recordingOf".equals(key) && value instanceof MusicComposition) { this.recordingOf((MusicComposition)value); return; }
      if ("recordingOfs".equals(key) && value instanceof MusicComposition) { this.recordingOf((MusicComposition)value); return; }
