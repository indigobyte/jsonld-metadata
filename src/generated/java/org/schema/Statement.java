 ...
 */
public class Statement extends CreativeWork {
  protected Statement(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Statement}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public Statement build() {
      return new Statement(myData);
    }
    /**
