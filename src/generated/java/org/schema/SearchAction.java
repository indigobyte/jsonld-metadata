...
public class SearchAction extends Action {
  @JsonIgnore public Query getQuery() {
    return (Query) getValue("query");
  }
  @JsonIgnore public Collection<Query> getQuerys() {
    final Object current = myData.get("query");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<Query>) current;
    }
    return Arrays.asList((Query) current);
  }
  ...
  public static class Builder extends Action.Builder {
    ...
    @NotNull public Builder query(@NotNull Query query) {
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("query".equals(key) && value instanceof Query) { query((Query)value); return; }
      if ("querys".equals(key) && value instanceof Query) { query((Query)value); return; }
