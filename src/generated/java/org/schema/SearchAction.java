...
public class SearchAction extends Action {
   ...
   * @return query property set by first invocation of query method or {@code null}.
   */
  ...
  /**
   * A sub property of instrument. The query used on this action.
   * @return all query properties as {@link java.util.Collection} or an empty collection 
   * if query was not set.
   */
  @JsonIgnore public java.util.Collection<Instrument> getQuerys() {
    final java.lang.Object current = myData.get("query");
  ...
  protected SearchAction(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends Action.Builder {
    ...
    /**
     * Remove query property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeQuery() {
      removeValue("query");
      return this;
    }
    /**
     * Get currently set value for query property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getQuery() {
      return myData.get("query");
    }
    /**
