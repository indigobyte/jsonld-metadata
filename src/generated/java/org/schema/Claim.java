 ...
 * 
 * At this time, Schema.org does not define any types of relationship between claims. This is a natural area for future exploration.Source: https://github.com/schemaorg/schemaorg/issues/1828
 */
public class Claim extends CreativeWork {
   ...
   * Indicates an occurence of a &lt;a class=&quot;localLink&quot; href=&quot;http://schema.org/Claim&quot;&gt;Claim&lt;/a&gt; in some &lt;a class=&quot;localLink&quot; href=&quot;http://schema.org/CreativeWork&quot;&gt;CreativeWork&lt;/a&gt;.
   */
  @JsonIgnore public Collection<WorkExample> getAppearances() {
    final Object current = myData.get("appearance");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<WorkExample>) current;
    }
