...
public class Claim extends CreativeWork {
   ...
   * @return firstAppearance property set by first invocation of firstAppearance method or {@code null}.
   */
  ...
  /**
   * Indicates the first known occurence of a [[Claim]] in some [[CreativeWork]].
   * @return all firstAppearance properties as {@link java.util.Collection} or an empty collection 
   * if firstAppearance was not set.
   */
  @JsonIgnore public java.util.Collection<WorkExample> getFirstAppearances() {
    final java.lang.Object current = myData.get("firstAppearance");
   ...
   * @return appearance property set by first invocation of appearance method or {@code null}.
   */
  ...
  /**
   * Indicates an occurence of a [[Claim]] in some [[CreativeWork]].
   * @return all appearance properties as {@link java.util.Collection} or an empty collection 
   * if appearance was not set.
   */
  @JsonIgnore public java.util.Collection<WorkExample> getAppearances() {
    final java.lang.Object current = myData.get("appearance");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<WorkExample>) current;
    }
   ...
   *                             @return claimInterpreter property set by first invocation of claimInterpreter method or {@code null}.
   */
  @JsonIgnore public Organization getClaimInterpreterOrganization() {
    return (Organization) getValue("claimInterpreter");
  }
  /**
   *                                 For a [[Claim]] interpreted from [[MediaObject]] content
   * sed to indicate a claim contained, implied or refined from the content of a [[MediaObject]].
   *                                 @return all claimInterpreter properties as {@link java.util.Collection} or an empty collection 
   *                                 if claimInterpreter was not set.
   */
  @JsonIgnore public java.util.Collection<Organization> getClaimInterpreterOrganizations() {
    final java.lang.Object current = myData.get("claimInterpreter");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   *                             @return claimInterpreter property set by first invocation of claimInterpreter method or {@code null}.
   */
  @JsonIgnore public Person getClaimInterpreterPerson() {
    return (Person) getValue("claimInterpreter");
  }
  /**
   *                                 For a [[Claim]] interpreted from [[MediaObject]] content
   * sed to indicate a claim contained, implied or refined from the content of a [[MediaObject]].
  ...
  protected Claim(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link Claim}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public Claim build() {
      return new Claim(myData);
    }
    /**
     * Indicates the first known occurence of a [[Claim]] in some [[CreativeWork]].
    ...
    /**
     * Remove firstAppearance property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeFirstAppearance() {
      removeValue("firstAppearance");
      return this;
    }
    /**
     * Get currently set value for firstAppearance property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getFirstAppearance() {
      return myData.get("firstAppearance");
    }
    /**
     * Indicates an occurence of a [[Claim]] in some [[CreativeWork]].
     * @param workExample value to set
    ...
    /**
     * Remove appearance property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAppearance() {
      removeValue("appearance");
      return this;
    }
    /**
     * Get currently set value for appearance property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAppearance() {
      return myData.get("appearance");
    }
    /**
     *                                     For a [[Claim]] interpreted from [[MediaObject]] content
     * sed to indicate a claim contained, implied or refined from the content of a [[MediaObject]].
     ...
     *                                     @return this builder instance
     */
    @NotNull public Builder claimInterpreter(@NotNull Organization organization) {
      putValue("claimInterpreter", organization);
      return this;
    }
    /**
     *                                         For a [[Claim]] interpreted from [[MediaObject]] content
     ...
     *                                         @return this builder instance
     */
    @NotNull public Builder claimInterpreter(@NotNull Organization.Builder organization) {
      putValue("claimInterpreter", organization.build());
      return this;
    }
    /**
     *                                     For a [[Claim]] interpreted from [[MediaObject]] content
     ...
     *                                     @return this builder instance
     */
    @NotNull public Builder claimInterpreter(@NotNull Person person) {
      putValue("claimInterpreter", person);
      return this;
    }
    /**
     *                                         For a [[Claim]] interpreted from [[MediaObject]] content
     ...
     *                                         @return this builder instance
     */
    @NotNull public Builder claimInterpreter(@NotNull Person.Builder person) {
      putValue("claimInterpreter", person.build());
      return this;
    }
    /**
     * Remove claimInterpreter property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeClaimInterpreter() {
      removeValue("claimInterpreter");
      return this;
    }
    /**
     * Get currently set value for claimInterpreter property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getClaimInterpreter() {
      return myData.get("claimInterpreter");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("claimInterpreters".equals(key) && value instanceof Person) { this.claimInterpreter((Person)value); return; }
