...
public class UserDownloads extends UserInteraction {
  protected UserDownloads(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link UserDownloads}
   */
  public static class Builder extends UserInteraction.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public UserDownloads build() {
      return new UserDownloads(myData);
    }
    /**
