...
public class VideoObject extends MediaObject {
   ...
   * @return videoQuality property set by first invocation of videoQuality method or {@code null}.
   */
  @JsonIgnore public String getVideoQuality() {
    return (String) getValue("videoQuality");
  }
  /**
   * The quality of the video.
   * @return all videoQuality properties as {@link java.util.Collection} or an empty collection 
   * if videoQuality was not set.
   */
  @JsonIgnore public java.util.Collection<String> getVideoQualitys() {
    final java.lang.Object current = myData.get("videoQuality");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return transcript property set by first invocation of transcript method or {@code null}.
   */
  ...
  /**
   * If this MediaObject is an AudioObject or VideoObject, the transcript of that object.
   * @return all transcript properties as {@link java.util.Collection} or an empty collection 
   * if transcript was not set.
   */
  @JsonIgnore public java.util.Collection<String> getTranscripts() {
    final java.lang.Object current = myData.get("transcript");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
   ...
   * @return caption property set by first invocation of caption method or {@code null}.
   */
  @JsonIgnore public Caption getCaption() {
    return (Caption) getValue("caption");
  }
  /**
   * The caption for this object. For downloadable machine formats (closed caption, subtitles etc.) use MediaObject and indicate the [[encodingFormat]].
   * @return all caption properties as {@link java.util.Collection} or an empty collection 
   * if caption was not set.
   */
  @JsonIgnore public java.util.Collection<Caption> getCaptions() {
    final java.lang.Object current = myData.get("caption");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return embeddedTextCaption property set by first invocation of embeddedTextCaption method or {@code null}.
   */
  ...
  /**
   * Represents textual captioning from a [[MediaObject]], e.g. text of a 'meme'.
   * @return all embeddedTextCaption properties as {@link java.util.Collection} or an empty collection 
   * if embeddedTextCaption was not set.
   */
  @JsonIgnore public java.util.Collection<Caption> getEmbeddedTextCaptions() {
    final java.lang.Object current = myData.get("embeddedTextCaption");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Caption>) current;
    }
   ...
   * @return videoFrameSize property set by first invocation of videoFrameSize method or {@code null}.
   */
  @JsonIgnore public String getVideoFrameSize() {
    return (String) getValue("videoFrameSize");
  }
  /**
   * The frame size of the video.
   * @return all videoFrameSize properties as {@link java.util.Collection} or an empty collection 
   * if videoFrameSize was not set.
   */
  @JsonIgnore public java.util.Collection<String> getVideoFrameSizes() {
    final java.lang.Object current = myData.get("videoFrameSize");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
   ...
   * @return thumbnail property set by first invocation of thumbnail method or {@code null}.
   */
  ...
  /**
   * Thumbnail image for an image or video.
   * @return all thumbnail properties as {@link java.util.Collection} or an empty collection 
   * if thumbnail was not set.
   */
  @JsonIgnore public java.util.Collection<ImageObject> getThumbnails() {
    final java.lang.Object current = myData.get("thumbnail");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected VideoObject(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends MediaObject.Builder {
    ...
    /**
     * The quality of the video.
     * @param videoQuality value to set
     * @return this builder instance
     */
    @NotNull public Builder videoQuality(@NotNull String videoQuality) {
      putValue("videoQuality", videoQuality);
      return this;
    }
    /**
     * Remove videoQuality property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeVideoQuality() {
      removeValue("videoQuality");
      return this;
    }
    /**
     * Get currently set value for videoQuality property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getVideoQuality() {
      return myData.get("videoQuality");
    }
    /**
     * If this MediaObject is an AudioObject or VideoObject, the transcript of that object.
     * @param transcript value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove transcript property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeTranscript() {
      removeValue("transcript");
      return this;
    }
    /**
     * Get currently set value for transcript property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getTranscript() {
      return myData.get("transcript");
    }
    /**
     * The caption for this object. For downloadable machine formats (closed caption, subtitles etc.) use MediaObject and indicate the [[encodingFormat]].
     ...
     * @return this builder instance
     */
    @NotNull public Builder caption(@NotNull Caption caption) {
      putValue("caption", caption);
      return this;
    }
    /**
     * Remove caption property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCaption() {
      removeValue("caption");
      return this;
    }
    /**
     * Get currently set value for caption property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCaption() {
      return myData.get("caption");
    }
    /**
     * Represents textual captioning from a [[MediaObject]], e.g. text of a 'meme'.
     * @param caption value to set
    ...
    /**
     * Remove embeddedTextCaption property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeEmbeddedTextCaption() {
      removeValue("embeddedTextCaption");
      return this;
    }
    /**
     * Get currently set value for embeddedTextCaption property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getEmbeddedTextCaption() {
      return myData.get("embeddedTextCaption");
    }
    /**
     * A director of e.g. tv, radio, movie, video gaming etc. content, or of an event. Directors can be associated with individual items or with a series, episode, clip.
    ...
    /**
     * The frame size of the video.
     * @param videoFrameSize value to set
     * @return this builder instance
     */
    @NotNull public Builder videoFrameSize(@NotNull String videoFrameSize) {
      putValue("videoFrameSize", videoFrameSize);
      return this;
    }
    /**
     * Remove videoFrameSize property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeVideoFrameSize() {
      removeValue("videoFrameSize");
      return this;
    }
    /**
     * Get currently set value for videoFrameSize property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getVideoFrameSize() {
      return myData.get("videoFrameSize");
    }
    /**
     * The composer of the soundtrack.
    ...
    /**
     * Remove thumbnail property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeThumbnail() {
      removeValue("thumbnail");
      return this;
    }
    /**
     * Get currently set value for thumbnail property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getThumbnail() {
      return myData.get("thumbnail");
    }
    /**
    ...
    /**
     * Remove productionCompany property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeProductionCompany() {
      removeValue("productionCompany");
      return this;
    }
    /**
     * Get currently set value for productionCompany property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getProductionCompany() {
      return myData.get("productionCompany");
    }
    /**
    ...
    /**
     * Remove embedUrl property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeEmbedUrl() {
      removeValue("embedUrl");
      return this;
    }
    /**
     * Get currently set value for embedUrl property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getEmbedUrl() {
      return myData.get("embedUrl");
    }
    /**
     * Actual bytes of the media object, for example the image file or video file.
     * @param contentUrl value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove contentUrl property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeContentUrl() {
      removeValue("contentUrl");
      return this;
    }
    /**
     * Get currently set value for contentUrl property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getContentUrl() {
      return myData.get("contentUrl");
    }
    /**
    ...
    /**
     * Remove uploadDate property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeUploadDate() {
      removeValue("uploadDate");
      return this;
    }
    /**
     * Get currently set value for uploadDate property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getUploadDate() {
      return myData.get("uploadDate");
    }
    /**
    ...
    /**
     * Remove sha256 property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSha256() {
      removeValue("sha256");
      return this;
    }
    /**
     * Get currently set value for sha256 property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSha256() {
      return myData.get("sha256");
    }
    /**
    ...
    /**
     * Remove playerType property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePlayerType() {
      removeValue("playerType");
      return this;
    }
    /**
     * Get currently set value for playerType property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPlayerType() {
      return myData.get("playerType");
    }
    /**
     ...
     * @param newsArticle value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove associatedArticle property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAssociatedArticle() {
      removeValue("associatedArticle");
      return this;
    }
    /**
     * Get currently set value for associatedArticle property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAssociatedArticle() {
      return myData.get("associatedArticle");
    }
    /**
     * File size in (mega/kilo) bytes.
     * @param contentSize value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove contentSize property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeContentSize() {
      removeValue("contentSize");
      return this;
    }
    /**
     * Get currently set value for contentSize property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getContentSize() {
      return myData.get("contentSize");
    }
    /**
    ...
    /**
     * Remove regionsAllowed property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRegionsAllowed() {
      removeValue("regionsAllowed");
      return this;
    }
    /**
     * Get currently set value for regionsAllowed property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRegionsAllowed() {
      return myData.get("regionsAllowed");
    }
    /**
     * The bitrate of the media object.
     * @param bitrate value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove bitrate property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeBitrate() {
      removeValue("bitrate");
      return this;
    }
    /**
     * Get currently set value for bitrate property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getBitrate() {
      return myData.get("bitrate");
    }
    /**
    ...
    /**
     * Remove encodesCreativeWork property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeEncodesCreativeWork() {
      removeValue("encodesCreativeWork");
      return this;
    }
    /**
     * Get currently set value for encodesCreativeWork property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getEncodesCreativeWork() {
      return myData.get("encodesCreativeWork");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("videoQuality".equals(key) && value instanceof String) { this.videoQuality((String)value); return; }
      if ("videoQualitys".equals(key) && value instanceof String) { this.videoQuality((String)value); return; }
      if ("transcript".equals(key) && value instanceof String) { this.transcript((String)value); return; }
      if ("transcripts".equals(key) && value instanceof String) { this.transcript((String)value); return; }
      ...
      if ("videoFrameSize".equals(key) && value instanceof String) { this.videoFrameSize((String)value); return; }
      if ("videoFrameSizes".equals(key) && value instanceof String) { this.videoFrameSize((String)value); return; }
      ...
      if ("thumbnails".equals(key) && value instanceof ImageObject) { this.thumbnail((ImageObject)value); return; }
