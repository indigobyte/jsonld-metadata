 ...
 */
public class PublicHealth extends MedicalBusiness {
  protected PublicHealth(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends MedicalBusiness.Builder {
    ...
    @NotNull public PublicHealth build() {
      return new PublicHealth(myData);
    }
    /**
