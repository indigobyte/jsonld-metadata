...
public class EndorseAction extends ReactAction {
   ...
   * @return endorsee property set by first invocation of endorsee method or {@code null}.
   */
  ...
  /**
   * A sub property of participant. The person/organization being supported.
   * @return all endorsee properties as {@link java.util.Collection} or an empty collection 
   * if endorsee was not set.
   */
  @JsonIgnore public java.util.Collection<Participant> getEndorsees() {
    final java.lang.Object current = myData.get("endorsee");
  ...
  protected EndorseAction(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends ReactAction.Builder {
    ...
    /**
     * Remove endorsee property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeEndorsee() {
      removeValue("endorsee");
      return this;
    }
    /**
     * Get currently set value for endorsee property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getEndorsee() {
      return myData.get("endorsee");
    }
    /**
