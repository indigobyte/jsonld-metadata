 ...
 */
public class DietNutrition extends MedicalBusiness {
  protected DietNutrition(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends MedicalBusiness.Builder {
    ...
    @NotNull public DietNutrition build() {
      return new DietNutrition(myData);
    }
    /**
