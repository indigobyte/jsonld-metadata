...
/**
 * A motorized bicycle is a bicycle with an attached motor used to power the vehicle, or to assist with pedaling.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#Automotive_Ontology_Working_Group
 */
public class MotorizedBicycle extends Vehicle {
  protected MotorizedBicycle(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link MotorizedBicycle}
   */
  public static class Builder extends Vehicle.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public MotorizedBicycle build() {
      return new MotorizedBicycle(myData);
    }
    /**
