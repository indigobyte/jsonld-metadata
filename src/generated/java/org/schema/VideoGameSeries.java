...
public class VideoGameSeries extends CreativeWorkSeries {
   ...
   * @return numberOfSeasons property set by first invocation of numberOfSeasons method or {@code null}.
   */
  ...
  /**
   * The number of seasons in this series.
   * @return all numberOfSeasons properties as {@link java.util.Collection} or an empty collection 
   * if numberOfSeasons was not set.
   */
  @JsonIgnore public java.util.Collection<Integer> getNumberOfSeasonss() {
    final java.lang.Object current = myData.get("numberOfSeasons");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return productionCompany property set by first invocation of productionCompany method or {@code null}.
   */
  ...
  /**
   * The production company or studio responsible for the item e.g. series, video game, episode etc.
   * @return all productionCompany properties as {@link java.util.Collection} or an empty collection 
   * if productionCompany was not set.
   */
   ...
   * @return numberOfEpisodes property set by first invocation of numberOfEpisodes method or {@code null}.
   */
  ...
  /**
   * The number of episodes in this season or series.
   * @return all numberOfEpisodes properties as {@link java.util.Collection} or an empty collection 
   * if numberOfEpisodes was not set.
   */
  @JsonIgnore public java.util.Collection<Integer> getNumberOfEpisodess() {
    final java.lang.Object current = myData.get("numberOfEpisodes");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Integer>) current;
    }
   ...
   * @return characterAttribute property set by first invocation of characterAttribute method or {@code null}.
   */
  ...
  /**
   * A piece of data that represents a particular aspect of a fictional character (skill, power, character points, advantage, disadvantage).
   * @return all characterAttribute properties as {@link java.util.Collection} or an empty collection 
   * if characterAttribute was not set.
   */
  @JsonIgnore public java.util.Collection<Thing> getCharacterAttributes() {
    final java.lang.Object current = myData.get("characterAttribute");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Thing>) current;
    }
   ...
   * @return episode property set by first invocation of episode method or {@code null}.
   */
  ...
  /**
   * An episode of a tv, radio or game media within a series or season.
   * @return all episode properties as {@link java.util.Collection} or an empty collection 
   * if episode was not set.
   */
  @JsonIgnore public java.util.Collection<HasPart> getEpisodes() {
    final java.lang.Object current = myData.get("episode");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return gameLocation property set by first invocation of gameLocation method or {@code null}.
   */
  ...
  /**
   * Real or fictional location of the game (or part of game).
   * @return all gameLocation properties as {@link java.util.Collection} or an empty collection 
   * if gameLocation was not set.
   */
  @JsonIgnore public java.util.Collection<Place> getGameLocationPlaces() {
    final java.lang.Object current = myData.get("gameLocation");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return numberOfPlayers property set by first invocation of numberOfPlayers method or {@code null}.
   */
  ...
  /**
   * Indicate how many people can play this game (minimum, maximum, or range).
   * @return all numberOfPlayers properties as {@link java.util.Collection} or an empty collection 
   * if numberOfPlayers was not set.
   */
  @JsonIgnore public java.util.Collection<QuantitativeValue> getNumberOfPlayerss() {
    final java.lang.Object current = myData.get("numberOfPlayers");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return gameItem property set by first invocation of gameItem method or {@code null}.
   */
  ...
  /**
   * An item is an object within the game world that can be collected by a player or, occasionally, a non-player character.
   * @return all gameItem properties as {@link java.util.Collection} or an empty collection 
   * if gameItem was not set.
   */
  @JsonIgnore public java.util.Collection<Thing> getGameItems() {
    final java.lang.Object current = myData.get("gameItem");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Thing>) current;
    }
   ...
   * @return quest property set by first invocation of quest method or {@code null}.
   */
  ...
  /**
   * The task that a player-controlled character, or group of characters may complete in order to gain a reward.
   * @return all quest properties as {@link java.util.Collection} or an empty collection 
   * if quest was not set.
   */
  @JsonIgnore public java.util.Collection<Thing> getQuests() {
    final java.lang.Object current = myData.get("quest");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Thing>) current;
    }
   ...
   * @return containsSeason property set by first invocation of containsSeason method or {@code null}.
   */
  ...
  /**
   * A season that is part of the media series.
   * @return all containsSeason properties as {@link java.util.Collection} or an empty collection 
   * if containsSeason was not set.
   */
  @JsonIgnore public java.util.Collection<HasPart> getContainsSeasons() {
    final java.lang.Object current = myData.get("containsSeason");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<HasPart>) current;
    }
  ...
  protected VideoGameSeries(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends CreativeWorkSeries.Builder {
    ...
    /**
     * Remove numberOfSeasons property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeNumberOfSeasons() {
      removeValue("numberOfSeasons");
      return this;
    }
    /**
     * Get currently set value for numberOfSeasons property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getNumberOfSeasons() {
      return myData.get("numberOfSeasons");
    }
    /**
     * The electronic systems used to play &lt;a href=&quot;http://en.wikipedia.org/wiki/Category:Video_game_platforms&quot;&gt;video games&lt;/a&gt;.
    ...
    /**
     * Remove numberOfEpisodes property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeNumberOfEpisodes() {
      removeValue("numberOfEpisodes");
      return this;
    }
    /**
     * Get currently set value for numberOfEpisodes property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getNumberOfEpisodes() {
      return myData.get("numberOfEpisodes");
    }
    /**
     * A piece of data that represents a particular aspect of a fictional character (skill, power, character points, advantage, disadvantage).
     * @param thing value to set
    ...
    /**
     * Remove characterAttribute property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCharacterAttribute() {
      removeValue("characterAttribute");
      return this;
    }
    /**
     * Get currently set value for characterAttribute property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCharacterAttribute() {
      return myData.get("characterAttribute");
    }
    /**
     * An episode of a tv, radio or game media within a series or season.
    ...
    /**
     * Remove episode property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeEpisode() {
      removeValue("episode");
      return this;
    }
    /**
     * Get currently set value for episode property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getEpisode() {
      return myData.get("episode");
    }
    /**
     * A director of e.g. tv, radio, movie, video gaming etc. content, or of an event. Directors can be associated with individual items or with a series, episode, clip.
    ...
    /**
     * Real or fictional location of the game (or part of game).
     * @param gameLocation value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove gameLocation property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeGameLocation() {
      removeValue("gameLocation");
      return this;
    }
    /**
     * Get currently set value for gameLocation property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getGameLocation() {
      return myData.get("gameLocation");
    }
    /**
     * The composer of the soundtrack.
    ...
    /**
     * Remove numberOfPlayers property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeNumberOfPlayers() {
      removeValue("numberOfPlayers");
      return this;
    }
    /**
     * Get currently set value for numberOfPlayers property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getNumberOfPlayers() {
      return myData.get("numberOfPlayers");
    }
    /**
     * An item is an object within the game world that can be collected by a player or, occasionally, a non-player character.
     * @param thing value to set
    ...
    /**
     * Remove gameItem property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeGameItem() {
      removeValue("gameItem");
      return this;
    }
    /**
     * Get currently set value for gameItem property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getGameItem() {
      return myData.get("gameItem");
    }
    /**
     * The task that a player-controlled character, or group of characters may complete in order to gain a reward.
     * @param thing value to set
    ...
    /**
     * Remove quest property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeQuest() {
      removeValue("quest");
      return this;
    }
    /**
     * Get currently set value for quest property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getQuest() {
      return myData.get("quest");
    }
    /**
     * A season that is part of the media series.
     * @param hasPart value to set
    ...
    /**
     * Remove containsSeason property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeContainsSeason() {
      removeValue("containsSeason");
      return this;
    }
    /**
     * Get currently set value for containsSeason property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getContainsSeason() {
      return myData.get("containsSeason");
    }
    /**
    ...
    /**
     * Remove issn property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIssn() {
      removeValue("issn");
      return this;
    }
    /**
     * Get currently set value for issn property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIssn() {
      return myData.get("issn");
    }
    /**
