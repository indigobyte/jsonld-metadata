...
public class Seat extends Intangible {
   ...
   * @return seatSection property set by first invocation of seatSection method or {@code null}.
   */
  ...
  /**
   * The section location of the reserved seat (e.g. Orchestra).
   * @return all seatSection properties as {@link java.util.Collection} or an empty collection 
   * if seatSection was not set.
   */
   ...
   * @return seatRow property set by first invocation of seatRow method or {@code null}.
   */
  ...
  /**
   * The row location of the reserved seat (e.g., B).
   * @return all seatRow properties as {@link java.util.Collection} or an empty collection 
   * if seatRow was not set.
   */
   ...
   * @return seatingType property set by first invocation of seatingType method or {@code null}.
   */
  ...
  /**
   * The type/class of the seat.
   * @return all seatingType properties as {@link java.util.Collection} or an empty collection 
   * if seatingType was not set.
   */
   ...
   * @return seatNumber property set by first invocation of seatNumber method or {@code null}.
   */
  ...
  /**
   * The location of the reserved seat (e.g., 27).
   * @return all seatNumber properties as {@link java.util.Collection} or an empty collection 
   * if seatNumber was not set.
   */
  ...
  public static class Builder extends Intangible.Builder {
    ...
    /**
     * The section location of the reserved seat (e.g. Orchestra).
     * @param seatSection value to set
    ...
    /**
     * Remove seatSection property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSeatSection() {
      removeValue("seatSection");
      return this;
    }
    /**
     * Get currently set value for seatSection property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSeatSection() {
      return myData.get("seatSection");
    }
    /**
     * The row location of the reserved seat (e.g., B).
     * @param seatRow value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove seatRow property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSeatRow() {
      removeValue("seatRow");
      return this;
    }
    /**
     * Get currently set value for seatRow property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSeatRow() {
      return myData.get("seatRow");
    }
    /**
     * The type/class of the seat.
    ...
    /**
     * The type/class of the seat.
     * @param seatingType value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove seatingType property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSeatingType() {
      removeValue("seatingType");
      return this;
    }
    /**
     * Get currently set value for seatingType property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSeatingType() {
      return myData.get("seatingType");
    }
    /**
     * The location of the reserved seat (e.g., 27).
     * @param seatNumber value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove seatNumber property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSeatNumber() {
      removeValue("seatNumber");
      return this;
    }
    /**
     * Get currently set value for seatNumber property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSeatNumber() {
      return myData.get("seatNumber");
    }
    /**
