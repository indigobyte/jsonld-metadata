...
public class AutoPartsStore extends AutomotiveBusiness {
  protected AutoPartsStore(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link AutoPartsStore}
   */
  public static class Builder extends AutomotiveBusiness.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public AutoPartsStore build() {
      return new AutoPartsStore(myData);
    }
    /**
