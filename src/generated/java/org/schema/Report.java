...
public class Report extends Article {
   ...
   * @return reportNumber property set by first invocation of reportNumber method or {@code null}.
   */
  @JsonIgnore public String getReportNumber() {
    return (String) getValue("reportNumber");
  }
  /**
   * The number or other unique designator assigned to a Report by the publishing organization.
   * @return all reportNumber properties as {@link java.util.Collection} or an empty collection 
   * if reportNumber was not set.
   */
  @JsonIgnore public java.util.Collection<String> getReportNumbers() {
    final java.lang.Object current = myData.get("reportNumber");
  ...
  protected Report(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends Article.Builder {
    ...
    @NotNull public Report build() {
      return new Report(myData);
    }
    /**
     * The number or other unique designator assigned to a Report by the publishing organization.
     * @param reportNumber value to set
     * @return this builder instance
     */
    @NotNull public Builder reportNumber(@NotNull String reportNumber) {
      putValue("reportNumber", reportNumber);
      return this;
    }
    /**
     * Remove reportNumber property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeReportNumber() {
      removeValue("reportNumber");
      return this;
    }
    /**
     * Get currently set value for reportNumber property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getReportNumber() {
      return myData.get("reportNumber");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("reportNumber".equals(key) && value instanceof String) { this.reportNumber((String)value); return; }
      if ("reportNumbers".equals(key) && value instanceof String) { this.reportNumber((String)value); return; }
