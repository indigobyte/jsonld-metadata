...
public class Comment extends CreativeWork {
   ...
   * @return downvoteCount property set by first invocation of downvoteCount method or {@code null}.
   */
  ...
  /**
   * The number of downvotes this question, answer or comment has received from the community.
   * @return all downvoteCount properties as {@link java.util.Collection} or an empty collection 
   * if downvoteCount was not set.
   */
  @JsonIgnore public java.util.Collection<Integer> getDownvoteCounts() {
    final java.lang.Object current = myData.get("downvoteCount");
   ...
   * @return upvoteCount property set by first invocation of upvoteCount method or {@code null}.
   */
  ...
  /**
   * The number of upvotes this question, answer or comment has received from the community.
   * @return all upvoteCount properties as {@link java.util.Collection} or an empty collection 
   * if upvoteCount was not set.
   */
  @JsonIgnore public java.util.Collection<Integer> getUpvoteCounts() {
    final java.lang.Object current = myData.get("upvoteCount");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Integer>) current;
    }
   ...
   * @return parentItem property set by first invocation of parentItem method or {@code null}.
   */
  @JsonIgnore public Comment getParentItem() {
    return (Comment) getValue("parentItem");
  }
  /**
   * The parent of a question, answer or item in general.
   * @return all parentItem properties as {@link java.util.Collection} or an empty collection 
   * if parentItem was not set.
   */
  @JsonIgnore public java.util.Collection<Comment> getParentItems() {
    final java.lang.Object current = myData.get("parentItem");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected Comment(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("parentItem".equals(key) && value instanceof Comment) { this.parentItem((Comment)value); return; }
      if ("parentItems".equals(key) && value instanceof Comment) { this.parentItem((Comment)value); return; }
