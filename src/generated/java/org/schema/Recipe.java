...
public class Recipe extends HowTo {
   ...
   * @return suitableForDiet property set by first invocation of suitableForDiet method or {@code null}.
   */
  ...
  /**
   * Indicates a dietary restriction or guideline for which this recipe or menu item is suitable, e.g. diabetic, halal etc.
   * @return all suitableForDiet properties as {@link java.util.Collection} or an empty collection 
   * if suitableForDiet was not set.
   */
   ...
   * @return recipeCategory property set by first invocation of recipeCategory method or {@code null}.
   */
  ...
  /**
   * The category of the recipe&mdash;for example, appetizer, entree, etc.
   * @return all recipeCategory properties as {@link java.util.Collection} or an empty collection 
   * if recipeCategory was not set.
   */
  @JsonIgnore public java.util.Collection<String> getRecipeCategorys() {
    final java.lang.Object current = myData.get("recipeCategory");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return recipeIngredient property set by first invocation of recipeIngredient method or {@code null}.
   */
  ...
  /**
   * A single ingredient used in the recipe, e.g. sugar, flour or garlic.
   * @return all recipeIngredient properties as {@link java.util.Collection} or an empty collection 
   * if recipeIngredient was not set.
   */
  @JsonIgnore public java.util.Collection<Supply> getRecipeIngredients() {
    final java.lang.Object current = myData.get("recipeIngredient");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return recipeInstructions property set by first invocation of recipeInstructions method or {@code null}.
   */
  @JsonIgnore public Step getRecipeInstructions() {
    return (Step) getValue("recipeInstructions");
  }
  /**
   * A step in making the recipe, in the form of a single item (document, video, etc.) or an ordered list with HowToStep and/or HowToSection items.
   * @return all recipeInstructions properties as {@link java.util.Collection} or an empty collection 
   * if recipeInstructions was not set.
   */
  @JsonIgnore public java.util.Collection<Step> getRecipeInstructionss() {
    final java.lang.Object current = myData.get("recipeInstructions");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return recipeCuisine property set by first invocation of recipeCuisine method or {@code null}.
   */
  @JsonIgnore public String getRecipeCuisine() {
    return (String) getValue("recipeCuisine");
  }
  /**
   * The cuisine of the recipe (for example, French or Ethiopian).
   * @return all recipeCuisine properties as {@link java.util.Collection} or an empty collection 
   * if recipeCuisine was not set.
   */
  @JsonIgnore public java.util.Collection<String> getRecipeCuisines() {
    final java.lang.Object current = myData.get("recipeCuisine");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
   ...
   * @return nutrition property set by first invocation of nutrition method or {@code null}.
   */
  ...
  /**
   * Nutrition information about the recipe or menu item.
   * @return all nutrition properties as {@link java.util.Collection} or an empty collection 
   * if nutrition was not set.
   */
   ...
   * @return cookingMethod property set by first invocation of cookingMethod method or {@code null}.
   */
  @JsonIgnore public String getCookingMethod() {
    return (String) getValue("cookingMethod");
  }
  /**
   * The method of cooking, such as Frying, Steaming, ...
   * @return all cookingMethod properties as {@link java.util.Collection} or an empty collection 
   * if cookingMethod was not set.
   */
  @JsonIgnore public java.util.Collection<String> getCookingMethods() {
    final java.lang.Object current = myData.get("cookingMethod");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
   ...
   * @return recipeYield property set by first invocation of recipeYield method or {@code null}.
   */
  ...
  /**
   * The quantity produced by the recipe (for example, number of people served, number of servings, etc).
   * @return all recipeYield properties as {@link java.util.Collection} or an empty collection 
   * if recipeYield was not set.
   */
  @JsonIgnore public java.util.Collection<Yield> getRecipeYields() {
    final java.lang.Object current = myData.get("recipeYield");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return cookTime property set by first invocation of cookTime method or {@code null}.
   */
  ...
  /**
   * The time it takes to actually cook the dish, in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).
   * @return all cookTime properties as {@link java.util.Collection} or an empty collection 
   * if cookTime was not set.
   */
  @JsonIgnore public java.util.Collection<PerformTime> getCookTimes() {
    final java.lang.Object current = myData.get("cookTime");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected Recipe(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends HowTo.Builder {
    ...
    /**
     * Indicates a dietary restriction or guideline for which this recipe or menu item is suitable, e.g. diabetic, halal etc.
     * @param restrictedDiet value to set
    ...
    /**
     * Remove suitableForDiet property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSuitableForDiet() {
      removeValue("suitableForDiet");
      return this;
    }
    /**
     * Get currently set value for suitableForDiet property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSuitableForDiet() {
      return myData.get("suitableForDiet");
    }
    /**
     * The category of the recipe&mdash;for example, appetizer, entree, etc.
     * @param recipeCategory value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove recipeCategory property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRecipeCategory() {
      removeValue("recipeCategory");
      return this;
    }
    /**
     * Get currently set value for recipeCategory property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRecipeCategory() {
      return myData.get("recipeCategory");
    }
    /**
     * A single ingredient used in the recipe, e.g. sugar, flour or garlic.
    ...
    /**
     * Remove recipeIngredient property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRecipeIngredient() {
      removeValue("recipeIngredient");
      return this;
    }
    /**
     * Get currently set value for recipeIngredient property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRecipeIngredient() {
      return myData.get("recipeIngredient");
    }
    /**
     * A step in making the recipe, in the form of a single item (document, video, etc.) or an ordered list with HowToStep and/or HowToSection items.
     ...
     * @return this builder instance
     */
    @NotNull public Builder recipeInstructions(@NotNull Step step) {
      putValue("recipeInstructions", step);
      return this;
    }
    /**
     * Remove recipeInstructions property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRecipeInstructions() {
      removeValue("recipeInstructions");
      return this;
    }
    /**
     * Get currently set value for recipeInstructions property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRecipeInstructions() {
      return myData.get("recipeInstructions");
    }
    /**
     * The cuisine of the recipe (for example, French or Ethiopian).
     * @param recipeCuisine value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove recipeCuisine property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRecipeCuisine() {
      removeValue("recipeCuisine");
      return this;
    }
    /**
     * Get currently set value for recipeCuisine property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRecipeCuisine() {
      return myData.get("recipeCuisine");
    }
    /**
     * Nutrition information about the recipe or menu item.
     * @param nutritionInformation value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove nutrition property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeNutrition() {
      removeValue("nutrition");
      return this;
    }
    /**
     * Get currently set value for nutrition property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getNutrition() {
      return myData.get("nutrition");
    }
    /**
     * The method of cooking, such as Frying, Steaming, ...
     * @param cookingMethod value to set
     * @return this builder instance
     */
    @NotNull public Builder cookingMethod(@NotNull String cookingMethod) {
      putValue("cookingMethod", cookingMethod);
      return this;
    }
    /**
     * Remove cookingMethod property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCookingMethod() {
      removeValue("cookingMethod");
      return this;
    }
    /**
     * Get currently set value for cookingMethod property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCookingMethod() {
      return myData.get("cookingMethod");
    }
    /**
     * The quantity produced by the recipe (for example, number of people served, number of servings, etc).
     * @param yield value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove recipeYield property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRecipeYield() {
      removeValue("recipeYield");
      return this;
    }
    /**
     * Get currently set value for recipeYield property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRecipeYield() {
      return myData.get("recipeYield");
    }
    /**
     * The time it takes to actually cook the dish, in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).
    ...
    /**
     * Remove cookTime property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCookTime() {
      removeValue("cookTime");
      return this;
    }
    /**
     * Get currently set value for cookTime property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCookTime() {
      return myData.get("cookTime");
    }
    /**
    ...
    /**
     * The estimated cost of the supply or supplies consumed when performing instructions.
     * @param estimatedCost value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove estimatedCost property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeEstimatedCost() {
      removeValue("estimatedCost");
      return this;
    }
    /**
     * Get currently set value for estimatedCost property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getEstimatedCost() {
      return myData.get("estimatedCost");
    }
    /**
    ...
    /**
     * Remove step property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeStep() {
      removeValue("step");
      return this;
    }
    /**
     * Get currently set value for step property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getStep() {
      return myData.get("step");
    }
    /**
    ...
    /**
     * Remove yield property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeYield() {
      removeValue("yield");
      return this;
    }
    /**
     * Get currently set value for yield property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getYield() {
      return myData.get("yield");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("recipeCuisines".equals(key) && value instanceof String) { this.recipeCuisine((String)value); return; }
