...
public class MusicPlaylist extends CreativeWork {
   ...
   * @return track property set by first invocation of track method or {@code null}.
   */
  ...
  /**
   * A music recording (track)&amp;#x2014;usually a single song. If an ItemList is given, the list should contain items of type MusicRecording.
   * @return all track properties as {@link java.util.Collection} or an empty collection 
   * if track was not set.
   */
   ...
   * @return numTracks property set by first invocation of numTracks method or {@code null}.
   */
  @JsonIgnore public Integer getNumTracks() {
    return (Integer) getValue("numTracks");
  }
  /**
   * The number of tracks in this album or playlist.
   * @return all numTracks properties as {@link java.util.Collection} or an empty collection 
   * if numTracks was not set.
   */
  @JsonIgnore public java.util.Collection<Integer> getNumTrackss() {
    final java.lang.Object current = myData.get("numTracks");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected MusicPlaylist(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link MusicPlaylist}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MusicPlaylist build() {
      return new MusicPlaylist(myData);
    }
    /**
     * A music recording (track)&amp;#x2014;usually a single song. If an ItemList is given, the list should contain items of type MusicRecording.
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("numTracks".equals(key) && value instanceof Integer) { this.numTracks((Integer)value); return; }
      if ("numTrackss".equals(key) && value instanceof Integer) { this.numTracks((Integer)value); return; }
