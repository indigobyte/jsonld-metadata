 ...
 */
public class Nursing extends MedicalBusiness {
  protected Nursing(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Nursing}
   */
  public static class Builder extends MedicalBusiness.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public Nursing build() {
      return new Nursing(myData);
    }
    /**
