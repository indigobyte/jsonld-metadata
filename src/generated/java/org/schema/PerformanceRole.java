...
public class PerformanceRole extends Role {
   ...
   * @return characterName property set by first invocation of characterName method or {@code null}.
   */
  ...
  /**
   * The name of a character played in some acting or performing role, i.e. in a PerformanceRole.
   * @return all characterName properties as {@link java.util.Collection} or an empty collection 
   * if characterName was not set.
   */
  @JsonIgnore public java.util.Collection<String> getCharacterNames() {
    final java.lang.Object current = myData.get("characterName");
  ...
  protected PerformanceRole(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends Role.Builder {
    ...
    /**
     * The name of a character played in some acting or performing role, i.e. in a PerformanceRole.
     * @param characterName value to set
    ...
    /**
     * Remove characterName property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCharacterName() {
      removeValue("characterName");
      return this;
    }
    /**
     * Get currently set value for characterName property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCharacterName() {
      return myData.get("characterName");
    }
    /**
