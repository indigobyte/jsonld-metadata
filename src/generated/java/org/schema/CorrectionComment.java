...
public class CorrectionComment extends Comment {
  protected CorrectionComment(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link CorrectionComment}
   */
  public static class Builder extends Comment.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public CorrectionComment build() {
      return new CorrectionComment(myData);
    }
    /**
