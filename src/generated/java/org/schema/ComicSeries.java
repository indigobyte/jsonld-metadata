...
public class ComicSeries extends Periodical {
  protected ComicSeries(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link ComicSeries}
   */
  public static class Builder extends Periodical.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public ComicSeries build() {
      return new ComicSeries(myData);
    }
    /**
