...
public class ListItem extends Intangible {
   ...
   * @return previousItem property set by first invocation of previousItem method or {@code null}.
   */
  ...
  /**
   * A link to the ListItem that preceeds the current one.
   * @return all previousItem properties as {@link java.util.Collection} or an empty collection 
   * if previousItem was not set.
   */
   ...
   * @return nextItem property set by first invocation of nextItem method or {@code null}.
   */
  ...
  /**
   * A link to the ListItem that follows the current one.
   * @return all nextItem properties as {@link java.util.Collection} or an empty collection 
   * if nextItem was not set.
   */
