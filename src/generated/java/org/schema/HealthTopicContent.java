...
public class HealthTopicContent extends WebContent {
   ...
   * @return hasHealthAspect property set by first invocation of hasHealthAspect method or {@code null}.
   */
  @JsonIgnore public HealthAspectEnumeration getHasHealthAspect() {
    return (HealthAspectEnumeration) getValue("hasHealthAspect");
  }
  /**
   * Indicates the aspect or aspects specifically addressed in some [[HealthTopicContent]]. For example, that the content is an overview, or that it talks about treatment, self-care, treatments or their side-effects.
   * @return all hasHealthAspect properties as {@link java.util.Collection} or an empty collection 
   * if hasHealthAspect was not set.
   */
  @JsonIgnore public java.util.Collection<HealthAspectEnumeration> getHasHealthAspects() {
    final java.lang.Object current = myData.get("hasHealthAspect");
  ...
  protected HealthTopicContent(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link HealthTopicContent}
   */
  public static class Builder extends WebContent.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public HealthTopicContent build() {
      return new HealthTopicContent(myData);
    }
    /**
     * Indicates the aspect or aspects specifically addressed in some [[HealthTopicContent]]. For example, that the content is an overview, or that it talks about treatment, self-care, treatments or their side-effects.
     * @param healthAspectEnumeration value to set
     * @return this builder instance
     */
    @NotNull public Builder hasHealthAspect(@NotNull HealthAspectEnumeration healthAspectEnumeration) {
      putValue("hasHealthAspect", healthAspectEnumeration);
      return this;
    }
    /**
     * Remove hasHealthAspect property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeHasHealthAspect() {
      removeValue("hasHealthAspect");
      return this;
    }
    /**
     * Get currently set value for hasHealthAspect property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getHasHealthAspect() {
      return myData.get("hasHealthAspect");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("hasHealthAspect".equals(key) && value instanceof HealthAspectEnumeration) { this.hasHealthAspect((HealthAspectEnumeration)value); return; }
      if ("hasHealthAspects".equals(key) && value instanceof HealthAspectEnumeration) { this.hasHealthAspect((HealthAspectEnumeration)value); return; }
