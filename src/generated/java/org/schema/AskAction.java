...
public class AskAction extends CommunicateAction {
   ...
   * @return question property set by first invocation of question method or {@code null}.
   */
  ...
  /**
   * A sub property of object. A question.
   * @return all question properties as {@link java.util.Collection} or an empty collection 
   * if question was not set.
   */
  ...
  public static class Builder extends CommunicateAction.Builder {
    ...
    /**
     * Remove question property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeQuestion() {
      removeValue("question");
      return this;
    }
    /**
     * Get currently set value for question property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getQuestion() {
      return myData.get("question");
    }
    /**
