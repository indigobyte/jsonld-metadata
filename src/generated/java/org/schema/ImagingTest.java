...
public class ImagingTest extends MedicalTest {
   ...
   * @return imagingTechnique property set by first invocation of imagingTechnique method or {@code null}.
   */
  @JsonIgnore public MedicalImagingTechnique getImagingTechnique() {
    return (MedicalImagingTechnique) getValue("imagingTechnique");
  }
  /**
   * Imaging technique used.
   * @return all imagingTechnique properties as {@link java.util.Collection} or an empty collection 
   * if imagingTechnique was not set.
   */
  @JsonIgnore public java.util.Collection<MedicalImagingTechnique> getImagingTechniques() {
    final java.lang.Object current = myData.get("imagingTechnique");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<MedicalImagingTechnique>) current;
    }
    return Arrays.asList((MedicalImagingTechnique) current);
  }
  protected ImagingTest(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
   ...
   */
  public static class Builder extends MedicalTest.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public ImagingTest build() {
      return new ImagingTest(myData);
    }
    /**
     * Imaging technique used.
     * @param medicalImagingTechnique value to set
     * @return this builder instance
     */
    @NotNull public Builder imagingTechnique(@NotNull MedicalImagingTechnique medicalImagingTechnique) {
      putValue("imagingTechnique", medicalImagingTechnique);
      return this;
    }
    /**
     * Remove imagingTechnique property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeImagingTechnique() {
      removeValue("imagingTechnique");
      return this;
    }
    /**
     * Get currently set value for imagingTechnique property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getImagingTechnique() {
      return myData.get("imagingTechnique");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("imagingTechnique".equals(key) && value instanceof MedicalImagingTechnique) { this.imagingTechnique((MedicalImagingTechnique)value); return; }
      if ("imagingTechniques".equals(key) && value instanceof MedicalImagingTechnique) { this.imagingTechnique((MedicalImagingTechnique)value); return; }
