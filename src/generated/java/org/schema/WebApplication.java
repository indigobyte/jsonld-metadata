...
public class WebApplication extends SoftwareApplication {
   ...
   * @return browserRequirements property set by first invocation of browserRequirements method or {@code null}.
   */
  @JsonIgnore public String getBrowserRequirements() {
    return (String) getValue("browserRequirements");
  }
  /**
   * Specifies browser requirements in human-readable text. For example, 'requires HTML5 support'.
   * @return all browserRequirements properties as {@link java.util.Collection} or an empty collection 
   * if browserRequirements was not set.
   */
  @JsonIgnore public java.util.Collection<String> getBrowserRequirementss() {
    final java.lang.Object current = myData.get("browserRequirements");
  ...
  protected WebApplication(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends SoftwareApplication.Builder {
    ...
    /**
     * Specifies browser requirements in human-readable text. For example, 'requires HTML5 support'.
     * @param browserRequirements value to set
     * @return this builder instance
     */
    @NotNull public Builder browserRequirements(@NotNull String browserRequirements) {
      putValue("browserRequirements", browserRequirements);
      return this;
    }
    /**
     * Remove browserRequirements property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeBrowserRequirements() {
      removeValue("browserRequirements");
      return this;
    }
    /**
     * Get currently set value for browserRequirements property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getBrowserRequirements() {
      return myData.get("browserRequirements");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("browserRequirements".equals(key) && value instanceof String) { this.browserRequirements((String)value); return; }
      if ("browserRequirementss".equals(key) && value instanceof String) { this.browserRequirements((String)value); return; }
