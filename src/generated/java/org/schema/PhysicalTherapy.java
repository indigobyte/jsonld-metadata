...
public class PhysicalTherapy extends MedicalTherapy {
  protected PhysicalTherapy(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link PhysicalTherapy}
   */
  public static class Builder extends MedicalTherapy.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public PhysicalTherapy build() {
      return new PhysicalTherapy(myData);
    }
    /**
