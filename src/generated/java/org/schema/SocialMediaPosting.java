...
public class SocialMediaPosting extends Article {
   ...
   * @return sharedContent property set by first invocation of sharedContent method or {@code null}.
   */
  @JsonIgnore public CreativeWork getSharedContent() {
    return (CreativeWork) getValue("sharedContent");
  }
  /**
   * A CreativeWork such as an image, video, or audio clip shared as part of this posting.
   * @return all sharedContent properties as {@link java.util.Collection} or an empty collection 
   * if sharedContent was not set.
   */
  @JsonIgnore public java.util.Collection<CreativeWork> getSharedContents() {
    final java.lang.Object current = myData.get("sharedContent");
  ...
  protected SocialMediaPosting(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends Article.Builder {
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("sharedContent".equals(key) && value instanceof CreativeWork) { this.sharedContent((CreativeWork)value); return; }
      if ("sharedContents".equals(key) && value instanceof CreativeWork) { this.sharedContent((CreativeWork)value); return; }
