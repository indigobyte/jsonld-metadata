 ...
 */
public class CompleteDataFeed extends DataFeed {
  protected CompleteDataFeed(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link CompleteDataFeed}
   */
  public static class Builder extends DataFeed.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public CompleteDataFeed build() {
      return new CompleteDataFeed(myData);
    }
    /**
