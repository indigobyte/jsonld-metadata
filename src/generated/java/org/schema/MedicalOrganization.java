...
public class MedicalOrganization extends Organization {
   ...
   * @return isAcceptingNewPatients property set by first invocation of isAcceptingNewPatients method or {@code null}.
   */
  @JsonIgnore public Boolean getIsAcceptingNewPatients() {
    return (Boolean) getValue("isAcceptingNewPatients");
  }
  /**
   * Whether the provider is accepting new patients.
   * @return all isAcceptingNewPatients properties as {@link java.util.Collection} or an empty collection 
   * if isAcceptingNewPatients was not set.
   */
  @JsonIgnore public java.util.Collection<Boolean> getIsAcceptingNewPatientss() {
    final java.lang.Object current = myData.get("isAcceptingNewPatients");
   ...
   * @return healthPlanNetworkId property set by first invocation of healthPlanNetworkId method or {@code null}.
   */
  ...
  /**
   * Name or unique ID of network. (Networks are often reused across different insurance plans).
   * @return all healthPlanNetworkId properties as {@link java.util.Collection} or an empty collection 
   * if healthPlanNetworkId was not set.
   */
  @JsonIgnore public java.util.Collection<String> getHealthPlanNetworkIds() {
    final java.lang.Object current = myData.get("healthPlanNetworkId");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected MedicalOrganization(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends Organization.Builder {
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("isAcceptingNewPatients".equals(key) && value instanceof Boolean) { this.isAcceptingNewPatients((Boolean)value); return; }
      if ("isAcceptingNewPatientss".equals(key) && value instanceof Boolean) { this.isAcceptingNewPatients((Boolean)value); return; }
