 ...
 */
public class Midwifery extends MedicalBusiness {
  protected Midwifery(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends MedicalBusiness.Builder {
    ...
    @NotNull public Midwifery build() {
      return new Midwifery(myData);
    }
    /**
