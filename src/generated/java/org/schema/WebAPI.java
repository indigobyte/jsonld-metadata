...
public class WebAPI extends Service {
   ...
   * @return documentation property set by first invocation of documentation method or {@code null}.
   */
  @JsonIgnore public CreativeWork getDocumentationCreativeWork() {
    return (CreativeWork) getValue("documentation");
  }
  /**
   * Further documentation describing the Web API in more detail.
   * @return all documentation properties as {@link java.util.Collection} or an empty collection 
   * if documentation was not set.
   */
   ...
   * @return documentation property set by first invocation of documentation method or {@code null}.
   */
  @JsonIgnore public String getDocumentationString() {
  ...
  public static class Builder extends Service.Builder {
     ...
     */
    @NotNull public Builder documentation(@NotNull CreativeWork creativeWork) {
      putValue("documentation", creativeWork);
      return this;
    }
    /**
     * Further documentation describing the Web API in more detail.
     ...
     * @return this builder instance
     */
    @NotNull public Builder documentation(@NotNull CreativeWork.Builder creativeWork) {
      putValue("documentation", creativeWork.build());
      return this;
    }
    /**
     * Further documentation describing the Web API in more detail.
     * @param documentation value to set
     * @return this builder instance
     */
    @NotNull public Builder documentation(@NotNull String documentation) {
      putValue("documentation", documentation);
      return this;
    }
    /**
     * Remove documentation property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeDocumentation() {
      removeValue("documentation");
      return this;
    }
    /**
     * Get currently set value for documentation property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getDocumentation() {
      return myData.get("documentation");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("documentations".equals(key) && value instanceof String) { this.documentation((String)value); return; }
