 ...
 */
public class GLEIF extends Organization {
  protected GLEIF(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link GLEIF}
   */
  public static class Builder extends Organization.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public GLEIF build() {
      return new GLEIF(myData);
    }
    /**
