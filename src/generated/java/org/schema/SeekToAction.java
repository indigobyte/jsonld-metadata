...
public class SeekToAction extends Action {
  ...
  protected SeekToAction(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link SeekToAction}
   */
  public static class Builder extends Action.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public SeekToAction build() {
      return new SeekToAction(myData);
    }
    /**
     * The start time of the clip expressed as the number of seconds from the beginning of the work.
