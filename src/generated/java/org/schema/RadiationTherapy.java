...
public class RadiationTherapy extends MedicalTherapy {
  protected RadiationTherapy(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link RadiationTherapy}
   */
  public static class Builder extends MedicalTherapy.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public RadiationTherapy build() {
      return new RadiationTherapy(myData);
    }
    /**
