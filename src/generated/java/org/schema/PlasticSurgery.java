 ...
 */
public class PlasticSurgery extends MedicalBusiness {
  protected PlasticSurgery(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends MedicalBusiness.Builder {
    ...
    @NotNull public PlasticSurgery build() {
      return new PlasticSurgery(myData);
    }
    /**
