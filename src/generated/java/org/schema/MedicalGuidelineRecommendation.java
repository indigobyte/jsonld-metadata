...
public class MedicalGuidelineRecommendation extends MedicalGuideline {
   ...
   * @return recommendationStrength property set by first invocation of recommendationStrength method or {@code null}.
   */
  @JsonIgnore public String getRecommendationStrength() {
    return (String) getValue("recommendationStrength");
  }
  /**
   * Strength of the guideline's recommendation (e.g. 'class I').
   * @return all recommendationStrength properties as {@link java.util.Collection} or an empty collection 
   * if recommendationStrength was not set.
   */
  @JsonIgnore public java.util.Collection<String> getRecommendationStrengths() {
    final java.lang.Object current = myData.get("recommendationStrength");
  ...
  protected MedicalGuidelineRecommendation(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link MedicalGuidelineRecommendation}
   */
  public static class Builder extends MedicalGuideline.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MedicalGuidelineRecommendation build() {
      return new MedicalGuidelineRecommendation(myData);
    }
    /**
     * Strength of the guideline's recommendation (e.g. 'class I').
     * @param recommendationStrength value to set
     * @return this builder instance
     */
    @NotNull public Builder recommendationStrength(@NotNull String recommendationStrength) {
      putValue("recommendationStrength", recommendationStrength);
      return this;
    }
    /**
     * Remove recommendationStrength property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRecommendationStrength() {
      removeValue("recommendationStrength");
      return this;
    }
    /**
     * Get currently set value for recommendationStrength property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRecommendationStrength() {
      return myData.get("recommendationStrength");
    }
    /**
    ...
    /**
     * Remove guidelineDate property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeGuidelineDate() {
      removeValue("guidelineDate");
      return this;
    }
    /**
     * Get currently set value for guidelineDate property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getGuidelineDate() {
      return myData.get("guidelineDate");
    }
    /**
     * Source of the data used to formulate the guidance, e.g. RCT, consensus opinion, etc.
     * @param evidenceOrigin value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove evidenceOrigin property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeEvidenceOrigin() {
      removeValue("evidenceOrigin");
      return this;
    }
    /**
     * Get currently set value for evidenceOrigin property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getEvidenceOrigin() {
      return myData.get("evidenceOrigin");
    }
    /**
    ...
    /**
     * Remove guidelineSubject property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeGuidelineSubject() {
      removeValue("guidelineSubject");
      return this;
    }
    /**
     * Get currently set value for guidelineSubject property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getGuidelineSubject() {
      return myData.get("guidelineSubject");
    }
    /**
     * Strength of evidence of the data used to formulate the guideline (enumerated).
     * @param medicalEvidenceLevel value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove evidenceLevel property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeEvidenceLevel() {
      removeValue("evidenceLevel");
      return this;
    }
    /**
     * Get currently set value for evidenceLevel property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getEvidenceLevel() {
      return myData.get("evidenceLevel");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("recommendationStrength".equals(key) && value instanceof String) { this.recommendationStrength((String)value); return; }
      if ("recommendationStrengths".equals(key) && value instanceof String) { this.recommendationStrength((String)value); return; }
