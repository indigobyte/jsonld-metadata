...
public class ApprovedIndication extends MedicalIndication {
  protected ApprovedIndication(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link ApprovedIndication}
   */
  public static class Builder extends MedicalIndication.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public ApprovedIndication build() {
      return new ApprovedIndication(myData);
    }
    /**
