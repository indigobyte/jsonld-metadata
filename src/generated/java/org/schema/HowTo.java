...
public class HowTo extends CreativeWork {
   ...
   * @return estimatedCost property set by first invocation of estimatedCost method or {@code null}.
   */
  ...
  /**
   * The estimated cost of the supply or supplies consumed when performing instructions.
   * @return all estimatedCost properties as {@link java.util.Collection} or an empty collection 
   * if estimatedCost was not set.
   */
   ...
   * @return step property set by first invocation of step method or {@code null}.
   */
  ...
  /**
   * A single step item (as HowToStep, text, document, video, etc.) or a HowToSection.
   * @return all step properties as {@link java.util.Collection} or an empty collection 
   * if step was not set.
   */
  @JsonIgnore public java.util.Collection<Step> getSteps() {
    final java.lang.Object current = myData.get("step");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return yield property set by first invocation of yield method or {@code null}.
   */
  ...
  /**
   * The quantity that results by performing instructions. For example, a paper airplane, 10 personalized candles.
   * @return all yield properties as {@link java.util.Collection} or an empty collection 
   * if yield was not set.
   */
  @JsonIgnore public java.util.Collection<Yield> getYields() {
    final java.lang.Object current = myData.get("yield");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected HowTo(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("step".equals(key) && value instanceof Step) { this.step((Step)value); return; }
      if ("steps".equals(key) && value instanceof Step) { this.step((Step)value); return; }
