 ...
 */
public class Legislation extends CreativeWork implements org.schema.LegislationApplies {
  /**
   * An identifier for the legislation. This can be either a string-based identifier, like the CELEX at EU level or the NOR in France, or a web-based, URL/URI identifier, like an ELI (European Legislation Identifier) or an URN-Lex.
   * @return legislationIdentifier property set by first invocation of legislationIdentifier method or {@code null}.
   */
  @JsonIgnore public Identifier getLegislationIdentifier() {
    return (Identifier) getValue("legislationIdentifier");
  }
  /**
   * An identifier for the legislation. This can be either a string-based identifier, like the CELEX at EU level or the NOR in France, or a web-based, URL/URI identifier, like an ELI (European Legislation Identifier) or an URN-Lex.
   * @return all legislationIdentifier properties as {@link java.util.Collection} or an empty collection 
   * if legislationIdentifier was not set.
   */
  @JsonIgnore public java.util.Collection<Identifier> getLegislationIdentifiers() {
    final java.lang.Object current = myData.get("legislationIdentifier");
   ...
   * @return legislationDate property set by first invocation of legislationDate method or {@code null}.
   */
  ...
  /**
   * The date of adoption or signature of the legislation. This is the date at which the text is officially aknowledged to be a legislation, even though it might not even be published or in force.
   * @return all legislationDate properties as {@link java.util.Collection} or an empty collection 
   * if legislationDate was not set.
   */
  @JsonIgnore public java.util.Collection<DateCreated> getLegislationDates() {
    final java.lang.Object current = myData.get("legislationDate");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return legislationJurisdiction property set by first invocation of legislationJurisdiction method or {@code null}.
   */
  @JsonIgnore public Jurisdiction getLegislationJurisdiction() {
    return (Jurisdiction) getValue("legislationJurisdiction");
  }
  /**
   * The jurisdiction from which the legislation originates.
   * @return all legislationJurisdiction properties as {@link java.util.Collection} or an empty collection 
   * if legislationJurisdiction was not set.
   */
  @JsonIgnore public java.util.Collection<Jurisdiction> getLegislationJurisdictions() {
    final java.lang.Object current = myData.get("legislationJurisdiction");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return legislationType property set by first invocation of legislationType method or {@code null}.
   */
  @JsonIgnore public Genre getLegislationType() {
    return (Genre) getValue("legislationType");
  }
  /**
   * The type of the legislation. Examples of values are &quot;law&quot;, &quot;act&quot;, &quot;directive&quot;, &quot;decree&quot;, &quot;regulation&quot;, &quot;statutory instrument&quot;, &quot;loi organique&quot;, &quot;r&egrave;glement grand-ducal&quot;, etc., depending on the country.
   * @return all legislationType properties as {@link java.util.Collection} or an empty collection 
   * if legislationType was not set.
   */
  @JsonIgnore public java.util.Collection<Genre> getLegislationTypes() {
    final java.lang.Object current = myData.get("legislationType");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return legislationLegalForce property set by first invocation of legislationLegalForce method or {@code null}.
   */
  @JsonIgnore public LegalForceStatus getLegislationLegalForce() {
    return (LegalForceStatus) getValue("legislationLegalForce");
  }
  /**
   * Whether the legislation is currently in force, not in force, or partially in force.
   * @return all legislationLegalForce properties as {@link java.util.Collection} or an empty collection 
   * if legislationLegalForce was not set.
   */
  @JsonIgnore public java.util.Collection<LegalForceStatus> getLegislationLegalForces() {
    final java.lang.Object current = myData.get("legislationLegalForce");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return legislationDateVersion property set by first invocation of legislationDateVersion method or {@code null}.
   */
  @JsonIgnore public java.util.Date getLegislationDateVersion() {
    return (java.util.Date) getValue("legislationDateVersion");
  }
  /**
   * The point-in-time at which the provided description of the legislation is valid (e.g. : when looking at the law on the 2016-04-07 (= dateVersion), I get the consolidation of 2015-04-12 of the &quot;National Insurance Contributions Act 2015&quot;)
   * @return all legislationDateVersion properties as {@link java.util.Collection} or an empty collection 
   * if legislationDateVersion was not set.
   */
  @JsonIgnore public java.util.Collection<java.util.Date> getLegislationDateVersions() {
    final java.lang.Object current = myData.get("legislationDateVersion");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return legislationTransposes property set by first invocation of legislationTransposes method or {@code null}.
   */
  @JsonIgnore public LegislationApplies getLegislationTransposes() {
    return (LegislationApplies) getValue("legislationTransposes");
  }
  /**
   * Indicates that this legislation (or part of legislation) fulfills the objectives set by another legislation, by passing appropriate implementation measures. Typically, some legislations of European Union's member states or regions transpose European Directives. This indicates a legally binding link between the 2 legislations.
   * @return all legislationTransposes properties as {@link java.util.Collection} or an empty collection 
   * if legislationTransposes was not set.
   */
  @JsonIgnore public java.util.Collection<LegislationApplies> getLegislationTransposess() {
    final java.lang.Object current = myData.get("legislationTransposes");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return legislationApplies property set by first invocation of legislationApplies method or {@code null}.
   */
  @JsonIgnore public LegislationApplies getLegislationApplies() {
    return (LegislationApplies) getValue("legislationApplies");
  }
  /**
   * Indicates that this legislation (or part of a legislation) somehow transfers another legislation in a different legislative context. This is an informative link, and it has no legal value. For legally-binding links of transposition, use the &lt;a href=&quot;/legislationTransposes&quot;&gt;legislationTransposes&lt;/a&gt; property. For example an informative consolidated law of a European Union's member state &quot;applies&quot; the consolidated version of the European Directive implemented in it.
   * @return all legislationApplies properties as {@link java.util.Collection} or an empty collection 
   * if legislationApplies was not set.
   */
  @JsonIgnore public java.util.Collection<LegislationApplies> getLegislationAppliess() {
    final java.lang.Object current = myData.get("legislationApplies");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<LegislationApplies>) current;
    }
   ...
   * @return legislationPassedBy property set by first invocation of legislationPassedBy method or {@code null}.
   */
  ...
  /**
   * The person or organization that originally passed or made the law : typically parliament (for primary legislation) or government (for secondary legislation). This indicates the &quot;legal author&quot; of the law, as opposed to its physical author.
   * @return all legislationPassedBy properties as {@link java.util.Collection} or an empty collection 
   * if legislationPassedBy was not set.
   */
  @JsonIgnore public java.util.Collection<Creator> getLegislationPassedBys() {
    final java.lang.Object current = myData.get("legislationPassedBy");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return legislationChanges property set by first invocation of legislationChanges method or {@code null}.
   */
  @JsonIgnore public Legislation getLegislationChanges() {
    return (Legislation) getValue("legislationChanges");
  }
  /**
   * Another legislation that this legislation changes. This encompasses the notions of amendment, replacement, correction, repeal, or other types of change. This may be a direct change (textual or non-textual amendment) or a consequential or indirect change. The property is to be used to express the existence of a change relationship between two acts rather than the existence of a consolidated version of the text that shows the result of the change. For consolidation relationships, use the &lt;a href=&quot;/legislationConsolidates&quot;&gt;legislationConsolidates&lt;/a&gt; property.
   * @return all legislationChanges properties as {@link java.util.Collection} or an empty collection 
   * if legislationChanges was not set.
   */
  @JsonIgnore public java.util.Collection<Legislation> getLegislationChangess() {
    final java.lang.Object current = myData.get("legislationChanges");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return legislationConsolidates property set by first invocation of legislationConsolidates method or {@code null}.
   */
  @JsonIgnore public Legislation getLegislationConsolidates() {
    return (Legislation) getValue("legislationConsolidates");
  }
  /**
   * Indicates another legislation taken into account in this consolidated legislation (which is usually the product of an editorial process that revises the legislation). This property should be used multiple times to refer to both the original version or the previous consolidated version, and to the legislations making the change.
   * @return all legislationConsolidates properties as {@link java.util.Collection} or an empty collection 
   * if legislationConsolidates was not set.
   */
  @JsonIgnore public java.util.Collection<Legislation> getLegislationConsolidatess() {
    final java.lang.Object current = myData.get("legislationConsolidates");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Legislation>) current;
    }
   ...
   * @return legislationResponsible property set by first invocation of legislationResponsible method or {@code null}.
   */
  @JsonIgnore public Organization getLegislationResponsibleOrganization() {
    return (Organization) getValue("legislationResponsible");
  }
  /**
   * An individual or organization that has some kind of responsibility for the legislation. Typically the ministry who is/was in charge of elaborating the legislation, or the adressee for potential questions about the legislation once it is published.
   * @return all legislationResponsible properties as {@link java.util.Collection} or an empty collection 
   * if legislationResponsible was not set.
   */
  @JsonIgnore public java.util.Collection<Organization> getLegislationResponsibleOrganizations() {
    final java.lang.Object current = myData.get("legislationResponsible");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return legislationResponsible property set by first invocation of legislationResponsible method or {@code null}.
   */
  @JsonIgnore public Person getLegislationResponsiblePerson() {
    return (Person) getValue("legislationResponsible");
  }
  /**
   * An individual or organization that has some kind of responsibility for the legislation. Typically the ministry who is/was in charge of elaborating the legislation, or the adressee for potential questions about the legislation once it is published.
   * @return all legislationResponsible properties as {@link java.util.Collection} or an empty collection 
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @NotNull public Legislation build() {
      return new Legislation(myData);
    }
    /**
     * An identifier for the legislation. This can be either a string-based identifier, like the CELEX at EU level or the NOR in France, or a web-based, URL/URI identifier, like an ELI (European Legislation Identifier) or an URN-Lex.
     ...
     */
    @NotNull public Builder legislationIdentifier(@NotNull Identifier identifier) {
      putValue("legislationIdentifier", identifier);
      return this;
    }
    /**
     * Remove legislationIdentifier property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLegislationIdentifier() {
      removeValue("legislationIdentifier");
      return this;
    }
    /**
     * Get currently set value for legislationIdentifier property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLegislationIdentifier() {
      return myData.get("legislationIdentifier");
    }
    /**
     * The date of adoption or signature of the legislation. This is the date at which the text is officially aknowledged to be a legislation, even though it might not even be published or in force.
    ...
    /**
     * Remove legislationDate property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLegislationDate() {
      removeValue("legislationDate");
      return this;
    }
    /**
     * Get currently set value for legislationDate property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLegislationDate() {
      return myData.get("legislationDate");
    }
    /**
     * The jurisdiction from which the legislation originates.
     ...
     * @return this builder instance
     */
    @NotNull public Builder legislationJurisdiction(@NotNull Jurisdiction jurisdiction) {
      putValue("legislationJurisdiction", jurisdiction);
      return this;
    }
    /**
     * Remove legislationJurisdiction property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLegislationJurisdiction() {
      removeValue("legislationJurisdiction");
      return this;
    }
    /**
     * Get currently set value for legislationJurisdiction property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLegislationJurisdiction() {
      return myData.get("legislationJurisdiction");
    }
    /**
     * Indicates a legal jurisdiction, e.g. of some legislation, or where some government service is based.
     * @param jurisdiction value to set
     ...
     * @return this builder instance
     */
    @NotNull public Builder legislationType(@NotNull Genre genre) {
      putValue("legislationType", genre);
      return this;
    }
    /**
     * Remove legislationType property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLegislationType() {
      removeValue("legislationType");
      return this;
    }
    /**
     * Get currently set value for legislationType property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLegislationType() {
      return myData.get("legislationType");
    }
    /**
     * Whether the legislation is currently in force, not in force, or partially in force.
     * @param legalForceStatus value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove legislationLegalForce property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLegislationLegalForce() {
      removeValue("legislationLegalForce");
      return this;
    }
    /**
     * Get currently set value for legislationLegalForce property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLegislationLegalForce() {
      return myData.get("legislationLegalForce");
    }
    /**
     * The point-in-time at which the provided description of the legislation is valid (e.g. : when looking at the law on the 2016-04-07 (= dateVersion), I get the consolidation of 2015-04-12 of the &quot;National Insurance Contributions Act 2015&quot;)
     ...
     * @return this builder instance
     */
    @NotNull public Builder legislationDateVersion(@NotNull java.util.Date date) {
      putValue("legislationDateVersion", date);
      return this;
    }
    /**
     * Remove legislationDateVersion property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLegislationDateVersion() {
      removeValue("legislationDateVersion");
      return this;
    }
    /**
     * Get currently set value for legislationDateVersion property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLegislationDateVersion() {
      return myData.get("legislationDateVersion");
    }
    /**
     * Indicates that this legislation (or part of legislation) fulfills the objectives set by another legislation, by passing appropriate implementation measures. Typically, some legislations of European Union's member states or regions transpose European Directives. This indicates a legally binding link between the 2 legislations.
     * @param legislationApplies value to set
     * @return this builder instance
     */
    @NotNull public Builder legislationTransposes(@NotNull LegislationApplies legislationApplies) {
      putValue("legislationTransposes", legislationApplies);
      return this;
    }
    /**
     * Remove legislationTransposes property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLegislationTransposes() {
      removeValue("legislationTransposes");
      return this;
    }
    /**
     * Get currently set value for legislationTransposes property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLegislationTransposes() {
      return myData.get("legislationTransposes");
    }
    /**
     * Indicates that this legislation (or part of a legislation) somehow transfers another legislation in a different legislative context. This is an informative link, and it has no legal value. For legally-binding links of transposition, use the &lt;a href=&quot;/legislationTransposes&quot;&gt;legislationTransposes&lt;/a&gt; property. For example an informative consolidated law of a European Union's member state &quot;applies&quot; the consolidated version of the European Directive implemented in it.
     * @param legislationApplies value to set
     * @return this builder instance
     */
    @NotNull public Builder legislationApplies(@NotNull LegislationApplies legislationApplies) {
      putValue("legislationApplies", legislationApplies);
      return this;
    }
    /**
     * Remove legislationApplies property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLegislationApplies() {
      removeValue("legislationApplies");
      return this;
    }
    /**
     * Get currently set value for legislationApplies property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLegislationApplies() {
      return myData.get("legislationApplies");
    }
    /**
     * The person or organization that originally passed or made the law : typically parliament (for primary legislation) or government (for secondary legislation). This indicates the &quot;legal author&quot; of the law, as opposed to its physical author.
    ...
    /**
     * Remove legislationPassedBy property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLegislationPassedBy() {
      removeValue("legislationPassedBy");
      return this;
    }
    /**
     * Get currently set value for legislationPassedBy property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLegislationPassedBy() {
      return myData.get("legislationPassedBy");
    }
    /**
     * Another legislation that this legislation changes. This encompasses the notions of amendment, replacement, correction, repeal, or other types of change. This may be a direct change (textual or non-textual amendment) or a consequential or indirect change. The property is to be used to express the existence of a change relationship between two acts rather than the existence of a consolidated version of the text that shows the result of the change. For consolidation relationships, use the &lt;a href=&quot;/legislationConsolidates&quot;&gt;legislationConsolidates&lt;/a&gt; property.
     * @param legislation value to set
     * @return this builder instance
     */
    @NotNull public Builder legislationChanges(@NotNull Legislation legislation) {
      putValue("legislationChanges", legislation);
      return this;
    }
    /**
     * Another legislation that this legislation changes. This encompasses the notions of amendment, replacement, correction, repeal, or other types of change. This may be a direct change (textual or non-textual amendment) or a consequential or indirect change. The property is to be used to express the existence of a change relationship between two acts rather than the existence of a consolidated version of the text that shows the result of the change. For consolidation relationships, use the &lt;a href=&quot;/legislationConsolidates&quot;&gt;legislationConsolidates&lt;/a&gt; property.
     ...
     * @return this builder instance
     */
    @NotNull public Builder legislationChanges(@NotNull Legislation.Builder legislation) {
      putValue("legislationChanges", legislation.build());
      return this;
    }
    /**
     * Remove legislationChanges property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLegislationChanges() {
      removeValue("legislationChanges");
      return this;
    }
    /**
     * Get currently set value for legislationChanges property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLegislationChanges() {
      return myData.get("legislationChanges");
    }
    /**
     * Indicates another legislation taken into account in this consolidated legislation (which is usually the product of an editorial process that revises the legislation). This property should be used multiple times to refer to both the original version or the previous consolidated version, and to the legislations making the change.
     * @param legislation value to set
     * @return this builder instance
     */
    @NotNull public Builder legislationConsolidates(@NotNull Legislation legislation) {
      putValue("legislationConsolidates", legislation);
      return this;
    }
    /**
     * Indicates another legislation taken into account in this consolidated legislation (which is usually the product of an editorial process that revises the legislation). This property should be used multiple times to refer to both the original version or the previous consolidated version, and to the legislations making the change.
     ...
     * @return this builder instance
     */
    @NotNull public Builder legislationConsolidates(@NotNull Legislation.Builder legislation) {
      putValue("legislationConsolidates", legislation.build());
      return this;
    }
    /**
     * Remove legislationConsolidates property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLegislationConsolidates() {
      removeValue("legislationConsolidates");
      return this;
    }
    /**
     * Get currently set value for legislationConsolidates property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLegislationConsolidates() {
      return myData.get("legislationConsolidates");
    }
    /**
     * An individual or organization that has some kind of responsibility for the legislation. Typically the ministry who is/was in charge of elaborating the legislation, or the adressee for potential questions about the legislation once it is published.
     ...
     * @return this builder instance
     */
    @NotNull public Builder legislationResponsible(@NotNull Organization organization) {
      putValue("legislationResponsible", organization);
      return this;
    }
    /**
     * An individual or organization that has some kind of responsibility for the legislation. Typically the ministry who is/was in charge of elaborating the legislation, or the adressee for potential questions about the legislation once it is published.
     ...
     * @return this builder instance
     */
    @NotNull public Builder legislationResponsible(@NotNull Organization.Builder organization) {
      putValue("legislationResponsible", organization.build());
      return this;
    }
    /**
     * An individual or organization that has some kind of responsibility for the legislation. Typically the ministry who is/was in charge of elaborating the legislation, or the adressee for potential questions about the legislation once it is published.
     ...
     * @return this builder instance
     */
    @NotNull public Builder legislationResponsible(@NotNull Person person) {
      putValue("legislationResponsible", person);
      return this;
    }
    /**
     * An individual or organization that has some kind of responsibility for the legislation. Typically the ministry who is/was in charge of elaborating the legislation, or the adressee for potential questions about the legislation once it is published.
     ...
     * @return this builder instance
     */
    @NotNull public Builder legislationResponsible(@NotNull Person.Builder person) {
      putValue("legislationResponsible", person.build());
      return this;
    }
    /**
     * Remove legislationResponsible property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLegislationResponsible() {
      removeValue("legislationResponsible");
      return this;
    }
    /**
     * Get currently set value for legislationResponsible property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLegislationResponsible() {
      return myData.get("legislationResponsible");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("jurisdictions".equals(key) && value instanceof Jurisdiction) { this.jurisdiction((Jurisdiction)value); return; }
      if ("legislationType".equals(key) && value instanceof Genre) { this.legislationType((Genre)value); return; }
      if ("legislationTypes".equals(key) && value instanceof Genre) { this.legislationType((Genre)value); return; }
      if ("legislationLegalForce".equals(key) && value instanceof LegalForceStatus) { this.legislationLegalForce((LegalForceStatus)value); return; }
      if ("legislationLegalForces".equals(key) && value instanceof LegalForceStatus) { this.legislationLegalForce((LegalForceStatus)value); return; }
      if ("legislationDateVersion".equals(key) && value instanceof java.util.Date) { this.legislationDateVersion((java.util.Date)value); return; }
      if ("legislationDateVersions".equals(key) && value instanceof java.util.Date) { this.legislationDateVersion((java.util.Date)value); return; }
      if ("legislationTransposes".equals(key) && value instanceof LegislationApplies) { this.legislationTransposes((LegislationApplies)value); return; }
      ...
      if ("legislationConsolidatess".equals(key) && value instanceof Legislation) { this.legislationConsolidates((Legislation)value); return; }
      if ("legislationResponsible".equals(key) && value instanceof Organization) { this.legislationResponsible((Organization)value); return; }
      if ("legislationResponsibles".equals(key) && value instanceof Organization) { this.legislationResponsible((Organization)value); return; }
      if ("legislationResponsible".equals(key) && value instanceof Person) { this.legislationResponsible((Person)value); return; }
      if ("legislationResponsibles".equals(key) && value instanceof Person) { this.legislationResponsible((Person)value); return; }
