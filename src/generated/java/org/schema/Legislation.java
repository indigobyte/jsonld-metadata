...
/**
 * A legal document such as an act, decree, bill, etc. (enforceable or not) or a component of a legal act (like an article).Source: https://github.com/schemaorg/schemaorg/issues/1156
 */
public class Legislation extends CreativeWork implements LegislationApplies {
  /**
   ...
   */
  @JsonIgnore public CategoryCode getLegislationTypeCategoryCode() {
    return (CategoryCode) getValue("legislationType");
  }
  /**
   * The type of the legislation. Examples of values are &quot;law&quot;, &quot;act&quot;, &quot;directive&quot;, &quot;decree&quot;, &quot;regulation&quot;, &quot;statutory instrument&quot;, &quot;loi organique&quot;, &quot;r&egrave;glement grand-ducal&quot;, etc., depending on the country.
   */
  @JsonIgnore public Collection<CategoryCode> getLegislationTypeCategoryCodes() {
   ...
   * The type of the legislation. Examples of values are &quot;law&quot;, &quot;act&quot;, &quot;directive&quot;, &quot;decree&quot;, &quot;regulation&quot;, &quot;statutory instrument&quot;, &quot;loi organique&quot;, &quot;r&egrave;glement grand-ducal&quot;, etc., depending on the country.
   */
  @JsonIgnore public String getLegislationTypeString() {
    return (String) getValue("legislationType");
  }
  /**
   * The type of the legislation. Examples of values are &quot;law&quot;, &quot;act&quot;, &quot;directive&quot;, &quot;decree&quot;, &quot;regulation&quot;, &quot;statutory instrument&quot;, &quot;loi organique&quot;, &quot;r&egrave;glement grand-ducal&quot;, etc., depending on the country.
   */
  @JsonIgnore public Collection<String> getLegislationTypeStrings() {
    final Object current = myData.get("legislationType");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
   ...
   */
  @JsonIgnore public AdministrativeArea getLegislationJurisdictionAdministrativeArea() {
    return (AdministrativeArea) getValue("legislationJurisdiction");
  }
  /**
   * The jurisdiction from which the legislation originates.
   */
  @JsonIgnore public Collection<AdministrativeArea> getLegislationJurisdictionAdministrativeAreas() {
   ...
   * The jurisdiction from which the legislation originates.
   */
  @JsonIgnore public String getLegislationJurisdictionString() {
    return (String) getValue("legislationJurisdiction");
  }
  /**
   * The jurisdiction from which the legislation originates.
   */
  @JsonIgnore public Collection<String> getLegislationJurisdictionStrings() {
    final Object current = myData.get("legislationJurisdiction");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<String>) current;
  ...
  protected Legislation(java.util.Map<String,Object> data) {
    super(data);
  }
  ...
  public static class Builder extends CreativeWork.Builder {
     ...
     * The type of the legislation. Examples of values are &quot;law&quot;, &quot;act&quot;, &quot;directive&quot;, &quot;decree&quot;, &quot;regulation&quot;, &quot;statutory instrument&quot;, &quot;loi organique&quot;, &quot;r&egrave;glement grand-ducal&quot;, etc., depending on the country.
     */
    @NotNull public Builder legislationType(@NotNull CategoryCode categoryCode) {
      putValue("legislationType", categoryCode);
      return this;
    }
    /**
     * The type of the legislation. Examples of values are &quot;law&quot;, &quot;act&quot;, &quot;directive&quot;, &quot;decree&quot;, &quot;regulation&quot;, &quot;statutory instrument&quot;, &quot;loi organique&quot;, &quot;r&egrave;glement grand-ducal&quot;, etc., depending on the country.
     */
    @NotNull public Builder legislationType(@NotNull CategoryCode.Builder categoryCode) {
      putValue("legislationType", categoryCode.build());
      return this;
    }
    /**
     * The type of the legislation. Examples of values are &quot;law&quot;, &quot;act&quot;, &quot;directive&quot;, &quot;decree&quot;, &quot;regulation&quot;, &quot;statutory instrument&quot;, &quot;loi organique&quot;, &quot;r&egrave;glement grand-ducal&quot;, etc., depending on the country.
     */
    @NotNull public Builder legislationType(@NotNull String legislationType) {
      putValue("legislationType", legislationType);
      return this;
    }
    /**
     * An identifier for the legislation. This can be either a string-based identifier, like the CELEX at EU level or the NOR in France, or a web-based, URL/URI identifier, like an ELI (European Legislation Identifier) or an URN-Lex.
     ...
     * The jurisdiction from which the legislation originates.
     */
    @NotNull public Builder legislationJurisdiction(@NotNull AdministrativeArea administrativeArea) {
      putValue("legislationJurisdiction", administrativeArea);
      return this;
    }
    /**
     * The jurisdiction from which the legislation originates.
     */
    @NotNull public Builder legislationJurisdiction(@NotNull AdministrativeArea.Builder administrativeArea) {
      putValue("legislationJurisdiction", administrativeArea.build());
      return this;
    }
    /**
     * The jurisdiction from which the legislation originates.
     */
    @NotNull public Builder legislationJurisdiction(@NotNull String legislationJurisdiction) {
      putValue("legislationJurisdiction", legislationJurisdiction);
      return this;
    }
    /**
     * The point-in-time at which the provided description of the legislation is valid (e.g. : when looking at the law on the 2016-04-07 (= dateVersion), I get the consolidation of 2015-04-12 of the &quot;National Insurance Contributions Act 2015&quot;)
    ...
    @Override protected void fromMap(String key, Object value) {
      ...
      if ("legislationType".equals(key) && value instanceof CategoryCode) { this.legislationType((CategoryCode)value); return; }
      if ("legislationTypes".equals(key) && value instanceof CategoryCode) { this.legislationType((CategoryCode)value); return; }
      if ("legislationType".equals(key) && value instanceof String) { this.legislationType((String)value); return; }
      if ("legislationTypes".equals(key) && value instanceof String) { this.legislationType((String)value); return; }
      ...
      if ("legislationJurisdiction".equals(key) && value instanceof AdministrativeArea) { this.legislationJurisdiction((AdministrativeArea)value); return; }
      if ("legislationJurisdictions".equals(key) && value instanceof AdministrativeArea) { this.legislationJurisdiction((AdministrativeArea)value); return; }
      if ("legislationJurisdiction".equals(key) && value instanceof String) { this.legislationJurisdiction((String)value); return; }
      if ("legislationJurisdictions".equals(key) && value instanceof String) { this.legislationJurisdiction((String)value); return; }
