 ...
 */
public class Throat extends PhysicalExam {
  protected Throat(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Throat}
   */
  public static class Builder extends PhysicalExam.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public Throat build() {
      return new Throat(myData);
    }
    /**
