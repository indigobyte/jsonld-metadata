...
public class SportsTeam extends SportsOrganization implements org.schema.Competitor {
   ...
   * @return coach property set by first invocation of coach method or {@code null}.
   */
  @JsonIgnore public Person getCoach() {
    return (Person) getValue("coach");
  }
  /**
   * A person that acts in a coaching role for a sports team.
   * @return all coach properties as {@link java.util.Collection} or an empty collection 
   * if coach was not set.
   */
   ...
   * @return athlete property set by first invocation of athlete method or {@code null}.
   */
  @JsonIgnore public Person getAthlete() {
    return (Person) getValue("athlete");
  }
  /**
   * A person that acts as performing member of a sports team; a player as opposed to a coach.
   * @return all athlete properties as {@link java.util.Collection} or an empty collection 
   * if athlete was not set.
   */
  ...
  public static class Builder extends SportsOrganization.Builder {
     ...
     */
    @NotNull public Builder coach(@NotNull Person person) {
      putValue("coach", person);
      return this;
    }
    /**
     * A person that acts in a coaching role for a sports team.
     ...
     * @return this builder instance
     */
    @NotNull public Builder coach(@NotNull Person.Builder person) {
      putValue("coach", person.build());
      return this;
    }
    /**
     * Remove coach property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCoach() {
      removeValue("coach");
      return this;
    }
    /**
     * Get currently set value for coach property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCoach() {
      return myData.get("coach");
    }
    /**
     * A person that acts as performing member of a sports team; a player as opposed to a coach.
     * @param person value to set
     * @return this builder instance
     */
    @NotNull public Builder athlete(@NotNull Person person) {
      putValue("athlete", person);
      return this;
    }
    /**
     * A person that acts as performing member of a sports team; a player as opposed to a coach.
     ...
     * @return this builder instance
     */
    @NotNull public Builder athlete(@NotNull Person.Builder person) {
      putValue("athlete", person.build());
      return this;
    }
    /**
     * Remove athlete property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAthlete() {
      removeValue("athlete");
      return this;
    }
    /**
     * Get currently set value for athlete property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAthlete() {
      return myData.get("athlete");
    }
    /**
     * Gender of something, typically a [[Person]], but possibly also fictional characters, animals, etc. While http://schema.org/Male and http://schema.org/Female may be used, text strings are also acceptable for people who do not identify as a binary gender. The [[gender]] property can also be used in an extended sense to cover e.g. the gender of sports teams. As with the gender of individuals, we do not try to enumerate all possibilities. A mixed-gender [[SportsTeam]] can be indicated with a text value of &quot;Mixed&quot;.
