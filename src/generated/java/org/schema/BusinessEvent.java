...
public class BusinessEvent extends Event {
  protected BusinessEvent(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link BusinessEvent}
   */
  public static class Builder extends Event.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public BusinessEvent build() {
      return new BusinessEvent(myData);
    }
    /**
