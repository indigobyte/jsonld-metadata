...
public class Collection extends CreativeWork {
   ...
   * @return collectionSize property set by first invocation of collectionSize method or {@code null}.
   */
  @JsonIgnore public Integer getCollectionSize() {
    return (Integer) getValue("collectionSize");
  }
  /**
   * The number of items in the [[Collection]].
   * @return all collectionSize properties as {@link java.util.Collection} or an empty collection 
   * if collectionSize was not set.
   */
  @JsonIgnore public java.util.Collection<Integer> getCollectionSizes() {
    final java.lang.Object current = myData.get("collectionSize");
  ...
  protected Collection(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @NotNull public Collection build() {
      return new Collection(myData);
    }
    /**
     * The number of items in the [[Collection]].
     ...
     */
    @NotNull public Builder collectionSize(@NotNull Integer integer) {
      putValue("collectionSize", integer);
      return this;
    }
    /**
     * Remove collectionSize property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCollectionSize() {
      removeValue("collectionSize");
      return this;
    }
    /**
     * Get currently set value for collectionSize property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCollectionSize() {
      return myData.get("collectionSize");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("collectionSize".equals(key) && value instanceof Integer) { this.collectionSize((Integer)value); return; }
      if ("collectionSizes".equals(key) && value instanceof Integer) { this.collectionSize((Integer)value); return; }
