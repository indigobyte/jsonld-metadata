...
public class MedicalCause extends MedicalEntity {
   ...
   * @return causeOf property set by first invocation of causeOf method or {@code null}.
   */
  @JsonIgnore public MedicalEntity getCauseOf() {
    return (MedicalEntity) getValue("causeOf");
  }
  /**
   * The condition, complication, symptom, sign, etc. caused.
   * @return all causeOf properties as {@link java.util.Collection} or an empty collection 
   * if causeOf was not set.
   */
  ...
  public static class Builder extends MedicalEntity.Builder {
    ...
    @NotNull public MedicalCause build() {
      return new MedicalCause(myData);
    }
    /**
     * The condition, complication, symptom, sign, etc. caused.
     ...
     */
    @NotNull public Builder causeOf(@NotNull MedicalEntity medicalEntity) {
      putValue("causeOf", medicalEntity);
      return this;
    }
    /**
     * The condition, complication, symptom, sign, etc. caused.
     ...
     * @return this builder instance
     */
    @NotNull public Builder causeOf(@NotNull MedicalEntity.Builder medicalEntity) {
      putValue("causeOf", medicalEntity.build());
      return this;
    }
    /**
     * Remove causeOf property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCauseOf() {
      removeValue("causeOf");
      return this;
    }
    /**
     * Get currently set value for causeOf property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCauseOf() {
      return myData.get("causeOf");
    }
    /**
