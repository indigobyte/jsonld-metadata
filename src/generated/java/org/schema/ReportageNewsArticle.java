...
public class ReportageNewsArticle extends NewsArticle {
  protected ReportageNewsArticle(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link ReportageNewsArticle}
   */
  public static class Builder extends NewsArticle.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public ReportageNewsArticle build() {
      return new ReportageNewsArticle(myData);
    }
    /**
