...
/**
 * A medical procedure intended primarily for therapeutic purposes, aimed at improving a health condition.Equivalent class: http://purl.bioontology.org/ontology/SNOMEDCT/277132007
 */
public class TherapeuticProcedure extends MedicalProcedure {
  ...
  public static class Builder extends MedicalProcedure.Builder {
    ...
    @NotNull public TherapeuticProcedure build() {
      return new TherapeuticProcedure(myData);
    }
    /**
     * Specifying a drug or medicine used in a medication procedure.
