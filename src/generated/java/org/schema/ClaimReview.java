...
public class ClaimReview extends Review {
   ...
   * @return claimReviewed property set by first invocation of claimReviewed method or {@code null}.
   */
  ...
  /**
   * A short summary of the specific claims reviewed in a ClaimReview.
   * @return all claimReviewed properties as {@link java.util.Collection} or an empty collection 
   * if claimReviewed was not set.
   */
  @JsonIgnore public java.util.Collection<String> getClaimRevieweds() {
    final java.lang.Object current = myData.get("claimReviewed");
  ...
  protected ClaimReview(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends Review.Builder {
    ...
    /**
     * A short summary of the specific claims reviewed in a ClaimReview.
     * @param claimReviewed value to set
    ...
    /**
     * Remove claimReviewed property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeClaimReviewed() {
      removeValue("claimReviewed");
      return this;
    }
    /**
     * Get currently set value for claimReviewed property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getClaimReviewed() {
      return myData.get("claimReviewed");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("claimReviewed".equals(key) && value instanceof String) { this.claimReviewed((String)value); return; }
      if ("claimRevieweds".equals(key) && value instanceof String) { this.claimReviewed((String)value); return; }
