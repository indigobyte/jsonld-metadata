 ...
 */
public class Otolaryngologic extends MedicalBusiness {
  protected Otolaryngologic(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends MedicalBusiness.Builder {
    ...
    @NotNull public Otolaryngologic build() {
      return new Otolaryngologic(myData);
    }
    /**
