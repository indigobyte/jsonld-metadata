...
public class Audience extends Intangible implements org.schema.Recipient {
   ...
   * @return audienceType property set by first invocation of audienceType method or {@code null}.
   */
  ...
  /**
   * The target group associated with a given audience (e.g. veterans, car owners, musicians, etc.).
   * @return all audienceType properties as {@link java.util.Collection} or an empty collection 
   * if audienceType was not set.
   */
   ...
   * @return geographicArea property set by first invocation of geographicArea method or {@code null}.
   */
  ...
  /**
   * The geographic area associated with the audience.
   * @return all geographicArea properties as {@link java.util.Collection} or an empty collection 
   * if geographicArea was not set.
   */
  ...
  public static class Builder extends Intangible.Builder {
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("geographicAreas".equals(key) && value instanceof AdministrativeArea) { this.geographicArea((AdministrativeArea)value); return; }
