...
public class LoseAction extends AchieveAction {
  @JsonIgnore public Winner getWinner() {
    return (Winner) getValue("winner");
  }
  @JsonIgnore public Collection<Winner> getWinners() {
    final Object current = myData.get("winner");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<Winner>) current;
    }
    return Arrays.asList((Winner) current);
  }
  ...
  public static class Builder extends AchieveAction.Builder {
    ...
    @NotNull public Builder winner(@NotNull Winner winner) {
      putValue("winner", winner);
      return this;
    }
    /**
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("winner".equals(key) && value instanceof Winner) { winner((Winner)value); return; }
      if ("winners".equals(key) && value instanceof Winner) { winner((Winner)value); return; }
