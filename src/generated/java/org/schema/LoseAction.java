...
public class LoseAction extends AchieveAction {
   ...
   * @return winner property set by first invocation of winner method or {@code null}.
   */
  @JsonIgnore public Participant getWinner() {
    return (Participant) getValue("winner");
  }
  /**
   * A sub property of participant. The winner of the action.
   * @return all winner properties as {@link java.util.Collection} or an empty collection 
   * if winner was not set.
   */
  @JsonIgnore public java.util.Collection<Participant> getWinners() {
    final java.lang.Object current = myData.get("winner");
  ...
  protected LoseAction(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends AchieveAction.Builder {
     ...
     */
    @NotNull public Builder winner(@NotNull Participant participant) {
      putValue("winner", participant);
      return this;
    }
    /**
     * Remove winner property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeWinner() {
      removeValue("winner");
      return this;
    }
    /**
     * Get currently set value for winner property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getWinner() {
      return myData.get("winner");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("winner".equals(key) && value instanceof Participant) { this.winner((Participant)value); return; }
      if ("winners".equals(key) && value instanceof Participant) { this.winner((Participant)value); return; }
