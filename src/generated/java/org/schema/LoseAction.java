...
public class LoseAction extends AchieveAction {
   ...
   */
  @JsonIgnore public Person getWinner() {
    return (Person) getValue("winner");
  }
  /**
   * A sub property of participant. The winner of the action.
   */
  @JsonIgnore public Collection<Person> getWinners() {
  ...
  protected LoseAction(java.util.Map<String,Object> data) {
    super(data);
  }
  ...
  public static class Builder extends AchieveAction.Builder {
     ...
     * A sub property of participant. The winner of the action.
     */
    @NotNull public Builder winner(@NotNull Person person) {
      putValue("winner", person);
      return this;
    }
    /**
     * A sub property of participant. The winner of the action.
     */
    @NotNull public Builder winner(@NotNull Person.Builder person) {
      putValue("winner", person.build());
      return this;
    }
    /**
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("winner".equals(key) && value instanceof Person) { this.winner((Person)value); return; }
      if ("winners".equals(key) && value instanceof Person) { this.winner((Person)value); return; }
