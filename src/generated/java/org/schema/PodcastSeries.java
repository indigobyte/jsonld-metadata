...
/**
 * A podcast is an episodic series of digital audio or video files which a user can download and listen to.Source: https://github.com/schemaorg/schemaorg/issues/373
 */
public class PodcastSeries extends CreativeWorkSeries {
  ...
  protected PodcastSeries(java.util.Map<String,Object> data) {
    super(data);
  }
