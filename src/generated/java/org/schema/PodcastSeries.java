...
public class PodcastSeries extends CreativeWorkSeries {
   ...
   * @return webFeed property set by first invocation of webFeed method or {@code null}.
   */
  ...
  /**
   * The URL for a feed, e.g. associated with a podcast series, blog, or series of date-stamped updates. This is usually RSS or Atom.
   * @return all webFeed properties as {@link java.util.Collection} or an empty collection 
   * if webFeed was not set.
   */
  @JsonIgnore public java.util.Collection<DataFeed> getWebFeedDataFeeds() {
    final java.lang.Object current = myData.get("webFeed");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected PodcastSeries(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link PodcastSeries}
   */
  public static class Builder extends CreativeWorkSeries.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public PodcastSeries build() {
      return new PodcastSeries(myData);
    }
    /**
     * An actor, e.g. in tv, radio, movie, video games etc., or in an event. Actors can be associated with individual items or with a series, episode, clip.
    ...
    /**
     * Remove webFeed property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeWebFeed() {
      removeValue("webFeed");
      return this;
    }
    /**
     * Get currently set value for webFeed property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getWebFeed() {
      return myData.get("webFeed");
    }
    /**
