...
public class FinancialProduct extends Service {
   ...
   * @return interestRate property set by first invocation of interestRate method or {@code null}.
   */
  @JsonIgnore public Integer getInterestRateInteger() {
    return (Integer) getValue("interestRate");
  }
  /**
   * The interest rate, charged or paid, applicable to the financial product. Note: This is different from the calculated annualPercentageRate.
   * @return all interestRate properties as {@link java.util.Collection} or an empty collection 
   * if interestRate was not set.
   */
   ...
   * @return interestRate property set by first invocation of interestRate method or {@code null}.
   */
  @JsonIgnore public Long getInterestRateLong() {
    return (Long) getValue("interestRate");
  }
  /**
   * The interest rate, charged or paid, applicable to the financial product. Note: This is different from the calculated annualPercentageRate.
   * @return all interestRate properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return interestRate property set by first invocation of interestRate method or {@code null}.
   */
  @JsonIgnore public Float getInterestRateFloat() {
    return (Float) getValue("interestRate");
  }
  /**
   * The interest rate, charged or paid, applicable to the financial product. Note: This is different from the calculated annualPercentageRate.
   * @return all interestRate properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return interestRate property set by first invocation of interestRate method or {@code null}.
   */
  @JsonIgnore public Double getInterestRateDouble() {
    return (Double) getValue("interestRate");
  }
  /**
   * The interest rate, charged or paid, applicable to the financial product. Note: This is different from the calculated annualPercentageRate.
   * @return all interestRate properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return interestRate property set by first invocation of interestRate method or {@code null}.
   */
  @JsonIgnore public String getInterestRateString() {
    return (String) getValue("interestRate");
  }
  /**
   * The interest rate, charged or paid, applicable to the financial product. Note: This is different from the calculated annualPercentageRate.
   * @return all interestRate properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return feesAndCommissionsSpecification property set by first invocation of feesAndCommissionsSpecification method or {@code null}.
   */
  ...
  /**
   * Description of fees, commissions, and other terms applied either to a class of financial product, or by a financial service organization.
   * @return all feesAndCommissionsSpecification properties as {@link java.util.Collection} or an empty collection 
   * if feesAndCommissionsSpecification was not set.
   */
   ...
   * @return annualPercentageRate property set by first invocation of annualPercentageRate method or {@code null}.
   */
  ...
  /**
   * The annual rate that is charged for borrowing (or made by investing), expressed as a single percentage number that represents the actual yearly cost of funds over the term of a loan. This includes any fees or additional costs associated with the transaction.
   * @return all annualPercentageRate properties as {@link java.util.Collection} or an empty collection 
   * if annualPercentageRate was not set.
   */
  ...
  public static class Builder extends Service.Builder {
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("interestRates".equals(key) && value instanceof Long) { this.interestRate((Long)value); return; }
      if ("interestRate".equals(key) && value instanceof Float) { this.interestRate((Float)value); return; }
      if ("interestRates".equals(key) && value instanceof Float) { this.interestRate((Float)value); return; }
      if ("interestRate".equals(key) && value instanceof Double) { this.interestRate((Double)value); return; }
      if ("interestRates".equals(key) && value instanceof Double) { this.interestRate((Double)value); return; }
      if ("interestRate".equals(key) && value instanceof String) { this.interestRate((String)value); return; }
      if ("interestRates".equals(key) && value instanceof String) { this.interestRate((String)value); return; }
