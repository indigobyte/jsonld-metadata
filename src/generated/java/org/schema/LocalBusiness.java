...
public class LocalBusiness extends Place {
   ...
   * @return currenciesAccepted property set by first invocation of currenciesAccepted method or {@code null}.
   */
  @JsonIgnore public String getCurrenciesAccepted() {
    return (String) getValue("currenciesAccepted");
  }
  /**
   * The currency accepted.\n\nUse standard formats: [ISO 4217 currency format](http://en.wikipedia.org/wiki/ISO_4217) e.g. &quot;USD&quot;; [Ticker symbol](https://en.wikipedia.org/wiki/List_of_cryptocurrencies) for cryptocurrencies e.g. &quot;BTC&quot;; well known names for [Local Exchange Tradings Systems](https://en.wikipedia.org/wiki/Local_exchange_trading_system) (LETS) and other currency types e.g. &quot;Ithaca HOUR&quot;.
   * @return all currenciesAccepted properties as {@link java.util.Collection} or an empty collection 
   * if currenciesAccepted was not set.
   */
  @JsonIgnore public java.util.Collection<String> getCurrenciesAccepteds() {
    final java.lang.Object current = myData.get("currenciesAccepted");
   ...
   * @return paymentAccepted property set by first invocation of paymentAccepted method or {@code null}.
   */
  @JsonIgnore public String getPaymentAccepted() {
    return (String) getValue("paymentAccepted");
  }
  /**
   * Cash, Credit Card, Cryptocurrency, Local Exchange Tradings System, etc.
   * @return all paymentAccepted properties as {@link java.util.Collection} or an empty collection 
   * if paymentAccepted was not set.
   */
  @JsonIgnore public java.util.Collection<String> getPaymentAccepteds() {
    final java.lang.Object current = myData.get("paymentAccepted");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
   ...
   * @return priceRange property set by first invocation of priceRange method or {@code null}.
   */
  @JsonIgnore public String getPriceRange() {
    return (String) getValue("priceRange");
  }
  /**
   * The price range of the business, for example ```$$$```.
   * @return all priceRange properties as {@link java.util.Collection} or an empty collection 
   * if priceRange was not set.
   */
  @JsonIgnore public java.util.Collection<String> getPriceRanges() {
    final java.lang.Object current = myData.get("priceRange");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
   ...
   * @return openingHours property set by first invocation of openingHours method or {@code null}.
   */
  @JsonIgnore public String getOpeningHours() {
    return (String) getValue("openingHours");
  }
  /**
   * The general opening hours for a business. Opening hours can be specified as a weekly time range, starting with days, then times per day. Multiple days can be listed with commas ',' separating each day. Day or time ranges are specified using a hyphen '-'.\n\n* Days are specified using the following two-letter combinations: ```Mo```, ```Tu```, ```We```, ```Th```, ```Fr```, ```Sa```, ```Su```.\n* Times are specified using 24:00 format. For example, 3pm is specified as ```15:00```, 10am as ```10:00```. \n* Here is an example: &lt;code&gt;&amp;lt;time itemprop=&quot;openingHours&quot; datetime=&amp;quot;Tu,Th 16:00-20:00&amp;quot;&amp;gt;Tuesdays and Thursdays 4-8pm&amp;lt;/time&amp;gt;&lt;/code&gt;.\n* If a business is open 7 days a week, then it can be specified as &lt;code&gt;&amp;lt;time itemprop=&amp;quot;openingHours&amp;quot; datetime=&amp;quot;Mo-Su&amp;quot;&amp;gt;Monday through Sunday, all day&amp;lt;/time&amp;gt;&lt;/code&gt;.
   * @return all openingHours properties as {@link java.util.Collection} or an empty collection 
   * if openingHours was not set.
   */
  @JsonIgnore public java.util.Collection<String> getOpeningHourss() {
    final java.lang.Object current = myData.get("openingHours");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
  ...
  protected LocalBusiness(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends Place.Builder {
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("currenciesAccepted".equals(key) && value instanceof String) { this.currenciesAccepted((String)value); return; }
      if ("currenciesAccepteds".equals(key) && value instanceof String) { this.currenciesAccepted((String)value); return; }
      if ("paymentAccepted".equals(key) && value instanceof String) { this.paymentAccepted((String)value); return; }
      if ("paymentAccepteds".equals(key) && value instanceof String) { this.paymentAccepted((String)value); return; }
      if ("priceRange".equals(key) && value instanceof String) { this.priceRange((String)value); return; }
      if ("priceRanges".equals(key) && value instanceof String) { this.priceRange((String)value); return; }
      if ("openingHours".equals(key) && value instanceof String) { this.openingHours((String)value); return; }
      if ("openingHourss".equals(key) && value instanceof String) { this.openingHours((String)value); return; }
