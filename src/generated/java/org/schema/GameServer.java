...
public class GameServer extends Intangible {
   ...
   * @return serverStatus property set by first invocation of serverStatus method or {@code null}.
   */
  ...
  /**
   * Status of a game server.
   * @return all serverStatus properties as {@link java.util.Collection} or an empty collection 
   * if serverStatus was not set.
   */
  @JsonIgnore public java.util.Collection<GameServerStatus> getServerStatuss() {
    final java.lang.Object current = myData.get("serverStatus");
   ...
   * @return playersOnline property set by first invocation of playersOnline method or {@code null}.
   */
  ...
  /**
   * Number of players on the server.
   * @return all playersOnline properties as {@link java.util.Collection} or an empty collection 
   * if playersOnline was not set.
   */
  @JsonIgnore public java.util.Collection<Integer> getPlayersOnlines() {
    final java.lang.Object current = myData.get("playersOnline");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return game property set by first invocation of game method or {@code null}.
   */
  ...
  /**
   * Video game which is played on this server.
   * @return all game properties as {@link java.util.Collection} or an empty collection 
   * if game was not set.
   */
  @JsonIgnore public java.util.Collection<VideoGame> getGames() {
    final java.lang.Object current = myData.get("game");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected GameServer(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends Intangible.Builder {
    ...
    /**
     * Status of a game server.
     * @param gameServerStatus value to set
    ...
    /**
     * Remove serverStatus property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeServerStatus() {
      removeValue("serverStatus");
      return this;
    }
    /**
     * Get currently set value for serverStatus property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getServerStatus() {
      return myData.get("serverStatus");
    }
    /**
     * Number of players on the server.
    ...
    /**
     * Remove playersOnline property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePlayersOnline() {
      removeValue("playersOnline");
      return this;
    }
    /**
     * Get currently set value for playersOnline property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPlayersOnline() {
      return myData.get("playersOnline");
    }
    /**
     * Video game which is played on this server.
     * @param videoGame value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove game property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeGame() {
      removeValue("game");
      return this;
    }
    /**
     * Get currently set value for game property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getGame() {
      return myData.get("game");
    }
    /**
