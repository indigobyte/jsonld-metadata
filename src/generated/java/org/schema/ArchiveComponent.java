...
public class ArchiveComponent extends CreativeWork {
   ...
   * @return itemLocation property set by first invocation of itemLocation method or {@code null}.
   */
  ...
  /**
   * Current location of the item.
   * @return all itemLocation properties as {@link java.util.Collection} or an empty collection 
   * if itemLocation was not set.
   */
  @JsonIgnore public java.util.Collection<Location> getItemLocations() {
    final java.lang.Object current = myData.get("itemLocation");
   ...
   * @return holdingArchive property set by first invocation of holdingArchive method or {@code null}.
   */
  @JsonIgnore public ArchiveOrganization getHoldingArchive() {
    return (ArchiveOrganization) getValue("holdingArchive");
  }
  /**
   * [[ArchiveOrganization]] that holds, keeps or maintains the [[ArchiveComponent]].
   * @return all holdingArchive properties as {@link java.util.Collection} or an empty collection 
   * if holdingArchive was not set.
   */
  @JsonIgnore public java.util.Collection<ArchiveOrganization> getHoldingArchives() {
    final java.lang.Object current = myData.get("holdingArchive");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected ArchiveComponent(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link ArchiveComponent}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public ArchiveComponent build() {
      return new ArchiveComponent(myData);
    }
    /**
     * Current location of the item.
    ...
    /**
     * Remove itemLocation property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeItemLocation() {
      removeValue("itemLocation");
      return this;
    }
    /**
     * Get currently set value for itemLocation property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getItemLocation() {
      return myData.get("itemLocation");
    }
    /**
     * [[ArchiveOrganization]] that holds, keeps or maintains the [[ArchiveComponent]].
     * @param archiveOrganization value to set
     * @return this builder instance
     */
    @NotNull public Builder holdingArchive(@NotNull ArchiveOrganization archiveOrganization) {
      putValue("holdingArchive", archiveOrganization);
      return this;
    }
    /**
     * [[ArchiveOrganization]] that holds, keeps or maintains the [[ArchiveComponent]].
     ...
     * @return this builder instance
     */
    @NotNull public Builder holdingArchive(@NotNull ArchiveOrganization.Builder archiveOrganization) {
      putValue("holdingArchive", archiveOrganization.build());
      return this;
    }
    /**
     * Remove holdingArchive property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeHoldingArchive() {
      removeValue("holdingArchive");
      return this;
    }
    /**
     * Get currently set value for holdingArchive property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getHoldingArchive() {
      return myData.get("holdingArchive");
    }
    /**
