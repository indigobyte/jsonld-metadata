...
/**
 * An intangible type to be applied to any archive content, carrying with it a set of properties required to describe archival items and collections.Source: https://github.com/schemaorg/schemaorg/issues/1758
 */
public class ArchiveComponent extends CreativeWork {
  ...
  protected ArchiveComponent(java.util.Map<String,Object> data) {
    super(data);
  }
