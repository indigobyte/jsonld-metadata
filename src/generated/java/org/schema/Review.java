 ...
 */
public class Review extends CreativeWork implements org.schema.AssociatedReview {
  /**
   ...
   * @return positiveNotes property set by first invocation of positiveNotes method or {@code null}.
   */
  @JsonIgnore public ItemList getPositiveNotesItemList() {
    return (ItemList) getValue("positiveNotes");
  }
  /**
   * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), positive considerations - either as unstructured text, or a list.
   * @return all positiveNotes properties as {@link java.util.Collection} or an empty collection 
   * if positiveNotes was not set.
   */
  @JsonIgnore public java.util.Collection<ItemList> getPositiveNotesItemLists() {
    final java.lang.Object current = myData.get("positiveNotes");
   ...
   * @return positiveNotes property set by first invocation of positiveNotes method or {@code null}.
   */
  @JsonIgnore public ListItem getPositiveNotesListItem() {
    return (ListItem) getValue("positiveNotes");
  }
  /**
   * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), positive considerations - either as unstructured text, or a list.
   * @return all positiveNotes properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return positiveNotes property set by first invocation of positiveNotes method or {@code null}.
   */
  @JsonIgnore public String getPositiveNotesString() {
    return (String) getValue("positiveNotes");
  }
  /**
   * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), positive considerations - either as unstructured text, or a list.
   * @return all positiveNotes properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return positiveNotes property set by first invocation of positiveNotes method or {@code null}.
   */
  @JsonIgnore public WebContent getPositiveNotesWebContent() {
    return (WebContent) getValue("positiveNotes");
  }
  /**
   * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), positive considerations - either as unstructured text, or a list.
   * @return all positiveNotes properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return associatedMediaReview property set by first invocation of associatedMediaReview method or {@code null}.
   */
  @JsonIgnore public AssociatedReview getAssociatedMediaReview() {
    return (AssociatedReview) getValue("associatedMediaReview");
  }
  /**
   * An associated [[MediaReview]], related by specific common content, topic or claim. The expectation is that this property would be most typically used in cases where a single activity is conducting both claim reviews and media reviews, in which case [[relatedMediaReview]] would commonly be used on a [[ClaimReview]], while [[relatedClaimReview]] would be used on [[MediaReview]].
   * @return all associatedMediaReview properties as {@link java.util.Collection} or an empty collection 
   * if associatedMediaReview was not set.
   */
  @JsonIgnore public java.util.Collection<AssociatedReview> getAssociatedMediaReviews() {
    final java.lang.Object current = myData.get("associatedMediaReview");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return associatedReview property set by first invocation of associatedReview method or {@code null}.
   */
  @JsonIgnore public AssociatedReview getAssociatedReview() {
    return (AssociatedReview) getValue("associatedReview");
  }
  /**
   * An associated [[Review]].
   * @return all associatedReview properties as {@link java.util.Collection} or an empty collection 
   * if associatedReview was not set.
   */
  @JsonIgnore public java.util.Collection<AssociatedReview> getAssociatedReviews() {
    final java.lang.Object current = myData.get("associatedReview");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<AssociatedReview>) current;
    }
   ...
   * @return reviewBody property set by first invocation of reviewBody method or {@code null}.
   */
  @JsonIgnore public String getReviewBody() {
    return (String) getValue("reviewBody");
  }
  /**
   * The actual body of the review.
   * @return all reviewBody properties as {@link java.util.Collection} or an empty collection 
   * if reviewBody was not set.
   */
  @JsonIgnore public java.util.Collection<String> getReviewBodys() {
    final java.lang.Object current = myData.get("reviewBody");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
   ...
   * @return reviewAspect property set by first invocation of reviewAspect method or {@code null}.
   */
  ...
  /**
   * This Review or Rating is relevant to this part or facet of the itemReviewed.
   * @return all reviewAspect properties as {@link java.util.Collection} or an empty collection 
   * if reviewAspect was not set.
   */
   ...
   * @return reviewRating property set by first invocation of reviewRating method or {@code null}.
   */
  @JsonIgnore public Rating getReviewRating() {
    return (Rating) getValue("reviewRating");
  }
  /**
   * The rating given in this review. Note that reviews can themselves be rated. The ```reviewRating``` applies to rating given by the review. The [[aggregateRating]] property applies to the review itself, as a creative work.
   * @return all reviewRating properties as {@link java.util.Collection} or an empty collection 
   * if reviewRating was not set.
   */
  @JsonIgnore public java.util.Collection<Rating> getReviewRatings() {
    final java.lang.Object current = myData.get("reviewRating");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return associatedClaimReview property set by first invocation of associatedClaimReview method or {@code null}.
   */
  ...
  /**
   * An associated [[ClaimReview]], related by specific common content, topic or claim. The expectation is that this property would be most typically used in cases where a single activity is conducting both claim reviews and media reviews, in which case [[relatedMediaReview]] would commonly be used on a [[ClaimReview]], while [[relatedClaimReview]] would be used on [[MediaReview]].
   * @return all associatedClaimReview properties as {@link java.util.Collection} or an empty collection 
   * if associatedClaimReview was not set.
   */
  @JsonIgnore public java.util.Collection<AssociatedReview> getAssociatedClaimReviews() {
    final java.lang.Object current = myData.get("associatedClaimReview");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<AssociatedReview>) current;
    }
   ...
   * @return negativeNotes property set by first invocation of negativeNotes method or {@code null}.
   */
  @JsonIgnore public ItemList getNegativeNotesItemList() {
    return (ItemList) getValue("negativeNotes");
  }
  /**
   * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), negative considerations - either as unstructured text, or a list.
   * @return all negativeNotes properties as {@link java.util.Collection} or an empty collection 
   * if negativeNotes was not set.
   */
  @JsonIgnore public java.util.Collection<ItemList> getNegativeNotesItemLists() {
    final java.lang.Object current = myData.get("negativeNotes");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<ItemList>) current;
    }
   ...
   * @return negativeNotes property set by first invocation of negativeNotes method or {@code null}.
   */
  @JsonIgnore public ListItem getNegativeNotesListItem() {
    return (ListItem) getValue("negativeNotes");
  }
  /**
   * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), negative considerations - either as unstructured text, or a list.
   * @return all negativeNotes properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return negativeNotes property set by first invocation of negativeNotes method or {@code null}.
   */
  @JsonIgnore public String getNegativeNotesString() {
    return (String) getValue("negativeNotes");
  }
  /**
   * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), negative considerations - either as unstructured text, or a list.
   * @return all negativeNotes properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return negativeNotes property set by first invocation of negativeNotes method or {@code null}.
   */
  @JsonIgnore public WebContent getNegativeNotesWebContent() {
    return (WebContent) getValue("negativeNotes");
  }
  /**
   * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), negative considerations - either as unstructured text, or a list.
   * @return all negativeNotes properties as {@link java.util.Collection} or an empty collection 
  ...
  protected Review(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends CreativeWork.Builder {
     ...
     */
    @NotNull public Builder positiveNotes(@NotNull ItemList itemList) {
      putValue("positiveNotes", itemList);
      return this;
    }
    /**
     * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), positive considerations - either as unstructured text, or a list.
     ...
     * @return this builder instance
     */
    @NotNull public Builder positiveNotes(@NotNull ItemList.Builder itemList) {
      putValue("positiveNotes", itemList.build());
      return this;
    }
    /**
     * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), positive considerations - either as unstructured text, or a list.
     ...
     * @return this builder instance
     */
    @NotNull public Builder positiveNotes(@NotNull ListItem listItem) {
      putValue("positiveNotes", listItem);
      return this;
    }
    /**
     * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), positive considerations - either as unstructured text, or a list.
     ...
     * @return this builder instance
     */
    @NotNull public Builder positiveNotes(@NotNull ListItem.Builder listItem) {
      putValue("positiveNotes", listItem.build());
      return this;
    }
    /**
     * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), positive considerations - either as unstructured text, or a list.
     * @param positiveNotes value to set
     * @return this builder instance
     */
    @NotNull public Builder positiveNotes(@NotNull String positiveNotes) {
      putValue("positiveNotes", positiveNotes);
      return this;
    }
    /**
     * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), positive considerations - either as unstructured text, or a list.
     * @param webContent value to set
     * @return this builder instance
     */
    @NotNull public Builder positiveNotes(@NotNull WebContent webContent) {
      putValue("positiveNotes", webContent);
      return this;
    }
    /**
     * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), positive considerations - either as unstructured text, or a list.
     ...
     * @return this builder instance
     */
    @NotNull public Builder positiveNotes(@NotNull WebContent.Builder webContent) {
      putValue("positiveNotes", webContent.build());
      return this;
    }
    /**
     * Remove positiveNotes property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePositiveNotes() {
      removeValue("positiveNotes");
      return this;
    }
    /**
     * Get currently set value for positiveNotes property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPositiveNotes() {
      return myData.get("positiveNotes");
    }
    /**
     * The item that is being reviewed/rated.
    ...
    /**
     * An associated [[MediaReview]], related by specific common content, topic or claim. The expectation is that this property would be most typically used in cases where a single activity is conducting both claim reviews and media reviews, in which case [[relatedMediaReview]] would commonly be used on a [[ClaimReview]], while [[relatedClaimReview]] would be used on [[MediaReview]].
     * @param associatedReview value to set
     * @return this builder instance
     */
    @NotNull public Builder associatedMediaReview(@NotNull AssociatedReview associatedReview) {
      putValue("associatedMediaReview", associatedReview);
      return this;
    }
    /**
     * Remove associatedMediaReview property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAssociatedMediaReview() {
      removeValue("associatedMediaReview");
      return this;
    }
    /**
     * Get currently set value for associatedMediaReview property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAssociatedMediaReview() {
      return myData.get("associatedMediaReview");
    }
    /**
     * An associated [[Review]].
     * @param associatedReview value to set
     * @return this builder instance
     */
    @NotNull public Builder associatedReview(@NotNull AssociatedReview associatedReview) {
      putValue("associatedReview", associatedReview);
      return this;
    }
    /**
     * Remove associatedReview property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAssociatedReview() {
      removeValue("associatedReview");
      return this;
    }
    /**
     * Get currently set value for associatedReview property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAssociatedReview() {
      return myData.get("associatedReview");
    }
    /**
     * The actual body of the review.
     * @param reviewBody value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove reviewBody property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeReviewBody() {
      removeValue("reviewBody");
      return this;
    }
    /**
     * Get currently set value for reviewBody property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getReviewBody() {
      return myData.get("reviewBody");
    }
    /**
     * This Review or Rating is relevant to this part or facet of the itemReviewed.
    ...
    /**
     * Remove reviewRating property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeReviewRating() {
      removeValue("reviewRating");
      return this;
    }
    /**
     * Get currently set value for reviewRating property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getReviewRating() {
      return myData.get("reviewRating");
    }
    /**
     * An associated [[ClaimReview]], related by specific common content, topic or claim. The expectation is that this property would be most typically used in cases where a single activity is conducting both claim reviews and media reviews, in which case [[relatedMediaReview]] would commonly be used on a [[ClaimReview]], while [[relatedClaimReview]] would be used on [[MediaReview]].
     * @param associatedReview value to set
    ...
    /**
     * Remove associatedClaimReview property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAssociatedClaimReview() {
      removeValue("associatedClaimReview");
      return this;
    }
    /**
     * Get currently set value for associatedClaimReview property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAssociatedClaimReview() {
      return myData.get("associatedClaimReview");
    }
    /**
     * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), negative considerations - either as unstructured text, or a list.
     * @param itemList value to set
     * @return this builder instance
     */
    @NotNull public Builder negativeNotes(@NotNull ItemList itemList) {
      putValue("negativeNotes", itemList);
      return this;
    }
    /**
     * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), negative considerations - either as unstructured text, or a list.
     ...
     * @return this builder instance
     */
    @NotNull public Builder negativeNotes(@NotNull ItemList.Builder itemList) {
      putValue("negativeNotes", itemList.build());
      return this;
    }
    /**
     * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), negative considerations - either as unstructured text, or a list.
     ...
     * @return this builder instance
     */
    @NotNull public Builder negativeNotes(@NotNull ListItem listItem) {
      putValue("negativeNotes", listItem);
      return this;
    }
    /**
     * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), negative considerations - either as unstructured text, or a list.
     ...
     * @return this builder instance
     */
    @NotNull public Builder negativeNotes(@NotNull ListItem.Builder listItem) {
      putValue("negativeNotes", listItem.build());
      return this;
    }
    /**
     * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), negative considerations - either as unstructured text, or a list.
     * @param negativeNotes value to set
     * @return this builder instance
     */
    @NotNull public Builder negativeNotes(@NotNull String negativeNotes) {
      putValue("negativeNotes", negativeNotes);
      return this;
    }
    /**
     * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), negative considerations - either as unstructured text, or a list.
     ...
     * @return this builder instance
     */
    @NotNull public Builder negativeNotes(@NotNull WebContent webContent) {
      putValue("negativeNotes", webContent);
      return this;
    }
    /**
     * Indicates, in the context of a [[Review]] (e.g. framed as 'pro' vs 'con' considerations), negative considerations - either as unstructured text, or a list.
     ...
     * @return this builder instance
     */
    @NotNull public Builder negativeNotes(@NotNull WebContent.Builder webContent) {
      putValue("negativeNotes", webContent.build());
      return this;
    }
    /**
     * Remove negativeNotes property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeNegativeNotes() {
      removeValue("negativeNotes");
      return this;
    }
    /**
     * Get currently set value for negativeNotes property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getNegativeNotes() {
      return myData.get("negativeNotes");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("positiveNotes".equals(key) && value instanceof ItemList) { this.positiveNotes((ItemList)value); return; }
      if ("positiveNotess".equals(key) && value instanceof ItemList) { this.positiveNotes((ItemList)value); return; }
      if ("positiveNotes".equals(key) && value instanceof ListItem) { this.positiveNotes((ListItem)value); return; }
      if ("positiveNotess".equals(key) && value instanceof ListItem) { this.positiveNotes((ListItem)value); return; }
      if ("positiveNotes".equals(key) && value instanceof String) { this.positiveNotes((String)value); return; }
      if ("positiveNotess".equals(key) && value instanceof String) { this.positiveNotes((String)value); return; }
      if ("positiveNotes".equals(key) && value instanceof WebContent) { this.positiveNotes((WebContent)value); return; }
      if ("positiveNotess".equals(key) && value instanceof WebContent) { this.positiveNotes((WebContent)value); return; }
      ...
      if ("associatedMediaReview".equals(key) && value instanceof AssociatedReview) { this.associatedMediaReview((AssociatedReview)value); return; }
      if ("associatedMediaReviews".equals(key) && value instanceof AssociatedReview) { this.associatedMediaReview((AssociatedReview)value); return; }
      if ("associatedReview".equals(key) && value instanceof AssociatedReview) { this.associatedReview((AssociatedReview)value); return; }
      if ("associatedReviews".equals(key) && value instanceof AssociatedReview) { this.associatedReview((AssociatedReview)value); return; }
      if ("reviewBody".equals(key) && value instanceof String) { this.reviewBody((String)value); return; }
      if ("reviewBodys".equals(key) && value instanceof String) { this.reviewBody((String)value); return; }
      ...
      if ("negativeNotess".equals(key) && value instanceof ListItem) { this.negativeNotes((ListItem)value); return; }
      if ("negativeNotes".equals(key) && value instanceof String) { this.negativeNotes((String)value); return; }
      if ("negativeNotess".equals(key) && value instanceof String) { this.negativeNotes((String)value); return; }
      if ("negativeNotes".equals(key) && value instanceof WebContent) { this.negativeNotes((WebContent)value); return; }
      if ("negativeNotess".equals(key) && value instanceof WebContent) { this.negativeNotes((WebContent)value); return; }
