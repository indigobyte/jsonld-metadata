...
public class Accommodation extends Place {
   ...
   * @return yearBuilt property set by first invocation of yearBuilt method or {@code null}.
   */
  ...
  /**
   * The year an [[Accommodation]] was constructed. This corresponds to the [YearBuilt field in RESO](https://ddwiki.reso.org/display/DDW17/YearBuilt+Field). 
   * @return all yearBuilt properties as {@link java.util.Collection} or an empty collection 
   * if yearBuilt was not set.
   */
   ...
   * @return accommodationFloorPlan property set by first invocation of accommodationFloorPlan method or {@code null}.
   */
  ...
  /**
   * A floorplan of some [[Accommodation]].
   * @return all accommodationFloorPlan properties as {@link java.util.Collection} or an empty collection 
   * if accommodationFloorPlan was not set.
   */
   ...
   * @return permittedUsage property set by first invocation of permittedUsage method or {@code null}.
   */
  ...
  /**
   * Indications regarding the permitted usage of the accommodation.
   * @return all permittedUsage properties as {@link java.util.Collection} or an empty collection 
   * if permittedUsage was not set.
   */
   ...
   * @return accommodationCategory property set by first invocation of accommodationCategory method or {@code null}.
   */
  @JsonIgnore public Category getAccommodationCategory() {
    return (Category) getValue("accommodationCategory");
  }
  /**
   * Category of an [[Accommodation]], following real estate conventions e.g. RESO (see [PropertySubType](https://ddwiki.reso.org/display/DDW17/PropertySubType+Field), and [PropertyType](https://ddwiki.reso.org/display/DDW17/PropertyType+Field) fields  for suggested values).
   * @return all accommodationCategory properties as {@link java.util.Collection} or an empty collection 
   * if accommodationCategory was not set.
   */
   ...
   *                               @return floorLevel property set by first invocation of floorLevel method or {@code null}.
   */
   ...
   *                                   The floor level for an [[Accommodation]] in a multi-storey building. Since counting
   * systems [vary internationally](https://en.wikipedia.org/wiki/Storey#Consecutive_number_floor_designations), the local system should be used where possible.
   *                                   @return all floorLevel properties as {@link java.util.Collection} or an empty collection 
   *                                   if floorLevel was not set.
   */
  ...
  public static class Builder extends Place.Builder {
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("accommodationCategory".equals(key) && value instanceof Category) { this.accommodationCategory((Category)value); return; }
      if ("accommodationCategorys".equals(key) && value instanceof Category) { this.accommodationCategory((Category)value); return; }
