...
public class ProductGroup extends Product {
   ...
   * @return variesBy property set by first invocation of variesBy method or {@code null}.
   */
  @JsonIgnore public DefinedTerm getVariesByDefinedTerm() {
    return (DefinedTerm) getValue("variesBy");
  }
  /**
   * Indicates the property or properties by which the variants in a [[ProductGroup]] vary, e.g. their size, color etc. Schema.org properties can be referenced by their short name e.g. &quot;color&quot;; terms defined elsewhere can be referenced with their URIs.
   * @return all variesBy properties as {@link java.util.Collection} or an empty collection 
   * if variesBy was not set.
   */
   ...
   * @return variesBy property set by first invocation of variesBy method or {@code null}.
   */
  @JsonIgnore public String getVariesByString() {
    return (String) getValue("variesBy");
  }
  /**
   * Indicates the property or properties by which the variants in a [[ProductGroup]] vary, e.g. their size, color etc. Schema.org properties can be referenced by their short name e.g. &quot;color&quot;; terms defined elsewhere can be referenced with their URIs.
   * @return all variesBy properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return productGroupID property set by first invocation of productGroupID method or {@code null}.
   */
  @JsonIgnore public String getProductGroupID() {
    return (String) getValue("productGroupID");
  }
  /**
   * Indicates a textual identifier for a ProductGroup.
   * @return all productGroupID properties as {@link java.util.Collection} or an empty collection 
   * if productGroupID was not set.
   */
   ...
   * @return hasVariant property set by first invocation of hasVariant method or {@code null}.
   */
  @JsonIgnore public Product getHasVariant() {
    return (Product) getValue("hasVariant");
  }
  /**
   * Indicates a [[Product]] that is a member of this [[ProductGroup]] (or [[ProductModel]]).
   * @return all hasVariant properties as {@link java.util.Collection} or an empty collection 
   * if hasVariant was not set.
   */
  ...
  public static class Builder extends Product.Builder {
    ...
    @NotNull public ProductGroup build() {
      return new ProductGroup(myData);
    }
    /**
     * Indicates the property or properties by which the variants in a [[ProductGroup]] vary, e.g. their size, color etc. Schema.org properties can be referenced by their short name e.g. &quot;color&quot;; terms defined elsewhere can be referenced with their URIs.
     ...
     */
    @NotNull public Builder variesBy(@NotNull DefinedTerm definedTerm) {
      putValue("variesBy", definedTerm);
      return this;
    }
    /**
     * Indicates the property or properties by which the variants in a [[ProductGroup]] vary, e.g. their size, color etc. Schema.org properties can be referenced by their short name e.g. &quot;color&quot;; terms defined elsewhere can be referenced with their URIs.
     ...
     * @return this builder instance
     */
    @NotNull public Builder variesBy(@NotNull DefinedTerm.Builder definedTerm) {
      putValue("variesBy", definedTerm.build());
      return this;
    }
    /**
     * Indicates the property or properties by which the variants in a [[ProductGroup]] vary, e.g. their size, color etc. Schema.org properties can be referenced by their short name e.g. &quot;color&quot;; terms defined elsewhere can be referenced with their URIs.
     * @param variesBy value to set
     * @return this builder instance
     */
    @NotNull public Builder variesBy(@NotNull String variesBy) {
      putValue("variesBy", variesBy);
      return this;
    }
    /**
     * Remove variesBy property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeVariesBy() {
      removeValue("variesBy");
      return this;
    }
    /**
     * Get currently set value for variesBy property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getVariesBy() {
      return myData.get("variesBy");
    }
    /**
     * Indicates a textual identifier for a ProductGroup.
     * @param productGroupID value to set
     * @return this builder instance
     */
    @NotNull public Builder productGroupID(@NotNull String productGroupID) {
      putValue("productGroupID", productGroupID);
      return this;
    }
    /**
     * Remove productGroupID property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeProductGroupID() {
      removeValue("productGroupID");
      return this;
    }
    /**
     * Get currently set value for productGroupID property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getProductGroupID() {
      return myData.get("productGroupID");
    }
    /**
     * Indicates a [[Product]] that is a member of this [[ProductGroup]] (or [[ProductModel]]).
     ...
     * @return this builder instance
     */
    @NotNull public Builder hasVariant(@NotNull Product product) {
      putValue("hasVariant", product);
      return this;
    }
    /**
     * Indicates a [[Product]] that is a member of this [[ProductGroup]] (or [[ProductModel]]).
     ...
     * @return this builder instance
     */
    @NotNull public Builder hasVariant(@NotNull Product.Builder product) {
      putValue("hasVariant", product.build());
      return this;
    }
    /**
     * Remove hasVariant property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeHasVariant() {
      removeValue("hasVariant");
      return this;
    }
    /**
     * Get currently set value for hasVariant property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getHasVariant() {
      return myData.get("hasVariant");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("variesBys".equals(key) && value instanceof String) { this.variesBy((String)value); return; }
      if ("productGroupID".equals(key) && value instanceof String) { this.productGroupID((String)value); return; }
      if ("productGroupIDs".equals(key) && value instanceof String) { this.productGroupID((String)value); return; }
      if ("hasVariant".equals(key) && value instanceof Product) { this.hasVariant((Product)value); return; }
      if ("hasVariants".equals(key) && value instanceof Product) { this.hasVariant((Product)value); return; }
