...
public class MedicalScholarlyArticle extends ScholarlyArticle {
   ...
   * @return publicationType property set by first invocation of publicationType method or {@code null}.
   */
  @JsonIgnore public String getPublicationType() {
    return (String) getValue("publicationType");
  }
  /**
   * The type of the medical article, taken from the US NLM MeSH publication type catalog. See also [MeSH documentation](http://www.nlm.nih.gov/mesh/pubtypes.html).
   * @return all publicationType properties as {@link java.util.Collection} or an empty collection 
   * if publicationType was not set.
   */
  @JsonIgnore public java.util.Collection<String> getPublicationTypes() {
    final java.lang.Object current = myData.get("publicationType");
  ...
  protected MedicalScholarlyArticle(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link MedicalScholarlyArticle}
   */
  public static class Builder extends ScholarlyArticle.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MedicalScholarlyArticle build() {
      return new MedicalScholarlyArticle(myData);
    }
    /**
     * The type of the medical article, taken from the US NLM MeSH publication type catalog. See also [MeSH documentation](http://www.nlm.nih.gov/mesh/pubtypes.html).
     * @param publicationType value to set
     * @return this builder instance
     */
    @NotNull public Builder publicationType(@NotNull String publicationType) {
      putValue("publicationType", publicationType);
      return this;
    }
    /**
     * Remove publicationType property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePublicationType() {
      removeValue("publicationType");
      return this;
    }
    /**
     * Get currently set value for publicationType property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPublicationType() {
      return myData.get("publicationType");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("publicationType".equals(key) && value instanceof String) { this.publicationType((String)value); return; }
      if ("publicationTypes".equals(key) && value instanceof String) { this.publicationType((String)value); return; }
