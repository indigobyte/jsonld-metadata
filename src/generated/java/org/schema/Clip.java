...
public class Clip extends CreativeWork {
   ...
   */
  @JsonIgnore public Integer getStartOffsetInteger() {
    return (Integer) getValue("startOffset");
  }
  /**
   * The start time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Collection<Integer> getStartOffsetIntegers() {
   ...
   * The start time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Long getStartOffsetLong() {
    return (Long) getValue("startOffset");
  }
  /**
   * The start time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Collection<Long> getStartOffsetLongs() {
    final Object current = myData.get("startOffset");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
   ...
   * The start time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Float getStartOffsetFloat() {
    return (Float) getValue("startOffset");
  }
  /**
   * The start time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Collection<Float> getStartOffsetFloats() {
    final Object current = myData.get("startOffset");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
   ...
   * The start time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Double getStartOffsetDouble() {
    return (Double) getValue("startOffset");
  }
  /**
   * The start time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Collection<Double> getStartOffsetDoubles() {
    final Object current = myData.get("startOffset");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
   ...
   * The start time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public String getStartOffsetString() {
    return (String) getValue("startOffset");
  }
  /**
   * The start time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Collection<String> getStartOffsetStrings() {
    final Object current = myData.get("startOffset");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
   ...
   */
  @JsonIgnore public Integer getEndOffsetInteger() {
    return (Integer) getValue("endOffset");
  }
  /**
   * The end time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Collection<Integer> getEndOffsetIntegers() {
   ...
   * The end time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Long getEndOffsetLong() {
    return (Long) getValue("endOffset");
  }
  /**
   * The end time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Collection<Long> getEndOffsetLongs() {
    final Object current = myData.get("endOffset");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<Long>) current;
   ...
   * The end time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Float getEndOffsetFloat() {
    return (Float) getValue("endOffset");
  }
  /**
   * The end time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Collection<Float> getEndOffsetFloats() {
    final Object current = myData.get("endOffset");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<Float>) current;
   ...
   * The end time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Double getEndOffsetDouble() {
    return (Double) getValue("endOffset");
  }
  /**
   * The end time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Collection<Double> getEndOffsetDoubles() {
    final Object current = myData.get("endOffset");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<Double>) current;
   ...
   * The end time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public String getEndOffsetString() {
    return (String) getValue("endOffset");
  }
  /**
   * The end time of the clip expressed as the number of seconds from the beginning of the work.
   */
  @JsonIgnore public Collection<String> getEndOffsetStrings() {
    final Object current = myData.get("endOffset");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<String>) current;
   ...
   */
  @JsonIgnore public Episode getPartOfEpisode() {
    return (Episode) getValue("partOfEpisode");
  }
  /**
   * The episode to which this clip belongs.
   */
  @JsonIgnore public Collection<Episode> getPartOfEpisodes() {
  ...
  public static class Builder extends CreativeWork.Builder {
     ...
     * The start time of the clip expressed as the number of seconds from the beginning of the work.
     */
    @NotNull public Builder startOffset(@NotNull Integer integer) {
      putValue("startOffset", integer);
      return this;
    }
    /**
     * The start time of the clip expressed as the number of seconds from the beginning of the work.
     */
    @NotNull public Builder startOffset(@NotNull Long startOffset) {
      putValue("startOffset", startOffset);
      return this;
    }
    /**
     * The start time of the clip expressed as the number of seconds from the beginning of the work.
     */
    @NotNull public Builder startOffset(@NotNull Float startOffset) {
      putValue("startOffset", startOffset);
      return this;
    }
    /**
     * The start time of the clip expressed as the number of seconds from the beginning of the work.
     */
    @NotNull public Builder startOffset(@NotNull Double startOffset) {
      putValue("startOffset", startOffset);
      return this;
    }
    /**
     * The start time of the clip expressed as the number of seconds from the beginning of the work.
     */
    @NotNull public Builder startOffset(@NotNull String startOffset) {
      putValue("startOffset", startOffset);
      return this;
    }
    /**
     ...
     * The end time of the clip expressed as the number of seconds from the beginning of the work.
     */
    @NotNull public Builder endOffset(@NotNull Integer integer) {
      putValue("endOffset", integer);
      return this;
    }
    /**
     * The end time of the clip expressed as the number of seconds from the beginning of the work.
     */
    @NotNull public Builder endOffset(@NotNull Long endOffset) {
      putValue("endOffset", endOffset);
      return this;
    }
    /**
     * The end time of the clip expressed as the number of seconds from the beginning of the work.
     */
    @NotNull public Builder endOffset(@NotNull Float endOffset) {
      putValue("endOffset", endOffset);
      return this;
    }
    /**
     * The end time of the clip expressed as the number of seconds from the beginning of the work.
     */
    @NotNull public Builder endOffset(@NotNull Double endOffset) {
      putValue("endOffset", endOffset);
      return this;
    }
    /**
     * The end time of the clip expressed as the number of seconds from the beginning of the work.
     */
    @NotNull public Builder endOffset(@NotNull String endOffset) {
      putValue("endOffset", endOffset);
      return this;
    }
    /**
    ...
    @Override protected void fromMap(String key, Object value) {
      ...
      if ("startOffset".equals(key) && value instanceof Integer) { this.startOffset((Integer)value); return; }
      if ("startOffsets".equals(key) && value instanceof Integer) { this.startOffset((Integer)value); return; }
      if ("startOffset".equals(key) && value instanceof Long) { this.startOffset((Long)value); return; }
      if ("startOffsets".equals(key) && value instanceof Long) { this.startOffset((Long)value); return; }
      if ("startOffset".equals(key) && value instanceof Float) { this.startOffset((Float)value); return; }
      if ("startOffsets".equals(key) && value instanceof Float) { this.startOffset((Float)value); return; }
      if ("startOffset".equals(key) && value instanceof Double) { this.startOffset((Double)value); return; }
      if ("startOffsets".equals(key) && value instanceof Double) { this.startOffset((Double)value); return; }
      if ("startOffset".equals(key) && value instanceof String) { this.startOffset((String)value); return; }
      if ("startOffsets".equals(key) && value instanceof String) { this.startOffset((String)value); return; }
      ...
      if ("endOffset".equals(key) && value instanceof Integer) { this.endOffset((Integer)value); return; }
      if ("endOffsets".equals(key) && value instanceof Integer) { this.endOffset((Integer)value); return; }
      if ("endOffset".equals(key) && value instanceof Long) { this.endOffset((Long)value); return; }
      if ("endOffsets".equals(key) && value instanceof Long) { this.endOffset((Long)value); return; }
      if ("endOffset".equals(key) && value instanceof Float) { this.endOffset((Float)value); return; }
      if ("endOffsets".equals(key) && value instanceof Float) { this.endOffset((Float)value); return; }
      if ("endOffset".equals(key) && value instanceof Double) { this.endOffset((Double)value); return; }
      if ("endOffsets".equals(key) && value instanceof Double) { this.endOffset((Double)value); return; }
      if ("endOffset".equals(key) && value instanceof String) { this.endOffset((String)value); return; }
      if ("endOffsets".equals(key) && value instanceof String) { this.endOffset((String)value); return; }
      ...
      if ("partOfEpisode".equals(key) && value instanceof Episode) { this.partOfEpisode((Episode)value); return; }
      if ("partOfEpisodes".equals(key) && value instanceof Episode) { this.partOfEpisode((Episode)value); return; }
