...
public class ScreeningEvent extends Event {
   ...
   * @return workPresented property set by first invocation of workPresented method or {@code null}.
   */
  ...
  /**
   * The movie presented during this event.
   * @return all workPresented properties as {@link java.util.Collection} or an empty collection 
   * if workPresented was not set.
   */
  @JsonIgnore public java.util.Collection<WorkFeatured> getWorkPresenteds() {
    final java.lang.Object current = myData.get("workPresented");
  ...
  protected ScreeningEvent(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends Event.Builder {
    ...
    /**
     * Remove workPresented property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeWorkPresented() {
      removeValue("workPresented");
      return this;
    }
    /**
     * Get currently set value for workPresented property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getWorkPresented() {
      return myData.get("workPresented");
    }
    /**
     * Languages in which subtitles/captions are available, in [IETF BCP 47 standard format](http://tools.ietf.org/html/bcp47).
