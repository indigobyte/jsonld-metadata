 ...
 */
public class Emergency extends MedicalBusiness {
  protected Emergency(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends MedicalBusiness.Builder {
    ...
    @NotNull public Emergency build() {
      return new Emergency(myData);
    }
    /**
