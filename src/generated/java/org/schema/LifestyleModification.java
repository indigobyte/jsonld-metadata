 ...
 */
public class LifestyleModification extends MedicalEntity {
  protected LifestyleModification(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends MedicalEntity.Builder {
    ...
    @NotNull public LifestyleModification build() {
