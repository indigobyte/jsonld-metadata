...
public class MedicalDevice extends MedicalEntity {
   ...
   * @return seriousAdverseOutcome property set by first invocation of seriousAdverseOutcome method or {@code null}.
   */
  ...
  /**
   * A possible serious complication and/or serious side effect of this therapy. Serious adverse outcomes include those that are life-threatening; result in death, disability, or permanent damage; require hospitalization or prolong existing hospitalization; cause congenital anomalies or birth defects; or jeopardize the patient and may require medical or surgical intervention to prevent one of the outcomes in this definition.
   * @return all seriousAdverseOutcome properties as {@link java.util.Collection} or an empty collection 
   * if seriousAdverseOutcome was not set.
   */
   ...
   * @return contraindication property set by first invocation of contraindication method or {@code null}.
   */
  ...
  /**
   * A contraindication for this therapy.
   * @return all contraindication properties as {@link java.util.Collection} or an empty collection 
   * if contraindication was not set.
   */
   ...
   * @return preOp property set by first invocation of preOp method or {@code null}.
   */
  ...
  /**
   * A description of the workup, testing, and other preparations required before implanting this device.
   * @return all preOp properties as {@link java.util.Collection} or an empty collection 
   * if preOp was not set.
   */
   ...
   * @return procedure property set by first invocation of procedure method or {@code null}.
   */
  ...
  /**
   * A description of the procedure involved in setting up, using, and/or installing the device.
   * @return all procedure properties as {@link java.util.Collection} or an empty collection 
   * if procedure was not set.
   */
   ...
   * @return postOp property set by first invocation of postOp method or {@code null}.
   */
  ...
  /**
   * A description of the postoperative procedures, care, and/or followups for this device.
   * @return all postOp properties as {@link java.util.Collection} or an empty collection 
   * if postOp was not set.
   */
   ...
   * @return adverseOutcome property set by first invocation of adverseOutcome method or {@code null}.
   */
  ...
  /**
   * A possible complication and/or side effect of this therapy. If it is known that an adverse outcome is serious (resulting in death, disability, or permanent damage; requiring hospitalization; or is otherwise life-threatening or requires immediate medical attention), tag it as a seriouseAdverseOutcome instead.
   * @return all adverseOutcome properties as {@link java.util.Collection} or an empty collection 
   * if adverseOutcome was not set.
   */
  ...
  public static class Builder extends MedicalEntity.Builder {
    ...
    /**
     * Remove seriousAdverseOutcome property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSeriousAdverseOutcome() {
      removeValue("seriousAdverseOutcome");
      return this;
    }
    /**
     * Get currently set value for seriousAdverseOutcome property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSeriousAdverseOutcome() {
      return myData.get("seriousAdverseOutcome");
    }
    /**
     * A contraindication for this therapy.
     * @param medicalContraindication value to set
     * @return this builder instance
     */
    ...
    /**
     * A contraindication for this therapy.
     * @param contraindication value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove contraindication property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeContraindication() {
      removeValue("contraindication");
      return this;
    }
    /**
     * Get currently set value for contraindication property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getContraindication() {
      return myData.get("contraindication");
    }
    /**
     * A description of the workup, testing, and other preparations required before implanting this device.
     * @param preOp value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove preOp property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePreOp() {
      removeValue("preOp");
      return this;
    }
    /**
     * Get currently set value for preOp property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPreOp() {
      return myData.get("preOp");
    }
    /**
     * A description of the procedure involved in setting up, using, and/or installing the device.
     * @param procedure value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove procedure property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeProcedure() {
      removeValue("procedure");
      return this;
    }
    /**
     * Get currently set value for procedure property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getProcedure() {
      return myData.get("procedure");
    }
    /**
     * A description of the postoperative procedures, care, and/or followups for this device.
     * @param postOp value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove postOp property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removePostOp() {
      removeValue("postOp");
      return this;
    }
    /**
     * Get currently set value for postOp property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getPostOp() {
      return myData.get("postOp");
    }
    /**
     * A possible complication and/or side effect of this therapy. If it is known that an adverse outcome is serious (resulting in death, disability, or permanent damage; requiring hospitalization; or is otherwise life-threatening or requires immediate medical attention), tag it as a seriouseAdverseOutcome instead.
     * @param medicalEntity value to set
    ...
    /**
     * Remove adverseOutcome property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAdverseOutcome() {
      removeValue("adverseOutcome");
      return this;
    }
    /**
     * Get currently set value for adverseOutcome property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAdverseOutcome() {
      return myData.get("adverseOutcome");
    }
    /**
