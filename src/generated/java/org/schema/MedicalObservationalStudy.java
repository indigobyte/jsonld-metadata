...
public class MedicalObservationalStudy extends MedicalStudy {
   ...
   * @return studyDesign property set by first invocation of studyDesign method or {@code null}.
   */
  @JsonIgnore public MedicalObservationalStudyDesign getStudyDesign() {
    return (MedicalObservationalStudyDesign) getValue("studyDesign");
  }
  /**
   * Specifics about the observational study design (enumerated).
   * @return all studyDesign properties as {@link java.util.Collection} or an empty collection 
   * if studyDesign was not set.
   */
  @JsonIgnore public java.util.Collection<MedicalObservationalStudyDesign> getStudyDesigns() {
    final java.lang.Object current = myData.get("studyDesign");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<MedicalObservationalStudyDesign>) current;
    }
    return Arrays.asList((MedicalObservationalStudyDesign) current);
  }
  protected MedicalObservationalStudy(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link MedicalObservationalStudy}
   */
  public static class Builder extends MedicalStudy.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MedicalObservationalStudy build() {
      return new MedicalObservationalStudy(myData);
    }
    /**
     * Specifics about the observational study design (enumerated).
     * @param medicalObservationalStudyDesign value to set
     * @return this builder instance
     */
    @NotNull public Builder studyDesign(@NotNull MedicalObservationalStudyDesign medicalObservationalStudyDesign) {
      putValue("studyDesign", medicalObservationalStudyDesign);
      return this;
    }
    /**
     * Remove studyDesign property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeStudyDesign() {
      removeValue("studyDesign");
      return this;
    }
    /**
     * Get currently set value for studyDesign property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getStudyDesign() {
      return myData.get("studyDesign");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("studyDesign".equals(key) && value instanceof MedicalObservationalStudyDesign) { this.studyDesign((MedicalObservationalStudyDesign)value); return; }
      if ("studyDesigns".equals(key) && value instanceof MedicalObservationalStudyDesign) { this.studyDesign((MedicalObservationalStudyDesign)value); return; }
