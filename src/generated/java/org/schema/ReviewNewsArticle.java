 ...
 */
public class ReviewNewsArticle extends CriticReview {
  protected ReviewNewsArticle(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link ReviewNewsArticle}
   */
  public static class Builder extends CriticReview.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public ReviewNewsArticle build() {
      return new ReviewNewsArticle(myData);
    }
    /**
