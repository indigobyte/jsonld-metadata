...
public class MoneyTransfer extends TransferAction {
   ...
   * @return beneficiaryBank property set by first invocation of beneficiaryBank method or {@code null}.
   */
  ...
  /**
   * A bank or bank&rsquo;s branch, financial institution or international financial institution operating the beneficiary&rsquo;s bank account or releasing funds for the beneficiary.
   * @return all beneficiaryBank properties as {@link java.util.Collection} or an empty collection 
   * if beneficiaryBank was not set.
   */
  @JsonIgnore public java.util.Collection<BankOrCreditUnion> getBeneficiaryBankBankOrCreditUnions() {
    final java.lang.Object current = myData.get("beneficiaryBank");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected MoneyTransfer(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends TransferAction.Builder {
    ...
    /**
     * A bank or bank&rsquo;s branch, financial institution or international financial institution operating the beneficiary&rsquo;s bank account or releasing funds for the beneficiary.
     * @param bankOrCreditUnion value to set
     * @return this builder instance
     */
    ...
    /**
     * A bank or bank&rsquo;s branch, financial institution or international financial institution operating the beneficiary&rsquo;s bank account or releasing funds for the beneficiary.
     * @param beneficiaryBank value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove beneficiaryBank property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeBeneficiaryBank() {
      removeValue("beneficiaryBank");
      return this;
    }
    /**
     * Get currently set value for beneficiaryBank property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getBeneficiaryBank() {
      return myData.get("beneficiaryBank");
    }
    /**
