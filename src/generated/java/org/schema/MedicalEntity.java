...
public class MedicalEntity extends Thing {
   ...
   * @return code property set by first invocation of code method or {@code null}.
   */
  ...
  /**
   * A medical code for the entity, taken from a controlled vocabulary or ontology such as ICD-9, DiseasesDB, MeSH, SNOMED-CT, RxNorm, etc.
   * @return all code properties as {@link java.util.Collection} or an empty collection 
   * if code was not set.
   */
   ...
   * @return relevantSpecialty property set by first invocation of relevantSpecialty method or {@code null}.
   */
  ...
  /**
   * If applicable, a medical specialty in which this entity is relevant.
   * @return all relevantSpecialty properties as {@link java.util.Collection} or an empty collection 
   * if relevantSpecialty was not set.
   */
   ...
   * @return medicineSystem property set by first invocation of medicineSystem method or {@code null}.
   */
  ...
  /**
   * The system of medicine that includes this MedicalEntity, for example 'evidence-based', 'homeopathic', 'chiropractic', etc.
   * @return all medicineSystem properties as {@link java.util.Collection} or an empty collection 
   * if medicineSystem was not set.
   */
   ...
   * @return study property set by first invocation of study method or {@code null}.
   */
  ...
  /**
   * A medical study or trial related to this entity.
   * @return all study properties as {@link java.util.Collection} or an empty collection 
   * if study was not set.
   */
   ...
   * @return guideline property set by first invocation of guideline method or {@code null}.
   */
  ...
  /**
   * A medical guideline related to this entity.
   * @return all guideline properties as {@link java.util.Collection} or an empty collection 
   * if guideline was not set.
   */
   ...
   * @return recognizingAuthority property set by first invocation of recognizingAuthority method or {@code null}.
   */
  ...
  /**
   * If applicable, the organization that officially recognizes this entity as part of its endorsed system of medicine.
   * @return all recognizingAuthority properties as {@link java.util.Collection} or an empty collection 
   * if recognizingAuthority was not set.
   */
