 ...
 */
public class ImageObjectSnapshot extends ImageObject {
  protected ImageObjectSnapshot(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link ImageObjectSnapshot}
   */
  public static class Builder extends ImageObject.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public ImageObjectSnapshot build() {
      return new ImageObjectSnapshot(myData);
    }
    /**
