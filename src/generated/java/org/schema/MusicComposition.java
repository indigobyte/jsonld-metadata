...
public class MusicComposition extends CreativeWork {
   ...
   * @return lyricist property set by first invocation of lyricist method or {@code null}.
   */
  @JsonIgnore public Person getLyricist() {
    return (Person) getValue("lyricist");
  }
  /**
   * The person who wrote the words.
   * @return all lyricist properties as {@link java.util.Collection} or an empty collection 
   * if lyricist was not set.
   */
  @JsonIgnore public java.util.Collection<Person> getLyricists() {
    final java.lang.Object current = myData.get("lyricist");
   ...
   * @return musicArrangement property set by first invocation of musicArrangement method or {@code null}.
   */
  @JsonIgnore public MusicComposition getMusicArrangement() {
    return (MusicComposition) getValue("musicArrangement");
  }
  /**
   * An arrangement derived from the composition.
   * @return all musicArrangement properties as {@link java.util.Collection} or an empty collection 
   * if musicArrangement was not set.
   */
  @JsonIgnore public java.util.Collection<MusicComposition> getMusicArrangements() {
    final java.lang.Object current = myData.get("musicArrangement");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return includedComposition property set by first invocation of includedComposition method or {@code null}.
   */
  @JsonIgnore public MusicComposition getIncludedComposition() {
    return (MusicComposition) getValue("includedComposition");
  }
  /**
   * Smaller compositions included in this work (e.g. a movement in a symphony).
   * @return all includedComposition properties as {@link java.util.Collection} or an empty collection 
   * if includedComposition was not set.
   */
  @JsonIgnore public java.util.Collection<MusicComposition> getIncludedCompositions() {
    final java.lang.Object current = myData.get("includedComposition");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<MusicComposition>) current;
    }
   ...
   * @return musicCompositionForm property set by first invocation of musicCompositionForm method or {@code null}.
   */
  @JsonIgnore public String getMusicCompositionForm() {
    return (String) getValue("musicCompositionForm");
  }
  /**
   * The type of composition (e.g. overture, sonata, symphony, etc.).
   * @return all musicCompositionForm properties as {@link java.util.Collection} or an empty collection 
   * if musicCompositionForm was not set.
   */
  @JsonIgnore public java.util.Collection<String> getMusicCompositionForms() {
    final java.lang.Object current = myData.get("musicCompositionForm");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return lyrics property set by first invocation of lyrics method or {@code null}.
   */
  @JsonIgnore public CreativeWork getLyrics() {
    return (CreativeWork) getValue("lyrics");
  }
  /**
   * The words in the song.
   * @return all lyrics properties as {@link java.util.Collection} or an empty collection 
   * if lyrics was not set.
   */
  @JsonIgnore public java.util.Collection<CreativeWork> getLyricss() {
    final java.lang.Object current = myData.get("lyrics");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return musicalKey property set by first invocation of musicalKey method or {@code null}.
   */
  @JsonIgnore public String getMusicalKey() {
    return (String) getValue("musicalKey");
  }
  /**
   * The key, mode, or scale this composition uses.
   * @return all musicalKey properties as {@link java.util.Collection} or an empty collection 
   * if musicalKey was not set.
   */
  @JsonIgnore public java.util.Collection<String> getMusicalKeys() {
    final java.lang.Object current = myData.get("musicalKey");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
   ...
   * @return firstPerformance property set by first invocation of firstPerformance method or {@code null}.
   */
  @JsonIgnore public Event getFirstPerformance() {
    return (Event) getValue("firstPerformance");
  }
  /**
   * The date and place the work was first performed.
   * @return all firstPerformance properties as {@link java.util.Collection} or an empty collection 
   * if firstPerformance was not set.
   */
  @JsonIgnore public java.util.Collection<Event> getFirstPerformances() {
    final java.lang.Object current = myData.get("firstPerformance");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return iswcCode property set by first invocation of iswcCode method or {@code null}.
   */
  @JsonIgnore public String getIswcCode() {
    return (String) getValue("iswcCode");
  }
  /**
   * The International Standard Musical Work Code for the composition.
   * @return all iswcCode properties as {@link java.util.Collection} or an empty collection 
   * if iswcCode was not set.
   */
  @JsonIgnore public java.util.Collection<String> getIswcCodes() {
    final java.lang.Object current = myData.get("iswcCode");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
   ...
   * @return recordedAs property set by first invocation of recordedAs method or {@code null}.
   */
  @JsonIgnore public MusicRecording getRecordedAs() {
    return (MusicRecording) getValue("recordedAs");
  }
  /**
   * An audio recording of the work.
   * @return all recordedAs properties as {@link java.util.Collection} or an empty collection 
   * if recordedAs was not set.
   */
  @JsonIgnore public java.util.Collection<MusicRecording> getRecordedAss() {
    final java.lang.Object current = myData.get("recordedAs");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected MusicComposition(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link MusicComposition}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MusicComposition build() {
      return new MusicComposition(myData);
    }
    /**
     * The person who wrote the words.
     ...
     */
    @NotNull public Builder lyricist(@NotNull Person person) {
      putValue("lyricist", person);
      return this;
    }
    /**
     * The person who wrote the words.
     ...
     * @return this builder instance
     */
    @NotNull public Builder lyricist(@NotNull Person.Builder person) {
      putValue("lyricist", person.build());
      return this;
    }
    /**
     * Remove lyricist property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLyricist() {
      removeValue("lyricist");
      return this;
    }
    /**
     * Get currently set value for lyricist property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLyricist() {
      return myData.get("lyricist");
    }
    /**
     * The person or organization who wrote a composition, or who is the composer of a work performed at some event.
    ...
    /**
     * An arrangement derived from the composition.
     * @param musicComposition value to set
     * @return this builder instance
     */
    @NotNull public Builder musicArrangement(@NotNull MusicComposition musicComposition) {
      putValue("musicArrangement", musicComposition);
      return this;
    }
    /**
     * An arrangement derived from the composition.
     ...
     * @return this builder instance
     */
    @NotNull public Builder musicArrangement(@NotNull MusicComposition.Builder musicComposition) {
      putValue("musicArrangement", musicComposition.build());
      return this;
    }
    /**
     * Remove musicArrangement property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeMusicArrangement() {
      removeValue("musicArrangement");
      return this;
    }
    /**
     * Get currently set value for musicArrangement property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getMusicArrangement() {
      return myData.get("musicArrangement");
    }
    /**
     * Smaller compositions included in this work (e.g. a movement in a symphony).
     * @param musicComposition value to set
     * @return this builder instance
     */
    @NotNull public Builder includedComposition(@NotNull MusicComposition musicComposition) {
      putValue("includedComposition", musicComposition);
      return this;
    }
    /**
     * Smaller compositions included in this work (e.g. a movement in a symphony).
     ...
     * @return this builder instance
     */
    @NotNull public Builder includedComposition(@NotNull MusicComposition.Builder musicComposition) {
      putValue("includedComposition", musicComposition.build());
      return this;
    }
    /**
     * Remove includedComposition property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIncludedComposition() {
      removeValue("includedComposition");
      return this;
    }
    /**
     * Get currently set value for includedComposition property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIncludedComposition() {
      return myData.get("includedComposition");
    }
    /**
     * The type of composition (e.g. overture, sonata, symphony, etc.).
     * @param musicCompositionForm value to set
     * @return this builder instance
     */
    @NotNull public Builder musicCompositionForm(@NotNull String musicCompositionForm) {
      putValue("musicCompositionForm", musicCompositionForm);
      return this;
    }
    /**
     * Remove musicCompositionForm property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeMusicCompositionForm() {
      removeValue("musicCompositionForm");
      return this;
    }
    /**
     * Get currently set value for musicCompositionForm property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getMusicCompositionForm() {
      return myData.get("musicCompositionForm");
    }
    /**
     * The words in the song.
     ...
     * @return this builder instance
     */
    @NotNull public Builder lyrics(@NotNull CreativeWork creativeWork) {
      putValue("lyrics", creativeWork);
      return this;
    }
    /**
     * The words in the song.
     ...
     * @return this builder instance
     */
    @NotNull public Builder lyrics(@NotNull CreativeWork.Builder creativeWork) {
      putValue("lyrics", creativeWork.build());
      return this;
    }
    /**
     * Remove lyrics property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLyrics() {
      removeValue("lyrics");
      return this;
    }
    /**
     * Get currently set value for lyrics property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLyrics() {
      return myData.get("lyrics");
    }
    /**
     * The key, mode, or scale this composition uses.
     * @param musicalKey value to set
     * @return this builder instance
     */
    @NotNull public Builder musicalKey(@NotNull String musicalKey) {
      putValue("musicalKey", musicalKey);
      return this;
    }
    /**
     * Remove musicalKey property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeMusicalKey() {
      removeValue("musicalKey");
      return this;
    }
    /**
     * Get currently set value for musicalKey property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getMusicalKey() {
      return myData.get("musicalKey");
    }
    /**
     * The date and place the work was first performed.
     ...
     * @return this builder instance
     */
    @NotNull public Builder firstPerformance(@NotNull Event event) {
      putValue("firstPerformance", event);
      return this;
    }
    /**
     * The date and place the work was first performed.
     ...
     * @return this builder instance
     */
    @NotNull public Builder firstPerformance(@NotNull Event.Builder event) {
      putValue("firstPerformance", event.build());
      return this;
    }
    /**
     * Remove firstPerformance property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeFirstPerformance() {
      removeValue("firstPerformance");
      return this;
    }
    /**
     * Get currently set value for firstPerformance property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getFirstPerformance() {
      return myData.get("firstPerformance");
    }
    /**
     * The International Standard Musical Work Code for the composition.
     * @param iswcCode value to set
     * @return this builder instance
     */
    @NotNull public Builder iswcCode(@NotNull String iswcCode) {
      putValue("iswcCode", iswcCode);
      return this;
    }
    /**
     * Remove iswcCode property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIswcCode() {
      removeValue("iswcCode");
      return this;
    }
    /**
     * Get currently set value for iswcCode property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIswcCode() {
      return myData.get("iswcCode");
    }
    /**
     * An audio recording of the work.
     ...
     * @return this builder instance
     */
    @NotNull public Builder recordedAs(@NotNull MusicRecording musicRecording) {
      putValue("recordedAs", musicRecording);
      return this;
    }
    /**
     * An audio recording of the work.
     ...
     * @return this builder instance
     */
    @NotNull public Builder recordedAs(@NotNull MusicRecording.Builder musicRecording) {
      putValue("recordedAs", musicRecording.build());
      return this;
    }
    /**
     * Remove recordedAs property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRecordedAs() {
      removeValue("recordedAs");
      return this;
    }
    /**
     * Get currently set value for recordedAs property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRecordedAs() {
      return myData.get("recordedAs");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("lyricist".equals(key) && value instanceof Person) { this.lyricist((Person)value); return; }
      if ("lyricists".equals(key) && value instanceof Person) { this.lyricist((Person)value); return; }
      ...
      if ("musicArrangement".equals(key) && value instanceof MusicComposition) { this.musicArrangement((MusicComposition)value); return; }
      if ("musicArrangements".equals(key) && value instanceof MusicComposition) { this.musicArrangement((MusicComposition)value); return; }
      if ("includedComposition".equals(key) && value instanceof MusicComposition) { this.includedComposition((MusicComposition)value); return; }
      if ("includedCompositions".equals(key) && value instanceof MusicComposition) { this.includedComposition((MusicComposition)value); return; }
      if ("musicCompositionForm".equals(key) && value instanceof String) { this.musicCompositionForm((String)value); return; }
      if ("musicCompositionForms".equals(key) && value instanceof String) { this.musicCompositionForm((String)value); return; }
      if ("lyrics".equals(key) && value instanceof CreativeWork) { this.lyrics((CreativeWork)value); return; }
      if ("lyricss".equals(key) && value instanceof CreativeWork) { this.lyrics((CreativeWork)value); return; }
      if ("musicalKey".equals(key) && value instanceof String) { this.musicalKey((String)value); return; }
      if ("musicalKeys".equals(key) && value instanceof String) { this.musicalKey((String)value); return; }
      if ("firstPerformance".equals(key) && value instanceof Event) { this.firstPerformance((Event)value); return; }
      if ("firstPerformances".equals(key) && value instanceof Event) { this.firstPerformance((Event)value); return; }
      if ("iswcCode".equals(key) && value instanceof String) { this.iswcCode((String)value); return; }
      if ("iswcCodes".equals(key) && value instanceof String) { this.iswcCode((String)value); return; }
      if ("recordedAs".equals(key) && value instanceof MusicRecording) { this.recordedAs((MusicRecording)value); return; }
      if ("recordedAss".equals(key) && value instanceof MusicRecording) { this.recordedAs((MusicRecording)value); return; }
