...
public class EducationalAudience extends Audience {
   ...
   * @return educationalRole property set by first invocation of educationalRole method or {@code null}.
   */
  @JsonIgnore public String getEducationalRole() {
    return (String) getValue("educationalRole");
  }
  /**
   * An educationalRole of an EducationalAudience.
   * @return all educationalRole properties as {@link java.util.Collection} or an empty collection 
   * if educationalRole was not set.
   */
  @JsonIgnore public java.util.Collection<String> getEducationalRoles() {
    final java.lang.Object current = myData.get("educationalRole");
  ...
  protected EducationalAudience(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends Audience.Builder {
    ...
    /**
     * An educationalRole of an EducationalAudience.
     * @param educationalRole value to set
     * @return this builder instance
     */
    @NotNull public Builder educationalRole(@NotNull String educationalRole) {
      putValue("educationalRole", educationalRole);
      return this;
    }
    /**
     * Remove educationalRole property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeEducationalRole() {
      removeValue("educationalRole");
      return this;
    }
    /**
     * Get currently set value for educationalRole property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getEducationalRole() {
      return myData.get("educationalRole");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("educationalRole".equals(key) && value instanceof String) { this.educationalRole((String)value); return; }
      if ("educationalRoles".equals(key) && value instanceof String) { this.educationalRole((String)value); return; }
