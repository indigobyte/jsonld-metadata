...
public class ExercisePlan extends CreativeWork {
   ...
   * @return restPeriods property set by first invocation of restPeriods method or {@code null}.
   */
  @JsonIgnore public QuantitativeValue getRestPeriodsQuantitativeValue() {
    return (QuantitativeValue) getValue("restPeriods");
  }
  /**
   * How often one should break from the activity.
   * @return all restPeriods properties as {@link java.util.Collection} or an empty collection 
   * if restPeriods was not set.
   */
  @JsonIgnore public java.util.Collection<QuantitativeValue> getRestPeriodsQuantitativeValues() {
    final java.lang.Object current = myData.get("restPeriods");
   ...
   * @return restPeriods property set by first invocation of restPeriods method or {@code null}.
   */
  @JsonIgnore public String getRestPeriodsString() {
   ...
   * @return activityFrequency property set by first invocation of activityFrequency method or {@code null}.
   */
  @JsonIgnore public QuantitativeValue getActivityFrequencyQuantitativeValue() {
    return (QuantitativeValue) getValue("activityFrequency");
  }
  /**
   * How often one should engage in the activity.
   * @return all activityFrequency properties as {@link java.util.Collection} or an empty collection 
   * if activityFrequency was not set.
   */
  @JsonIgnore public java.util.Collection<QuantitativeValue> getActivityFrequencyQuantitativeValues() {
    final java.lang.Object current = myData.get("activityFrequency");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<QuantitativeValue>) current;
    }
   ...
   * @return activityFrequency property set by first invocation of activityFrequency method or {@code null}.
   */
  @JsonIgnore public String getActivityFrequencyString() {
   ...
   * @return activityDuration property set by first invocation of activityDuration method or {@code null}.
   */
  @JsonIgnore public Duration getActivityDurationDuration() {
    return (Duration) getValue("activityDuration");
  }
  /**
   * Length of time to engage in the activity.
   * @return all activityDuration properties as {@link java.util.Collection} or an empty collection 
   * if activityDuration was not set.
   */
  @JsonIgnore public java.util.Collection<Duration> getActivityDurationDurations() {
    final java.lang.Object current = myData.get("activityDuration");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return activityDuration property set by first invocation of activityDuration method or {@code null}.
   */
  @JsonIgnore public QuantitativeValue getActivityDurationQuantitativeValue() {
    return (QuantitativeValue) getValue("activityDuration");
  }
  /**
   * Length of time to engage in the activity.
   * @return all activityDuration properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return workload property set by first invocation of workload method or {@code null}.
   */
  @JsonIgnore public Energy getWorkloadEnergy() {
    return (Energy) getValue("workload");
  }
  /**
   * Quantitative measure of the physiologic output of the exercise; also referred to as energy expenditure.
   * @return all workload properties as {@link java.util.Collection} or an empty collection 
   * if workload was not set.
   */
  @JsonIgnore public java.util.Collection<Energy> getWorkloadEnergys() {
    final java.lang.Object current = myData.get("workload");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return workload property set by first invocation of workload method or {@code null}.
   */
  @JsonIgnore public QuantitativeValue getWorkloadQuantitativeValue() {
    return (QuantitativeValue) getValue("workload");
  }
  /**
   * Quantitative measure of the physiologic output of the exercise; also referred to as energy expenditure.
   * @return all workload properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return additionalVariable property set by first invocation of additionalVariable method or {@code null}.
   */
  ...
  /**
   * Any additional component of the exercise prescription that may need to be articulated to the patient. This may include the order of exercises, the number of repetitions of movement, quantitative distance, progressions over time, etc.
   * @return all additionalVariable properties as {@link java.util.Collection} or an empty collection 
   * if additionalVariable was not set.
   */
  @JsonIgnore public java.util.Collection<String> getAdditionalVariables() {
    final java.lang.Object current = myData.get("additionalVariable");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
   ...
   * @return repetitions property set by first invocation of repetitions method or {@code null}.
   */
  ...
  /**
   * Number of times one should repeat the activity.
   * @return all repetitions properties as {@link java.util.Collection} or an empty collection 
   * if repetitions was not set.
   */
  @JsonIgnore public java.util.Collection<Integer> getRepetitionsIntegers() {
    final java.lang.Object current = myData.get("repetitions");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return intensity property set by first invocation of intensity method or {@code null}.
   */
  @JsonIgnore public QuantitativeValue getIntensityQuantitativeValue() {
    return (QuantitativeValue) getValue("intensity");
  }
  /**
   * Quantitative measure gauging the degree of force involved in the exercise, for example, heartbeats per minute. May include the velocity of the movement.
   * @return all intensity properties as {@link java.util.Collection} or an empty collection 
   * if intensity was not set.
   */
  @JsonIgnore public java.util.Collection<QuantitativeValue> getIntensityQuantitativeValues() {
    final java.lang.Object current = myData.get("intensity");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<QuantitativeValue>) current;
    }
   ...
   * @return intensity property set by first invocation of intensity method or {@code null}.
   */
  @JsonIgnore public String getIntensityString() {
  ...
  protected ExercisePlan(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @NotNull public ExercisePlan build() {
     ...
     */
    @NotNull public Builder restPeriods(@NotNull QuantitativeValue quantitativeValue) {
      putValue("restPeriods", quantitativeValue);
      return this;
    }
    /**
     * How often one should break from the activity.
     ...
     * @return this builder instance
     */
    @NotNull public Builder restPeriods(@NotNull QuantitativeValue.Builder quantitativeValue) {
      putValue("restPeriods", quantitativeValue.build());
      return this;
    }
    /**
     * How often one should break from the activity.
     * @param restPeriods value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove restPeriods property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRestPeriods() {
      removeValue("restPeriods");
      return this;
    }
    /**
     * Get currently set value for restPeriods property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRestPeriods() {
      return myData.get("restPeriods");
    }
    /**
     * How often one should engage in the activity.
     * @param quantitativeValue value to set
     * @return this builder instance
     */
    @NotNull public Builder activityFrequency(@NotNull QuantitativeValue quantitativeValue) {
      putValue("activityFrequency", quantitativeValue);
      return this;
    }
    /**
     * How often one should engage in the activity.
     ...
     * @return this builder instance
     */
    @NotNull public Builder activityFrequency(@NotNull QuantitativeValue.Builder quantitativeValue) {
      putValue("activityFrequency", quantitativeValue.build());
      return this;
    }
    /**
     * How often one should engage in the activity.
     * @param activityFrequency value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove activityFrequency property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeActivityFrequency() {
      removeValue("activityFrequency");
      return this;
    }
    /**
     * Get currently set value for activityFrequency property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getActivityFrequency() {
      return myData.get("activityFrequency");
    }
    /**
     * Length of time to engage in the activity.
     ...
     * @return this builder instance
     */
    @NotNull public Builder activityDuration(@NotNull QuantitativeValue quantitativeValue) {
      putValue("activityDuration", quantitativeValue);
      return this;
    }
    /**
     * Length of time to engage in the activity.
     ...
     * @return this builder instance
     */
    @NotNull public Builder activityDuration(@NotNull QuantitativeValue.Builder quantitativeValue) {
      putValue("activityDuration", quantitativeValue.build());
      return this;
    }
    /**
     * Remove activityDuration property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeActivityDuration() {
      removeValue("activityDuration");
      return this;
    }
    /**
     * Get currently set value for activityDuration property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getActivityDuration() {
      return myData.get("activityDuration");
    }
    /**
     * Quantitative measure of the physiologic output of the exercise; also referred to as energy expenditure.
     ...
     * @return this builder instance
     */
    @NotNull public Builder workload(@NotNull QuantitativeValue quantitativeValue) {
      putValue("workload", quantitativeValue);
      return this;
    }
    /**
     * Quantitative measure of the physiologic output of the exercise; also referred to as energy expenditure.
     ...
     * @return this builder instance
     */
    @NotNull public Builder workload(@NotNull QuantitativeValue.Builder quantitativeValue) {
      putValue("workload", quantitativeValue.build());
      return this;
    }
    /**
     * Remove workload property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeWorkload() {
      removeValue("workload");
      return this;
    }
    /**
     * Get currently set value for workload property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getWorkload() {
      return myData.get("workload");
    }
    /**
     * Any additional component of the exercise prescription that may need to be articulated to the patient. This may include the order of exercises, the number of repetitions of movement, quantitative distance, progressions over time, etc.
     * @param additionalVariable value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove additionalVariable property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAdditionalVariable() {
      removeValue("additionalVariable");
      return this;
    }
    /**
     * Get currently set value for additionalVariable property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAdditionalVariable() {
      return myData.get("additionalVariable");
    }
    /**
     * Number of times one should repeat the activity.
    ...
    /**
     * Number of times one should repeat the activity.
     * @param repetitions value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove repetitions property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRepetitions() {
      removeValue("repetitions");
      return this;
    }
    /**
     * Get currently set value for repetitions property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRepetitions() {
      return myData.get("repetitions");
    }
    /**
     * Type(s) of exercise or activity, such as strength training, flexibility training, aerobics, cardiac rehabilitation, etc.
     ...
     * @return this builder instance
     */
    @NotNull public Builder intensity(@NotNull QuantitativeValue quantitativeValue) {
      putValue("intensity", quantitativeValue);
      return this;
    }
    /**
     * Quantitative measure gauging the degree of force involved in the exercise, for example, heartbeats per minute. May include the velocity of the movement.
     ...
     * @return this builder instance
     */
    @NotNull public Builder intensity(@NotNull QuantitativeValue.Builder quantitativeValue) {
      putValue("intensity", quantitativeValue.build());
      return this;
    }
    /**
     * Quantitative measure gauging the degree of force involved in the exercise, for example, heartbeats per minute. May include the velocity of the movement.
    ...
    /**
     * Remove intensity property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIntensity() {
      removeValue("intensity");
      return this;
    }
    /**
     * Get currently set value for intensity property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIntensity() {
      return myData.get("intensity");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("restPeriods".equals(key) && value instanceof QuantitativeValue) { this.restPeriods((QuantitativeValue)value); return; }
      if ("restPeriodss".equals(key) && value instanceof QuantitativeValue) { this.restPeriods((QuantitativeValue)value); return; }
      if ("restPeriods".equals(key) && value instanceof String) { this.restPeriods((String)value); return; }
      if ("restPeriodss".equals(key) && value instanceof String) { this.restPeriods((String)value); return; }
      if ("activityFrequency".equals(key) && value instanceof QuantitativeValue) { this.activityFrequency((QuantitativeValue)value); return; }
      if ("activityFrequencys".equals(key) && value instanceof QuantitativeValue) { this.activityFrequency((QuantitativeValue)value); return; }
      if ("activityFrequency".equals(key) && value instanceof String) { this.activityFrequency((String)value); return; }
      if ("activityFrequencys".equals(key) && value instanceof String) { this.activityFrequency((String)value); return; }
      if ("activityDuration".equals(key) && value instanceof Duration) { this.activityDuration((Duration)value); return; }
      if ("activityDurations".equals(key) && value instanceof Duration) { this.activityDuration((Duration)value); return; }
      if ("activityDuration".equals(key) && value instanceof QuantitativeValue) { this.activityDuration((QuantitativeValue)value); return; }
      if ("activityDurations".equals(key) && value instanceof QuantitativeValue) { this.activityDuration((QuantitativeValue)value); return; }
      if ("workload".equals(key) && value instanceof Energy) { this.workload((Energy)value); return; }
      if ("workloads".equals(key) && value instanceof Energy) { this.workload((Energy)value); return; }
      if ("workload".equals(key) && value instanceof QuantitativeValue) { this.workload((QuantitativeValue)value); return; }
      if ("workloads".equals(key) && value instanceof QuantitativeValue) { this.workload((QuantitativeValue)value); return; }
      if ("additionalVariable".equals(key) && value instanceof String) { this.additionalVariable((String)value); return; }
      if ("additionalVariables".equals(key) && value instanceof String) { this.additionalVariable((String)value); return; }
      if ("repetitions".equals(key) && value instanceof Integer) { this.repetitions((Integer)value); return; }
      if ("repetitionss".equals(key) && value instanceof Integer) { this.repetitions((Integer)value); return; }
      if ("repetitions".equals(key) && value instanceof Long) { this.repetitions((Long)value); return; }
      if ("repetitionss".equals(key) && value instanceof Long) { this.repetitions((Long)value); return; }
      if ("repetitions".equals(key) && value instanceof Float) { this.repetitions((Float)value); return; }
      if ("repetitionss".equals(key) && value instanceof Float) { this.repetitions((Float)value); return; }
      if ("repetitions".equals(key) && value instanceof Double) { this.repetitions((Double)value); return; }
      if ("repetitionss".equals(key) && value instanceof Double) { this.repetitions((Double)value); return; }
      if ("repetitions".equals(key) && value instanceof String) { this.repetitions((String)value); return; }
      if ("repetitionss".equals(key) && value instanceof String) { this.repetitions((String)value); return; }
      ...
      if ("intensity".equals(key) && value instanceof QuantitativeValue) { this.intensity((QuantitativeValue)value); return; }
      if ("intensitys".equals(key) && value instanceof QuantitativeValue) { this.intensity((QuantitativeValue)value); return; }
      if ("intensity".equals(key) && value instanceof String) { this.intensity((String)value); return; }
      if ("intensitys".equals(key) && value instanceof String) { this.intensity((String)value); return; }
