...
public class TravelAgency extends LocalBusiness {
  protected TravelAgency(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link TravelAgency}
   */
  public static class Builder extends LocalBusiness.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public TravelAgency build() {
      return new TravelAgency(myData);
    }
    /**
