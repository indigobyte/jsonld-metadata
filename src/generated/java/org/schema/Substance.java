...
/**
 * Any matter of defined composition that has discrete existence, whose origin may be biological, mineral or chemical.Equivalent class: http://purl.bioontology.org/ontology/SNOMEDCT/105590001
 */
public class Substance extends MedicalEntity {
  ...
  protected Substance(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link Substance}
   */
  public static class Builder extends MedicalEntity.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public Substance build() {
      return new Substance(myData);
    }
    /**
     * An active ingredient, typically chemical compounds and/or biologic substances.
