...
public class RadioBroadcastService extends BroadcastService {
  protected RadioBroadcastService(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link RadioBroadcastService}
   */
  public static class Builder extends BroadcastService.Builder {
