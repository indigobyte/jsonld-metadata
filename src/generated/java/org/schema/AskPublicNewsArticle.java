 ...
 */
public class AskPublicNewsArticle extends NewsArticle {
  protected AskPublicNewsArticle(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link AskPublicNewsArticle}
   */
  public static class Builder extends NewsArticle.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public AskPublicNewsArticle build() {
      return new AskPublicNewsArticle(myData);
    }
    /**
