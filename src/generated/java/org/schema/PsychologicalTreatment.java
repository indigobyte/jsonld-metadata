 ...
 */
public class PsychologicalTreatment extends TherapeuticProcedure {
  protected PsychologicalTreatment(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link PsychologicalTreatment}
   */
  public static class Builder extends TherapeuticProcedure.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public PsychologicalTreatment build() {
      return new PsychologicalTreatment(myData);
    }
    /**
