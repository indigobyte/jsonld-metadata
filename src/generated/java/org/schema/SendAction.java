...
public class SendAction extends TransferAction {
   ...
   * @return deliveryMethod property set by first invocation of deliveryMethod method or {@code null}.
   */
  @JsonIgnore public Instrument getDeliveryMethod() {
    return (Instrument) getValue("deliveryMethod");
  }
  /**
   * A sub property of instrument. The method of delivery.
   * @return all deliveryMethod properties as {@link java.util.Collection} or an empty collection 
   * if deliveryMethod was not set.
   */
  @JsonIgnore public java.util.Collection<Instrument> getDeliveryMethods() {
    final java.lang.Object current = myData.get("deliveryMethod");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected SendAction(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link SendAction}
   */
  public static class Builder extends TransferAction.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public SendAction build() {
      return new SendAction(myData);
    }
    /**
     * A sub property of participant. The participant who is at the receiving end of the action.
     ...
     * @return this builder instance
     */
    @NotNull public Builder deliveryMethod(@NotNull Instrument instrument) {
      putValue("deliveryMethod", instrument);
      return this;
    }
    /**
     * Remove deliveryMethod property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeDeliveryMethod() {
      removeValue("deliveryMethod");
      return this;
    }
    /**
     * Get currently set value for deliveryMethod property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getDeliveryMethod() {
      return myData.get("deliveryMethod");
    }
    /**
