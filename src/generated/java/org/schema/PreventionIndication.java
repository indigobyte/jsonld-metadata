...
public class PreventionIndication extends MedicalIndication {
  protected PreventionIndication(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends MedicalIndication.Builder {
    ...
    @NotNull public PreventionIndication build() {
      return new PreventionIndication(myData);
    }
    /**
