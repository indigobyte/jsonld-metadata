...
public class RadioStation extends LocalBusiness {
  protected RadioStation(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link RadioStation}
   */
  public static class Builder extends LocalBusiness.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public RadioStation build() {
      return new RadioStation(myData);
    }
    /**
