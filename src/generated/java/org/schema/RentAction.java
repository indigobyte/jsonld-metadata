...
public class RentAction extends TradeAction {
   ...
   * @return realEstateAgent property set by first invocation of realEstateAgent method or {@code null}.
   */
  ...
  /**
   * A sub property of participant. The real estate agent involved in the action.
   * @return all realEstateAgent properties as {@link java.util.Collection} or an empty collection 
   * if realEstateAgent was not set.
   */
  @JsonIgnore public java.util.Collection<Participant> getRealEstateAgents() {
    final java.lang.Object current = myData.get("realEstateAgent");
   ...
   * @return landlord property set by first invocation of landlord method or {@code null}.
   */
  ...
  /**
   * A sub property of participant. The owner of the real estate property.
   * @return all landlord properties as {@link java.util.Collection} or an empty collection 
   * if landlord was not set.
   */
  @JsonIgnore public java.util.Collection<Participant> getLandlords() {
    final java.lang.Object current = myData.get("landlord");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Participant>) current;
    }
  ...
  protected RentAction(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends TradeAction.Builder {
    ...
    /**
     * Remove realEstateAgent property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRealEstateAgent() {
      removeValue("realEstateAgent");
      return this;
    }
    /**
     * Get currently set value for realEstateAgent property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRealEstateAgent() {
      return myData.get("realEstateAgent");
    }
    /**
     * A sub property of participant. The owner of the real estate property.
     * @param participant value to set
    ...
    /**
     * Remove landlord property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLandlord() {
      removeValue("landlord");
      return this;
    }
    /**
     * Get currently set value for landlord property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLandlord() {
      return myData.get("landlord");
    }
    /**
