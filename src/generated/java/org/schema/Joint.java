...
public class Joint extends AnatomicalStructure {
   ...
   * @return functionalClass property set by first invocation of functionalClass method or {@code null}.
   */
  ...
  /**
   * The degree of mobility the joint allows.
   * @return all functionalClass properties as {@link java.util.Collection} or an empty collection 
   * if functionalClass was not set.
   */
  @JsonIgnore public java.util.Collection<MedicalEntity> getFunctionalClassMedicalEntitys() {
    final java.lang.Object current = myData.get("functionalClass");
   ...
   * @return biomechnicalClass property set by first invocation of biomechnicalClass method or {@code null}.
   */
  ...
  /**
   * The biomechanical properties of the bone.
   * @return all biomechnicalClass properties as {@link java.util.Collection} or an empty collection 
   * if biomechnicalClass was not set.
   */
  @JsonIgnore public java.util.Collection<String> getBiomechnicalClasss() {
    final java.lang.Object current = myData.get("biomechnicalClass");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
   ...
   * @return structuralClass property set by first invocation of structuralClass method or {@code null}.
   */
  ...
  /**
   * The name given to how bone physically connects to each other.
   * @return all structuralClass properties as {@link java.util.Collection} or an empty collection 
   * if structuralClass was not set.
   */
  @JsonIgnore public java.util.Collection<String> getStructuralClasss() {
    final java.lang.Object current = myData.get("structuralClass");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<String>) current;
    }
  ...
  protected Joint(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends AnatomicalStructure.Builder {
    ...
    /**
     * The degree of mobility the joint allows.
     * @param functionalClass value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove functionalClass property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeFunctionalClass() {
      removeValue("functionalClass");
      return this;
    }
    /**
     * Get currently set value for functionalClass property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getFunctionalClass() {
      return myData.get("functionalClass");
    }
    /**
     * The biomechanical properties of the bone.
     * @param biomechnicalClass value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove biomechnicalClass property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeBiomechnicalClass() {
      removeValue("biomechnicalClass");
      return this;
    }
    /**
     * Get currently set value for biomechnicalClass property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getBiomechnicalClass() {
      return myData.get("biomechnicalClass");
    }
    /**
     * The name given to how bone physically connects to each other.
     * @param structuralClass value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove structuralClass property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeStructuralClass() {
      removeValue("structuralClass");
      return this;
    }
    /**
     * Get currently set value for structuralClass property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getStructuralClass() {
      return myData.get("structuralClass");
    }
    /**
