...
public class OccupationalExperienceRequirements extends Intangible {
   ...
   * @return monthsOfExperience property set by first invocation of monthsOfExperience method or {@code null}.
   */
  ...
  /**
   * Indicates the minimal number of months of experience required for a position.
   * @return all monthsOfExperience properties as {@link java.util.Collection} or an empty collection 
   * if monthsOfExperience was not set.
   */
  ...
  public static class Builder extends Intangible.Builder {
    ...
    /**
     * Indicates the minimal number of months of experience required for a position.
     * @param monthsOfExperience value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove monthsOfExperience property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeMonthsOfExperience() {
      removeValue("monthsOfExperience");
      return this;
    }
    /**
     * Get currently set value for monthsOfExperience property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getMonthsOfExperience() {
      return myData.get("monthsOfExperience");
    }
    /**
