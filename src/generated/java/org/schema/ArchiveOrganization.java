...
public class ArchiveOrganization extends LocalBusiness {
   ...
   * @return archiveHeld property set by first invocation of archiveHeld method or {@code null}.
   */
  @JsonIgnore public ArchiveComponent getArchiveHeld() {
    return (ArchiveComponent) getValue("archiveHeld");
  }
  /**
   * Collection, [fonds](https://en.wikipedia.org/wiki/Fonds), or item held, kept or maintained by an [[ArchiveOrganization]].
   * @return all archiveHeld properties as {@link java.util.Collection} or an empty collection 
   * if archiveHeld was not set.
   */
  @JsonIgnore public java.util.Collection<ArchiveComponent> getArchiveHelds() {
    final java.lang.Object current = myData.get("archiveHeld");
  ...
  protected ArchiveOrganization(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link ArchiveOrganization}
   */
  public static class Builder extends LocalBusiness.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public ArchiveOrganization build() {
      return new ArchiveOrganization(myData);
    }
    /**
     * Collection, [fonds](https://en.wikipedia.org/wiki/Fonds), or item held, kept or maintained by an [[ArchiveOrganization]].
     * @param archiveComponent value to set
     * @return this builder instance
     */
    @NotNull public Builder archiveHeld(@NotNull ArchiveComponent archiveComponent) {
      putValue("archiveHeld", archiveComponent);
      return this;
    }
    /**
     * Collection, [fonds](https://en.wikipedia.org/wiki/Fonds), or item held, kept or maintained by an [[ArchiveOrganization]].
     ...
     * @return this builder instance
     */
    @NotNull public Builder archiveHeld(@NotNull ArchiveComponent.Builder archiveComponent) {
      putValue("archiveHeld", archiveComponent.build());
      return this;
    }
    /**
     * Remove archiveHeld property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeArchiveHeld() {
      removeValue("archiveHeld");
      return this;
    }
    /**
     * Get currently set value for archiveHeld property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getArchiveHeld() {
      return myData.get("archiveHeld");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("archiveHeld".equals(key) && value instanceof ArchiveComponent) { this.archiveHeld((ArchiveComponent)value); return; }
      if ("archiveHelds".equals(key) && value instanceof ArchiveComponent) { this.archiveHeld((ArchiveComponent)value); return; }
