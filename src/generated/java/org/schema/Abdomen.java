 ...
 */
public class Abdomen extends PhysicalExam {
  protected Abdomen(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends PhysicalExam.Builder {
    ...
    @NotNull public Abdomen build() {
      return new Abdomen(myData);
    }
    /**
