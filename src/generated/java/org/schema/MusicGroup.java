...
public class MusicGroup extends PerformingGroup {
  ...
  /**
   * A music album.
   * @return album property set by first invocation of album method or {@code null}.
   */
  @JsonIgnore public MusicAlbum getAlbum() {
    return (MusicAlbum) getValue("album");
  }
  /**
   * A music album.
   * @return all album properties as {@link java.util.Collection} or an empty collection 
   * if album was not set.
   */
  ...
  public static class Builder extends PerformingGroup.Builder {
     ...
     * @return this builder instance
     */
    @NotNull public Builder album(@NotNull MusicAlbum musicAlbum) {
      putValue("album", musicAlbum);
      return this;
    }
    /**
     * A music album.
    ...
    /**
     * Remove album property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAlbum() {
      removeValue("album");
      return this;
    }
    /**
     * Get currently set value for album property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAlbum() {
      return myData.get("album");
    }
    /**
     * A music recording (track)&amp;#x2014;usually a single song. If an ItemList is given, the list should contain items of type MusicRecording.
