...
public class OpinionNewsArticle extends NewsArticle {
  protected OpinionNewsArticle(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link OpinionNewsArticle}
   */
  public static class Builder extends NewsArticle.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public OpinionNewsArticle build() {
      return new OpinionNewsArticle(myData);
    }
    /**
