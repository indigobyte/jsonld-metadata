...
public class CommentAction extends CommunicateAction {
   ...
   * @return resultComment property set by first invocation of resultComment method or {@code null}.
   */
  @JsonIgnore public Result getResultComment() {
    return (Result) getValue("resultComment");
  }
  /**
   * A sub property of result. The Comment created or sent as a result of this action.
   * @return all resultComment properties as {@link java.util.Collection} or an empty collection 
   * if resultComment was not set.
   */
  @JsonIgnore public java.util.Collection<Result> getResultComments() {
    final java.lang.Object current = myData.get("resultComment");
  ...
  protected CommentAction(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends CommunicateAction.Builder {
     ...
     */
    @NotNull public Builder resultComment(@NotNull Result result) {
      putValue("resultComment", result);
      return this;
    }
    /**
     * Remove resultComment property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeResultComment() {
      removeValue("resultComment");
      return this;
    }
    /**
     * Get currently set value for resultComment property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getResultComment() {
      return myData.get("resultComment");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("resultComment".equals(key) && value instanceof Result) { this.resultComment((Result)value); return; }
      if ("resultComments".equals(key) && value instanceof Result) { this.resultComment((Result)value); return; }
