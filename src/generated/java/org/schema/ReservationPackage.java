...
public class ReservationPackage extends Reservation {
   ...
   * @return subReservation property set by first invocation of subReservation method or {@code null}.
   */
  @JsonIgnore public Reservation getSubReservation() {
    return (Reservation) getValue("subReservation");
  }
  /**
   * The individual reservations included in the package. Typically a repeated property.
   * @return all subReservation properties as {@link java.util.Collection} or an empty collection 
   * if subReservation was not set.
   */
  ...
  public static class Builder extends Reservation.Builder {
    ...
    @NotNull public Builder subReservation(@NotNull Reservation reservation) {
      putValue("subReservation", reservation);
      return this;
    }
    /**
     * The individual reservations included in the package. Typically a repeated property.
    ...
    @NotNull public Builder subReservation(@NotNull Reservation.Builder reservation) {
      putValue("subReservation", reservation.build());
      return this;
    }
    /**
     * Remove subReservation property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSubReservation() {
      removeValue("subReservation");
      return this;
    }
    /**
     * Get currently set value for subReservation property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSubReservation() {
      return myData.get("subReservation");
    }
    /**
