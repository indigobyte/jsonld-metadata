 ...
 */
public class RespiratoryTherapy extends MedicalTherapy {
  protected RespiratoryTherapy(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link RespiratoryTherapy}
   */
  public static class Builder extends MedicalTherapy.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public RespiratoryTherapy build() {
      return new RespiratoryTherapy(myData);
    }
    /**
