 ...
 */
public class VideoObjectSnapshot extends VideoObject {
  protected VideoObjectSnapshot(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link VideoObjectSnapshot}
   */
  public static class Builder extends VideoObject.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public VideoObjectSnapshot build() {
      return new VideoObjectSnapshot(myData);
    }
    /**
