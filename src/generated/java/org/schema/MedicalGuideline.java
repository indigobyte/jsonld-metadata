...
public class MedicalGuideline extends MedicalEntity {
   ...
   * @return guidelineDate property set by first invocation of guidelineDate method or {@code null}.
   */
  ...
  /**
   * Date on which this guideline's recommendation was made.
   * @return all guidelineDate properties as {@link java.util.Collection} or an empty collection 
   * if guidelineDate was not set.
   */
   ...
   * @return evidenceOrigin property set by first invocation of evidenceOrigin method or {@code null}.
   */
  ...
  /**
   * Source of the data used to formulate the guidance, e.g. RCT, consensus opinion, etc.
   * @return all evidenceOrigin properties as {@link java.util.Collection} or an empty collection 
   * if evidenceOrigin was not set.
   */
   ...
   * @return guidelineSubject property set by first invocation of guidelineSubject method or {@code null}.
   */
  ...
  /**
   * The medical conditions, treatments, etc. that are the subject of the guideline.
   * @return all guidelineSubject properties as {@link java.util.Collection} or an empty collection 
   * if guidelineSubject was not set.
   */
   ...
   * @return evidenceLevel property set by first invocation of evidenceLevel method or {@code null}.
   */
  ...
  /**
   * Strength of evidence of the data used to formulate the guideline (enumerated).
   * @return all evidenceLevel properties as {@link java.util.Collection} or an empty collection 
   * if evidenceLevel was not set.
   */
