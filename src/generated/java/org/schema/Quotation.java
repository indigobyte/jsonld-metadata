...
public class Quotation extends CreativeWork {
   ...
   * @return spokenByCharacter property set by first invocation of spokenByCharacter method or {@code null}.
   */
  @JsonIgnore public Organization getSpokenByCharacterOrganization() {
    return (Organization) getValue("spokenByCharacter");
  }
  /**
   * The (e.g. fictional) character, Person or Organization to whom the quotation is attributed within the containing CreativeWork.
   * @return all spokenByCharacter properties as {@link java.util.Collection} or an empty collection 
   * if spokenByCharacter was not set.
   */
  @JsonIgnore public java.util.Collection<Organization> getSpokenByCharacterOrganizations() {
    final java.lang.Object current = myData.get("spokenByCharacter");
   ...
   * @return spokenByCharacter property set by first invocation of spokenByCharacter method or {@code null}.
   */
  @JsonIgnore public Person getSpokenByCharacterPerson() {
    return (Person) getValue("spokenByCharacter");
  }
  /**
   * The (e.g. fictional) character, Person or Organization to whom the quotation is attributed within the containing CreativeWork.
   * @return all spokenByCharacter properties as {@link java.util.Collection} or an empty collection 
  ...
  protected Quotation(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link Quotation}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public Quotation build() {
      return new Quotation(myData);
    }
    /**
     * The (e.g. fictional) character, Person or Organization to whom the quotation is attributed within the containing CreativeWork.
     ...
     */
    @NotNull public Builder spokenByCharacter(@NotNull Organization organization) {
      putValue("spokenByCharacter", organization);
      return this;
    }
    /**
     * The (e.g. fictional) character, Person or Organization to whom the quotation is attributed within the containing CreativeWork.
     ...
     * @return this builder instance
     */
    @NotNull public Builder spokenByCharacter(@NotNull Organization.Builder organization) {
      putValue("spokenByCharacter", organization.build());
      return this;
    }
    /**
     * The (e.g. fictional) character, Person or Organization to whom the quotation is attributed within the containing CreativeWork.
     ...
     * @return this builder instance
     */
    @NotNull public Builder spokenByCharacter(@NotNull Person person) {
      putValue("spokenByCharacter", person);
      return this;
    }
    /**
     * The (e.g. fictional) character, Person or Organization to whom the quotation is attributed within the containing CreativeWork.
     ...
     * @return this builder instance
     */
    @NotNull public Builder spokenByCharacter(@NotNull Person.Builder person) {
      putValue("spokenByCharacter", person.build());
      return this;
    }
    /**
     * Remove spokenByCharacter property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSpokenByCharacter() {
      removeValue("spokenByCharacter");
      return this;
    }
    /**
     * Get currently set value for spokenByCharacter property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSpokenByCharacter() {
      return myData.get("spokenByCharacter");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("spokenByCharacter".equals(key) && value instanceof Organization) { this.spokenByCharacter((Organization)value); return; }
      if ("spokenByCharacters".equals(key) && value instanceof Organization) { this.spokenByCharacter((Organization)value); return; }
      if ("spokenByCharacter".equals(key) && value instanceof Person) { this.spokenByCharacter((Person)value); return; }
      if ("spokenByCharacters".equals(key) && value instanceof Person) { this.spokenByCharacter((Person)value); return; }
