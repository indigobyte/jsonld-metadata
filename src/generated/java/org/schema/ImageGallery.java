 ...
 */
public class ImageGallery extends MediaGallery {
  protected ImageGallery(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
   ...
   */
  public static class Builder extends MediaGallery.Builder {
