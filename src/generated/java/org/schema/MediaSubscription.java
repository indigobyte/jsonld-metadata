...
public class MediaSubscription extends Intangible {
   ...
   * @return authenticator property set by first invocation of authenticator method or {@code null}.
   */
  ...
  /**
   * The Organization responsible for authenticating the user's subscription. For example, many media apps require a cable/satellite provider to authenticate your subscription before playing media.
   * @return all authenticator properties as {@link java.util.Collection} or an empty collection 
   * if authenticator was not set.
   */
  @JsonIgnore public java.util.Collection<Organization> getAuthenticators() {
    final java.lang.Object current = myData.get("authenticator");
  ...
  protected MediaSubscription(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends Intangible.Builder {
    ...
    /**
     * Remove authenticator property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAuthenticator() {
      removeValue("authenticator");
      return this;
    }
    /**
     * Get currently set value for authenticator property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAuthenticator() {
      return myData.get("authenticator");
    }
    /**
     * An Offer which must be accepted before the user can perform the Action. For example, the user may need to buy a movie before being able to watch it.
