 ...
 * A ski resort.
 */
public class SkiResort extends Resort {
  protected SkiResort(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link SkiResort}
   */
  public static class Builder extends Resort.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public SkiResort build() {
      return new SkiResort(myData);
    }
    /**
