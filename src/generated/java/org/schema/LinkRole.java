...
public class LinkRole extends Role {
   ...
   * @return linkRelationship property set by first invocation of linkRelationship method or {@code null}.
   */
  ...
  /**
   * Indicates the relationship type of a Web link. 
   * @return all linkRelationship properties as {@link java.util.Collection} or an empty collection 
   * if linkRelationship was not set.
   */
  ...
  public static class Builder extends Role.Builder {
    ...
    /**
     * Indicates the relationship type of a Web link. 
     * @param linkRelationship value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove linkRelationship property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLinkRelationship() {
      removeValue("linkRelationship");
      return this;
    }
    /**
     * Get currently set value for linkRelationship property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLinkRelationship() {
      return myData.get("linkRelationship");
    }
    /**
