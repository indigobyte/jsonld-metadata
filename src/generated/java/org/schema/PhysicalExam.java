...
public class PhysicalExam extends MedicalProcedure {
  protected PhysicalExam(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link PhysicalExam}
   */
  public static class Builder extends MedicalProcedure.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public PhysicalExam build() {
      return new PhysicalExam(myData);
    }
    /**
