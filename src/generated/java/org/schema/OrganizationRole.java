...
public class OrganizationRole extends Role {
   ...
   * @return numberedPosition property set by first invocation of numberedPosition method or {@code null}.
   */
  ...
  /**
   * A number associated with a role in an organization, for example, the number on an athlete's jersey.
   * @return all numberedPosition properties as {@link java.util.Collection} or an empty collection 
   * if numberedPosition was not set.
   */
