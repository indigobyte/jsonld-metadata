...
/**
 * A public toilet is a room or small building containing one or more toilets (and possibly also urinals) which is available for use by the general public, or by customers or employees of certain businesses.Source: https://github.com/schemaorg/schemaorg/issues/1624
 */
public class PublicToilet extends CivicStructure {
  protected PublicToilet(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link PublicToilet}
   */
  public static class Builder extends CivicStructure.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public PublicToilet build() {
      return new PublicToilet(myData);
    }
    /**
