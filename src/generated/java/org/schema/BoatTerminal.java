 ...
 */
public class BoatTerminal extends CivicStructure {
  protected BoatTerminal(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link BoatTerminal}
   */
  public static class Builder extends CivicStructure.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public BoatTerminal build() {
      return new BoatTerminal(myData);
    }
    /**
