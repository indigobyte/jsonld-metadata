 ...
 */
public class HowToTool extends HowToItem implements Tool {
  protected HowToTool(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link HowToTool}
   */
  public static class Builder extends HowToItem.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public HowToTool build() {
      return new HowToTool(myData);
    }
    /**
