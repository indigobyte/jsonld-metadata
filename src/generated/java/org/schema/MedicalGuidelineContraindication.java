...
public class MedicalGuidelineContraindication extends MedicalGuideline {
  protected MedicalGuidelineContraindication(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link MedicalGuidelineContraindication}
   */
  public static class Builder extends MedicalGuideline.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MedicalGuidelineContraindication build() {
      return new MedicalGuidelineContraindication(myData);
    }
    /**
