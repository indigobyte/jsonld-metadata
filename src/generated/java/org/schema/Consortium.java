...
/**
 * A Consortium is a membership &lt;a class=&quot;localLink&quot; href=&quot;http://schema.org/Organization&quot;&gt;Organization&lt;/a&gt; whose members are typically Organizations.Source: https://github.com/schemaorg/schemaorg/issues/1559
 */
public class Consortium extends Organization {
  protected Consortium(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Consortium}
   */
  public static class Builder extends Organization.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public Consortium build() {
      return new Consortium(myData);
    }
    /**
