 ...
 */
public class HowToTip extends CreativeWork {
  protected HowToTip(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link HowToTip}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public HowToTip build() {
      return new HowToTip(myData);
    }
    /**
