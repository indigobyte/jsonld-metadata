...
public class MedicalRiskScore extends MedicalRiskEstimator {
   ...
   * @return algorithm property set by first invocation of algorithm method or {@code null}.
   */
  @JsonIgnore public String getAlgorithm() {
    return (String) getValue("algorithm");
  }
  /**
   * The algorithm or rules to follow to compute the score.
   * @return all algorithm properties as {@link java.util.Collection} or an empty collection 
   * if algorithm was not set.
   */
  @JsonIgnore public java.util.Collection<String> getAlgorithms() {
    final java.lang.Object current = myData.get("algorithm");
  ...
  protected MedicalRiskScore(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link MedicalRiskScore}
   */
  public static class Builder extends MedicalRiskEstimator.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MedicalRiskScore build() {
      return new MedicalRiskScore(myData);
    }
    /**
     * The algorithm or rules to follow to compute the score.
     ...
     */
    @NotNull public Builder algorithm(@NotNull String algorithm) {
      putValue("algorithm", algorithm);
      return this;
    }
    /**
     * Remove algorithm property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAlgorithm() {
      removeValue("algorithm");
      return this;
    }
    /**
     * Get currently set value for algorithm property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAlgorithm() {
      return myData.get("algorithm");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("algorithm".equals(key) && value instanceof String) { this.algorithm((String)value); return; }
      if ("algorithms".equals(key) && value instanceof String) { this.algorithm((String)value); return; }
