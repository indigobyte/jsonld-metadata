 ...
 */
public class Tourism extends Organization {
  protected Tourism(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Tourism}
   */
  public static class Builder extends Organization.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public Tourism build() {
      return new Tourism(myData);
    }
    /**
