...
public class WebPageElement extends CreativeWork {
   ...
   * @return cssSelector property set by first invocation of cssSelector method or {@code null}.
   */
  ...
  /**
   * A CSS selector, e.g. of a [[SpeakableSpecification]] or [[WebPageElement]]. In the latter case, multiple matches within a page can constitute a single conceptual &quot;Web page element&quot;.
   * @return all cssSelector properties as {@link java.util.Collection} or an empty collection 
   * if cssSelector was not set.
   */
   ...
   * @return xpath property set by first invocation of xpath method or {@code null}.
   */
  ...
  /**
   * An XPath, e.g. of a [[SpeakableSpecification]] or [[WebPageElement]]. In the latter case, multiple matches within a page can constitute a single conceptual &quot;Web page element&quot;.
   * @return all xpath properties as {@link java.util.Collection} or an empty collection 
   * if xpath was not set.
   */
  ...
  protected WebPageElement(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    /**
     * A CSS selector, e.g. of a [[SpeakableSpecification]] or [[WebPageElement]]. In the latter case, multiple matches within a page can constitute a single conceptual &quot;Web page element&quot;.
     * @param cssSelector value to set
    ...
    /**
     * Remove cssSelector property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCssSelector() {
      removeValue("cssSelector");
      return this;
    }
    /**
     * Get currently set value for cssSelector property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCssSelector() {
      return myData.get("cssSelector");
    }
    /**
     * An XPath, e.g. of a [[SpeakableSpecification]] or [[WebPageElement]]. In the latter case, multiple matches within a page can constitute a single conceptual &quot;Web page element&quot;.
     * @param xpath value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove xpath property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeXpath() {
      removeValue("xpath");
      return this;
    }
    /**
     * Get currently set value for xpath property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getXpath() {
      return myData.get("xpath");
    }
    /**
