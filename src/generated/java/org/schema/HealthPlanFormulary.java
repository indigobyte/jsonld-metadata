...
public class HealthPlanFormulary extends Intangible {
   ...
   * @return offersPrescriptionByMail property set by first invocation of offersPrescriptionByMail method or {@code null}.
   */
  ...
  /**
   * Whether prescriptions can be delivered by mail.
   * @return all offersPrescriptionByMail properties as {@link java.util.Collection} or an empty collection 
   * if offersPrescriptionByMail was not set.
   */
  @JsonIgnore public java.util.Collection<Boolean> getOffersPrescriptionByMails() {
    final java.lang.Object current = myData.get("offersPrescriptionByMail");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<Boolean>) current;
    }
  ...
  protected HealthPlanFormulary(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends Intangible.Builder {
    ...
    /**
     * Whether prescriptions can be delivered by mail.
     * @param offersPrescriptionByMail value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove offersPrescriptionByMail property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeOffersPrescriptionByMail() {
      removeValue("offersPrescriptionByMail");
      return this;
    }
    /**
     * Get currently set value for offersPrescriptionByMail property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getOffersPrescriptionByMail() {
      return myData.get("offersPrescriptionByMail");
    }
    /**
