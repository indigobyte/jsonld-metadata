...
public class Role extends Intangible {
   ...
   * @return roleName property set by first invocation of roleName method or {@code null}.
   */
  @JsonIgnore public String getRoleName() {
    return (String) getValue("roleName");
  }
  /**
   * A role played, performed or filled by a person or organization. For example, the team of creators for a comic book might fill the roles named 'inker', 'penciller', and 'letterer'; or an athlete in a SportsTeam might play in the position named 'Quarterback'.
   * @return all roleName properties as {@link java.util.Collection} or an empty collection 
   * if roleName was not set.
   */
  @JsonIgnore public java.util.Collection<String> getRoleNames() {
    final java.lang.Object current = myData.get("roleName");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected Role(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends Intangible.Builder {
    ...
    @NotNull public Role build() {
      return new Role(myData);
    }
    /**
     * The start date and time of the item (in [ISO 8601 date format](http://en.wikipedia.org/wiki/ISO_8601)).
