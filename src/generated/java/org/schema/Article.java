...
public class Article extends CreativeWork {
   ...
   * @return articleSection property set by first invocation of articleSection method or {@code null}.
   */
  @JsonIgnore public String getArticleSection() {
    return (String) getValue("articleSection");
  }
  /**
   * Articles may belong to one or more 'sections' in a magazine or newspaper, such as Sports, Lifestyle, etc.
   * @return all articleSection properties as {@link java.util.Collection} or an empty collection 
   * if articleSection was not set.
   */
   ...
   * @return articleBody property set by first invocation of articleBody method or {@code null}.
   */
  @JsonIgnore public String getArticleBody() {
    return (String) getValue("articleBody");
  }
  /**
   * The actual body of the article.
   * @return all articleBody properties as {@link java.util.Collection} or an empty collection 
   * if articleBody was not set.
   */
   ...
   * @return pageEnd property set by first invocation of pageEnd method or {@code null}.
   */
  ...
  /**
   * The page on which the work ends; for example &quot;138&quot; or &quot;xvi&quot;.
   * @return all pageEnd properties as {@link java.util.Collection} or an empty collection 
   * if pageEnd was not set.
   */
   ...
   * @return wordCount property set by first invocation of wordCount method or {@code null}.
   */
  @JsonIgnore public Integer getWordCount() {
    return (Integer) getValue("wordCount");
  }
  /**
   * The number of words in the text of the Article.
   * @return all wordCount properties as {@link java.util.Collection} or an empty collection 
   * if wordCount was not set.
   */
   ...
   * @return pageStart property set by first invocation of pageStart method or {@code null}.
   */
  ...
  /**
   * The page on which the work starts; for example &quot;135&quot; or &quot;xiii&quot;.
   * @return all pageStart properties as {@link java.util.Collection} or an empty collection 
   * if pageStart was not set.
   */
   ...
   * @return pagination property set by first invocation of pagination method or {@code null}.
   */
  ...
  /**
   * Any description of pages that is not separated into pageStart and pageEnd; for example, &quot;1-6, 9, 55&quot; or &quot;10-12, 46-49&quot;.
   * @return all pagination properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return backstory property set by first invocation of backstory method or {@code null}.
   */
  @JsonIgnore public CreativeWork getBackstoryCreativeWork() {
    return (CreativeWork) getValue("backstory");
  }
  /**
   * For an [[Article]], typically a [[NewsArticle]], the backstory property provides a textual summary giving a brief explanation of why and how an article was created. In a journalistic setting this could include information about reporting process, methods, interviews, data sources, etc.
   * @return all backstory properties as {@link java.util.Collection} or an empty collection 
   * if backstory was not set.
   */
   ...
   * @return backstory property set by first invocation of backstory method or {@code null}.
   */
  @JsonIgnore public String getBackstoryString() {
    return (String) getValue("backstory");
  }
  /**
   * For an [[Article]], typically a [[NewsArticle]], the backstory property provides a textual summary giving a brief explanation of why and how an article was created. In a journalistic setting this could include information about reporting process, methods, interviews, data sources, etc.
   * @return all backstory properties as {@link java.util.Collection} or an empty collection 
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("backstory".equals(key) && value instanceof CreativeWork) { this.backstory((CreativeWork)value); return; }
      if ("backstorys".equals(key) && value instanceof CreativeWork) { this.backstory((CreativeWork)value); return; }
      if ("backstory".equals(key) && value instanceof String) { this.backstory((String)value); return; }
      if ("backstorys".equals(key) && value instanceof String) { this.backstory((String)value); return; }
