...
public class ConsumeAction extends Action {
   ...
   * @return actionAccessibilityRequirement property set by first invocation of actionAccessibilityRequirement method or {@code null}.
   */
  ...
  /**
   * A set of requirements that a must be fulfilled in order to perform an Action. If more than one value is specied, fulfilling one set of requirements will allow the Action to be performed.
   * @return all actionAccessibilityRequirement properties as {@link java.util.Collection} or an empty collection 
   * if actionAccessibilityRequirement was not set.
   */
  ...
  public static class Builder extends Action.Builder {
    ...
    @NotNull public ConsumeAction build() {
      return new ConsumeAction(myData);
    }
    /**
     * An Offer which must be accepted before the user can perform the Action. For example, the user may need to buy a movie before being able to watch it.
