...
public class PerformAction extends PlayAction {
  @JsonIgnore public EntertainmentBusiness getEntertainmentBusiness() {
    return (EntertainmentBusiness) getValue("entertainmentBusiness");
  }
  @JsonIgnore public Collection<EntertainmentBusiness> getEntertainmentBusinesss() {
    final Object current = myData.get("entertainmentBusiness");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<EntertainmentBusiness>) current;
    }
    return Arrays.asList((EntertainmentBusiness) current);
  }
  ...
  public static class Builder extends PlayAction.Builder {
    ...
    @NotNull public Builder entertainmentBusiness(@NotNull EntertainmentBusiness entertainmentBusiness) {
      putValue("entertainmentBusiness", entertainmentBusiness);
      return this;
    }
    @NotNull public Builder entertainmentBusiness(@NotNull EntertainmentBusiness.Builder entertainmentBusiness) {
      putValue("entertainmentBusiness", entertainmentBusiness.build());
      return this;
    }
    /**
