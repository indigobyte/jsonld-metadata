...
public class PerformAction extends PlayAction {
   ...
   * @return entertainmentBusiness property set by first invocation of entertainmentBusiness method or {@code null}.
   */
  @JsonIgnore public Location getEntertainmentBusiness() {
    return (Location) getValue("entertainmentBusiness");
  }
  /**
   * A sub property of location. The entertainment business where the action occurred.
   * @return all entertainmentBusiness properties as {@link java.util.Collection} or an empty collection 
   * if entertainmentBusiness was not set.
   */
  ...
  public static class Builder extends PlayAction.Builder {
     ...
     */
    @NotNull public Builder entertainmentBusiness(@NotNull Location location) {
      putValue("entertainmentBusiness", location);
      return this;
    }
    /**
     * Remove entertainmentBusiness property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeEntertainmentBusiness() {
      removeValue("entertainmentBusiness");
      return this;
    }
    /**
     * Get currently set value for entertainmentBusiness property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getEntertainmentBusiness() {
      return myData.get("entertainmentBusiness");
    }
    /**
