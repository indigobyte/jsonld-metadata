...
public class ResearchOrganization extends Organization {
  protected ResearchOrganization(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link ResearchOrganization}
   */
  public static class Builder extends Organization.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public ResearchOrganization build() {
      return new ResearchOrganization(myData);
    }
    /**
