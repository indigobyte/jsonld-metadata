...
public class CriticReview extends Review {
  protected CriticReview(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link CriticReview}
   */
  public static class Builder extends Review.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public CriticReview build() {
      return new CriticReview(myData);
    }
    /**
