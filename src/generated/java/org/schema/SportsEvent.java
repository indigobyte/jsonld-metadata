...
public class SportsEvent extends Event {
   ...
   * @return competitor property set by first invocation of competitor method or {@code null}.
   */
  ...
  /**
   * A competitor in a sports event.
   * @return all competitor properties as {@link java.util.Collection} or an empty collection 
   * if competitor was not set.
   */
   ...
   * @return homeTeam property set by first invocation of homeTeam method or {@code null}.
   */
  ...
  /**
   * The home team in a sports event.
   * @return all homeTeam properties as {@link java.util.Collection} or an empty collection 
   * if homeTeam was not set.
   */
   ...
   * @return awayTeam property set by first invocation of awayTeam method or {@code null}.
   */
  ...
  /**
   * The away team in a sports event.
   * @return all awayTeam properties as {@link java.util.Collection} or an empty collection 
   * if awayTeam was not set.
   */
   ...
   * @return sport property set by first invocation of sport method or {@code null}.
   */
  @JsonIgnore public String getSport() {
    return (String) getValue("sport");
  }
  /**
   * A type of sport (e.g. Baseball).
   * @return all sport properties as {@link java.util.Collection} or an empty collection 
   * if sport was not set.
   */
  ...
  public static class Builder extends Event.Builder {
    ...
    /**
     * Remove competitor property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCompetitor() {
      removeValue("competitor");
      return this;
    }
    /**
     * Get currently set value for competitor property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCompetitor() {
      return myData.get("competitor");
    }
    /**
     * The home team in a sports event.
     * @param competitor value to set
    ...
    /**
     * Remove homeTeam property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeHomeTeam() {
      removeValue("homeTeam");
      return this;
    }
    /**
     * Get currently set value for homeTeam property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getHomeTeam() {
      return myData.get("homeTeam");
    }
    /**
     * The away team in a sports event.
     * @param competitor value to set
    ...
    /**
     * Remove awayTeam property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAwayTeam() {
      removeValue("awayTeam");
      return this;
    }
    /**
     * Get currently set value for awayTeam property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAwayTeam() {
      return myData.get("awayTeam");
    }
    /**
     * A type of sport (e.g. Baseball).
     * @param sport value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove sport property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSport() {
      removeValue("sport");
      return this;
    }
    /**
     * Get currently set value for sport property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSport() {
      return myData.get("sport");
    }
    /**
