 ...
 */
public class OfferForLease extends Offer {
  protected OfferForLease(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link OfferForLease}
   */
  public static class Builder extends Offer.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public OfferForLease build() {
      return new OfferForLease(myData);
    }
    /**
