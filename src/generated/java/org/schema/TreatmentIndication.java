...
public class TreatmentIndication extends MedicalIndication {
  protected TreatmentIndication(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link TreatmentIndication}
   */
  public static class Builder extends MedicalIndication.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public TreatmentIndication build() {
      return new TreatmentIndication(myData);
    }
    /**
