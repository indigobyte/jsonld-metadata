...
public class Corporation extends Organization {
   ...
   * @return tickerSymbol property set by first invocation of tickerSymbol method or {@code null}.
   */
  @JsonIgnore public String getTickerSymbol() {
    return (String) getValue("tickerSymbol");
  }
  /**
   * The exchange traded instrument associated with a Corporation object. The tickerSymbol is expressed as an exchange and an instrument name separated by a space character. For the exchange component of the tickerSymbol attribute, we recommend using the controlled vocabulary of Market Identifier Codes (MIC) specified in ISO15022.
   * @return all tickerSymbol properties as {@link java.util.Collection} or an empty collection 
   * if tickerSymbol was not set.
   */
  @JsonIgnore public java.util.Collection<String> getTickerSymbols() {
    final java.lang.Object current = myData.get("tickerSymbol");
  ...
  protected Corporation(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends Organization.Builder {
    ...
    @NotNull public Corporation build() {
      return new Corporation(myData);
    }
    /**
     * The exchange traded instrument associated with a Corporation object. The tickerSymbol is expressed as an exchange and an instrument name separated by a space character. For the exchange component of the tickerSymbol attribute, we recommend using the controlled vocabulary of Market Identifier Codes (MIC) specified in ISO15022.
     * @param tickerSymbol value to set
     * @return this builder instance
     */
    @NotNull public Builder tickerSymbol(@NotNull String tickerSymbol) {
      putValue("tickerSymbol", tickerSymbol);
      return this;
    }
    /**
     * Remove tickerSymbol property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeTickerSymbol() {
      removeValue("tickerSymbol");
      return this;
    }
    /**
     * Get currently set value for tickerSymbol property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getTickerSymbol() {
      return myData.get("tickerSymbol");
    }
    /**
