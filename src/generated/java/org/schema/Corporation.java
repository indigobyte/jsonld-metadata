...
/**
 * Organization: A business corporation.Source: http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_rNews
 */
public class Corporation extends Organization {
  ...
  protected Corporation(java.util.Map<String,Object> data) {
    super(data);
  }
