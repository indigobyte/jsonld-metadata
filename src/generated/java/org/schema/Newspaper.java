...
/**
 * A publication containing information about varied topics that are pertinent to general information, a geographic area, or a specific subject matter (i.e. business, culture, education). Often published daily.Source: http://www.productontology.org/id/Newspaper
 */
public class Newspaper extends Periodical {
  protected Newspaper(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Newspaper}
   */
  public static class Builder extends Periodical.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public Newspaper build() {
      return new Newspaper(myData);
    }
    /**
