...
public class MedicalWebPage extends WebPage {
   ...
   * @return medicalAudience property set by first invocation of medicalAudience method or {@code null}.
   */
  @JsonIgnore public MedicalAudience getMedicalAudienceMedicalAudience() {
    return (MedicalAudience) getValue("medicalAudience");
  }
  /**
   * Medical audience for page.
   * @return all medicalAudience properties as {@link java.util.Collection} or an empty collection 
   * if medicalAudience was not set.
   */
  @JsonIgnore public java.util.Collection<MedicalAudience> getMedicalAudienceMedicalAudiences() {
    final java.lang.Object current = myData.get("medicalAudience");
   ...
   * @return medicalAudience property set by first invocation of medicalAudience method or {@code null}.
   */
  @JsonIgnore public MedicalAudienceType getMedicalAudienceMedicalAudienceType() {
    return (MedicalAudienceType) getValue("medicalAudience");
  }
  /**
   * Medical audience for page.
   * @return all medicalAudience properties as {@link java.util.Collection} or an empty collection 
  ...
  protected MedicalWebPage(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link MedicalWebPage}
   */
  public static class Builder extends WebPage.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MedicalWebPage build() {
      return new MedicalWebPage(myData);
    }
    /**
     * Medical audience for page.
     * @param medicalAudience value to set
     * @return this builder instance
     */
    @NotNull public Builder medicalAudience(@NotNull MedicalAudience medicalAudience) {
      putValue("medicalAudience", medicalAudience);
      return this;
    }
    /**
     * Medical audience for page.
     * @param medicalAudienceType value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove medicalAudience property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeMedicalAudience() {
      removeValue("medicalAudience");
      return this;
    }
    /**
     * Get currently set value for medicalAudience property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getMedicalAudience() {
      return myData.get("medicalAudience");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("medicalAudience".equals(key) && value instanceof MedicalAudience) { this.medicalAudience((MedicalAudience)value); return; }
      if ("medicalAudiences".equals(key) && value instanceof MedicalAudience) { this.medicalAudience((MedicalAudience)value); return; }
      if ("medicalAudience".equals(key) && value instanceof MedicalAudienceType) { this.medicalAudience((MedicalAudienceType)value); return; }
      if ("medicalAudiences".equals(key) && value instanceof MedicalAudienceType) { this.medicalAudience((MedicalAudienceType)value); return; }
