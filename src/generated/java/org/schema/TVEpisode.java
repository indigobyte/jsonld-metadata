...
public class TVEpisode extends Episode {
   ...
   * 
   *                                 @return titleEIDR property set by first invocation of titleEIDR method or {@code null}.
   */
  @JsonIgnore public Identifier getTitleEIDR() {
    return (Identifier) getValue("titleEIDR");
  }
  /**
   *                                     An [EIDR](https://eidr.org/) (Entertainment Identifier Registry) [[identifier]] representing at the most general/abstract level, a work of film or television.
   * 
   ...
   * Since schema.org types like [[Movie]] and [[TVEpisode]] can be used for both works and their multiple expressions, it is possible to use [[titleEIDR]] alone (for a general description), or alongside [[editEIDR]] for a more edit-specific description.
   * 
   *                                     @return all titleEIDR properties as {@link java.util.Collection} or an empty collection 
   *                                     if titleEIDR was not set.
   */
  @JsonIgnore public java.util.Collection<Identifier> getTitleEIDRs() {
    final java.lang.Object current = myData.get("titleEIDR");
   ...
   * @return subtitleLanguage property set by first invocation of subtitleLanguage method or {@code null}.
   */
  @JsonIgnore public Language getSubtitleLanguageLanguage() {
    return (Language) getValue("subtitleLanguage");
  }
  /**
   * Languages in which subtitles/captions are available, in [IETF BCP 47 standard format](http://tools.ietf.org/html/bcp47).
   * @return all subtitleLanguage properties as {@link java.util.Collection} or an empty collection 
   * if subtitleLanguage was not set.
   */
  @JsonIgnore public java.util.Collection<Language> getSubtitleLanguageLanguages() {
    final java.lang.Object current = myData.get("subtitleLanguage");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return subtitleLanguage property set by first invocation of subtitleLanguage method or {@code null}.
   */
  @JsonIgnore public String getSubtitleLanguageString() {
    return (String) getValue("subtitleLanguage");
  }
  /**
   * Languages in which subtitles/captions are available, in [IETF BCP 47 standard format](http://tools.ietf.org/html/bcp47).
   * @return all subtitleLanguage properties as {@link java.util.Collection} or an empty collection 
  ...
  protected TVEpisode(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends Episode.Builder {
     ...
     */
    @NotNull public Builder titleEIDR(@NotNull Identifier identifier) {
      putValue("titleEIDR", identifier);
      return this;
    }
    /**
     * Remove titleEIDR property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeTitleEIDR() {
      removeValue("titleEIDR");
      return this;
    }
    /**
     * Get currently set value for titleEIDR property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getTitleEIDR() {
      return myData.get("titleEIDR");
    }
    /**
     *                                         The country of origin of something, including products as well as creative  works such as movie and TV content.
     * 
     ...
     * @return this builder instance
     */
    @NotNull public Builder subtitleLanguage(@NotNull Language language) {
      putValue("subtitleLanguage", language);
      return this;
    }
    /**
     * Languages in which subtitles/captions are available, in [IETF BCP 47 standard format](http://tools.ietf.org/html/bcp47).
    ...
    /**
     * Languages in which subtitles/captions are available, in [IETF BCP 47 standard format](http://tools.ietf.org/html/bcp47).
     * @param subtitleLanguage value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove subtitleLanguage property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSubtitleLanguage() {
      removeValue("subtitleLanguage");
      return this;
    }
    /**
     * Get currently set value for subtitleLanguage property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSubtitleLanguage() {
      return myData.get("subtitleLanguage");
    }
    /**
    ...
    /**
     * Position of the episode within an ordered group of episodes.
     * @param episodeNumber value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove episodeNumber property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeEpisodeNumber() {
      removeValue("episodeNumber");
      return this;
    }
    /**
     * Get currently set value for episodeNumber property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getEpisodeNumber() {
      return myData.get("episodeNumber");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("titleEIDR".equals(key) && value instanceof Identifier) { this.titleEIDR((Identifier)value); return; }
      if ("titleEIDRs".equals(key) && value instanceof Identifier) { this.titleEIDR((Identifier)value); return; }
