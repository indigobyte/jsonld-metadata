...
/**
 * A picture or diagram made with a pencil, pen, or crayon rather than paint.Source: https://github.com/schemaorg/schemaorg/issues/1448
 */
public class Drawing extends CreativeWork {
  protected Drawing(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Drawing}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public Drawing build() {
      return new Drawing(myData);
    }
    /**
