 ...
 */
public class AnalysisNewsArticle extends NewsArticle {
  protected AnalysisNewsArticle(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link AnalysisNewsArticle}
   */
  public static class Builder extends NewsArticle.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public AnalysisNewsArticle build() {
      return new AnalysisNewsArticle(myData);
    }
    /**
