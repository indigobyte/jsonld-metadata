...
public class PublicationEvent extends Event {
   ...
   * @return publishedOn property set by first invocation of publishedOn method or {@code null}.
   */
  @JsonIgnore public BroadcastService getPublishedOn() {
    return (BroadcastService) getValue("publishedOn");
  }
  /**
   * A broadcast service associated with the publication event.
   * @return all publishedOn properties as {@link java.util.Collection} or an empty collection 
   * if publishedOn was not set.
   */
   ...
   * @return publishedBy property set by first invocation of publishedBy method or {@code null}.
   */
  @JsonIgnore public Organization getPublishedByOrganization() {
    return (Organization) getValue("publishedBy");
  }
  /**
   * An agent associated with the publication event.
   * @return all publishedBy properties as {@link java.util.Collection} or an empty collection 
   * if publishedBy was not set.
   */
   ...
   * @return publishedBy property set by first invocation of publishedBy method or {@code null}.
   */
  @JsonIgnore public Person getPublishedByPerson() {
    return (Person) getValue("publishedBy");
  }
  /**
   * An agent associated with the publication event.
   * @return all publishedBy properties as {@link java.util.Collection} or an empty collection 
  ...
  public static class Builder extends Event.Builder {
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      ...
      if ("publishedBys".equals(key) && value instanceof Organization) { this.publishedBy((Organization)value); return; }
      if ("publishedBy".equals(key) && value instanceof Person) { this.publishedBy((Person)value); return; }
      if ("publishedBys".equals(key) && value instanceof Person) { this.publishedBy((Person)value); return; }
