...
public class MediaReview extends Review {
   ...
   * @return mediaAuthenticityCategory property set by first invocation of mediaAuthenticityCategory method or {@code null}.
   */
  @JsonIgnore public MediaManipulationRatingEnumeration getMediaAuthenticityCategory() {
    return (MediaManipulationRatingEnumeration) getValue("mediaAuthenticityCategory");
  }
  /**
   * Indicates a MediaManipulationRatingEnumeration classification of a media object (in the context of how it was published or shared).
   * @return all mediaAuthenticityCategory properties as {@link java.util.Collection} or an empty collection 
   * if mediaAuthenticityCategory was not set.
   */
  @JsonIgnore public java.util.Collection<MediaManipulationRatingEnumeration> getMediaAuthenticityCategorys() {
    final java.lang.Object current = myData.get("mediaAuthenticityCategory");
   ...
   * @return originalMediaLink property set by first invocation of originalMediaLink method or {@code null}.
   */
  @JsonIgnore public MediaObject getOriginalMediaLinkMediaObject() {
    return (MediaObject) getValue("originalMediaLink");
  }
  /**
   * Link to the page containing an original version of the content, or directly to an online copy of the original [[MediaObject]] content, e.g. video file.
   * @return all originalMediaLink properties as {@link java.util.Collection} or an empty collection 
   * if originalMediaLink was not set.
   */
  @JsonIgnore public java.util.Collection<MediaObject> getOriginalMediaLinkMediaObjects() {
    final java.lang.Object current = myData.get("originalMediaLink");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return originalMediaLink property set by first invocation of originalMediaLink method or {@code null}.
   */
  @JsonIgnore public String getOriginalMediaLinkString() {
    return (String) getValue("originalMediaLink");
  }
  /**
   * Link to the page containing an original version of the content, or directly to an online copy of the original [[MediaObject]] content, e.g. video file.
   * @return all originalMediaLink properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return originalMediaLink property set by first invocation of originalMediaLink method or {@code null}.
   */
  @JsonIgnore public WebPage getOriginalMediaLinkWebPage() {
    return (WebPage) getValue("originalMediaLink");
  }
  /**
   * Link to the page containing an original version of the content, or directly to an online copy of the original [[MediaObject]] content, e.g. video file.
   * @return all originalMediaLink properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return originalMediaContextDescription property set by first invocation of originalMediaContextDescription method or {@code null}.
   */
  ...
  /**
   * Describes, in a [[MediaReview]] when dealing with [[DecontextualizedContent]], background information that can contribute to better interpretation of the [[MediaObject]].
   * @return all originalMediaContextDescription properties as {@link java.util.Collection} or an empty collection 
   * if originalMediaContextDescription was not set.
   */
  ...
  /**
   * Builder for {@link MediaReview}
   */
  public static class Builder extends Review.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MediaReview build() {
      return new MediaReview(myData);
    }
    /**
     * Indicates a MediaManipulationRatingEnumeration classification of a media object (in the context of how it was published or shared).
     * @param mediaManipulationRatingEnumeration value to set
     * @return this builder instance
     */
    @NotNull public Builder mediaAuthenticityCategory(@NotNull MediaManipulationRatingEnumeration mediaManipulationRatingEnumeration) {
      putValue("mediaAuthenticityCategory", mediaManipulationRatingEnumeration);
      return this;
    }
    /**
     * Remove mediaAuthenticityCategory property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeMediaAuthenticityCategory() {
      removeValue("mediaAuthenticityCategory");
      return this;
    }
    /**
     * Get currently set value for mediaAuthenticityCategory property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getMediaAuthenticityCategory() {
      return myData.get("mediaAuthenticityCategory");
    }
    /**
     * Link to the page containing an original version of the content, or directly to an online copy of the original [[MediaObject]] content, e.g. video file.
     ...
     * @return this builder instance
     */
    @NotNull public Builder originalMediaLink(@NotNull MediaObject mediaObject) {
      putValue("originalMediaLink", mediaObject);
      return this;
    }
    /**
     * Link to the page containing an original version of the content, or directly to an online copy of the original [[MediaObject]] content, e.g. video file.
     ...
     * @return this builder instance
     */
    @NotNull public Builder originalMediaLink(@NotNull MediaObject.Builder mediaObject) {
      putValue("originalMediaLink", mediaObject.build());
      return this;
    }
    /**
     * Link to the page containing an original version of the content, or directly to an online copy of the original [[MediaObject]] content, e.g. video file.
     * @param originalMediaLink value to set
     * @return this builder instance
     */
    @NotNull public Builder originalMediaLink(@NotNull String originalMediaLink) {
      putValue("originalMediaLink", originalMediaLink);
      return this;
    }
    /**
     * Link to the page containing an original version of the content, or directly to an online copy of the original [[MediaObject]] content, e.g. video file.
     ...
     * @return this builder instance
     */
    @NotNull public Builder originalMediaLink(@NotNull WebPage webPage) {
      putValue("originalMediaLink", webPage);
      return this;
    }
    /**
     * Link to the page containing an original version of the content, or directly to an online copy of the original [[MediaObject]] content, e.g. video file.
     ...
     * @return this builder instance
     */
    @NotNull public Builder originalMediaLink(@NotNull WebPage.Builder webPage) {
      putValue("originalMediaLink", webPage.build());
      return this;
    }
    /**
     * Remove originalMediaLink property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeOriginalMediaLink() {
      removeValue("originalMediaLink");
      return this;
    }
    /**
     * Get currently set value for originalMediaLink property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getOriginalMediaLink() {
      return myData.get("originalMediaLink");
    }
    /**
     * Describes, in a [[MediaReview]] when dealing with [[DecontextualizedContent]], background information that can contribute to better interpretation of the [[MediaObject]].
     * @param originalMediaContextDescription value to set
     * @return this builder instance
     */
    ...
    /**
     * Remove originalMediaContextDescription property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeOriginalMediaContextDescription() {
      removeValue("originalMediaContextDescription");
      return this;
    }
    /**
     * Get currently set value for originalMediaContextDescription property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getOriginalMediaContextDescription() {
      return myData.get("originalMediaContextDescription");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("mediaAuthenticityCategory".equals(key) && value instanceof MediaManipulationRatingEnumeration) { this.mediaAuthenticityCategory((MediaManipulationRatingEnumeration)value); return; }
      if ("mediaAuthenticityCategorys".equals(key) && value instanceof MediaManipulationRatingEnumeration) { this.mediaAuthenticityCategory((MediaManipulationRatingEnumeration)value); return; }
      if ("originalMediaLink".equals(key) && value instanceof MediaObject) { this.originalMediaLink((MediaObject)value); return; }
      if ("originalMediaLinks".equals(key) && value instanceof MediaObject) { this.originalMediaLink((MediaObject)value); return; }
      if ("originalMediaLink".equals(key) && value instanceof String) { this.originalMediaLink((String)value); return; }
