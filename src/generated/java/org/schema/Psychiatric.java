 ...
 */
public class Psychiatric extends MedicalBusiness {
  protected Psychiatric(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link Psychiatric}
   */
  public static class Builder extends MedicalBusiness.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public Psychiatric build() {
      return new Psychiatric(myData);
    }
    /**
