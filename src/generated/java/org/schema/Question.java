...
public class Question extends Comment {
   ...
   * @return answerCount property set by first invocation of answerCount method or {@code null}.
   */
  @JsonIgnore public Integer getAnswerCount() {
    return (Integer) getValue("answerCount");
  }
  /**
   * The number of answers this question has received.
   * @return all answerCount properties as {@link java.util.Collection} or an empty collection 
   * if answerCount was not set.
   */
  @JsonIgnore public java.util.Collection<Integer> getAnswerCounts() {
    final java.lang.Object current = myData.get("answerCount");
   ...
   * @return eduQuestionType property set by first invocation of eduQuestionType method or {@code null}.
   */
  @JsonIgnore public String getEduQuestionType() {
    return (String) getValue("eduQuestionType");
  }
  /**
   * For questions that are part of learning resources (e.g. Quiz), eduQuestionType indicates the format of question being given. Example: &quot;Multiple choice&quot;, &quot;Open ended&quot;, &quot;Flashcard&quot;.
   * @return all eduQuestionType properties as {@link java.util.Collection} or an empty collection 
   * if eduQuestionType was not set.
   */
  @JsonIgnore public java.util.Collection<String> getEduQuestionTypes() {
    final java.lang.Object current = myData.get("eduQuestionType");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return suggestedAnswer property set by first invocation of suggestedAnswer method or {@code null}.
   */
  @JsonIgnore public SuggestedAnswer getSuggestedAnswer() {
    return (SuggestedAnswer) getValue("suggestedAnswer");
  }
  /**
   * An answer (possibly one of several, possibly incorrect) to a Question, e.g. on a Question/Answer site.
   * @return all suggestedAnswer properties as {@link java.util.Collection} or an empty collection 
   * if suggestedAnswer was not set.
   */
  @JsonIgnore public java.util.Collection<SuggestedAnswer> getSuggestedAnswers() {
    final java.lang.Object current = myData.get("suggestedAnswer");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return acceptedAnswer property set by first invocation of acceptedAnswer method or {@code null}.
   */
  ...
  /**
   * The answer(s) that has been accepted as best, typically on a Question/Answer site. Sites vary in their selection mechanisms, e.g. drawing on community opinion and/or the view of the Question author.
   * @return all acceptedAnswer properties as {@link java.util.Collection} or an empty collection 
   * if acceptedAnswer was not set.
   */
  @JsonIgnore public java.util.Collection<SuggestedAnswer> getAcceptedAnswers() {
    final java.lang.Object current = myData.get("acceptedAnswer");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<SuggestedAnswer>) current;
    }
  ...
  protected Question(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends Comment.Builder {
     ...
     */
    @NotNull public Builder answerCount(@NotNull Integer integer) {
      putValue("answerCount", integer);
      return this;
    }
    /**
     * Remove answerCount property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAnswerCount() {
      removeValue("answerCount");
      return this;
    }
    /**
     * Get currently set value for answerCount property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAnswerCount() {
      return myData.get("answerCount");
    }
    /**
     * For questions that are part of learning resources (e.g. Quiz), eduQuestionType indicates the format of question being given. Example: &quot;Multiple choice&quot;, &quot;Open ended&quot;, &quot;Flashcard&quot;.
     * @param eduQuestionType value to set
     * @return this builder instance
     */
    @NotNull public Builder eduQuestionType(@NotNull String eduQuestionType) {
      putValue("eduQuestionType", eduQuestionType);
      return this;
    }
    /**
     * Remove eduQuestionType property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeEduQuestionType() {
      removeValue("eduQuestionType");
      return this;
    }
    /**
     * Get currently set value for eduQuestionType property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getEduQuestionType() {
      return myData.get("eduQuestionType");
    }
    /**
     * An answer (possibly one of several, possibly incorrect) to a Question, e.g. on a Question/Answer site.
     * @param suggestedAnswer value to set
     * @return this builder instance
     */
    @NotNull public Builder suggestedAnswer(@NotNull SuggestedAnswer suggestedAnswer) {
      putValue("suggestedAnswer", suggestedAnswer);
      return this;
    }
    /**
     * Remove suggestedAnswer property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSuggestedAnswer() {
      removeValue("suggestedAnswer");
      return this;
    }
    /**
     * Get currently set value for suggestedAnswer property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSuggestedAnswer() {
      return myData.get("suggestedAnswer");
    }
    /**
     * The answer(s) that has been accepted as best, typically on a Question/Answer site. Sites vary in their selection mechanisms, e.g. drawing on community opinion and/or the view of the Question author.
     * @param suggestedAnswer value to set
    ...
    /**
     * Remove acceptedAnswer property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAcceptedAnswer() {
      removeValue("acceptedAnswer");
      return this;
    }
    /**
     * Get currently set value for acceptedAnswer property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAcceptedAnswer() {
      return myData.get("acceptedAnswer");
    }
    /**
    ...
    /**
     * Remove downvoteCount property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeDownvoteCount() {
      removeValue("downvoteCount");
      return this;
    }
    /**
     * Get currently set value for downvoteCount property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getDownvoteCount() {
      return myData.get("downvoteCount");
    }
    /**
    ...
    /**
     * Remove upvoteCount property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeUpvoteCount() {
      removeValue("upvoteCount");
      return this;
    }
    /**
     * Get currently set value for upvoteCount property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getUpvoteCount() {
      return myData.get("upvoteCount");
    }
    /**
     ...
     * @return this builder instance
     */
    @NotNull public Builder parentItem(@NotNull Comment comment) {
      putValue("parentItem", comment);
      return this;
    }
    /**
     * The parent of a question, answer or item in general.
     ...
     * @return this builder instance
     */
    @NotNull public Builder parentItem(@NotNull Comment.Builder comment) {
      putValue("parentItem", comment.build());
      return this;
    }
    /**
     * Remove parentItem property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeParentItem() {
      removeValue("parentItem");
      return this;
    }
    /**
     * Get currently set value for parentItem property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getParentItem() {
      return myData.get("parentItem");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("answerCount".equals(key) && value instanceof Integer) { this.answerCount((Integer)value); return; }
      if ("answerCounts".equals(key) && value instanceof Integer) { this.answerCount((Integer)value); return; }
      if ("eduQuestionType".equals(key) && value instanceof String) { this.eduQuestionType((String)value); return; }
