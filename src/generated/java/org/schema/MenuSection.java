...
public class MenuSection extends CreativeWork {
   ...
   * @return hasMenuSection property set by first invocation of hasMenuSection method or {@code null}.
   */
  @JsonIgnore public MenuSection getHasMenuSection() {
    return (MenuSection) getValue("hasMenuSection");
  }
  /**
   * A subgrouping of the menu (by dishes, course, serving time period, etc.).
   * @return all hasMenuSection properties as {@link java.util.Collection} or an empty collection 
   * if hasMenuSection was not set.
   */
  @JsonIgnore public java.util.Collection<MenuSection> getHasMenuSections() {
    final java.lang.Object current = myData.get("hasMenuSection");
   ...
   * @return hasMenuItem property set by first invocation of hasMenuItem method or {@code null}.
   */
  @JsonIgnore public MenuItem getHasMenuItem() {
    return (MenuItem) getValue("hasMenuItem");
  }
  /**
   * A food or drink item contained in a menu or menu section.
   * @return all hasMenuItem properties as {@link java.util.Collection} or an empty collection 
   * if hasMenuItem was not set.
   */
  @JsonIgnore public java.util.Collection<MenuItem> getHasMenuItems() {
    final java.lang.Object current = myData.get("hasMenuItem");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected MenuSection(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    /**
     * A subgrouping of the menu (by dishes, course, serving time period, etc.).
     * @param menuSection value to set
     * @return this builder instance
     */
    @NotNull public Builder hasMenuSection(@NotNull MenuSection menuSection) {
      putValue("hasMenuSection", menuSection);
      return this;
    }
    /**
     * A subgrouping of the menu (by dishes, course, serving time period, etc.).
     ...
     * @return this builder instance
     */
    @NotNull public Builder hasMenuSection(@NotNull MenuSection.Builder menuSection) {
      putValue("hasMenuSection", menuSection.build());
      return this;
    }
    /**
     * Remove hasMenuSection property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeHasMenuSection() {
      removeValue("hasMenuSection");
      return this;
    }
    /**
     * Get currently set value for hasMenuSection property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getHasMenuSection() {
      return myData.get("hasMenuSection");
    }
    /**
     * A food or drink item contained in a menu or menu section.
     ...
     * @return this builder instance
     */
    @NotNull public Builder hasMenuItem(@NotNull MenuItem menuItem) {
      putValue("hasMenuItem", menuItem);
      return this;
    }
    /**
     * A food or drink item contained in a menu or menu section.
     ...
     * @return this builder instance
     */
    @NotNull public Builder hasMenuItem(@NotNull MenuItem.Builder menuItem) {
      putValue("hasMenuItem", menuItem.build());
      return this;
    }
    /**
     * Remove hasMenuItem property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeHasMenuItem() {
      removeValue("hasMenuItem");
      return this;
    }
    /**
     * Get currently set value for hasMenuItem property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getHasMenuItem() {
      return myData.get("hasMenuItem");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("hasMenuSection".equals(key) && value instanceof MenuSection) { this.hasMenuSection((MenuSection)value); return; }
      if ("hasMenuSections".equals(key) && value instanceof MenuSection) { this.hasMenuSection((MenuSection)value); return; }
      if ("hasMenuItem".equals(key) && value instanceof MenuItem) { this.hasMenuItem((MenuItem)value); return; }
      if ("hasMenuItems".equals(key) && value instanceof MenuItem) { this.hasMenuItem((MenuItem)value); return; }
