...
public class MediaReviewItem extends CreativeWork {
   ...
   * @return mediaItemAppearance property set by first invocation of mediaItemAppearance method or {@code null}.
   */
  @JsonIgnore public MediaObject getMediaItemAppearance() {
    return (MediaObject) getValue("mediaItemAppearance");
  }
  /**
   * In the context of a [[MediaReview]], indicates specific media item(s) that are grouped using a [[MediaReviewItem]].
   * @return all mediaItemAppearance properties as {@link java.util.Collection} or an empty collection 
   * if mediaItemAppearance was not set.
   */
  @JsonIgnore public java.util.Collection<MediaObject> getMediaItemAppearances() {
    final java.lang.Object current = myData.get("mediaItemAppearance");
  ...
  protected MediaReviewItem(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link MediaReviewItem}
   */
  public static class Builder extends CreativeWork.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public MediaReviewItem build() {
      return new MediaReviewItem(myData);
    }
    /**
     * In the context of a [[MediaReview]], indicates specific media item(s) that are grouped using a [[MediaReviewItem]].
     ...
     */
    @NotNull public Builder mediaItemAppearance(@NotNull MediaObject mediaObject) {
      putValue("mediaItemAppearance", mediaObject);
      return this;
    }
    /**
     * In the context of a [[MediaReview]], indicates specific media item(s) that are grouped using a [[MediaReviewItem]].
     ...
     * @return this builder instance
     */
    @NotNull public Builder mediaItemAppearance(@NotNull MediaObject.Builder mediaObject) {
      putValue("mediaItemAppearance", mediaObject.build());
      return this;
    }
    /**
     * Remove mediaItemAppearance property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeMediaItemAppearance() {
      removeValue("mediaItemAppearance");
      return this;
    }
    /**
     * Get currently set value for mediaItemAppearance property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getMediaItemAppearance() {
      return myData.get("mediaItemAppearance");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("mediaItemAppearance".equals(key) && value instanceof MediaObject) { this.mediaItemAppearance((MediaObject)value); return; }
      if ("mediaItemAppearances".equals(key) && value instanceof MediaObject) { this.mediaItemAppearance((MediaObject)value); return; }
