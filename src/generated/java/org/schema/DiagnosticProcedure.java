...
public class DiagnosticProcedure extends MedicalProcedure {
  protected DiagnosticProcedure(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  /**
   * Builder for {@link DiagnosticProcedure}
   */
  public static class Builder extends MedicalProcedure.Builder {
    public Builder(@NotNull HashMap<String,java.lang.Object> data) {
      super(data);
    }
    @NotNull public DiagnosticProcedure build() {
      return new DiagnosticProcedure(myData);
    }
    /**
