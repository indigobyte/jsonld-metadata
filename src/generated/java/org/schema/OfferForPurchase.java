 ...
 *   background on the underlying concepts.Source: https://github.com/schemaorg/schemaorg/issues/2348
 */
public class OfferForPurchase extends Offer {
  protected OfferForPurchase(java.util.Map<String,Object> data) {
    super(data);
  }
  
  /**
   * Builder for {@link OfferForPurchase}
   */
  public static class Builder extends Offer.Builder {
    public Builder(@NotNull HashMap<String,Object> data) {
      super(data);
    }
    @NotNull public OfferForPurchase build() {
      return new OfferForPurchase(myData);
    }
    /**
