...
public class DDxElement extends MedicalIntangible {
   ...
   * @return distinguishingSign property set by first invocation of distinguishingSign method or {@code null}.
   */
  @JsonIgnore public MedicalSignOrSymptom getDistinguishingSign() {
    return (MedicalSignOrSymptom) getValue("distinguishingSign");
  }
  /**
   * One of a set of signs and symptoms that can be used to distinguish this diagnosis from others in the differential diagnosis.
   * @return all distinguishingSign properties as {@link java.util.Collection} or an empty collection 
   * if distinguishingSign was not set.
   */
   ...
   * @return diagnosis property set by first invocation of diagnosis method or {@code null}.
   */
  ...
  /**
   * One or more alternative conditions considered in the differential diagnosis process as output of a diagnosis process.
   * @return all diagnosis properties as {@link java.util.Collection} or an empty collection 
   * if diagnosis was not set.
   */
  ...
  public static class Builder extends MedicalIntangible.Builder {
     ...
     */
    @NotNull public Builder distinguishingSign(@NotNull MedicalSignOrSymptom medicalSignOrSymptom) {
      putValue("distinguishingSign", medicalSignOrSymptom);
      return this;
    }
    /**
     * One of a set of signs and symptoms that can be used to distinguish this diagnosis from others in the differential diagnosis.
     ...
     * @return this builder instance
     */
    @NotNull public Builder distinguishingSign(@NotNull MedicalSignOrSymptom.Builder medicalSignOrSymptom) {
      putValue("distinguishingSign", medicalSignOrSymptom.build());
      return this;
    }
    /**
     * Remove distinguishingSign property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeDistinguishingSign() {
      removeValue("distinguishingSign");
      return this;
    }
    /**
     * Get currently set value for distinguishingSign property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getDistinguishingSign() {
      return myData.get("distinguishingSign");
    }
    /**
     * One or more alternative conditions considered in the differential diagnosis process as output of a diagnosis process.
    ...
    /**
     * Remove diagnosis property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeDiagnosis() {
      removeValue("diagnosis");
      return this;
    }
    /**
     * Get currently set value for diagnosis property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getDiagnosis() {
      return myData.get("diagnosis");
    }
    /**
