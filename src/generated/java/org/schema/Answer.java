 ...
 */
public class Answer extends Comment implements org.schema.SuggestedAnswer {
  /**
   * A step-by-step or full explanation about Answer. Can outline how this Answer was achieved or contain more broad clarification or statement about it. 
   * @return answerExplanation property set by first invocation of answerExplanation method or {@code null}.
   */
  @JsonIgnore public Comment getAnswerExplanationComment() {
    return (Comment) getValue("answerExplanation");
  }
  /**
   * A step-by-step or full explanation about Answer. Can outline how this Answer was achieved or contain more broad clarification or statement about it. 
   * @return all answerExplanation properties as {@link java.util.Collection} or an empty collection 
   * if answerExplanation was not set.
   */
  @JsonIgnore public java.util.Collection<Comment> getAnswerExplanationComments() {
    final java.lang.Object current = myData.get("answerExplanation");
   ...
   * @return answerExplanation property set by first invocation of answerExplanation method or {@code null}.
   */
  @JsonIgnore public WebContent getAnswerExplanationWebContent() {
    return (WebContent) getValue("answerExplanation");
  }
  /**
   * A step-by-step or full explanation about Answer. Can outline how this Answer was achieved or contain more broad clarification or statement about it. 
   * @return all answerExplanation properties as {@link java.util.Collection} or an empty collection 
  ...
  protected Answer(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends Comment.Builder {
     ...
     */
    @NotNull public Builder answerExplanation(@NotNull Comment comment) {
      putValue("answerExplanation", comment);
      return this;
    }
    /**
     * A step-by-step or full explanation about Answer. Can outline how this Answer was achieved or contain more broad clarification or statement about it. 
     ...
     * @return this builder instance
     */
    @NotNull public Builder answerExplanation(@NotNull Comment.Builder comment) {
      putValue("answerExplanation", comment.build());
      return this;
    }
    /**
     * A step-by-step or full explanation about Answer. Can outline how this Answer was achieved or contain more broad clarification or statement about it. 
     ...
     * @return this builder instance
     */
    @NotNull public Builder answerExplanation(@NotNull WebContent webContent) {
      putValue("answerExplanation", webContent);
      return this;
    }
    /**
     * A step-by-step or full explanation about Answer. Can outline how this Answer was achieved or contain more broad clarification or statement about it. 
     ...
     * @return this builder instance
     */
    @NotNull public Builder answerExplanation(@NotNull WebContent.Builder webContent) {
      putValue("answerExplanation", webContent.build());
      return this;
    }
    /**
     * Remove answerExplanation property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeAnswerExplanation() {
      removeValue("answerExplanation");
      return this;
    }
    /**
     * Get currently set value for answerExplanation property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getAnswerExplanation() {
      return myData.get("answerExplanation");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("answerExplanation".equals(key) && value instanceof Comment) { this.answerExplanation((Comment)value); return; }
      if ("answerExplanations".equals(key) && value instanceof Comment) { this.answerExplanation((Comment)value); return; }
      if ("answerExplanation".equals(key) && value instanceof WebContent) { this.answerExplanation((WebContent)value); return; }
      if ("answerExplanations".equals(key) && value instanceof WebContent) { this.answerExplanation((WebContent)value); return; }
