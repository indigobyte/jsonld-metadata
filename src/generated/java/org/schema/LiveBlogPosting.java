...
public class LiveBlogPosting extends BlogPosting {
   ...
   * @return coverageEndTime property set by first invocation of coverageEndTime method or {@code null}.
   */
  @JsonIgnore public java.util.Date getCoverageEndTime() {
    return (java.util.Date) getValue("coverageEndTime");
  }
  /**
   * The time when the live blog will stop covering the Event. Note that coverage may continue after the Event concludes.
   * @return all coverageEndTime properties as {@link java.util.Collection} or an empty collection 
   * if coverageEndTime was not set.
   */
  @JsonIgnore public java.util.Collection<java.util.Date> getCoverageEndTimes() {
    final java.lang.Object current = myData.get("coverageEndTime");
   ...
   * @return coverageStartTime property set by first invocation of coverageStartTime method or {@code null}.
   */
  @JsonIgnore public java.util.Date getCoverageStartTime() {
    return (java.util.Date) getValue("coverageStartTime");
  }
  /**
   * The time when the live blog will begin covering the Event. Note that coverage may begin before the Event's start time. The LiveBlogPosting may also be created before coverage begins.
   * @return all coverageStartTime properties as {@link java.util.Collection} or an empty collection 
   * if coverageStartTime was not set.
   */
  @JsonIgnore public java.util.Collection<java.util.Date> getCoverageStartTimes() {
    final java.lang.Object current = myData.get("coverageStartTime");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<java.util.Date>) current;
    }
   ...
   * @return liveBlogUpdate property set by first invocation of liveBlogUpdate method or {@code null}.
   */
  @JsonIgnore public BlogPosting getLiveBlogUpdate() {
    return (BlogPosting) getValue("liveBlogUpdate");
  }
  /**
   * An update to the LiveBlog.
   * @return all liveBlogUpdate properties as {@link java.util.Collection} or an empty collection 
   * if liveBlogUpdate was not set.
   */
  @JsonIgnore public java.util.Collection<BlogPosting> getLiveBlogUpdates() {
    final java.lang.Object current = myData.get("liveBlogUpdate");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected LiveBlogPosting(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends BlogPosting.Builder {
     ...
     */
    @NotNull public Builder coverageEndTime(@NotNull java.util.Date date) {
      putValue("coverageEndTime", date);
      return this;
    }
    /**
     * Remove coverageEndTime property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCoverageEndTime() {
      removeValue("coverageEndTime");
      return this;
    }
    /**
     * Get currently set value for coverageEndTime property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCoverageEndTime() {
      return myData.get("coverageEndTime");
    }
    /**
     * The time when the live blog will begin covering the Event. Note that coverage may begin before the Event's start time. The LiveBlogPosting may also be created before coverage begins.
     * @param date value to set
     * @return this builder instance
     */
    @NotNull public Builder coverageStartTime(@NotNull java.util.Date date) {
      putValue("coverageStartTime", date);
      return this;
    }
    /**
     * Remove coverageStartTime property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeCoverageStartTime() {
      removeValue("coverageStartTime");
      return this;
    }
    /**
     * Get currently set value for coverageStartTime property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getCoverageStartTime() {
      return myData.get("coverageStartTime");
    }
    /**
     * An update to the LiveBlog.
     * @param blogPosting value to set
     * @return this builder instance
     */
    @NotNull public Builder liveBlogUpdate(@NotNull BlogPosting blogPosting) {
      putValue("liveBlogUpdate", blogPosting);
      return this;
    }
    /**
     * An update to the LiveBlog.
     ...
     * @return this builder instance
     */
    @NotNull public Builder liveBlogUpdate(@NotNull BlogPosting.Builder blogPosting) {
      putValue("liveBlogUpdate", blogPosting.build());
      return this;
    }
    /**
     * Remove liveBlogUpdate property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeLiveBlogUpdate() {
      removeValue("liveBlogUpdate");
      return this;
    }
    /**
     * Get currently set value for liveBlogUpdate property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getLiveBlogUpdate() {
      return myData.get("liveBlogUpdate");
    }
    /**
     ...
     * @return this builder instance
     */
    @NotNull public Builder sharedContent(@NotNull CreativeWork creativeWork) {
      putValue("sharedContent", creativeWork);
      return this;
    }
    /**
     * A CreativeWork such as an image, video, or audio clip shared as part of this posting.
     ...
     * @return this builder instance
     */
    @NotNull public Builder sharedContent(@NotNull CreativeWork.Builder creativeWork) {
      putValue("sharedContent", creativeWork.build());
      return this;
    }
    /**
     * Remove sharedContent property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeSharedContent() {
      removeValue("sharedContent");
      return this;
    }
    /**
     * Get currently set value for sharedContent property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getSharedContent() {
      return myData.get("sharedContent");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("coverageEndTime".equals(key) && value instanceof java.util.Date) { this.coverageEndTime((java.util.Date)value); return; }
      if ("coverageEndTimes".equals(key) && value instanceof java.util.Date) { this.coverageEndTime((java.util.Date)value); return; }
      if ("coverageStartTime".equals(key) && value instanceof java.util.Date) { this.coverageStartTime((java.util.Date)value); return; }
      if ("coverageStartTimes".equals(key) && value instanceof java.util.Date) { this.coverageStartTime((java.util.Date)value); return; }
      if ("liveBlogUpdate".equals(key) && value instanceof BlogPosting) { this.liveBlogUpdate((BlogPosting)value); return; }
      if ("liveBlogUpdates".equals(key) && value instanceof BlogPosting) { this.liveBlogUpdate((BlogPosting)value); return; }
