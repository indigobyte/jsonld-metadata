...
public class AnatomicalSystem extends MedicalEntity {
   ...
   * @return relatedStructure property set by first invocation of relatedStructure method or {@code null}.
   */
  ...
  /**
   * Related anatomical structure(s) that are not part of the system but relate or connect to it, such as vascular bundles associated with an organ system.
   * @return all relatedStructure properties as {@link java.util.Collection} or an empty collection 
   * if relatedStructure was not set.
   */
  @JsonIgnore public java.util.Collection<AnatomicalStructure> getRelatedStructures() {
    final java.lang.Object current = myData.get("relatedStructure");
   ...
   * @return comprisedOf property set by first invocation of comprisedOf method or {@code null}.
   */
  ...
  /**
   * Specifying something physically contained by something else. Typically used here for the underlying anatomical structures, such as organs, that comprise the anatomical system.
   * @return all comprisedOf properties as {@link java.util.Collection} or an empty collection 
   * if comprisedOf was not set.
   */
  @JsonIgnore public java.util.Collection<AnatomicalStructure> getComprisedOfAnatomicalStructures() {
    final java.lang.Object current = myData.get("comprisedOf");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<AnatomicalStructure>) current;
    }
   ...
   * if comprisedOf was not set.
   */
  @JsonIgnore public java.util.Collection<AnatomicalSystem> getComprisedOfAnatomicalSystems() {
    final java.lang.Object current = myData.get("comprisedOf");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
  ...
  protected AnatomicalSystem(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  /**
  ...
  public static class Builder extends MedicalEntity.Builder {
    ...
    /**
     * Remove relatedStructure property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeRelatedStructure() {
      removeValue("relatedStructure");
      return this;
    }
    /**
     * Get currently set value for relatedStructure property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getRelatedStructure() {
      return myData.get("relatedStructure");
    }
    /**
     * Specifying something physically contained by something else. Typically used here for the underlying anatomical structures, such as organs, that comprise the anatomical system.
     * @param anatomicalStructure value to set
    ...
    /**
     * Remove comprisedOf property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeComprisedOf() {
      removeValue("comprisedOf");
      return this;
    }
    /**
     * Get currently set value for comprisedOf property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getComprisedOf() {
      return myData.get("comprisedOf");
    }
    /**
     * A medical condition associated with this anatomy.
