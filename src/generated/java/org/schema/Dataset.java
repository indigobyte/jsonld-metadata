...
/**
 * A body of structured information describing some topic(s) of interest.Equivalent class: http://purl.org/dc/dcmitype/Dataset
 */
public class Dataset extends CreativeWork {
  /**
   * A data catalog which contains this dataset.
   * @return includedInDataCatalog property set by first invocation of includedInDataCatalog method or {@code null}.
   */
  @JsonIgnore public DataCatalog getIncludedInDataCatalog() {
    return (DataCatalog) getValue("includedInDataCatalog");
  }
  /**
   * A data catalog which contains this dataset.
   * @return all includedInDataCatalog properties as {@link java.util.Collection} or an empty collection 
   * if includedInDataCatalog was not set.
   */
  @JsonIgnore public java.util.Collection<DataCatalog> getIncludedInDataCatalogs() {
    final java.lang.Object current = myData.get("includedInDataCatalog");
   ...
   * @return issn property set by first invocation of issn method or {@code null}.
   */
  ...
  /**
   * The International Standard Serial Number (ISSN) that identifies this serial publication. You can repeat this property to identify different formats of, or the linking ISSN (ISSN-L) for, this serial publication.
   * @return all issn properties as {@link java.util.Collection} or an empty collection 
   * if issn was not set.
   */
  @JsonIgnore public java.util.Collection<Identifier> getIssns() {
    final java.lang.Object current = myData.get("issn");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return distribution property set by first invocation of distribution method or {@code null}.
   */
  @JsonIgnore public DataDownload getDistribution() {
    return (DataDownload) getValue("distribution");
  }
  /**
   * A downloadable form of this dataset, at a specific location, in a specific format.
   * @return all distribution properties as {@link java.util.Collection} or an empty collection 
   * if distribution was not set.
   */
  @JsonIgnore public java.util.Collection<DataDownload> getDistributions() {
    final java.lang.Object current = myData.get("distribution");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return variablesMeasured property set by first invocation of variablesMeasured method or {@code null}.
   */
  @JsonIgnore public PropertyValue getVariablesMeasuredPropertyValue() {
    return (PropertyValue) getValue("variablesMeasured");
  }
  /**
   * Originally named [[variablesMeasured]], The [[variableMeasured]] property can indicate (repeated as necessary) the  variables that are measured in some dataset, either described as text or as pairs of identifier and description using PropertyValue.
   * @return all variablesMeasured properties as {@link java.util.Collection} or an empty collection 
   * if variablesMeasured was not set.
   */
  @JsonIgnore public java.util.Collection<PropertyValue> getVariablesMeasuredPropertyValues() {
    final java.lang.Object current = myData.get("variablesMeasured");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
   ...
   * @return variablesMeasured property set by first invocation of variablesMeasured method or {@code null}.
   */
  @JsonIgnore public String getVariablesMeasuredString() {
    return (String) getValue("variablesMeasured");
  }
  /**
   * Originally named [[variablesMeasured]], The [[variableMeasured]] property can indicate (repeated as necessary) the  variables that are measured in some dataset, either described as text or as pairs of identifier and description using PropertyValue.
   * @return all variablesMeasured properties as {@link java.util.Collection} or an empty collection 
   ...
   * @return variableMeasured property set by first invocation of variableMeasured method or {@code null}.
   */
  @JsonIgnore public PropertyValue getVariableMeasuredPropertyValue() {
    return (PropertyValue) getValue("variableMeasured");
  }
  /**
   * The variableMeasured property can indicate (repeated as necessary) the  variables that are measured in some dataset, either described as text or as pairs of identifier and description using PropertyValue.
   * @return all variableMeasured properties as {@link java.util.Collection} or an empty collection 
   * if variableMeasured was not set.
   */
  @JsonIgnore public java.util.Collection<PropertyValue> getVariableMeasuredPropertyValues() {
    final java.lang.Object current = myData.get("variableMeasured");
    if (current == null) return Collections.emptyList();
    if (current instanceof java.util.Collection) {
      return (java.util.Collection<PropertyValue>) current;
    }
   ...
   * @return variableMeasured property set by first invocation of variableMeasured method or {@code null}.
   */
  @JsonIgnore public String getVariableMeasuredString() {
    return (String) getValue("variableMeasured");
  }
  /**
   * The variableMeasured property can indicate (repeated as necessary) the  variables that are measured in some dataset, either described as text or as pairs of identifier and description using PropertyValue.
   * @return all variableMeasured properties as {@link java.util.Collection} or an empty collection 
  ...
  protected Dataset(java.util.Map<String,java.lang.Object> data) {
    super(data);
  }
  ...
  public static class Builder extends CreativeWork.Builder {
    ...
    /**
     * A data catalog which contains this dataset.
     * @param dataCatalog value to set
     * @return this builder instance
     */
    @NotNull public Builder includedInDataCatalog(@NotNull DataCatalog dataCatalog) {
      putValue("includedInDataCatalog", dataCatalog);
      return this;
    }
    /**
     * A data catalog which contains this dataset.
     ...
     * @return this builder instance
     */
    @NotNull public Builder includedInDataCatalog(@NotNull DataCatalog.Builder dataCatalog) {
      putValue("includedInDataCatalog", dataCatalog.build());
      return this;
    }
    /**
     * Remove includedInDataCatalog property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeIncludedInDataCatalog() {
      removeValue("includedInDataCatalog");
      return this;
    }
    /**
     * Get currently set value for includedInDataCatalog property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getIncludedInDataCatalog() {
      return myData.get("includedInDataCatalog");
    }
    /**
     * The International Standard Serial Number (ISSN) that identifies this serial publication. You can repeat this property to identify different formats of, or the linking ISSN (ISSN-L) for, this serial publication.
    ...
    /**
     * A downloadable form of this dataset, at a specific location, in a specific format.
     * @param dataDownload value to set
     * @return this builder instance
     */
    @NotNull public Builder distribution(@NotNull DataDownload dataDownload) {
      putValue("distribution", dataDownload);
      return this;
    }
    /**
     * A downloadable form of this dataset, at a specific location, in a specific format.
     ...
     * @return this builder instance
     */
    @NotNull public Builder distribution(@NotNull DataDownload.Builder dataDownload) {
      putValue("distribution", dataDownload.build());
      return this;
    }
    /**
     * Remove distribution property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeDistribution() {
      removeValue("distribution");
      return this;
    }
    /**
     * Get currently set value for distribution property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getDistribution() {
      return myData.get("distribution");
    }
    /**
     * Originally named [[variablesMeasured]], The [[variableMeasured]] property can indicate (repeated as necessary) the  variables that are measured in some dataset, either described as text or as pairs of identifier and description using PropertyValue.
     ...
     * @return this builder instance
     */
    @NotNull public Builder variablesMeasured(@NotNull PropertyValue propertyValue) {
      putValue("variablesMeasured", propertyValue);
      return this;
    }
    /**
     * Originally named [[variablesMeasured]], The [[variableMeasured]] property can indicate (repeated as necessary) the  variables that are measured in some dataset, either described as text or as pairs of identifier and description using PropertyValue.
     ...
     * @return this builder instance
     */
    @NotNull public Builder variablesMeasured(@NotNull PropertyValue.Builder propertyValue) {
      putValue("variablesMeasured", propertyValue.build());
      return this;
    }
    /**
     * Originally named [[variablesMeasured]], The [[variableMeasured]] property can indicate (repeated as necessary) the  variables that are measured in some dataset, either described as text or as pairs of identifier and description using PropertyValue.
     * @param variablesMeasured value to set
     * @return this builder instance
     */
    @NotNull public Builder variablesMeasured(@NotNull String variablesMeasured) {
      putValue("variablesMeasured", variablesMeasured);
      return this;
    }
    /**
     * Remove variablesMeasured property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeVariablesMeasured() {
      removeValue("variablesMeasured");
      return this;
    }
    /**
     * Get currently set value for variablesMeasured property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getVariablesMeasured() {
      return myData.get("variablesMeasured");
    }
    /**
     *                                         A technique or technology used in a [[Dataset]] (or [[DataDownload]], [[DataCatalog]]),
     * corresponding to the method used for measuring the corresponding variable(s) (described using [[variableMeasured]]). This is oriented towards scientific and scholarly dataset publication but may have broader applicability; it is not intended as a full representation of measurement, but rather as a high level summary for dataset discovery.
     ...
     * @return this builder instance
     */
    @NotNull public Builder variableMeasured(@NotNull PropertyValue propertyValue) {
      putValue("variableMeasured", propertyValue);
      return this;
    }
    /**
     * The variableMeasured property can indicate (repeated as necessary) the  variables that are measured in some dataset, either described as text or as pairs of identifier and description using PropertyValue.
     ...
     * @return this builder instance
     */
    @NotNull public Builder variableMeasured(@NotNull PropertyValue.Builder propertyValue) {
      putValue("variableMeasured", propertyValue.build());
      return this;
    }
    /**
     * The variableMeasured property can indicate (repeated as necessary) the  variables that are measured in some dataset, either described as text or as pairs of identifier and description using PropertyValue.
     * @param variableMeasured value to set
     * @return this builder instance
     */
    @NotNull public Builder variableMeasured(@NotNull String variableMeasured) {
      putValue("variableMeasured", variableMeasured);
      return this;
    }
    /**
     * Remove variableMeasured property from the builder.
     * If this property is repeatable, all instances are removed.
     * @return this builder instance
     */
    @NotNull public Builder removeVariableMeasured() {
      removeValue("variableMeasured");
      return this;
    }
    /**
     * Get currently set value for variableMeasured property in this builder.
     * @return previously set value or {@code null}. If multiple values have been 
     * set to this property, then {@link java.util.Collection} instance will be 
     * returned.
     */
    @Nullable public java.lang.Object getVariableMeasured() {
      return myData.get("variableMeasured");
    }
    /**
    ...
    @Override protected void fromMap(String key, java.lang.Object value) {
      if ("includedInDataCatalog".equals(key) && value instanceof DataCatalog) { this.includedInDataCatalog((DataCatalog)value); return; }
      if ("includedInDataCatalogs".equals(key) && value instanceof DataCatalog) { this.includedInDataCatalog((DataCatalog)value); return; }
      ...
      if ("distribution".equals(key) && value instanceof DataDownload) { this.distribution((DataDownload)value); return; }
      if ("distributions".equals(key) && value instanceof DataDownload) { this.distribution((DataDownload)value); return; }
      if ("variablesMeasured".equals(key) && value instanceof PropertyValue) { this.variablesMeasured((PropertyValue)value); return; }
      if ("variablesMeasureds".equals(key) && value instanceof PropertyValue) { this.variablesMeasured((PropertyValue)value); return; }
      if ("variablesMeasured".equals(key) && value instanceof String) { this.variablesMeasured((String)value); return; }
      if ("variablesMeasureds".equals(key) && value instanceof String) { this.variablesMeasured((String)value); return; }
      ...
      if ("variableMeasured".equals(key) && value instanceof PropertyValue) { this.variableMeasured((PropertyValue)value); return; }
      if ("variableMeasureds".equals(key) && value instanceof PropertyValue) { this.variableMeasured((PropertyValue)value); return; }
      if ("variableMeasured".equals(key) && value instanceof String) { this.variableMeasured((String)value); return; }
      if ("variableMeasureds".equals(key) && value instanceof String) { this.variableMeasured((String)value); return; }
