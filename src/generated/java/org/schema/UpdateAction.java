...
public class UpdateAction extends Action {
  @JsonIgnore public Collection getCollection() {
    return (Collection) getValue("collection");
  }
  @JsonIgnore public Collection<Collection> getCollections() {
    final Object current = myData.get("collection");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<Collection>) current;
    }
    return Arrays.asList((Collection) current);
  }
  @JsonIgnore public TargetCollection getTargetCollection() {
    return (TargetCollection) getValue("targetCollection");
  }
  @JsonIgnore public Collection<TargetCollection> getTargetCollections() {
    final Object current = myData.get("targetCollection");
    if (current == null) return Collections.emptyList();
    if (current instanceof Collection) {
      return (Collection<TargetCollection>) current;
    }
    return Arrays.asList((TargetCollection) current);
  }
  protected UpdateAction(java.util.Map<String,Object> data) {
    super(data);
  }
  ...
  public static class Builder extends Action.Builder {
    ...
    @NotNull public UpdateAction build() {
      return new UpdateAction(myData);
    }
    @NotNull public Builder collection(@NotNull Collection collection) {
      putValue("collection", collection);
      return this;
    }
    @NotNull public Builder targetCollection(@NotNull TargetCollection targetCollection) {
      putValue("targetCollection", targetCollection);
      return this;
    }
    /**
    ...
    @Override protected void fromMap(String key, Object value) {
      if ("collection".equals(key) && value instanceof Collection) { collection((Collection)value); return; }
      if ("collections".equals(key) && value instanceof Collection) { collection((Collection)value); return; }
      if ("targetCollection".equals(key) && value instanceof TargetCollection) { targetCollection((TargetCollection)value); return; }
      if ("targetCollections".equals(key) && value instanceof TargetCollection) { targetCollection((TargetCollection)value); return; }
