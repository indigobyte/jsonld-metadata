...
public class UpdateAction extends Action {
   ...
   * @return targetCollection property set by first invocation of targetCollection method or {@code null}.
   */
  ...
  /**
   * A sub property of object. The collection target of the action.
   * @return all targetCollection properties as {@link java.util.Collection} or an empty collection 
   * if targetCollection was not set.
   */
