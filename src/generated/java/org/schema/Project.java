...
public class Project extends Organization {
  ...
  public static class Builder extends Organization.Builder {
    ...
    @NotNull public Project build() {
      return new Project(myData);
    }
    /**
